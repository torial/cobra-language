...
// Source: selfhost/pipeline_test.zbr
...
pub fn runPipeline(src: []const u8) anyerror![]const u8 {
// zbr:selfhost/pipeline_test.zbr:14
    const pm_node = try Parser.Parser.parse(src);
// zbr:selfhost/pipeline_test.zbr:15
    switch (pm_node) {
        .module_ => |pm_ptr| {
            const pm = pm_ptr.*;
// zbr:selfhost/pipeline_test.zbr:17
            const module = try ASTBuilder.build(pm, "<test>");
// zbr:selfhost/pipeline_test.zbr:18
            return generateModule(module, "<test>");
        },
        else => {
// zbr:selfhost/pipeline_test.zbr:20
...
pub fn runPipelineFull(src: []const u8, preamble_path: []const u8) anyerror![]const u8 {
// zbr:selfhost/pipeline_test.zbr:23
    const pm_node = try Parser.Parser.parse(src);
// zbr:selfhost/pipeline_test.zbr:24
    switch (pm_node) {
        .module_ => |pm_ptr| {
            const pm = pm_ptr.*;
// zbr:selfhost/pipeline_test.zbr:26
            const module = try ASTBuilder.build(pm, "<test>");
// zbr:selfhost/pipeline_test.zbr:27
            return try generateFull(module, "<test>", preamble_path);
        },
        else => {
// zbr:selfhost/pipeline_test.zbr:29
            _error_ctx = .{ .message = "expected module_ from parser", .details = null };
            return error.ZebraError;
        },
    }
...
pub const PipelineTest = struct {
    _type_tag: u64 = _ttag_PipelineTest,
    pub fn run(self: *PipelineTest) anyerror!void {
// zbr:selfhost/pipeline_test.zbr:33
        try self.testEmptyClass();
// zbr:selfhost/pipeline_test.zbr:34
        try self.testClassWithField();
// zbr:selfhost/pipeline_test.zbr:35
        try self.testMethodWithReturn();
// zbr:selfhost/pipeline_test.zbr:36
        try self.testVarWithInit();
// zbr:selfhost/pipeline_test.zbr:37
        try self.testEnumDecl();
// zbr:selfhost/pipeline_test.zbr:38
        try self.testEntryPointNonThrowing();
// zbr:selfhost/pipeline_test.zbr:39
        try self.testEntryPointThrowing();
// zbr:selfhost/pipeline_test.zbr:40
        try self.testEntryPointNoMain();
// zbr:selfhost/pipeline_test.zbr:41
        try self.testResolverClean();
// zbr:selfhost/pipeline_test.zbr:42
        try self.testResolverError();
// zbr:selfhost/pipeline_test.zbr:43
        try self.testFullRoundTrip();
// zbr:selfhost/pipeline_test.zbr:44
        std.debug.print("{s}\n", .{"pipeline_test: all OK"});
    }

    pub fn testEmptyClass(self: *PipelineTest) anyerror!void {
        _ = self;
// zbr:selfhost/pipeline_test.zbr:49
        const src = "class Foo\n";
// zbr:selfhost/pipeline_test.zbr:50
        const zig = try runPipeline(src);
// zbr:selfhost/pipeline_test.zbr:51
        if (!((std.mem.indexOf(u8, zig, "pub const Foo") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:52
        if (!((std.mem.indexOf(u8, zig, "_type_tag") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:53
        std.debug.print("{s}\n", .{"testEmptyClass: OK"});
    }

    pub fn testClassWithField(self: *PipelineTest) anyerror!void {
        _ = self;
// zbr:selfhost/pipeline_test.zbr:56
        const src = "class Point\n    var x as int\n    var y as int\n";
// zbr:selfhost/pipeline_test.zbr:57
        const zig = try runPipeline(src);
// zbr:selfhost/pipeline_test.zbr:58
        if (!((std.mem.indexOf(u8, zig, "pub const Point") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:59
        if (!((std.mem.indexOf(u8, zig, "x: i64") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:60
        if (!((std.mem.indexOf(u8, zig, "y: i64") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:61
        std.debug.print("{s}\n", .{"testClassWithField: OK"});
    }

    pub fn testMethodWithReturn(self: *PipelineTest) anyerror!void {
        _ = self;
// zbr:selfhost/pipeline_test.zbr:64
        const src = "class Calc\n    def double(n as int) as int\n        return n\n";
// zbr:selfhost/pipeline_test.zbr:65
        const zig = try runPipeline(src);
// zbr:selfhost/pipeline_test.zbr:66
        if (!((std.mem.indexOf(u8, zig, "pub fn double") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:67
        if (!((std.mem.indexOf(u8, zig, "return") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:68
        std.debug.print("{s}\n", .{"testMethodWithReturn: OK"});
    }

    pub fn testVarWithInit(self: *PipelineTest) anyerror!void {
        _ = self;
// zbr:selfhost/pipeline_test.zbr:71
        const src = "class Counter\n    def reset()\n        var count = 0\n";
// zbr:selfhost/pipeline_test.zbr:72
        const zig = try runPipeline(src);
// zbr:selfhost/pipeline_test.zbr:73
        if (!((std.mem.indexOf(u8, zig, "pub fn reset") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:74
        if (!((std.mem.indexOf(u8, zig, "count") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:75
        std.debug.print("{s}\n", .{"testVarWithInit: OK"});
    }

    pub fn testEnumDecl(self: *PipelineTest) anyerror!void {
        _ = self;
// zbr:selfhost/pipeline_test.zbr:78
        const src = "enum Color\n    red\n    green\n    blue\n";
// zbr:selfhost/pipeline_test.zbr:79
        const zig = try runPipeline(src);
// zbr:selfhost/pipeline_test.zbr:80
        if (!((std.mem.indexOf(u8, zig, "pub const Color") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:81
        if (!((std.mem.indexOf(u8, zig, "red") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:82
        if (!((std.mem.indexOf(u8, zig, "blue") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:83
        std.debug.print("{s}\n", .{"testEnumDecl: OK"});
    }

    pub fn testEntryPointNonThrowing(self: *PipelineTest) anyerror!void {
        _ = self;
// zbr:selfhost/pipeline_test.zbr:88
        const src = "class Main\n    shared def main()\n        pass\n";
// zbr:selfhost/pipeline_test.zbr:89
        const pm_node = try Parser.Parser.parse(src);
// zbr:selfhost/pipeline_test.zbr:90
        switch (pm_node) {
            .module_ => |pm_ptr| {
                const pm = pm_ptr.*;
// zbr:selfhost/pipeline_test.zbr:92
                const module = try ASTBuilder.build(pm, "<test>");
// zbr:selfhost/pipeline_test.zbr:93
                const entry: []const u8 = generateEntryPoint(module);
// zbr:selfhost/pipeline_test.zbr:94
                if (!(_zebra_in("pub fn main()", entry))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/pipeline_test.zbr:95
                if (!(_zebra_in("_arena.allocator()", entry))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/pipeline_test.zbr:96
                if (!(_zebra_in("Main.main()", entry))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/pipeline_test.zbr:97
                if (!((!_zebra_in("catch", entry)))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
            },
            else => {
// zbr:selfhost/pipeline_test.zbr:99
                _error_ctx = .{ .message = "expected module", .details = null };
                return error.ZebraError;
            },
        }
// zbr:selfhost/pipeline_test.zbr:100
        std.debug.print("{s}\n", .{"testEntryPointNonThrowing: OK"});
    }

    pub fn testEntryPointThrowing(self: *PipelineTest) anyerror!void {
        _ = self;
// zbr:selfhost/pipeline_test.zbr:103
        const src = "class App\n    shared def main() throws\n        pass\n";
// zbr:selfhost/pipeline_test.zbr:104
        const pm_node = try Parser.Parser.parse(src);
// zbr:selfhost/pipeline_test.zbr:105
        switch (pm_node) {
            .module_ => |pm_ptr| {
                const pm = pm_ptr.*;
// zbr:selfhost/pipeline_test.zbr:107
                const module = try ASTBuilder.build(pm, "<test>");
// zbr:selfhost/pipeline_test.zbr:108
                const entry: []const u8 = generateEntryPoint(module);
// zbr:selfhost/pipeline_test.zbr:109
                if (!(_zebra_in("App.main() catch", entry))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/pipeline_test.zbr:110
                if (!(_zebra_in("ZebraError", entry))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
            },
            else => {
// zbr:selfhost/pipeline_test.zbr:112
                _error_ctx = .{ .message = "expected module", .details = null };
                return error.ZebraError;
            },
        }
// zbr:selfhost/pipeline_test.zbr:113
        std.debug.print("{s}\n", .{"testEntryPointThrowing: OK"});
    }

    pub fn testEntryPointNoMain(self: *PipelineTest) anyerror!void {
        _ = self;
// zbr:selfhost/pipeline_test.zbr:116
        const src = "class Util\n    def helper()\n        pass\n";
// zbr:selfhost/pipeline_test.zbr:117
        const pm_node = try Parser.Parser.parse(src);
// zbr:selfhost/pipeline_test.zbr:118
        switch (pm_node) {
            .module_ => |pm_ptr| {
                const pm = pm_ptr.*;
// zbr:selfhost/pipeline_test.zbr:120
                const module = try ASTBuilder.build(pm, "<test>");
// zbr:selfhost/pipeline_test.zbr:121
                const entry: []const u8 = generateEntryPoint(module);
// zbr:selfhost/pipeline_test.zbr:122
...
// zbr:selfhost/pipeline_test.zbr:124
                _error_ctx = .{ .message = "expected module", .details = null };
                return error.ZebraError;
            },
        }
// zbr:selfhost/pipeline_test.zbr:125
        std.debug.print("{s}\n", .{"testEntryPointNoMain: OK"});
    }

    pub fn testResolverClean(self: *PipelineTest) anyerror!void {
        _ = self;
// zbr:selfhost/pipeline_test.zbr:130
        const src = "class Adder\n    def add(a as int, b as int) as int\n        return a\n";
// zbr:selfhost/pipeline_test.zbr:131
        const pm_node = try Parser.Parser.parse(src);
// zbr:selfhost/pipeline_test.zbr:132
        var resolver = Resolver.Resolver.init();
// zbr:selfhost/pipeline_test.zbr:133
        try resolver.resolve(pm_node);
// zbr:selfhost/pipeline_test.zbr:134
        if (!((resolver.errorCount() == 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:135
        std.debug.print("{s}\n", .{"testResolverClean: OK"});
    }

    pub fn testResolverError(self: *PipelineTest) anyerror!void {
        _ = self;
// zbr:selfhost/pipeline_test.zbr:139
        const src = "class Broken\n    def bad()\n        print undeclaredVar\n";
// zbr:selfhost/pipeline_test.zbr:140
        const pm_node = try Parser.Parser.parse(src);
// zbr:selfhost/pipeline_test.zbr:141
        var resolver = Resolver.Resolver.init();
// zbr:selfhost/pipeline_test.zbr:142
        try resolver.resolve(pm_node);
// zbr:selfhost/pipeline_test.zbr:143
        if (!(_zebra_gt(resolver.errorCount(), 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:144
        std.debug.print("{s}\n", .{"testResolverError: OK"});
    }

    pub fn testFullRoundTrip(self: *PipelineTest) anyerror!void {
        _ = self;
// zbr:selfhost/pipeline_test.zbr:151
        const preamble_path = "selfhost/stdlib_preamble.zig";
// zbr:selfhost/pipeline_test.zbr:152
        if ((!(blk: { std.fs.cwd().access(preamble_path, .{}) catch break :blk false; break :blk true; }))) {
// zbr:selfhost/pipeline_test.zbr:153
            std.debug.print("{s}\n", .{_str_concat(_str_concat("testFullRoundTrip: SKIP (preamble file not found at ", preamble_path, _allocator), ")", _allocator)});
// zbr:selfhost/pipeline_test.zbr:154
            return;
        }
// zbr:selfhost/pipeline_test.zbr:155
        const src = "class Main\n    shared def main()\n        pass\n";
// zbr:selfhost/pipeline_test.zbr:156
        const zig = try runPipelineFull(src, preamble_path);
// zbr:selfhost/pipeline_test.zbr:158
        if (!((std.mem.indexOf(u8, zig, "const std") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:159
        if (!((std.mem.indexOf(u8, zig, "_arena") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:161
        if (!((std.mem.indexOf(u8, zig, "pub const Main") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:163
        if (!((std.mem.indexOf(u8, zig, "pub fn main()") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:164
        if (!((std.mem.indexOf(u8, zig, "Main.main()") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/pipeline_test.zbr:165
        std.debug.print("{s}\n", .{"testFullRoundTrip: OK"});
    }

    pub fn init() *PipelineTest {
        const self = _allocator.create(PipelineTest) catch @panic("OOM");
        self._type_tag = _ttag_PipelineTest;
        return self;
    }

};

const _ttag_PipelineTest: u64 = 425869399;
const _reflect_PipelineTest_name: []const u8 = "PipelineTest";
const _reflect_PipelineTest_fields: []const []const u8 = &.{};
const _reflect_PipelineTest_field_types: []const []const u8 = &.{};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:selfhost/pipeline_test.zbr:170
        var _try_err_13b8: ?anyerror = null;
        _try_blk_13b8: {
// zbr:selfhost/pipeline_test.zbr:171
            const t = PipelineTest.init();
// zbr:selfhost/pipeline_test.zbr:172
            t.run() catch |_tc_11e116f1378| { _try_err_13b8 = _tc_11e116f1378; break :_try_blk_13b8; };
            break :_try_blk_13b8;
        }
        if (_try_err_13b8 != null) {
// zbr:selfhost/pipeline_test.zbr:174
