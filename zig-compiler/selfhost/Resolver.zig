...
// zbr:selfhost\Resolver.zbr:98
                self.module_scope.put((_allocator.dupe(u8, path) catch @panic("OOM")), 5) catch unreachable;
            },
            else => {
                // pass
            },
...
// zbr:selfhost\Resolver.zbr:145
                try self.enterMethod(m.stmts);
            },
            .init_ => |i| {
// zbr:selfhost\Resolver.zbr:147
                try self.enterMethod(i.stmts);
            },
            else => {
                // pass
            },
    ...
    pub fn enterMethod(self: *Resolver, stmts: std.ArrayList(PNode)) anyerror!void {
