...
// Source: selfhost/codegen_test.zbr
...
pub fn zspan() Span {
// zbr:selfhost/codegen_test.zbr:20
    return Span.init(0, 0, 0, 0);
}

pub fn zmods() Modifiers {
// zbr:selfhost/codegen_test.zbr:23
    return Modifiers.init(false, false, false, false, false, false);
}

pub fn zshared() Modifiers {
// zbr:selfhost/codegen_test.zbr:26
    return Modifiers.init(false, false, false, true, false, false);
}

pub fn namedTr(name: []const u8) TypeRef {
// zbr:selfhost/codegen_test.zbr:29
    return TypeRef{ .named = NamedTypeRef.init(zspan(), name) };
}

pub fn nilableTr(inner: TypeRef) TypeRef {
// zbr:selfhost/codegen_test.zbr:32
    return TypeRef{ .nilable = _box_1cb161c07d0: { const _bp_1cb161c07d0 = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_1cb161c07d0.* = inner; break :_box_1cb161c07d0 _bp_1cb161c07d0; } };
}

pub fn refToTr(inner: TypeRef) TypeRef {
// zbr:selfhost/codegen_test.zbr:35
    return TypeRef{ .ref_to = _box_1cb161c0a38: { const _bp_1cb161c0a38 = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_1cb161c0a38.* = inner; break :_box_1cb161c0a38 _bp_1cb161c0a38; } };
}

pub fn errUnionTr(inner: TypeRef) TypeRef {
// zbr:selfhost/codegen_test.zbr:38
    return TypeRef{ .error_union = _box_1cb161c0de0: { const _bp_1cb161c0de0 = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_1cb161c0de0.* = inner; break :_box_1cb161c0de0 _bp_1cb161c0de0; } };
}

pub fn listTr(elem: TypeRef) TypeRef {
// zbr:selfhost/codegen_test.zbr:41
    var args = std.ArrayList(TypeRef){};
// zbr:selfhost/codegen_test.zbr:42
    args.append(_allocator, elem) catch unreachable;
// zbr:selfhost/codegen_test.zbr:43
    return TypeRef{ .generic = GenericTypeRef.init(zspan(), "List", args) };
}

pub fn hashTr(k: TypeRef, v: TypeRef) TypeRef {
// zbr:selfhost/codegen_test.zbr:46
    var args = std.ArrayList(TypeRef){};
// zbr:selfhost/codegen_test.zbr:47
    args.append(_allocator, k) catch unreachable;
// zbr:selfhost/codegen_test.zbr:48
    args.append(_allocator, v) catch unreachable;
// zbr:selfhost/codegen_test.zbr:49
    return TypeRef{ .generic = GenericTypeRef.init(zspan(), "HashMap", args) };
}

pub fn makeGen() Generator {
// zbr:selfhost/codegen_test.zbr:52
    const w = Writer.init();
// zbr:selfhost/codegen_test.zbr:53
    const cn = StrSet.init();
// zbr:selfhost/codegen_test.zbr:54
    return Generator.init(w, 0, "", false, false, false, false, null, "", "", cn);
}

pub fn testWriter() void {
// zbr:selfhost/codegen_test.zbr:59
    var w = Writer.init();
// zbr:selfhost/codegen_test.zbr:60
    w.emit("hello");
// zbr:selfhost/codegen_test.zbr:61
    w.emit(" world");
// zbr:selfhost/codegen_test.zbr:62
    if (!(std.mem.eql(u8, w.result(), "hello world"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:63
    std.debug.print("{s}\n", .{"1. Writer: OK"});
}

pub fn testGenerator() void {
// zbr:selfhost/codegen_test.zbr:68
    var g = makeGen();
// zbr:selfhost/codegen_test.zbr:69
    std.debug.assert((g.indent == 0));
// zbr:selfhost/codegen_test.zbr:70
    std.debug.assert(std.mem.eql(u8, g.owner, ""));
// zbr:selfhost/codegen_test.zbr:71
    std.debug.assert((!g.in_method));
// zbr:selfhost/codegen_test.zbr:73
    var g2 = g.withOwner("Foo");
// zbr:selfhost/codegen_test.zbr:74
    std.debug.assert(std.mem.eql(u8, g2.owner, "Foo"));
// zbr:selfhost/codegen_test.zbr:75
    std.debug.assert(std.mem.eql(u8, g.owner, ""));
// zbr:selfhost/codegen_test.zbr:77
    var g3 = g2.indented();
// zbr:selfhost/codegen_test.zbr:78
    std.debug.assert((g3.indent == 1));
// zbr:selfhost/codegen_test.zbr:79
    std.debug.assert((g2.indent == 0));
// zbr:selfhost/codegen_test.zbr:81
    const g4 = g3.asMethod();
// zbr:selfhost/codegen_test.zbr:82
    std.debug.assert(g4.in_method);
// zbr:selfhost/codegen_test.zbr:83
    std.debug.assert((!g3.in_method));
// zbr:selfhost/codegen_test.zbr:85
    std.debug.print("{s}\n", .{"2. Generator context-forking: OK"});
}

pub fn testGenTypePrimitive() void {
// zbr:selfhost/codegen_test.zbr:90
    var g = makeGen();
// zbr:selfhost/codegen_test.zbr:92
    g.genType(namedTr("int"));
// zbr:selfhost/codegen_test.zbr:93
    if (!(std.mem.eql(u8, g.w.result(), "i64"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:95
    var g2 = makeGen();
// zbr:selfhost/codegen_test.zbr:96
    g2.genType(namedTr("str"));
// zbr:selfhost/codegen_test.zbr:97
    if (!(std.mem.eql(u8, g2.w.result(), "[]const u8"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:99
    var g3 = makeGen();
// zbr:selfhost/codegen_test.zbr:100
    g3.genType(namedTr("float"));
// zbr:selfhost/codegen_test.zbr:101
    if (!(std.mem.eql(u8, g3.w.result(), "f64"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:103
    var g4 = makeGen();
// zbr:selfhost/codegen_test.zbr:104
    g4.genType(namedTr("bool"));
// zbr:selfhost/codegen_test.zbr:105
    if (!(std.mem.eql(u8, g4.w.result(), "bool"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:107
    var g5 = makeGen();
// zbr:selfhost/codegen_test.zbr:108
    g5.genType(namedTr("char"));
// zbr:selfhost/codegen_test.zbr:109
    if (!(std.mem.eql(u8, g5.w.result(), "u21"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:111
    var g6 = makeGen();
// zbr:selfhost/codegen_test.zbr:112
    g6.genType(TypeRef.void_);
// zbr:selfhost/codegen_test.zbr:113
    if (!(std.mem.eql(u8, g6.w.result(), "void"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:115
    var g7 = makeGen();
// zbr:selfhost/codegen_test.zbr:116
    g7.genType(namedTr("MyStruct"));
// zbr:selfhost/codegen_test.zbr:117
    if (!(std.mem.eql(u8, g7.w.result(), "MyStruct"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:120
    var cn = StrSet.init();
// zbr:selfhost/codegen_test.zbr:121
    cn.add("MyClass");
// zbr:selfhost/codegen_test.zbr:122
    const w8 = Writer.init();
// zbr:selfhost/codegen_test.zbr:123
    var g8 = Generator.init(w8, 0, "", false, false, false, false, null, "", "", cn);
// zbr:selfhost/codegen_test.zbr:124
    g8.genType(namedTr("MyClass"));
// zbr:selfhost/codegen_test.zbr:125
    if (!(std.mem.eql(u8, g8.w.result(), "*MyClass"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:127
    std.debug.print("{s}\n", .{"3. genType primitives: OK"});
}

pub fn testGenTypeGenerics() void {
// zbr:selfhost/codegen_test.zbr:132
    var g = makeGen();
// zbr:selfhost/codegen_test.zbr:133
    g.genType(listTr(namedTr("int")));
// zbr:selfhost/codegen_test.zbr:134
    if (!(std.mem.eql(u8, g.w.result(), "std.ArrayList(i64)"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:136
    var g2 = makeGen();
// zbr:selfhost/codegen_test.zbr:137
    g2.genType(hashTr(namedTr("str"), namedTr("int")));
// zbr:selfhost/codegen_test.zbr:138
    if (!(std.mem.eql(u8, g2.w.result(), "std.StringHashMap(i64)"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:140
    var g3 = makeGen();
// zbr:selfhost/codegen_test.zbr:141
    var rargs = std.ArrayList(TypeRef){};
// zbr:selfhost/codegen_test.zbr:142
    rargs.append(_allocator, namedTr("int")) catch unreachable;
// zbr:selfhost/codegen_test.zbr:143
    rargs.append(_allocator, namedTr("str")) catch unreachable;
// zbr:selfhost/codegen_test.zbr:144
    g3.genType(TypeRef{ .generic = GenericTypeRef.init(zspan(), "Result", rargs) });
// zbr:selfhost/codegen_test.zbr:145
    if (!(std.mem.eql(u8, g3.w.result(), "_Result(i64, []const u8)"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:147
    std.debug.print("{s}\n", .{"4. genType generics: OK"});
}

pub fn testGenTypeCompound() void {
// zbr:selfhost/codegen_test.zbr:152
    var g = makeGen();
// zbr:selfhost/codegen_test.zbr:153
    g.genType(nilableTr(namedTr("int")));
// zbr:selfhost/codegen_test.zbr:154
    if (!(std.mem.eql(u8, g.w.result(), "?i64"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:156
    var g2 = makeGen();
// zbr:selfhost/codegen_test.zbr:157
    g2.genType(errUnionTr(namedTr("str")));
// zbr:selfhost/codegen_test.zbr:158
    if (!(std.mem.eql(u8, g2.w.result(), "anyerror![]const u8"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:160
    var g3 = makeGen();
// zbr:selfhost/codegen_test.zbr:161
    g3.genType(refToTr(namedTr("Node")));
// zbr:selfhost/codegen_test.zbr:162
    if (!(std.mem.eql(u8, g3.w.result(), "*Node"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:164
    std.debug.print("{s}\n", .{"5. genType compound: OK"});
}

pub fn testGenEnum() void {
// zbr:selfhost/codegen_test.zbr:169
    var members = std.ArrayList(EnumMember){};
// zbr:selfhost/codegen_test.zbr:170
    members.append(_allocator, EnumMember.init(zspan(), "red", null)) catch unreachable;
// zbr:selfhost/codegen_test.zbr:171
    members.append(_allocator, EnumMember.init(zspan(), "green", null)) catch unreachable;
// zbr:selfhost/codegen_test.zbr:172
    members.append(_allocator, EnumMember.init(zspan(), "blue", null)) catch unreachable;
// zbr:selfhost/codegen_test.zbr:173
    const n = DeclEnum.init(zspan(), zmods(), "Color", null, members);
// zbr:selfhost/codegen_test.zbr:175
    var g = makeGen();
// zbr:selfhost/codegen_test.zbr:176
    g.genEnum(n);
// zbr:selfhost/codegen_test.zbr:177
    const out = g.w.result();
// zbr:selfhost/codegen_test.zbr:178
    if (!(std.mem.eql(u8, out, "pub const Color = enum {\n    red,\n    green,\n    blue,\n};\n\n"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:179
    std.debug.print("{s}\n", .{"6. genEnum: OK"});
}

pub fn testGenUnion() void {
// zbr:selfhost/codegen_test.zbr:184
    var variants = std.ArrayList(UnionVariant){};
// zbr:selfhost/codegen_test.zbr:185
    variants.append(_allocator, UnionVariant.init(zspan(), "int_", namedTr("int"))) catch unreachable;
// zbr:selfhost/codegen_test.zbr:186
    variants.append(_allocator, UnionVariant.init(zspan(), "str_", namedTr("str"))) catch unreachable;
// zbr:selfhost/codegen_test.zbr:187
    variants.append(_allocator, UnionVariant.init(zspan(), "void_", null)) catch unreachable;
// zbr:selfhost/codegen_test.zbr:188
    const n = DeclUnion.init(zspan(), zmods(), "Value", variants);
// zbr:selfhost/codegen_test.zbr:190
    var g = makeGen();
// zbr:selfhost/codegen_test.zbr:191
    g.genUnion(n);
// zbr:selfhost/codegen_test.zbr:192
    const out = g.w.result();
// zbr:selfhost/codegen_test.zbr:193
    if (!(std.mem.eql(u8, out, "pub const Value = union(enum) {\n    int_: i64,\n    str_: []const u8,\n    void_,\n};\n\n"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:194
    std.debug.print("{s}\n", .{"7. genUnion: OK"});
}

pub fn testGenStruct() void {
// zbr:selfhost/codegen_test.zbr:199
    var members = std.ArrayList(Decl){};
// zbr:selfhost/codegen_test.zbr:200
    const fld1 = DeclVar.init(zspan(), zmods(), "x", namedTr("int"), null, false);
...
// zbr:selfhost/codegen_test.zbr:202
    members.append(_allocator, Decl{ .var_ = _box_1cb162f6670: { const _bp_1cb162f6670 = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_1cb162f6670.* = fld1; break :_box_1cb162f6670 _bp_1cb162f6670; } }) catch unreachable;
// zbr:selfhost/codegen_test.zbr:203
    members.append(_allocator, Decl{ .var_ = _box_1cb162f6898: { const _bp_1cb162f6898 = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_1cb162f6898.* = fld2; break :_box_1cb162f6898 _bp_1cb162f6898; } }) catch unreachable;
...
// zbr:selfhost/codegen_test.zbr:206
    var g = makeGen();
// zbr:selfhost/codegen_test.zbr:207
    g.genStruct(n);
// zbr:selfhost/codegen_test.zbr:208
    const out = g.w.result();
// zbr:selfhost/codegen_test.zbr:209
    if (!(_zebra_in("pub const Point = struct {", out))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:210
    if (!(_zebra_in("x: i64,", out))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:211
    if (!(_zebra_in("name: []const u8,", out))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:212
    if (!(_zebra_in("};\n\n", out))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:213
    std.debug.print("{s}\n", .{"8. genStruct: OK"});
}

pub fn testGenClass() void {
// zbr:selfhost/codegen_test.zbr:218
    var members = std.ArrayList(Decl){};
...
// zbr:selfhost/codegen_test.zbr:220
    members.append(_allocator, Decl{ .var_ = _box_1cb16301210: { const _bp_1cb16301210 = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_1cb16301210.* = fld; break :_box_1cb16301210 _bp_1cb16301210; } }) catch unreachable;
...
// zbr:selfhost/codegen_test.zbr:223
    var g = makeGen();
// zbr:selfhost/codegen_test.zbr:224
    g.genClass(cls);
// zbr:selfhost/codegen_test.zbr:225
    const out = g.w.result();
// zbr:selfhost/codegen_test.zbr:226
    if (!(_zebra_in("pub const Counter = struct {", out))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:227
    if (!(_zebra_in("_type_tag: u64 = _ttag_Counter,", out))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:228
    if (!(_zebra_in("value: i64,", out))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:229
    if (!(_zebra_in("_ttag_Counter: u64 = _zbr_hash", out))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:231
    if (!(g.class_names.contains_("Counter"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:232
    std.debug.print("{s}\n", .{"9. genClass: OK"});
}

pub fn testGenFieldDeclSB() void {
// zbr:selfhost/codegen_test.zbr:237
    var g = makeGen();
// zbr:selfhost/codegen_test.zbr:238
    var ig = g.indented();
// zbr:selfhost/codegen_test.zbr:239
    const fld = DeclVar.init(zspan(), zmods(), "buf", namedTr("StringBuilder"), null, false);
// zbr:selfhost/codegen_test.zbr:240
    ig.genFieldDecl(fld);
// zbr:selfhost/codegen_test.zbr:241
    const out = g.w.result();
// zbr:selfhost/codegen_test.zbr:242
    if (!(std.mem.eql(u8, out, "    buf: std.ArrayList(u8) = .{},\n"))) {
        std.debug.print("assertion failed\n", .{});
        unreachable;
    }
// zbr:selfhost/codegen_test.zbr:243
    std.debug.print("{s}\n", .{"10. genFieldDecl StringBuilder: OK"});
}

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:selfhost/codegen_test.zbr:250
        testWriter();
// zbr:selfhost/codegen_test.zbr:251
        testGenerator();
// zbr:selfhost/codegen_test.zbr:252
        testGenTypePrimitive();
// zbr:selfhost/codegen_test.zbr:253
        testGenTypeGenerics();
// zbr:selfhost/codegen_test.zbr:254
        testGenTypeCompound();
// zbr:selfhost/codegen_test.zbr:255
        testGenEnum();
// zbr:selfhost/codegen_test.zbr:256
        testGenUnion();
// zbr:selfhost/codegen_test.zbr:257
        testGenStruct();
// zbr:selfhost/codegen_test.zbr:258
        testGenClass();
// zbr:selfhost/codegen_test.zbr:259
        testGenFieldDeclSB();
// zbr:selfhost/codegen_test.zbr:260
        std.debug.print("{s}\n", .{"codegen_test: all OK"});
    }
