...
// Source: C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr
...
pub const LexerTest = struct {
    _type_tag: u64 = _ttag_LexerTest,
    pub fn testKeyword() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:9
        var _try_err_f0: ?anyerror = null;
        _try_blk_f0: {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:10
            const toks = Lexer.tokenize("class") catch |_e| { _try_err_f0 = _e; break :_try_blk_f0; };
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:11
            if (!((toks.items.len == 3))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:12
            std.debug.print("{s}\n", .{"testKeyword: OK"});
            break :_try_blk_f0;
        }
        if (_try_err_f0 != null) {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:14
            std.debug.print("{s}\n", .{_str_concat("testKeyword FAILED: ", _error_ctx.message, _allocator)});
        }
    }

    pub fn testIdentifier() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:17
        var _try_err_1f0: ?anyerror = null;
        _try_blk_1f0: {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:18
            const toks = Lexer.tokenize("fooBar") catch |_e| { _try_err_1f0 = _e; break :_try_blk_1f0; };
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:19
            if (!((toks.items.len == 3))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:20
            if (!(std.mem.eql(u8, toks.items[@as(usize, @intCast(0))].text, "fooBar"))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:21
            std.debug.print("{s}\n", .{"testIdentifier: OK"});
            break :_try_blk_1f0;
        }
        if (_try_err_1f0 != null) {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:23
            std.debug.print("{s}\n", .{_str_concat("testIdentifier FAILED: ", _error_ctx.message, _allocator)});
        }
    }

    pub fn testClass() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:26
        var _try_err_60: ?anyerror = null;
        _try_blk_60: {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:27
            const src: []const u8 = "class Foo\n    def bar\n        return 1";
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:28
            const toks = Lexer.tokenize(src) catch |_e| { _try_err_60 = _e; break :_try_blk_60; };
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:29
            if (!(_zebra_ge(toks.items.len, 10))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:30
            if (!(std.mem.eql(u8, toks.items[@as(usize, @intCast(0))].text, "class"))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:31
            if (!(std.mem.eql(u8, toks.items[@as(usize, @intCast(1))].text, "Foo"))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:32
            std.debug.print("{s}\n", .{_str_concat(_str_concat("testClass: OK (", (std.fmt.allocPrint(_allocator, "{}", .{toks.items.len}) catch unreachable), _allocator), " tokens)", _allocator)});
            break :_try_blk_60;
        }
        if (_try_err_60 != null) {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:34
            std.debug.print("{s}\n", .{_str_concat("testClass FAILED: ", _error_ctx.message, _allocator)});
        }
    }

    pub fn testIndentation() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:37
        var _try_err_a50: ?anyerror = null;
        _try_blk_a50: {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:38
            const src: []const u8 = "a\n    b\n        c\n    d\ne";
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:39
            const toks = Lexer.tokenize(src) catch |_e| { _try_err_a50 = _e; break :_try_blk_a50; };
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:40
            if (!(_zebra_ge(toks.items.len, 12))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:41
            std.debug.print("{s}\n", .{_str_concat(_str_concat("testIndentation: OK (", (std.fmt.allocPrint(_allocator, "{}", .{toks.items.len}) catch unreachable), _allocator), " tokens)", _allocator)});
            break :_try_blk_a50;
        }
        if (_try_err_a50 != null) {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:43
            std.debug.print("{s}\n", .{_str_concat("testIndentation FAILED: ", _error_ctx.message, _allocator)});
        }
    }

    pub fn testLineComment() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:46
        var _try_err_16c0: ?anyerror = null;
        _try_blk_16c0: {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:47
            const src: []const u8 = "x # this is a comment\ny";
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:48
            const toks = Lexer.tokenize(src) catch |_e| { _try_err_16c0 = _e; break :_try_blk_16c0; };
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:49
            if (!((toks.items.len == 5))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:50
            if (!(std.mem.eql(u8, toks.items[@as(usize, @intCast(0))].text, "x"))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:51
            if (!(std.mem.eql(u8, toks.items[@as(usize, @intCast(2))].text, "y"))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:52
            std.debug.print("{s}\n", .{"testLineComment: OK"});
            break :_try_blk_16c0;
        }
        if (_try_err_16c0 != null) {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:54
            std.debug.print("{s}\n", .{_str_concat("testLineComment FAILED: ", _error_ctx.message, _allocator)});
        }
    }

    pub fn testOperators() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:57
        var _try_err_348: ?anyerror = null;
        _try_blk_348: {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:58
            const src: []const u8 = "a + b * c";
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:59
            const toks = Lexer.tokenize(src) catch |_e| { _try_err_348 = _e; break :_try_blk_348; };
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:60
            if (!((toks.items.len == 7))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:61
            if (!(std.mem.eql(u8, toks.items[@as(usize, @intCast(1))].text, "+"))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:62
            if (!(std.mem.eql(u8, toks.items[@as(usize, @intCast(3))].text, "*"))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:63
            std.debug.print("{s}\n", .{"testOperators: OK"});
            break :_try_blk_348;
        }
        if (_try_err_348 != null) {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:65
            std.debug.print("{s}\n", .{_str_concat("testOperators FAILED: ", _error_ctx.message, _allocator)});
        }
    }

    pub fn testIntLiteral() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:68
        var _try_err_d88: ?anyerror = null;
        _try_blk_d88: {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:69
            const src: []const u8 = "42";
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:70
            const toks = Lexer.tokenize(src) catch |_e| { _try_err_d88 = _e; break :_try_blk_d88; };
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:71
            if (!((toks.items.len == 3))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:72
            if (!(std.mem.eql(u8, toks.items[@as(usize, @intCast(0))].text, "42"))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:73
            std.debug.print("{s}\n", .{"testIntLiteral: OK"});
            break :_try_blk_d88;
        }
        if (_try_err_d88 != null) {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:75
            std.debug.print("{s}\n", .{_str_concat("testIntLiteral FAILED: ", _error_ctx.message, _allocator)});
        }
    }

    pub fn testOpenCall() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:78
        var _try_err_17c8: ?anyerror = null;
        _try_blk_17c8: {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:79
            const src: []const u8 = "foo()";
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:80
            const toks = Lexer.tokenize(src) catch |_e| { _try_err_17c8 = _e; break :_try_blk_17c8; };
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:81
            if (!((toks.items.len == 4))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:82
            if (!(std.mem.eql(u8, toks.items[@as(usize, @intCast(0))].text, "foo"))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:83
            std.debug.print("{s}\n", .{"testOpenCall: OK"});
            break :_try_blk_17c8;
        }
        if (_try_err_17c8 != null) {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:85
            std.debug.print("{s}\n", .{_str_concat("testOpenCall FAILED: ", _error_ctx.message, _allocator)});
        }
    }

    pub fn testSourcePositions() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:88
        var _try_err_23c8: ?anyerror = null;
        _try_blk_23c8: {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:89
            const src: []const u8 = "x\ny";
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:90
            const toks = Lexer.tokenize(src) catch |_e| { _try_err_23c8 = _e; break :_try_blk_23c8; };
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:91
            if (!((toks.items[@as(usize, @intCast(0))].line == 1))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:92
            if (!((toks.items[@as(usize, @intCast(0))].col == 1))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:93
            if (!((toks.items[@as(usize, @intCast(2))].line == 2))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:94
            std.debug.print("{s}\n", .{"testSourcePositions: OK"});
            break :_try_blk_23c8;
        }
        if (_try_err_23c8 != null) {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:96
            std.debug.print("{s}\n", .{_str_concat("testSourcePositions FAILED: ", _error_ctx.message, _allocator)});
        }
    }

    pub fn testTokenKinds() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:100
        var _try_err_3198: ?anyerror = null;
        _try_blk_3198: {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:101
            const toks = Lexer.tokenize("abc 123") catch |_e| { _try_err_3198 = _e; break :_try_blk_3198; };
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:102
            const idKind = toks.items[@as(usize, @intCast(0))].kind;
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:103
            const intKind = toks.items[@as(usize, @intCast(1))].kind;
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:104
            switch (idKind) {
                .id => {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:106
                    std.debug.print("{s}\n", .{"testTokenKinds id: OK"});
                },
                else => {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:108
                    std.debug.print("{s}\n", .{"testTokenKinds FAILED: expected id kind"});
                },
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:109
            switch (intKind) {
                .integer_lit => {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:111
                    std.debug.print("{s}\n", .{"testTokenKinds int: OK"});
                },
                else => {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:113
...
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:115
            std.debug.print("{s}\n", .{_str_concat("testTokenKinds FAILED: ", _error_ctx.message, _allocator)});
        }
    }

    pub fn testExposing() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:119
        var _try_err_3bc8: ?anyerror = null;
        _try_blk_3bc8: {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:120
            const toks = Lexer.tokenize("use Foo exposing Bar") catch |_e| { _try_err_3bc8 = _e; break :_try_blk_3bc8; };
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:121
            if (!(std.mem.eql(u8, toks.items[@as(usize, @intCast(2))].text, "exposing"))) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:122
            switch (toks.items[@as(usize, @intCast(2))].kind) {
                .kw_exposing => {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:124
                    std.debug.print("{s}\n", .{"testExposing: OK"});
                },
                else => {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:126
...
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:128
            std.debug.print("{s}\n", .{_str_concat("testExposing FAILED: ", _error_ctx.message, _allocator)});
        }
    }

    pub fn main() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:131
        std.debug.print("{s}\n", .{"=== Lexer Phase 1 Tests ==="});
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:132
        LexerTest.testKeyword();
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:133
        LexerTest.testIdentifier();
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:134
        LexerTest.testClass();
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:135
        LexerTest.testIndentation();
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:136
        LexerTest.testLineComment();
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:137
        LexerTest.testOperators();
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:138
        LexerTest.testIntLiteral();
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:139
        LexerTest.testOpenCall();
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:140
        LexerTest.testSourcePositions();
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:141
        LexerTest.testTokenKinds();
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:142
        LexerTest.testExposing();
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:143
        std.debug.print("{s}\n", .{"=== Tests complete ==="});
    }
...
const _ttag_LexerTest: u64 = 1417532185;
const _reflect_LexerTest_name: []const u8 = "LexerTest";
const _reflect_LexerTest_fields: []const []const u8 = &.{};
const _reflect_LexerTest_field_types: []const []const u8 = &.{};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:C:/projects/cobra-language/zig-compiler/selfhost/lexer_test.zbr:148
        LexerTest.main();
    }
