...
// Source: selfhost/resolver_test.zbr
...
pub const ResolverTest = struct {
    _type_tag: u64 = _ttag_ResolverTest,
    pub fn run(self: *ResolverTest) anyerror!void {
// zbr:selfhost/resolver_test.zbr:18
        try self.testEmptyClass();
// zbr:selfhost/resolver_test.zbr:19
        try self.testFieldInScope();
// zbr:selfhost/resolver_test.zbr:20
        try self.testMethodInScope();
// zbr:selfhost/resolver_test.zbr:21
        try self.testLocalDeclaredBeforeUse();
// zbr:selfhost/resolver_test.zbr:22
        try self.testUndefinedName();
// zbr:selfhost/resolver_test.zbr:23
        try self.testLocalNotVisibleBeforeDecl();
// zbr:selfhost/resolver_test.zbr:24
        try self.testArithExpr();
// zbr:selfhost/resolver_test.zbr:25
        try self.testIfCond();
// zbr:selfhost/resolver_test.zbr:26
        try self.testWhileLoop();
// zbr:selfhost/resolver_test.zbr:27
        try self.testTryCatch();
// zbr:selfhost/resolver_test.zbr:28
        std.debug.print("{s}\n", .{"resolver_test: all assertions passed"});
    }

    pub fn testEmptyClass(self: *ResolverTest) anyerror!void {
        _ = self;
// zbr:selfhost/resolver_test.zbr:33
        const root = try Parser.Parser.parse("class Empty\n");
// zbr:selfhost/resolver_test.zbr:34
        var r = Resolver.Resolver.init();
// zbr:selfhost/resolver_test.zbr:35
        try r.resolve(root);
// zbr:selfhost/resolver_test.zbr:36
        if (!((r.errorCount() == 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:37
        if (!(_zebra_ge(r.symbolCount(), 1))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:38
        std.debug.print("{s}\n", .{"testEmptyClass: OK"});
    }

    pub fn testFieldInScope(self: *ResolverTest) anyerror!void {
        _ = self;
// zbr:selfhost/resolver_test.zbr:42
        const src = "class Point\n    var x as int\n    def getX() as int\n        return x\n";
// zbr:selfhost/resolver_test.zbr:43
        const root = try Parser.Parser.parse(src);
// zbr:selfhost/resolver_test.zbr:44
        var r = Resolver.Resolver.init();
// zbr:selfhost/resolver_test.zbr:45
        try r.resolve(root);
// zbr:selfhost/resolver_test.zbr:46
        if (!((r.errorCount() == 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:47
        std.debug.print("{s}\n", .{"testFieldInScope: OK"});
    }

    pub fn testMethodInScope(self: *ResolverTest) anyerror!void {
        _ = self;
// zbr:selfhost/resolver_test.zbr:51
        const src = "class Counter\n    def value() as int\n        return 0\n    def doubled() as int\n        return value\n";
// zbr:selfhost/resolver_test.zbr:52
        const root = try Parser.Parser.parse(src);
// zbr:selfhost/resolver_test.zbr:53
        var r = Resolver.Resolver.init();
// zbr:selfhost/resolver_test.zbr:54
        try r.resolve(root);
// zbr:selfhost/resolver_test.zbr:55
        if (!((r.errorCount() == 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:56
        std.debug.print("{s}\n", .{"testMethodInScope: OK"});
    }

    pub fn testLocalDeclaredBeforeUse(self: *ResolverTest) anyerror!void {
        _ = self;
// zbr:selfhost/resolver_test.zbr:60
        const src = "class C\n    def compute() as int\n        var x as int = 0\n        return x\n";
// zbr:selfhost/resolver_test.zbr:61
        const root = try Parser.Parser.parse(src);
// zbr:selfhost/resolver_test.zbr:62
        var r = Resolver.Resolver.init();
// zbr:selfhost/resolver_test.zbr:63
        try r.resolve(root);
// zbr:selfhost/resolver_test.zbr:64
        if (!((r.errorCount() == 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:65
        std.debug.print("{s}\n", .{"testLocalDeclaredBeforeUse: OK"});
    }

    pub fn testUndefinedName(self: *ResolverTest) anyerror!void {
        _ = self;
// zbr:selfhost/resolver_test.zbr:69
        const src = "class C\n    def broken() as int\n        return undeclared\n";
// zbr:selfhost/resolver_test.zbr:70
        const root = try Parser.Parser.parse(src);
// zbr:selfhost/resolver_test.zbr:71
        var r = Resolver.Resolver.init();
// zbr:selfhost/resolver_test.zbr:72
        try r.resolve(root);
// zbr:selfhost/resolver_test.zbr:73
        if (!((r.errorCount() == 1))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:74
        const msg = r.firstError();
// zbr:selfhost/resolver_test.zbr:75
        if (!((std.mem.indexOf(u8, msg, "undeclared") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:76
        std.debug.print("{s}\n", .{"testUndefinedName: OK"});
    }

    pub fn testLocalNotVisibleBeforeDecl(self: *ResolverTest) anyerror!void {
        _ = self;
// zbr:selfhost/resolver_test.zbr:81
        const src = "class C\n    def bad()\n        var x as int = x\n";
// zbr:selfhost/resolver_test.zbr:82
        const root = try Parser.Parser.parse(src);
// zbr:selfhost/resolver_test.zbr:83
        var r = Resolver.Resolver.init();
// zbr:selfhost/resolver_test.zbr:84
        try r.resolve(root);
// zbr:selfhost/resolver_test.zbr:85
        if (!((r.errorCount() == 1))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:86
        const msg = r.firstError();
// zbr:selfhost/resolver_test.zbr:87
        if (!((std.mem.indexOf(u8, msg, "'x'") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:88
        std.debug.print("{s}\n", .{"testLocalNotVisibleBeforeDecl: OK"});
    }

    pub fn testArithExpr(self: *ResolverTest) anyerror!void {
        _ = self;
// zbr:selfhost/resolver_test.zbr:92
        const src = "class C\n    def calc() as int\n        var n as int = 3\n        return n + n\n";
// zbr:selfhost/resolver_test.zbr:93
        const root = try Parser.Parser.parse(src);
// zbr:selfhost/resolver_test.zbr:94
        var r = Resolver.Resolver.init();
// zbr:selfhost/resolver_test.zbr:95
        try r.resolve(root);
// zbr:selfhost/resolver_test.zbr:96
        if (!((r.errorCount() == 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:97
        std.debug.print("{s}\n", .{"testArithExpr: OK"});
    }

    pub fn testIfCond(self: *ResolverTest) anyerror!void {
        _ = self;
// zbr:selfhost/resolver_test.zbr:101
        const src = "class C\n    def check()\n        var flag as bool = true\n        if flag\n            var y as int = 1\n";
// zbr:selfhost/resolver_test.zbr:102
        const root = try Parser.Parser.parse(src);
// zbr:selfhost/resolver_test.zbr:103
        var r = Resolver.Resolver.init();
// zbr:selfhost/resolver_test.zbr:104
        try r.resolve(root);
// zbr:selfhost/resolver_test.zbr:105
        if (!((r.errorCount() == 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:106
        std.debug.print("{s}\n", .{"testIfCond: OK"});
    }

    pub fn testWhileLoop(self: *ResolverTest) anyerror!void {
        _ = self;
// zbr:selfhost/resolver_test.zbr:110
        const src = "class C\n    def loop()\n        var i as int = 0\n        while i\n            pass\n";
// zbr:selfhost/resolver_test.zbr:111
        const root = try Parser.Parser.parse(src);
// zbr:selfhost/resolver_test.zbr:112
        var r = Resolver.Resolver.init();
// zbr:selfhost/resolver_test.zbr:113
        try r.resolve(root);
// zbr:selfhost/resolver_test.zbr:114
        if (!((r.errorCount() == 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:115
        std.debug.print("{s}\n", .{"testWhileLoop: OK"});
    }

    pub fn testTryCatch(self: *ResolverTest) anyerror!void {
        _ = self;
// zbr:selfhost/resolver_test.zbr:119
        const src = "class C\n    def safe() throws\n        try\n            var x as int = 0\n        catch |e|\n            raise e\n";
// zbr:selfhost/resolver_test.zbr:120
        const root = try Parser.Parser.parse(src);
// zbr:selfhost/resolver_test.zbr:121
        var r = Resolver.Resolver.init();
// zbr:selfhost/resolver_test.zbr:122
        try r.resolve(root);
// zbr:selfhost/resolver_test.zbr:123
        if (!((r.errorCount() == 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/resolver_test.zbr:124
        std.debug.print("{s}\n", .{"testTryCatch: OK"});
    }
...
const _ttag_ResolverTest: u64 = 482440343;
const _reflect_ResolverTest_name: []const u8 = "ResolverTest";
const _reflect_ResolverTest_fields: []const []const u8 = &.{};
const _reflect_ResolverTest_field_types: []const []const u8 = &.{};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:selfhost/resolver_test.zbr:129
...
// zbr:selfhost/resolver_test.zbr:131
            t.run() catch |_tc_17a3e593af0| { _try_err_3b30 = _tc_17a3e593af0; break :_try_blk_3b30; };
            break :_try_blk_3b30;
        }
        if (_try_err_3b30 != null) {
// zbr:selfhost/resolver_test.zbr:133
