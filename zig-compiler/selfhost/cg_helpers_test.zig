...
// Source: selfhost/cg_helpers_test.zbr
...
const typeRefStr = cg_helpers.typeRefStr;
const exprHasTry = cg_helpers.exprHasTry;
const bodyHasRaise = cg_helpers.bodyHasRaise;
const nilNarrowVar = cg_helpers.nilNarrowVar;
const nameUsedInExpr = cg_helpers.nameUsedInExpr;
const nameUsedInStmts = cg_helpers.nameUsedInStmts;
const collectAllIdents = cg_helpers.collectAllIdents;
...
pub fn zspan() Span {
// zbr:selfhost/cg_helpers_test.zbr:19
    return Span.init(0, 0, 0, 0);
}

pub fn zmods() Modifiers {
// zbr:selfhost/cg_helpers_test.zbr:22
    return Modifiers.init(false, false, false, false, false, false);
}

pub fn testStrSet() void {
// zbr:selfhost/cg_helpers_test.zbr:27
    var s = StrSet.init();
// zbr:selfhost/cg_helpers_test.zbr:28
    std.debug.assert((s.count() == 0));
// zbr:selfhost/cg_helpers_test.zbr:29
    std.debug.assert((!s.contains_("a")));
// zbr:selfhost/cg_helpers_test.zbr:30
    s.add("alpha");
// zbr:selfhost/cg_helpers_test.zbr:31
    std.debug.assert((s.count() == 1));
// zbr:selfhost/cg_helpers_test.zbr:32
    std.debug.assert(s.contains_("alpha"));
// zbr:selfhost/cg_helpers_test.zbr:33
    std.debug.assert((!s.contains_("beta")));
// zbr:selfhost/cg_helpers_test.zbr:34
    s.add("beta");
// zbr:selfhost/cg_helpers_test.zbr:35
    s.add("alpha");
// zbr:selfhost/cg_helpers_test.zbr:36
    std.debug.assert((s.count() == 2));
// zbr:selfhost/cg_helpers_test.zbr:37
    std.debug.assert(s.contains_("beta"));
// zbr:selfhost/cg_helpers_test.zbr:38
    std.debug.print("{s}\n", .{"1. StrSet: OK"});
}

pub fn testAssignOpStr() void {
// zbr:selfhost/cg_helpers_test.zbr:43
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.assign), "="));
// zbr:selfhost/cg_helpers_test.zbr:44
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.plus_eq), "+="));
// zbr:selfhost/cg_helpers_test.zbr:45
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.minus_eq), "-="));
// zbr:selfhost/cg_helpers_test.zbr:46
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.star_eq), "*="));
// zbr:selfhost/cg_helpers_test.zbr:47
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.slash_eq), "/="));
// zbr:selfhost/cg_helpers_test.zbr:48
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.percent_eq), "%="));
// zbr:selfhost/cg_helpers_test.zbr:49
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.ampersand_eq), "&="));
// zbr:selfhost/cg_helpers_test.zbr:50
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.vertical_bar_eq), "|="));
// zbr:selfhost/cg_helpers_test.zbr:51
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.caret_eq), "^="));
// zbr:selfhost/cg_helpers_test.zbr:52
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.double_lt_eq), "<<="));
// zbr:selfhost/cg_helpers_test.zbr:53
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.double_gt_eq), ">>="));
// zbr:selfhost/cg_helpers_test.zbr:54
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.slashslash_eq), "="));
// zbr:selfhost/cg_helpers_test.zbr:55
    std.debug.assert(std.mem.eql(u8, assignOpStr(AssignOp.starstar_eq), "="));
// zbr:selfhost/cg_helpers_test.zbr:56
    std.debug.print("{s}\n", .{"2. assignOpStr: OK"});
}

pub fn testBinaryOpStr() void {
// zbr:selfhost/cg_helpers_test.zbr:61
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.add), "+"));
// zbr:selfhost/cg_helpers_test.zbr:62
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.sub), "-"));
// zbr:selfhost/cg_helpers_test.zbr:63
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.mul), "*"));
// zbr:selfhost/cg_helpers_test.zbr:64
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.div), "/"));
// zbr:selfhost/cg_helpers_test.zbr:65
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.mod), "%"));
// zbr:selfhost/cg_helpers_test.zbr:66
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.bit_and), "&"));
// zbr:selfhost/cg_helpers_test.zbr:67
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.bit_or), "|"));
// zbr:selfhost/cg_helpers_test.zbr:68
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.bit_xor), "^"));
// zbr:selfhost/cg_helpers_test.zbr:69
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.shl), "<<"));
// zbr:selfhost/cg_helpers_test.zbr:70
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.shr), ">>"));
// zbr:selfhost/cg_helpers_test.zbr:71
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.eq), "=="));
// zbr:selfhost/cg_helpers_test.zbr:72
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.ne), "!="));
// zbr:selfhost/cg_helpers_test.zbr:73
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.lt), "<"));
// zbr:selfhost/cg_helpers_test.zbr:74
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.le), "<="));
// zbr:selfhost/cg_helpers_test.zbr:75
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.gt), ">"));
// zbr:selfhost/cg_helpers_test.zbr:76
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.ge), ">="));
// zbr:selfhost/cg_helpers_test.zbr:77
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.and_), "and"));
// zbr:selfhost/cg_helpers_test.zbr:78
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.or_), "or"));
// zbr:selfhost/cg_helpers_test.zbr:79
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.int_div), "?"));
// zbr:selfhost/cg_helpers_test.zbr:80
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.pow), "?"));
// zbr:selfhost/cg_helpers_test.zbr:81
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.dotdot), "?"));
// zbr:selfhost/cg_helpers_test.zbr:82
    std.debug.assert(std.mem.eql(u8, binaryOpStr(BinaryOp.in_), "?"));
// zbr:selfhost/cg_helpers_test.zbr:83
    std.debug.print("{s}\n", .{"3. binaryOpStr: OK"});
}

pub fn testTypeRefStrSimple() void {
// zbr:selfhost/cg_helpers_test.zbr:88
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:89
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .named = NamedTypeRef.init(sp, "int") }), "int"));
// zbr:selfhost/cg_helpers_test.zbr:90
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .named = NamedTypeRef.init(sp, "bool") }), "bool"));
// zbr:selfhost/cg_helpers_test.zbr:91
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef.void_), "void"));
// zbr:selfhost/cg_helpers_test.zbr:92
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef.same_), "same"));
// zbr:selfhost/cg_helpers_test.zbr:93
    std.debug.print("{s}\n", .{"4a. typeRefStr simple: OK"});
}

pub fn testTypeRefStrGeneric() void {
// zbr:selfhost/cg_helpers_test.zbr:96
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:97
    var args1 = std.ArrayList(TypeRef){};
// zbr:selfhost/cg_helpers_test.zbr:98
    args1.append(_allocator, TypeRef{ .named = NamedTypeRef.init(sp, "str") }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:99
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .generic = GenericTypeRef.init(sp, "List", args1) }), "List(str)"));
// zbr:selfhost/cg_helpers_test.zbr:100
    var args2 = std.ArrayList(TypeRef){};
// zbr:selfhost/cg_helpers_test.zbr:101
    args2.append(_allocator, TypeRef{ .named = NamedTypeRef.init(sp, "str") }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:102
    args2.append(_allocator, TypeRef{ .named = NamedTypeRef.init(sp, "int") }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:103
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .generic = GenericTypeRef.init(sp, "HashMap", args2) }), "HashMap(str, int)"));
// zbr:selfhost/cg_helpers_test.zbr:104
    std.debug.print("{s}\n", .{"4b. typeRefStr generic: OK"});
}

pub fn testTypeRefStrTuple() void {
// zbr:selfhost/cg_helpers_test.zbr:107
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:108
    var elems = std.ArrayList(TypeRef){};
// zbr:selfhost/cg_helpers_test.zbr:109
    elems.append(_allocator, TypeRef{ .named = NamedTypeRef.init(sp, "int") }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:110
    elems.append(_allocator, TypeRef{ .named = NamedTypeRef.init(sp, "bool") }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:111
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .tuple = TupleTypeRef.init(sp, elems) }), "(int, bool)"));
// zbr:selfhost/cg_helpers_test.zbr:112
    std.debug.print("{s}\n", .{"4c. typeRefStr tuple: OK"});
}

pub fn testTypeRefStrBoxed() anyerror!void {
// zbr:selfhost/cg_helpers_test.zbr:117
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:118
    const inner = TypeRef{ .named = NamedTypeRef.init(sp, "str") };
// zbr:selfhost/cg_helpers_test.zbr:119
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .nilable = _box_1ebc3c22608: { const _bp_1ebc3c22608 = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_1ebc3c22608.* = inner; break :_box_1ebc3c22608 _bp_1ebc3c22608; } }), "?str"));
// zbr:selfhost/cg_helpers_test.zbr:120
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .stream = _box_1ebc3c22870: { const _bp_1ebc3c22870 = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_1ebc3c22870.* = inner; break :_box_1ebc3c22870 _bp_1ebc3c22870; } }), "str*"));
// zbr:selfhost/cg_helpers_test.zbr:121
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .error_union = _box_1ebc3c22ad8: { const _bp_1ebc3c22ad8 = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_1ebc3c22ad8.* = inner; break :_box_1ebc3c22ad8 _bp_1ebc3c22ad8; } }), "!str"));
// zbr:selfhost/cg_helpers_test.zbr:122
    std.debug.assert(std.mem.eql(u8, typeRefStr(TypeRef{ .ref_to = _box_1ebc3c22d40: { const _bp_1ebc3c22d40 = _allocator.create(ast.TypeRef) catch @panic("OOM"); _bp_1ebc3c22d40.* = inner; break :_box_1ebc3c22d40 _bp_1ebc3c22d40; } }), "^str"));
// zbr:selfhost/cg_helpers_test.zbr:123
    std.debug.print("{s}\n", .{"4d. typeRefStr boxed: OK"});
}

pub fn testNilNarrowVarSimple() void {
// zbr:selfhost/cg_helpers_test.zbr:128
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:130
    const id_x = Expr{ .ident = ExprIdent.init(sp, "x") };
// zbr:selfhost/cg_helpers_test.zbr:131
    std.debug.assert((nilNarrowVar(id_x, true) == null));
// zbr:selfhost/cg_helpers_test.zbr:132
    std.debug.assert((nilNarrowVar(id_x, false) == null));
// zbr:selfhost/cg_helpers_test.zbr:133
    std.debug.print("{s}\n", .{"5a. nilNarrowVar non-binary: OK"});
}

pub fn testNilNarrowVar() anyerror!void {
// zbr:selfhost/cg_helpers_test.zbr:136
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:137
    const id_x = Expr{ .ident = ExprIdent.init(sp, "x") };
// zbr:selfhost/cg_helpers_test.zbr:138
    const nil_ = Expr{ .nil_ = sp };
// zbr:selfhost/cg_helpers_test.zbr:140
    const ne = Expr{ .binary = _box_1ebc3c24188: { const _bp_1ebc3c24188 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_1ebc3c24188.* = ExprBinary.init(sp, BinaryOp.ne, _box_1ebc3c24010: { const _bp_1ebc3c24010 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_1ebc3c24010.* = id_x; break :_box_1ebc3c24010 _bp_1ebc3c24010; }, _box_1ebc3c24038: { const _bp_1ebc3c24038 = blk2: { break :blk2 _allocator.create(@TypeOf(nil_)) catch @panic("OOM"); }; _bp_1ebc3c24038.* = nil_; break :_box_1ebc3c24038 _bp_1ebc3c24038; }); break :_box_1ebc3c24188 _bp_1ebc3c24188; } };
// zbr:selfhost/cg_helpers_test.zbr:141
    std.debug.assert(std.mem.eql(u8, nilNarrowVar(ne, true).?, "x"));
// zbr:selfhost/cg_helpers_test.zbr:142
    std.debug.assert((nilNarrowVar(ne, false) == null));
// zbr:selfhost/cg_helpers_test.zbr:144
    const eq = Expr{ .binary = _box_1ebc3c24980: { const _bp_1ebc3c24980 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_1ebc3c24980.* = ExprBinary.init(sp, BinaryOp.eq, _box_1ebc3c24808: { const _bp_1ebc3c24808 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_1ebc3c24808.* = id_x; break :_box_1ebc3c24808 _bp_1ebc3c24808; }, _box_1ebc3c24830: { const _bp_1ebc3c24830 = blk2: { break :blk2 _allocator.create(@TypeOf(nil_)) catch @panic("OOM"); }; _bp_1ebc3c24830.* = nil_; break :_box_1ebc3c24830 _bp_1ebc3c24830; }); break :_box_1ebc3c24980 _bp_1ebc3c24980; } };
// zbr:selfhost/cg_helpers_test.zbr:145
    std.debug.assert(std.mem.eql(u8, nilNarrowVar(eq, false).?, "x"));
// zbr:selfhost/cg_helpers_test.zbr:146
    std.debug.assert((nilNarrowVar(eq, true) == null));
// zbr:selfhost/cg_helpers_test.zbr:148
    const ne2 = Expr{ .binary = _box_1ebc3c252b8: { const _bp_1ebc3c252b8 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_1ebc3c252b8.* = ExprBinary.init(sp, BinaryOp.ne, _box_1ebc3c25140: { const _bp_1ebc3c25140 = blk2: { break :blk2 _allocator.create(@TypeOf(nil_)) catch @panic("OOM"); }; _bp_1ebc3c25140.* = nil_; break :_box_1ebc3c25140 _bp_1ebc3c25140; }, _box_1ebc3c25168: { const _bp_1ebc3c25168 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_1ebc3c25168.* = id_x; break :_box_1ebc3c25168 _bp_1ebc3c25168; }); break :_box_1ebc3c252b8 _bp_1ebc3c252b8; } };
// zbr:selfhost/cg_helpers_test.zbr:149
    std.debug.assert(std.mem.eql(u8, nilNarrowVar(ne2, true).?, "x"));
// zbr:selfhost/cg_helpers_test.zbr:151
    const lit = Expr{ .int_lit = ExprIntLit.init(sp, "0", IntBase.decimal) };
// zbr:selfhost/cg_helpers_test.zbr:152
    const add = Expr{ .binary = _box_1ebc3c25c00: { const _bp_1ebc3c25c00 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_1ebc3c25c00.* = ExprBinary.init(sp, BinaryOp.add, _box_1ebc3c25a88: { const _bp_1ebc3c25a88 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_1ebc3c25a88.* = id_x; break :_box_1ebc3c25a88 _bp_1ebc3c25a88; }, _box_1ebc3c25ab0: { const _bp_1ebc3c25ab0 = blk2: { break :blk2 _allocator.create(@TypeOf(lit)) catch @panic("OOM"); }; _bp_1ebc3c25ab0.* = lit; break :_box_1ebc3c25ab0 _bp_1ebc3c25ab0; }); break :_box_1ebc3c25c00 _bp_1ebc3c25c00; } };
// zbr:selfhost/cg_helpers_test.zbr:153
    std.debug.assert((nilNarrowVar(add, true) == null));
// zbr:selfhost/cg_helpers_test.zbr:154
    std.debug.print("{s}\n", .{"5b. nilNarrowVar binary: OK"});
}

pub fn testExprHasTry() anyerror!void {
// zbr:selfhost/cg_helpers_test.zbr:159
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:161
    std.debug.assert((!exprHasTry(Expr{ .int_lit = ExprIntLit.init(sp, "1", IntBase.decimal) })));
// zbr:selfhost/cg_helpers_test.zbr:162
    std.debug.assert((!exprHasTry(Expr{ .bool_lit = ExprBoolLit.init(sp, true) })));
// zbr:selfhost/cg_helpers_test.zbr:163
    std.debug.assert((!exprHasTry(Expr{ .nil_ = sp })));
// zbr:selfhost/cg_helpers_test.zbr:164
    std.debug.assert((!exprHasTry(Expr{ .ident = ExprIdent.init(sp, "x") })));
// zbr:selfhost/cg_helpers_test.zbr:166
    const inner = Expr{ .ident = ExprIdent.init(sp, "f") };
// zbr:selfhost/cg_helpers_test.zbr:167
    const try_e = Expr{ .try_ = _box_1ebc3c302f0: { const _bp_1ebc3c302f0 = _allocator.create(ast.ExprTry) catch @panic("OOM"); _bp_1ebc3c302f0.* = ExprTry.init(sp, _box_1ebc3c30240: { const _bp_1ebc3c30240 = blk2: { break :blk2 _allocator.create(@TypeOf(inner)) catch @panic("OOM"); }; _bp_1ebc3c30240.* = inner; break :_box_1ebc3c30240 _bp_1ebc3c30240; }); break :_box_1ebc3c302f0 _bp_1ebc3c302f0; } };
// zbr:selfhost/cg_helpers_test.zbr:168
    std.debug.assert(exprHasTry(try_e));
// zbr:selfhost/cg_helpers_test.zbr:170
    const lhs = Expr{ .int_lit = ExprIntLit.init(sp, "0", IntBase.decimal) };
// zbr:selfhost/cg_helpers_test.zbr:171
    std.debug.assert(exprHasTry(Expr{ .binary = _box_1ebc3c30c78: { const _bp_1ebc3c30c78 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_1ebc3c30c78.* = ExprBinary.init(sp, BinaryOp.add, _box_1ebc3c30b00: { const _bp_1ebc3c30b00 = blk2: { break :blk2 _allocator.create(@TypeOf(lhs)) catch @panic("OOM"); }; _bp_1ebc3c30b00.* = lhs; break :_box_1ebc3c30b00 _bp_1ebc3c30b00; }, _box_1ebc3c30b28: { const _bp_1ebc3c30b28 = blk2: { break :blk2 _allocator.create(@TypeOf(try_e)) catch @panic("OOM"); }; _bp_1ebc3c30b28.* = try_e; break :_box_1ebc3c30b28 _bp_1ebc3c30b28; }); break :_box_1ebc3c30c78 _bp_1ebc3c30c78; } }));
// zbr:selfhost/cg_helpers_test.zbr:173
    const rhs = Expr{ .int_lit = ExprIntLit.init(sp, "1", IntBase.decimal) };
// zbr:selfhost/cg_helpers_test.zbr:174
    std.debug.assert((!exprHasTry(Expr{ .binary = _box_1ebc3c31408: { const _bp_1ebc3c31408 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_1ebc3c31408.* = ExprBinary.init(sp, BinaryOp.add, _box_1ebc3c31290: { const _bp_1ebc3c31290 = blk2: { break :blk2 _allocator.create(@TypeOf(lhs)) catch @panic("OOM"); }; _bp_1ebc3c31290.* = lhs; break :_box_1ebc3c31290 _bp_1ebc3c31290; }, _box_1ebc3c312b8: { const _bp_1ebc3c312b8 = blk2: { break :blk2 _allocator.create(@TypeOf(rhs)) catch @panic("OOM"); }; _bp_1ebc3c312b8.* = rhs; break :_box_1ebc3c312b8 _bp_1ebc3c312b8; }); break :_box_1ebc3c31408 _bp_1ebc3c31408; } })));
// zbr:selfhost/cg_helpers_test.zbr:175
    std.debug.print("{s}\n", .{"6. exprHasTry: OK"});
}

pub fn testBodyHasRaise() anyerror!void {
// zbr:selfhost/cg_helpers_test.zbr:180
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:182
    std.debug.assert((!bodyHasRaise(std.ArrayList(Stmt){})));
// zbr:selfhost/cg_helpers_test.zbr:184
    var with_raise = std.ArrayList(Stmt){};
// zbr:selfhost/cg_helpers_test.zbr:185
    with_raise.append(_allocator, Stmt{ .raise_ = _box_1ebc3c31d48: { const _bp_1ebc3c31d48 = _allocator.create(ast.StmtRaise) catch @panic("OOM"); _bp_1ebc3c31d48.* = StmtRaise.init(sp, null, null); break :_box_1ebc3c31d48 _bp_1ebc3c31d48; } }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:186
    std.debug.assert(bodyHasRaise(with_raise));
// zbr:selfhost/cg_helpers_test.zbr:188
    var with_pass = std.ArrayList(Stmt){};
// zbr:selfhost/cg_helpers_test.zbr:189
    with_pass.append(_allocator, Stmt{ .pass_ = sp }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:190
    std.debug.assert((!bodyHasRaise(with_pass)));
// zbr:selfhost/cg_helpers_test.zbr:192
    const try_e = Expr{ .try_ = _box_1ebc3c327c8: { const _bp_1ebc3c327c8 = _allocator.create(ast.ExprTry) catch @panic("OOM"); _bp_1ebc3c327c8.* = ExprTry.init(sp, _box_1ebc3c32718: { const _bp_1ebc3c32718 = blk2: { break :blk2 _allocator.create(@TypeOf(Expr{ .ident = ExprIdent.init(sp, "f") })) catch @panic("OOM"); }; _bp_1ebc3c32718.* = Expr{ .ident = ExprIdent.init(sp, "f") }; break :_box_1ebc3c32718 _bp_1ebc3c32718; }); break :_box_1ebc3c327c8 _bp_1ebc3c327c8; } };
// zbr:selfhost/cg_helpers_test.zbr:193
    const dv = DeclVar.init(sp, zmods(), "x", null, _box_1ebc3c32c88: { const _bp_1ebc3c32c88 = blk2: { break :blk2 _allocator.create(@TypeOf(try_e)) catch @panic("OOM"); }; _bp_1ebc3c32c88.* = try_e; break :_box_1ebc3c32c88 _bp_1ebc3c32c88; }, false);
// zbr:selfhost/cg_helpers_test.zbr:194
    var with_try_var = std.ArrayList(Stmt){};
// zbr:selfhost/cg_helpers_test.zbr:195
    with_try_var.append(_allocator, Stmt{ .var_ = _box_1ebc3c33008: { const _bp_1ebc3c33008 = _allocator.create(ast.DeclVar) catch @panic("OOM"); _bp_1ebc3c33008.* = dv; break :_box_1ebc3c33008 _bp_1ebc3c33008; } }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:196
    std.debug.assert(bodyHasRaise(with_try_var));
// zbr:selfhost/cg_helpers_test.zbr:198
    const ret_lit = Expr{ .int_lit = ExprIntLit.init(sp, "42", IntBase.decimal) };
// zbr:selfhost/cg_helpers_test.zbr:199
    var with_return = std.ArrayList(Stmt){};
// zbr:selfhost/cg_helpers_test.zbr:200
    with_return.append(_allocator, Stmt{ .return_ = _box_1ebc3c338a8: { const _bp_1ebc3c338a8 = _allocator.create(ast.StmtReturn) catch @panic("OOM"); _bp_1ebc3c338a8.* = StmtReturn.init(sp, _box_1ebc3c337f8: { const _bp_1ebc3c337f8 = blk2: { break :blk2 _allocator.create(@TypeOf(ret_lit)) catch @panic("OOM"); }; _bp_1ebc3c337f8.* = ret_lit; break :_box_1ebc3c337f8 _bp_1ebc3c337f8; }); break :_box_1ebc3c338a8 _bp_1ebc3c338a8; } }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:201
    std.debug.assert((!bodyHasRaise(with_return)));
// zbr:selfhost/cg_helpers_test.zbr:202
    std.debug.print("{s}\n", .{"7. bodyHasRaise: OK"});
}

pub fn testNameUsedInExprSimple() void {
// zbr:selfhost/cg_helpers_test.zbr:207
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:208
    const id_x = Expr{ .ident = ExprIdent.init(sp, "x") };
// zbr:selfhost/cg_helpers_test.zbr:209
    std.debug.assert(nameUsedInExpr("x", id_x));
// zbr:selfhost/cg_helpers_test.zbr:210
    std.debug.assert((!nameUsedInExpr("y", id_x)));
// zbr:selfhost/cg_helpers_test.zbr:211
    const lit = Expr{ .int_lit = ExprIntLit.init(sp, "1", IntBase.decimal) };
// zbr:selfhost/cg_helpers_test.zbr:212
    std.debug.assert((!nameUsedInExpr("x", lit)));
// zbr:selfhost/cg_helpers_test.zbr:213
    std.debug.assert((!nameUsedInExpr("x", Expr{ .nil_ = sp })));
// zbr:selfhost/cg_helpers_test.zbr:214
    std.debug.print("{s}\n", .{"8a. nameUsedInExpr simple: OK"});
}

pub fn testNameUsedInExprBinary() anyerror!void {
// zbr:selfhost/cg_helpers_test.zbr:217
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:218
    const id_x = Expr{ .ident = ExprIdent.init(sp, "x") };
// zbr:selfhost/cg_helpers_test.zbr:219
    const id_y = Expr{ .ident = ExprIdent.init(sp, "y") };
// zbr:selfhost/cg_helpers_test.zbr:220
    const bin = Expr{ .binary = _box_1ebc3c355b0: { const _bp_1ebc3c355b0 = _allocator.create(ast.ExprBinary) catch @panic("OOM"); _bp_1ebc3c355b0.* = ExprBinary.init(sp, BinaryOp.add, _box_1ebc3c35438: { const _bp_1ebc3c35438 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_1ebc3c35438.* = id_x; break :_box_1ebc3c35438 _bp_1ebc3c35438; }, _box_1ebc3c35460: { const _bp_1ebc3c35460 = blk2: { break :blk2 _allocator.create(@TypeOf(id_y)) catch @panic("OOM"); }; _bp_1ebc3c35460.* = id_y; break :_box_1ebc3c35460 _bp_1ebc3c35460; }); break :_box_1ebc3c355b0 _bp_1ebc3c355b0; } };
// zbr:selfhost/cg_helpers_test.zbr:221
    std.debug.assert(nameUsedInExpr("x", bin));
// zbr:selfhost/cg_helpers_test.zbr:222
    std.debug.assert(nameUsedInExpr("y", bin));
// zbr:selfhost/cg_helpers_test.zbr:223
    std.debug.assert((!nameUsedInExpr("z", bin)));
// zbr:selfhost/cg_helpers_test.zbr:224
    std.debug.print("{s}\n", .{"8b. nameUsedInExpr binary: OK"});
}

pub fn testNameUsedInStmts() anyerror!void {
// zbr:selfhost/cg_helpers_test.zbr:227
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:228
    const id_x = Expr{ .ident = ExprIdent.init(sp, "x") };
// zbr:selfhost/cg_helpers_test.zbr:229
    var stmts = std.ArrayList(Stmt){};
// zbr:selfhost/cg_helpers_test.zbr:230
    stmts.append(_allocator, Stmt{ .return_ = _box_1ebc3c363c0: { const _bp_1ebc3c363c0 = _allocator.create(ast.StmtReturn) catch @panic("OOM"); _bp_1ebc3c363c0.* = StmtReturn.init(sp, _box_1ebc3c36310: { const _bp_1ebc3c36310 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_1ebc3c36310.* = id_x; break :_box_1ebc3c36310 _bp_1ebc3c36310; }); break :_box_1ebc3c363c0 _bp_1ebc3c363c0; } }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:231
    std.debug.assert(nameUsedInStmts("x", stmts));
// zbr:selfhost/cg_helpers_test.zbr:232
    std.debug.assert((!nameUsedInStmts("y", stmts)));
// zbr:selfhost/cg_helpers_test.zbr:233
    std.debug.assert((!nameUsedInStmts("x", std.ArrayList(Stmt){})));
// zbr:selfhost/cg_helpers_test.zbr:234
    std.debug.print("{s}\n", .{"8c. nameUsedInStmts: OK"});
}

pub fn testAnalyzeEscapes() anyerror!void {
// zbr:selfhost/cg_helpers_test.zbr:239
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:240
    const id_x = Expr{ .ident = ExprIdent.init(sp, "x") };
// zbr:selfhost/cg_helpers_test.zbr:242
    var stmts = std.ArrayList(Stmt){};
// zbr:selfhost/cg_helpers_test.zbr:243
    stmts.append(_allocator, Stmt{ .return_ = _box_1ebc3c372c8: { const _bp_1ebc3c372c8 = _allocator.create(ast.StmtReturn) catch @panic("OOM"); _bp_1ebc3c372c8.* = StmtReturn.init(sp, _box_1ebc3c37218: { const _bp_1ebc3c37218 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_1ebc3c37218.* = id_x; break :_box_1ebc3c37218 _bp_1ebc3c37218; }); break :_box_1ebc3c372c8 _bp_1ebc3c372c8; } }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:244
    var esc = analyzeEscapes(stmts);
// zbr:selfhost/cg_helpers_test.zbr:245
    std.debug.assert(esc.contains_("x"));
// zbr:selfhost/cg_helpers_test.zbr:246
    std.debug.assert((!esc.contains_("y")));
// zbr:selfhost/cg_helpers_test.zbr:248
    std.debug.assert((analyzeEscapes(std.ArrayList(Stmt){}).count() == 0));
// zbr:selfhost/cg_helpers_test.zbr:249
    std.debug.print("{s}\n", .{"9. analyzeEscapes: OK"});
}

pub fn testScanMutations() anyerror!void {
// zbr:selfhost/cg_helpers_test.zbr:254
    const sp = zspan();
// zbr:selfhost/cg_helpers_test.zbr:255
    const id_x = Expr{ .ident = ExprIdent.init(sp, "x") };
// zbr:selfhost/cg_helpers_test.zbr:256
    const lit = Expr{ .int_lit = ExprIntLit.init(sp, "1", IntBase.decimal) };
// zbr:selfhost/cg_helpers_test.zbr:258
    var stmts = std.ArrayList(Stmt){};
// zbr:selfhost/cg_helpers_test.zbr:259
    stmts.append(_allocator, Stmt{ .assign = _box_1ebc3c38828: { const _bp_1ebc3c38828 = _allocator.create(ast.StmtAssign) catch @panic("OOM"); _bp_1ebc3c38828.* = StmtAssign.init(sp, _box_1ebc3c38638: { const _bp_1ebc3c38638 = blk2: { break :blk2 _allocator.create(@TypeOf(id_x)) catch @panic("OOM"); }; _bp_1ebc3c38638.* = id_x; break :_box_1ebc3c38638 _bp_1ebc3c38638; }, AssignOp.assign, _box_1ebc3c386d8: { const _bp_1ebc3c386d8 = blk2: { break :blk2 _allocator.create(@TypeOf(lit)) catch @panic("OOM"); }; _bp_1ebc3c386d8.* = lit; break :_box_1ebc3c386d8 _bp_1ebc3c386d8; }); break :_box_1ebc3c38828 _bp_1ebc3c38828; } }) catch unreachable;
// zbr:selfhost/cg_helpers_test.zbr:260
    var mut = scanMutations(stmts);
// zbr:selfhost/cg_helpers_test.zbr:261
    std.debug.assert(mut.contains_("x"));
// zbr:selfhost/cg_helpers_test.zbr:262
    std.debug.assert((!mut.contains_("y")));
// zbr:selfhost/cg_helpers_test.zbr:264
    std.debug.assert((scanMutations(std.ArrayList(Stmt){}).count() == 0));
// zbr:selfhost/cg_helpers_test.zbr:265
    std.debug.print("{s}\n", .{"10. scanMutations: OK"});
}
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:selfhost/cg_helpers_test.zbr:272
        testStrSet();
// zbr:selfhost/cg_helpers_test.zbr:273
        testAssignOpStr();
// zbr:selfhost/cg_helpers_test.zbr:274
        testBinaryOpStr();
// zbr:selfhost/cg_helpers_test.zbr:275
        testTypeRefStrSimple();
// zbr:selfhost/cg_helpers_test.zbr:276
        testTypeRefStrGeneric();
// zbr:selfhost/cg_helpers_test.zbr:277
        testTypeRefStrTuple();
// zbr:selfhost/cg_helpers_test.zbr:278
        var _try_err_9748: ?anyerror = null;
        _try_blk_9748: {
// zbr:selfhost/cg_helpers_test.zbr:279
            testTypeRefStrBoxed() catch |_e| { _try_err_9748 = _e; break :_try_blk_9748; };
            break :_try_blk_9748;
        }
        if (_try_err_9748 != null) {
// zbr:selfhost/cg_helpers_test.zbr:281
            if (!(false)) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
        }
// zbr:selfhost/cg_helpers_test.zbr:282
        testNilNarrowVarSimple();
// zbr:selfhost/cg_helpers_test.zbr:283
        var _try_err_9988: ?anyerror = null;
        _try_blk_9988: {
// zbr:selfhost/cg_helpers_test.zbr:284
            testNilNarrowVar() catch |_e| { _try_err_9988 = _e; break :_try_blk_9988; };
            break :_try_blk_9988;
        }
        if (_try_err_9988 != null) {
// zbr:selfhost/cg_helpers_test.zbr:286
            if (!(false)) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
        }
// zbr:selfhost/cg_helpers_test.zbr:287
        var _try_err_9c80: ?anyerror = null;
        _try_blk_9c80: {
// zbr:selfhost/cg_helpers_test.zbr:288
            testExprHasTry() catch |_e| { _try_err_9c80 = _e; break :_try_blk_9c80; };
            break :_try_blk_9c80;
        }
        if (_try_err_9c80 != null) {
// zbr:selfhost/cg_helpers_test.zbr:290
            if (!(false)) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
        }
// zbr:selfhost/cg_helpers_test.zbr:291
        var _try_err_9e38: ?anyerror = null;
        _try_blk_9e38: {
// zbr:selfhost/cg_helpers_test.zbr:292
            testBodyHasRaise() catch |_e| { _try_err_9e38 = _e; break :_try_blk_9e38; };
            break :_try_blk_9e38;
        }
        if (_try_err_9e38 != null) {
// zbr:selfhost/cg_helpers_test.zbr:294
            if (!(false)) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
        }
// zbr:selfhost/cg_helpers_test.zbr:295
        testNameUsedInExprSimple();
// zbr:selfhost/cg_helpers_test.zbr:296
        var _try_err_a078: ?anyerror = null;
        _try_blk_a078: {
// zbr:selfhost/cg_helpers_test.zbr:297
            testNameUsedInExprBinary() catch |_e| { _try_err_a078 = _e; break :_try_blk_a078; };
            break :_try_blk_a078;
        }
        if (_try_err_a078 != null) {
// zbr:selfhost/cg_helpers_test.zbr:299
            if (!(false)) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
        }
// zbr:selfhost/cg_helpers_test.zbr:300
        var _try_err_a230: ?anyerror = null;
        _try_blk_a230: {
// zbr:selfhost/cg_helpers_test.zbr:301
            testNameUsedInStmts() catch |_e| { _try_err_a230 = _e; break :_try_blk_a230; };
            break :_try_blk_a230;
        }
        if (_try_err_a230 != null) {
// zbr:selfhost/cg_helpers_test.zbr:303
            if (!(false)) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
        }
// zbr:selfhost/cg_helpers_test.zbr:304
        var _try_err_a3e8: ?anyerror = null;
        _try_blk_a3e8: {
// zbr:selfhost/cg_helpers_test.zbr:305
            testAnalyzeEscapes() catch |_e| { _try_err_a3e8 = _e; break :_try_blk_a3e8; };
            break :_try_blk_a3e8;
        }
        if (_try_err_a3e8 != null) {
// zbr:selfhost/cg_helpers_test.zbr:307
            if (!(false)) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
        }
// zbr:selfhost/cg_helpers_test.zbr:308
        var _try_err_a5a0: ?anyerror = null;
        _try_blk_a5a0: {
// zbr:selfhost/cg_helpers_test.zbr:309
            testScanMutations() catch |_e| { _try_err_a5a0 = _e; break :_try_blk_a5a0; };
            break :_try_blk_a5a0;
        }
        if (_try_err_a5a0 != null) {
// zbr:selfhost/cg_helpers_test.zbr:311
            if (!(false)) {
                std.debug.print("assertion failed\n", .{});
                unreachable;
            }
        }
// zbr:selfhost/cg_helpers_test.zbr:312
        std.debug.print("{s}\n", .{"cg_helpers_test: all OK"});
    }
...
pub fn main() void {
    ...
    defer _arena.deinit();
    @import("cg_helpers.zig")._initAllocator(_allocator);
