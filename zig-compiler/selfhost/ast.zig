...
pub const DeclProperty = struct {
    ...
    name: []const u8,
    type_: ?TypeRef,
    getter_: ?std.ArrayList(Stmt),
    setter_: ?std.ArrayList(Stmt),
    pub fn init(span: Span, mods: Modifiers, name: []const u8, type_: ?TypeRef, getter_: ?std.ArrayList(Stmt), setter_: ?std.ArrayList(Stmt)) DeclProperty {
        var _self: DeclProperty = undefined;
            _self.span = span;
            _self.mods = mods;
            _self.name = name;
            _self.type_ = type_;
            _self.getter_ = getter_;
            _self.setter_ = setter_;
        return _self;
    }
...
pub const StmtArenaScope = struct {
    ...
    pub fn init(span: Span, stmts: std.ArrayList(Stmt)) StmtArenaScope {
        var _self: StmtArenaScope = undefined;
            _self.span = span;
            _self.stmts = stmts;
        return _self;
    }
...
pub const ExprAllAny = struct {
    ...
    pub fn init(span: Span, kind: AllAnyKind, var_: []const u8, iter: *Expr, cond: *Expr) ExprAllAny {
        var _self: ExprAllAny = undefined;
            _self.span = span;
            _self.kind = kind;
            _self.var_ = var_;
            _self.iter = iter;
