...
// Source: selfhost/astbuilder_test.zbr
...
pub const ASTBuilderTest = struct {
    _type_tag: u64 = _ttag_ASTBuilderTest,
    pub fn run(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:23
        try self.testEmptyClass();
// zbr:selfhost/astbuilder_test.zbr:24
        try self.testClassWithField();
// zbr:selfhost/astbuilder_test.zbr:25
        try self.testEnumDecl();
// zbr:selfhost/astbuilder_test.zbr:26
        try self.testSimpleMethod();
// zbr:selfhost/astbuilder_test.zbr:27
        try self.testMethodWithParams();
// zbr:selfhost/astbuilder_test.zbr:28
        try self.testIfStmt();
// zbr:selfhost/astbuilder_test.zbr:29
        try self.testWhileStmt();
// zbr:selfhost/astbuilder_test.zbr:30
        try self.testForInStmt();
// zbr:selfhost/astbuilder_test.zbr:31
        try self.testAssignStmt();
// zbr:selfhost/astbuilder_test.zbr:32
        try self.testExprBinary();
// zbr:selfhost/astbuilder_test.zbr:33
        try self.testExprUnary();
// zbr:selfhost/astbuilder_test.zbr:34
        try self.testExprCall();
// zbr:selfhost/astbuilder_test.zbr:35
        try self.testExprMember();
// zbr:selfhost/astbuilder_test.zbr:36
        try self.testParseTypeRefSimple();
// zbr:selfhost/astbuilder_test.zbr:37
        try self.testParseTypeRefNilable();
// zbr:selfhost/astbuilder_test.zbr:38
        try self.testParseTypeRefGeneric();
// zbr:selfhost/astbuilder_test.zbr:39
        try self.testReturnValue();
// zbr:selfhost/astbuilder_test.zbr:40
        try self.testVarInit();
// zbr:selfhost/astbuilder_test.zbr:41
        try self.testAssertMessage();
// zbr:selfhost/astbuilder_test.zbr:42
        try self.testRaiseMessage();
// zbr:selfhost/astbuilder_test.zbr:43
        std.debug.print("{s}\n", .{"astbuilder_test: all assertions passed"});
    }

    pub fn buildModule(self: *ASTBuilderTest, src: []const u8) anyerror!Module {
        _ = self;
// zbr:selfhost/astbuilder_test.zbr:49
        const pm = try Parser.Parser.parse(src);
// zbr:selfhost/astbuilder_test.zbr:50
        switch (pm) {
            .module_ => |m_ptr| {
                const m = m_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:52
                return try ASTBuilder.build(m, "<test>");
            },
            else => {
// zbr:selfhost/astbuilder_test.zbr:54
                _error_ctx = .{ .message = "expected module_ from parser", .details = null };
                return error.ZebraError;
            },
        }
    }

    pub fn firstDecl(self: *ASTBuilderTest, src: []const u8) anyerror!Decl {
// zbr:selfhost/astbuilder_test.zbr:57
        const mod = try self.buildModule(src);
// zbr:selfhost/astbuilder_test.zbr:58
        if (!(_zebra_gt(@as(i64, @intCast(mod.decls.items.len)), 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:selfhost/astbuilder_test.zbr:59
        return mod.decls.items[@as(usize, @intCast(0))];
    }

    pub fn firstMethodStmt(self: *ASTBuilderTest, src: []const u8) anyerror!Stmt {
// zbr:selfhost/astbuilder_test.zbr:63
        const d = try self.firstDecl(src);
// zbr:selfhost/astbuilder_test.zbr:64
        switch (d) {
            .class_ => |c_ptr| {
                const c = c_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:66
                if (!(_zebra_gt(@as(i64, @intCast(c.members.items.len)), 0))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:67
                const meth_decl = c.members.items[@as(usize, @intCast(0))];
// zbr:selfhost/astbuilder_test.zbr:68
                switch (meth_decl) {
                    .method => |meth_ptr| {
                        const meth = meth_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:70
                        const stmts: std.ArrayList(Stmt) = meth.stmts.?;
// zbr:selfhost/astbuilder_test.zbr:71
                        if (!(_zebra_gt(@as(i64, @intCast(stmts.items.len)), 0))) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
// zbr:selfhost/astbuilder_test.zbr:72
                        return stmts.items[@as(usize, @intCast(0))];
                    },
                    else => {
// zbr:selfhost/astbuilder_test.zbr:74
                        _error_ctx = .{ .message = "expected method decl", .details = null };
                        return error.ZebraError;
                    },
                }
            },
            else => {
// zbr:selfhost/astbuilder_test.zbr:76
                _error_ctx = .{ .message = "expected class_ decl", .details = null };
                return error.ZebraError;
            },
        }
    }

    pub fn stmtExprValue(self: *ASTBuilderTest, s: Stmt) anyerror!Expr {
        _ = self;
// zbr:selfhost/astbuilder_test.zbr:80
        switch (s) {
            .expr => |e_ptr| {
                const e = e_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:82
                return e;
            },
            else => {
// zbr:selfhost/astbuilder_test.zbr:84
                _error_ctx = .{ .message = "expected Stmt.expr", .details = null };
                return error.ZebraError;
            },
        }
    }

    pub fn testEmptyClass(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:90
        const d = try self.firstDecl("class Foo\n");
// zbr:selfhost/astbuilder_test.zbr:91
        switch (d) {
            .class_ => |c_ptr| {
                const c = c_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:93
                if (!(std.mem.eql(u8, c.name, "Foo"))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:94
...
// zbr:selfhost/astbuilder_test.zbr:96
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:97
        std.debug.print("{s}\n", .{"testEmptyClass: OK"});
    }

    pub fn testClassWithField(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:100
        const d = try self.firstDecl("class Foo\n    var x as int\n");
// zbr:selfhost/astbuilder_test.zbr:101
        switch (d) {
            .class_ => |c_ptr| {
                const c = c_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:103
                if (!(std.mem.eql(u8, c.name, "Foo"))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:104
                if (!((@as(i64, @intCast(c.members.items.len)) == 1))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:105
                const m = c.members.items[@as(usize, @intCast(0))];
// zbr:selfhost/astbuilder_test.zbr:106
                switch (m) {
                    .var_ => |v_ptr| {
                        const v = v_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:108
                        if (!(std.mem.eql(u8, v.name, "x"))) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
// zbr:selfhost/astbuilder_test.zbr:109
                        const tr = v.type_.?;
// zbr:selfhost/astbuilder_test.zbr:110
                        switch (tr) {
                            .named => |nr| {
// zbr:selfhost/astbuilder_test.zbr:112
                                if (!(std.mem.eql(u8, nr.name, "int"))) {
                                    std.debug.print("assertion failed\n", .{});
                                    unreachable;
                                }
                            },
                            else => {
// zbr:selfhost/astbuilder_test.zbr:114
                                if (!(false)) {
                                    std.debug.print("assertion failed\n", .{});
                                    unreachable;
                                }
...
// zbr:selfhost/astbuilder_test.zbr:116
                        if (!(false)) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
...
// zbr:selfhost/astbuilder_test.zbr:118
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:119
        std.debug.print("{s}\n", .{"testClassWithField: OK"});
    }

    pub fn testEnumDecl(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:122
        const d = try self.firstDecl("enum Color\n    red\n    green\n    blue\n");
// zbr:selfhost/astbuilder_test.zbr:123
        switch (d) {
            .enum_ => |e_ptr| {
                const e = e_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:125
                if (!(std.mem.eql(u8, e.name, "Color"))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:126
                if (!((@as(i64, @intCast(e.members.items.len)) == 3))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:127
                if (!(std.mem.eql(u8, e.members.items[@as(usize, @intCast(0))].name, "red"))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:128
                if (!(std.mem.eql(u8, e.members.items[@as(usize, @intCast(1))].name, "green"))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:129
                if (!(std.mem.eql(u8, e.members.items[@as(usize, @intCast(2))].name, "blue"))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
            },
            else => {
// zbr:selfhost/astbuilder_test.zbr:131
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:132
        std.debug.print("{s}\n", .{"testEnumDecl: OK"});
    }

    pub fn testSimpleMethod(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:135
        const src = "class Foo\n    def bar()\n        pass\n";
// zbr:selfhost/astbuilder_test.zbr:136
        const d = try self.firstDecl(src);
// zbr:selfhost/astbuilder_test.zbr:137
        switch (d) {
            .class_ => |c_ptr| {
                const c = c_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:139
                if (!((@as(i64, @intCast(c.members.items.len)) == 1))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:140
                const m = c.members.items[@as(usize, @intCast(0))];
// zbr:selfhost/astbuilder_test.zbr:141
                switch (m) {
                    .method => |meth_ptr| {
                        const meth = meth_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:143
                        if (!(std.mem.eql(u8, meth.name, "bar"))) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
// zbr:selfhost/astbuilder_test.zbr:144
                        if (!((meth.mods.is_shared == false))) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
// zbr:selfhost/astbuilder_test.zbr:145
                        if (!((@as(i64, @intCast(meth.params.items.len)) == 0))) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
                    },
                    else => {
// zbr:selfhost/astbuilder_test.zbr:147
                        if (!(false)) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
...
// zbr:selfhost/astbuilder_test.zbr:149
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:150
        std.debug.print("{s}\n", .{"testSimpleMethod: OK"});
    }

    pub fn testMethodWithParams(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:153
        const src = "class Foo\n    def add(x as int, y as int) as int\n        pass\n";
// zbr:selfhost/astbuilder_test.zbr:154
        const d = try self.firstDecl(src);
// zbr:selfhost/astbuilder_test.zbr:155
        switch (d) {
            .class_ => |c_ptr| {
                const c = c_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:157
                if (!((@as(i64, @intCast(c.members.items.len)) == 1))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:158
                const m = c.members.items[@as(usize, @intCast(0))];
// zbr:selfhost/astbuilder_test.zbr:159
                switch (m) {
                    .method => |meth_ptr| {
                        const meth = meth_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:161
                        if (!(std.mem.eql(u8, meth.name, "add"))) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
// zbr:selfhost/astbuilder_test.zbr:162
                        if (!((@as(i64, @intCast(meth.params.items.len)) == 2))) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
// zbr:selfhost/astbuilder_test.zbr:163
                        if (!(std.mem.eql(u8, meth.params.items[@as(usize, @intCast(0))].name, "x"))) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
// zbr:selfhost/astbuilder_test.zbr:164
                        if (!(std.mem.eql(u8, meth.params.items[@as(usize, @intCast(1))].name, "y"))) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
// zbr:selfhost/astbuilder_test.zbr:165
                        const ret = meth.return_type.?;
// zbr:selfhost/astbuilder_test.zbr:166
                        switch (ret) {
                            .named => |nr| {
// zbr:selfhost/astbuilder_test.zbr:168
                                if (!(std.mem.eql(u8, nr.name, "int"))) {
                                    std.debug.print("assertion failed\n", .{});
                                    unreachable;
                                }
...
// zbr:selfhost/astbuilder_test.zbr:170
                                if (!(false)) {
                                    std.debug.print("assertion failed\n", .{});
                                    unreachable;
                                }
...
// zbr:selfhost/astbuilder_test.zbr:172
                        if (!(false)) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
...
// zbr:selfhost/astbuilder_test.zbr:174
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:175
        std.debug.print("{s}\n", .{"testMethodWithParams: OK"});
    }

    pub fn testIfStmt(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:178
        const src = "class Foo\n    def run()\n        if true\n            pass\n";
// zbr:selfhost/astbuilder_test.zbr:179
        const s = try self.firstMethodStmt(src);
// zbr:selfhost/astbuilder_test.zbr:180
        switch (s) {
            .if_ => |si_ptr| {
                const si = si_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:182
                if (!((@as(i64, @intCast(si.then_stmts.items.len)) == 1))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:183
                if (!((@as(i64, @intCast(si.else_ifs.items.len)) == 0))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
            },
            else => {
// zbr:selfhost/astbuilder_test.zbr:185
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:186
        std.debug.print("{s}\n", .{"testIfStmt: OK"});
    }

    pub fn testWhileStmt(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:189
        const src = "class Foo\n    def run()\n        while true\n            pass\n";
// zbr:selfhost/astbuilder_test.zbr:190
        const s = try self.firstMethodStmt(src);
// zbr:selfhost/astbuilder_test.zbr:191
        switch (s) {
            .while_ => |sw_ptr| {
                const sw = sw_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:193
                if (!((@as(i64, @intCast(sw.stmts.items.len)) == 1))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
            },
            else => {
// zbr:selfhost/astbuilder_test.zbr:195
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:196
        std.debug.print("{s}\n", .{"testWhileStmt: OK"});
    }

    pub fn testForInStmt(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:199
        const src = "class Foo\n    def run()\n        for x in items\n            pass\n";
// zbr:selfhost/astbuilder_test.zbr:200
        const s = try self.firstMethodStmt(src);
// zbr:selfhost/astbuilder_test.zbr:201
        switch (s) {
            .for_in => |sf_ptr| {
                const sf = sf_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:204
                if (!((@as(i64, @intCast(sf.vars.items.len)) == 1))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:205
                if (!(std.mem.eql(u8, sf.vars.items[@as(usize, @intCast(0))], "x"))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:206
                if (!((@as(i64, @intCast(sf.stmts.items.len)) == 1))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
            },
            else => {
// zbr:selfhost/astbuilder_test.zbr:208
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:209
        std.debug.print("{s}\n", .{"testForInStmt: OK"});
    }

    pub fn testAssignStmt(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:212
        const src = "class Foo\n    def run()\n        x = 42\n";
// zbr:selfhost/astbuilder_test.zbr:213
        const s = try self.firstMethodStmt(src);
// zbr:selfhost/astbuilder_test.zbr:214
        switch (s) {
            .assign => |sa_ptr| {
                const sa = sa_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:217
                switch (sa.op) {
                    .assign => {
                        // pass
                    },
                    else => {
// zbr:selfhost/astbuilder_test.zbr:221
                        if (!(false)) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
...
// zbr:selfhost/astbuilder_test.zbr:223
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:224
        std.debug.print("{s}\n", .{"testAssignStmt: OK"});
    }

    pub fn testExprBinary(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:229
        const src = "class Foo\n    def run()\n        foo(1 + 2)\n";
// zbr:selfhost/astbuilder_test.zbr:230
        const s = try self.firstMethodStmt(src);
// zbr:selfhost/astbuilder_test.zbr:231
        const se = try self.stmtExprValue(s);
// zbr:selfhost/astbuilder_test.zbr:232
        switch (se) {
            .call => |ec_ptr| {
                const ec = ec_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:234
                if (!((@as(i64, @intCast(ec.args.items.len)) == 1))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:235
                const arg_val = ec.args.items[@as(usize, @intCast(0))].value;
// zbr:selfhost/astbuilder_test.zbr:236
                switch (arg_val) {
                    .binary => |eb_ptr| {
                        const eb = eb_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:238
                        switch (eb.op) {
                            .add => {
                                // pass
                            },
                            else => {
// zbr:selfhost/astbuilder_test.zbr:242
                                if (!(false)) {
                                    std.debug.print("assertion failed\n", .{});
                                    unreachable;
                                }
...
// zbr:selfhost/astbuilder_test.zbr:245
                        if (!(false)) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
...
// zbr:selfhost/astbuilder_test.zbr:247
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:248
        std.debug.print("{s}\n", .{"testExprBinary: OK"});
    }

    pub fn testExprUnary(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:252
        const src = "class Foo\n    def run()\n        foo(not true)\n";
// zbr:selfhost/astbuilder_test.zbr:253
        const s = try self.firstMethodStmt(src);
// zbr:selfhost/astbuilder_test.zbr:254
        const se = try self.stmtExprValue(s);
// zbr:selfhost/astbuilder_test.zbr:255
        switch (se) {
            .call => |ec_ptr| {
                const ec = ec_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:257
                if (!((@as(i64, @intCast(ec.args.items.len)) == 1))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:258
                const arg_val = ec.args.items[@as(usize, @intCast(0))].value;
// zbr:selfhost/astbuilder_test.zbr:259
                switch (arg_val) {
                    .unary => |eu_ptr| {
                        const eu = eu_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:261
                        switch (eu.op) {
                            .not_ => {
                                // pass
                            },
                            else => {
// zbr:selfhost/astbuilder_test.zbr:265
                                if (!(false)) {
                                    std.debug.print("assertion failed\n", .{});
                                    unreachable;
                                }
...
// zbr:selfhost/astbuilder_test.zbr:268
                        if (!(false)) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
...
// zbr:selfhost/astbuilder_test.zbr:270
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:271
        std.debug.print("{s}\n", .{"testExprUnary: OK"});
    }

    pub fn testExprCall(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:275
        const src = "class Foo\n    def run()\n        foo(1, 2)\n";
// zbr:selfhost/astbuilder_test.zbr:276
        const s = try self.firstMethodStmt(src);
// zbr:selfhost/astbuilder_test.zbr:277
        const se = try self.stmtExprValue(s);
// zbr:selfhost/astbuilder_test.zbr:278
        switch (se) {
            .call => |ec_ptr| {
                const ec = ec_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:280
                if (!((@as(i64, @intCast(ec.args.items.len)) == 2))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:282
                switch (ec.callee) {
                    .ident => |id| {
// zbr:selfhost/astbuilder_test.zbr:284
                        if (!(std.mem.eql(u8, id.name, "foo"))) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
                    },
                    else => {
// zbr:selfhost/astbuilder_test.zbr:286
                        if (!(false)) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
...
// zbr:selfhost/astbuilder_test.zbr:288
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:289
        std.debug.print("{s}\n", .{"testExprCall: OK"});
    }

    pub fn testExprMember(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:293
        const src = "class Foo\n    def run()\n        foo(obj.field)\n";
// zbr:selfhost/astbuilder_test.zbr:294
        const s = try self.firstMethodStmt(src);
// zbr:selfhost/astbuilder_test.zbr:295
        const se = try self.stmtExprValue(s);
// zbr:selfhost/astbuilder_test.zbr:296
        switch (se) {
            .call => |ec_ptr| {
                const ec = ec_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:298
                if (!((@as(i64, @intCast(ec.args.items.len)) == 1))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
// zbr:selfhost/astbuilder_test.zbr:299
                const arg_val = ec.args.items[@as(usize, @intCast(0))].value;
// zbr:selfhost/astbuilder_test.zbr:300
                switch (arg_val) {
                    .member => |em_ptr| {
                        const em = em_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:302
                        if (!(std.mem.eql(u8, em.member, "field"))) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
                    },
                    else => {
// zbr:selfhost/astbuilder_test.zbr:305
                        if (!(false)) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
...
// zbr:selfhost/astbuilder_test.zbr:307
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:308
        std.debug.print("{s}\n", .{"testExprMember: OK"});
    }

    pub fn testParseTypeRefSimple(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:311
        const src = "class Foo\n    var n as int\n";
// zbr:selfhost/astbuilder_test.zbr:312
        const d = try self.firstDecl(src);
// zbr:selfhost/astbuilder_test.zbr:313
        switch (d) {
            .class_ => |c_ptr| {
                const c = c_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:315
                const m = c.members.items[@as(usize, @intCast(0))];
// zbr:selfhost/astbuilder_test.zbr:316
                switch (m) {
                    .var_ => |v_ptr| {
                        const v = v_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:319
                        const tr = v.type_.?;
// zbr:selfhost/astbuilder_test.zbr:320
                        switch (tr) {
                            .named => |nr| {
// zbr:selfhost/astbuilder_test.zbr:322
                                if (!(std.mem.eql(u8, nr.name, "int"))) {
                                    std.debug.print("assertion failed\n", .{});
                                    unreachable;
                                }
...
// zbr:selfhost/astbuilder_test.zbr:324
                                if (!(false)) {
                                    std.debug.print("assertion failed\n", .{});
                                    unreachable;
                                }
...
// zbr:selfhost/astbuilder_test.zbr:326
                        if (!(false)) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
...
// zbr:selfhost/astbuilder_test.zbr:328
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:329
        std.debug.print("{s}\n", .{"testParseTypeRefSimple: OK"});
    }

    pub fn testParseTypeRefNilable(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:332
        const src = "class Foo\n    var n as str?\n";
// zbr:selfhost/astbuilder_test.zbr:333
        const d = try self.firstDecl(src);
// zbr:selfhost/astbuilder_test.zbr:334
        switch (d) {
            .class_ => |c_ptr| {
                const c = c_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:336
                const m = c.members.items[@as(usize, @intCast(0))];
// zbr:selfhost/astbuilder_test.zbr:337
                switch (m) {
                    .var_ => |v_ptr| {
                        const v = v_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:339
                        const tr = v.type_.?;
// zbr:selfhost/astbuilder_test.zbr:340
                        switch (tr) {
                            .nilable => {
                                // pass
                            },
                            else => {
// zbr:selfhost/astbuilder_test.zbr:346
                                if (!(false)) {
                                    std.debug.print("assertion failed\n", .{});
                                    unreachable;
                                }
...
// zbr:selfhost/astbuilder_test.zbr:348
                        if (!(false)) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
...
// zbr:selfhost/astbuilder_test.zbr:350
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:351
        std.debug.print("{s}\n", .{"testParseTypeRefNilable: OK"});
    }

    pub fn testParseTypeRefGeneric(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:354
        const src = "class Foo\n    var items as List(str)\n";
// zbr:selfhost/astbuilder_test.zbr:355
        const d = try self.firstDecl(src);
// zbr:selfhost/astbuilder_test.zbr:356
        switch (d) {
            .class_ => |c_ptr| {
                const c = c_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:358
                const m = c.members.items[@as(usize, @intCast(0))];
// zbr:selfhost/astbuilder_test.zbr:359
                switch (m) {
                    .var_ => |v_ptr| {
                        const v = v_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:361
                        const tr = v.type_.?;
// zbr:selfhost/astbuilder_test.zbr:362
                        switch (tr) {
                            .generic => |g| {
// zbr:selfhost/astbuilder_test.zbr:364
                                if (!(std.mem.eql(u8, g.name, "List"))) {
                                    std.debug.print("assertion failed\n", .{});
                                    unreachable;
                                }
// zbr:selfhost/astbuilder_test.zbr:365
                                if (!((@as(i64, @intCast(g.args.items.len)) == 1))) {
                                    std.debug.print("assertion failed\n", .{});
                                    unreachable;
                                }
// zbr:selfhost/astbuilder_test.zbr:366
                                switch (g.args.items[@as(usize, @intCast(0))]) {
                                    .named => |nr| {
// zbr:selfhost/astbuilder_test.zbr:368
                                        if (!(std.mem.eql(u8, nr.name, "str"))) {
                                            std.debug.print("assertion failed\n", .{});
                                            unreachable;
                                        }
                                    },
                                    else => {
// zbr:selfhost/astbuilder_test.zbr:370
                                        if (!(false)) {
                                            std.debug.print("assertion failed\n", .{});
                                            unreachable;
                                        }
...
// zbr:selfhost/astbuilder_test.zbr:372
                                if (!(false)) {
                                    std.debug.print("assertion failed\n", .{});
                                    unreachable;
                                }
...
// zbr:selfhost/astbuilder_test.zbr:374
                        if (!(false)) {
                            std.debug.print("assertion failed\n", .{});
                            unreachable;
                        }
...
// zbr:selfhost/astbuilder_test.zbr:376
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:377
        std.debug.print("{s}\n", .{"testParseTypeRefGeneric: OK"});
    }

    pub fn testReturnValue(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:383
        const src = "class Foo\n    def bar() as int\n        return 42\n";
// zbr:selfhost/astbuilder_test.zbr:384
        const s = try self.firstMethodStmt(src);
// zbr:selfhost/astbuilder_test.zbr:385
        switch (s) {
            .return_ => |sr_ptr| {
                const sr = sr_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:388
                if (!((sr.value != null))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:390
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:391
        std.debug.print("{s}\n", .{"testReturnValue: OK"});
    }

    pub fn testVarInit(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:395
        const src = "class Foo\n    def bar()\n        var x = 10\n";
// zbr:selfhost/astbuilder_test.zbr:396
        const s = try self.firstMethodStmt(src);
// zbr:selfhost/astbuilder_test.zbr:397
        switch (s) {
            .var_ => |v_ptr| {
                const v = v_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:399
                if (!((v.init_expr != null))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:401
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:402
        std.debug.print("{s}\n", .{"testVarInit: OK"});
    }

    pub fn testAssertMessage(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:406
        const src = "class Foo\n    def bar()\n        assert true, 'bad'\n";
// zbr:selfhost/astbuilder_test.zbr:407
        const s = try self.firstMethodStmt(src);
// zbr:selfhost/astbuilder_test.zbr:408
        switch (s) {
            .assert_ => |sa_ptr| {
                const sa = sa_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:410
                if (!((sa.message != null))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:412
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:413
        std.debug.print("{s}\n", .{"testAssertMessage: OK"});
    }

    pub fn testRaiseMessage(self: *ASTBuilderTest) anyerror!void {
// zbr:selfhost/astbuilder_test.zbr:417
        const src = "class Foo\n    def bar() throws\n        raise 'oops'\n";
// zbr:selfhost/astbuilder_test.zbr:418
        const s = try self.firstMethodStmt(src);
// zbr:selfhost/astbuilder_test.zbr:419
        switch (s) {
            .raise_ => |sr_ptr| {
                const sr = sr_ptr.*;
// zbr:selfhost/astbuilder_test.zbr:421
                if (!((sr.message != null))) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:423
                if (!(false)) {
                    std.debug.print("assertion failed\n", .{});
                    unreachable;
                }
...
// zbr:selfhost/astbuilder_test.zbr:424
        std.debug.print("{s}\n", .{"testRaiseMessage: OK"});
    }

    pub fn init() *ASTBuilderTest {
        const self = _allocator.create(ASTBuilderTest) catch @panic("OOM");
        self._type_tag = _ttag_ASTBuilderTest;
        return self;
    }

};

const _ttag_ASTBuilderTest: u64 = 1745166314;
const _reflect_ASTBuilderTest_name: []const u8 = "ASTBuilderTest";
const _reflect_ASTBuilderTest_fields: []const []const u8 = &.{};
const _reflect_ASTBuilderTest_field_types: []const []const u8 = &.{};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:selfhost/astbuilder_test.zbr:429
        var _try_err_4d10: ?anyerror = null;
        _try_blk_4d10: {
...
// zbr:selfhost/astbuilder_test.zbr:433
...
pub fn main() void {
    ...
    defer _arena.deinit();
    @import("Token.zig")._initAllocator(_allocator);
    @import("Lexer.zig")._initAllocator(_allocator);
