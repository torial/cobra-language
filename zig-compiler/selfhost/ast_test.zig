...
// zbr:selfhost/ast_test.zbr:68
    ...
    pub fn testNilableTypeRef(self: *AstTest) anyerror!void {
        _ = self;
// zbr:selfhost/ast_test.zbr:76
        const s = ast.Span.init(6, 1, 6, 8);
// zbr:selfhost/ast_test.zbr:77
...
const _ttag_AstTest: u64 = 151245807;
const _reflect_AstTest_name: []const u8 = "AstTest";
const _reflect_AstTest_fields: []const []const u8 = &.{};
const _reflect_AstTest_field_types: []const []const u8 = &.{};
