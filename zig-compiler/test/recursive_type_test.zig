...
// Source: test/recursive_type_test.zbr
...
pub const Node = struct {
    ...
    pub fn init(v: i64) Node {
        ...
        self._type_tag = _ttag_Node;
// zbr:test/recursive_type_test.zbr:9
        self.value = v;
// zbr:test/recursive_type_test.zbr:10
        self.next = null;
        return self;
    }
...
const _ttag_Node: u64 = 879231789;
const _reflect_Node_name: []const u8 = "Node";
const _reflect_Node_fields: []const []const u8 = &.{"value", "next"};
const _reflect_Node_field_types: []const []const u8 = &.{"int", "^?Node"};

pub const Pair = struct {
    _type_tag: u64 = _ttag_Pair,
    a: i64 = undefined,
    b: i64 = undefined,
    pub fn init(pa: i64, pb: i64) Pair {
        var self: Pair = undefined;
        self._type_tag = _ttag_Pair;
// zbr:test/recursive_type_test.zbr:19
        self.a = pa;
// zbr:test/recursive_type_test.zbr:20
        self.b = pb;
        return self;
    }
...
const _ttag_Pair: u64 = 3810783697;
const _reflect_Pair_name: []const u8 = "Pair";
const _reflect_Pair_fields: []const []const u8 = &.{"a", "b"};
const _reflect_Pair_field_types: []const []const u8 = &.{"int", "int"};

pub const PairHolder = struct {
    _type_tag: u64 = _ttag_PairHolder,
    p: *Pair = undefined,
    pub fn init(pair: Pair) PairHolder {
        var self: PairHolder = undefined;
        self._type_tag = _ttag_PairHolder;
// zbr:test/recursive_type_test.zbr:25
        { const _rp = _allocator.create(Pair) catch @panic("OOM"); _rp.* = pair; self.p = _rp; }
        return self;
    }

};

const _ttag_PairHolder: u64 = 3553273131;
const _reflect_PairHolder_name: []const u8 = "PairHolder";
const _reflect_PairHolder_fields: []const []const u8 = &.{"p"};
const _reflect_PairHolder_field_types: []const []const u8 = &.{"^Pair"};
...
pub const Tree = struct {
    ...
    pub fn init(v: i64) Tree {
        ...
        self._type_tag = _ttag_Tree;
// zbr:test/recursive_type_test.zbr:33
        self.value = v;
// zbr:test/recursive_type_test.zbr:34
        self.left = null;
// zbr:test/recursive_type_test.zbr:35
        self.right = null;
        return self;
    }
...
const _ttag_Tree: u64 = 3988226293;
const _reflect_Tree_name: []const u8 = "Tree";
const _reflect_Tree_fields: []const []const u8 = &.{"value", "left", "right"};
const _reflect_Tree_field_types: []const []const u8 = &.{"int", "^?Tree", "^?Tree"};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/recursive_type_test.zbr:43
        const c = Node.init(3);
...
// zbr:test/recursive_type_test.zbr:56
        std.debug.assert((n.?.value == 2));
// zbr:test/recursive_type_test.zbr:58
        const n2 = n.?.next;
// zbr:test/recursive_type_test.zbr:59
        std.debug.assert((n2 != null));
// zbr:test/recursive_type_test.zbr:60
        std.debug.assert((n2.?.value == 3));
// zbr:test/recursive_type_test.zbr:64
        const leaf_l = Tree.init(10);
// zbr:test/recursive_type_test.zbr:65
        const leaf_r = Tree.init(20);
...
// zbr:test/recursive_type_test.zbr:76
        std.debug.assert((rr.?.value == 20));
// zbr:test/recursive_type_test.zbr:81
        const pair = Pair.init(7, 13);
