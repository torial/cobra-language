...
pub const Bench = struct {
    _type_tag: u64 = _ttag_Bench,
    pub fn fib(n: i64) i64 {
// zbr:test/bench_zebra.zbr:4
        if (_zebra_lt(n, 2)) {
// zbr:test/bench_zebra.zbr:5
            return n;
        }
// zbr:test/bench_zebra.zbr:6
        return (Bench.fib((n - 1)) + Bench.fib((n - 2)));
    }

    pub fn sumLoop(n: i64) i64 {
// zbr:test/bench_zebra.zbr:9
        var acc: i64 = 0;
// zbr:test/bench_zebra.zbr:10
        var i: i64 = 0;
        while (i < n) : (i += 1) {
// zbr:test/bench_zebra.zbr:11
            acc = (acc + i);
        }
// zbr:test/bench_zebra.zbr:12
        return acc;
    }

    pub fn init() Bench {
        var self: Bench = undefined;
        self._type_tag = _ttag_Bench;
        return self;
    }

};

const _ttag_Bench: u64 = 879416409;
const _reflect_Bench_name: []const u8 = "Bench";
const _reflect_Bench_fields: []const []const u8 = &.{};
const _reflect_Bench_field_types: []const []const u8 = &.{};

pub const Program = struct {
    _type_tag: u64 = _ttag_Program,
    pub fn main() void {
// zbr:test/bench_zebra.zbr:17
        const f = Bench.fib(40);
// zbr:test/bench_zebra.zbr:18
        std.debug.print("{}\n", .{f});
// zbr:test/bench_zebra.zbr:19
        const s = Bench.sumLoop(100000000);
// zbr:test/bench_zebra.zbr:20
        std.debug.print("{}\n", .{s});
    }
