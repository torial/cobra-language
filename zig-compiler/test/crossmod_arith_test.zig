...
// zbr:test/crossmod_arith_test.zbr:6
        const d = MathUtils.double(5);
// zbr:test/crossmod_arith_test.zbr:7
        const s = MathUtils.square(3);
// zbr:test/crossmod_arith_test.zbr:8
        const sum = (d + s);
// zbr:test/crossmod_arith_test.zbr:9
        std.debug.print("{}\n", .{sum});
    }

    pub fn testMathCombos() void {
// zbr:test/crossmod_arith_test.zbr:12
        const x = MathUtils.double(10);
// zbr:test/crossmod_arith_test.zbr:13
        const y = MathUtils.cube(2);
// zbr:test/crossmod_arith_test.zbr:14
        const z = MathUtils.max(x, y);
// zbr:test/crossmod_arith_test.zbr:15
        std.debug.print("{}\n", .{z});
    }

    pub fn testChaining() void {
// zbr:test/crossmod_arith_test.zbr:18
        const result = MathUtils.square(MathUtils.double(3));
// zbr:test/crossmod_arith_test.zbr:19
        std.debug.print("{}\n", .{result});
    }

    pub fn main() void {
// zbr:test/crossmod_arith_test.zbr:22
        App.testBasicArithmetic();
// zbr:test/crossmod_arith_test.zbr:23
        App.testMathCombos();
// zbr:test/crossmod_arith_test.zbr:24
        App.testChaining();
    }
