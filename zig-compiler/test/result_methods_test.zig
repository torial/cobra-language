...
// Source: test/result_methods_test.zbr
...
pub const Main = struct {
    pub fn main() void {
// zbr:test/result_methods_test.zbr:5
        const ok_r: _Result(i64, []const u8) = .{ .ok = 42 };
// zbr:test/result_methods_test.zbr:6
        const err_r: _Result(i64, []const u8) = .{ .err = "oops" };
// zbr:test/result_methods_test.zbr:7
        if (!((ok_r.isOk() == true))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:8
        if (!((ok_r.isErr() == false))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:9
        if (!((err_r.isOk() == false))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:10
        if (!((err_r.isErr() == true))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:13
        if (!((ok_r.unwrap() == 42))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:14
        if (!((ok_r.unwrapOr(0) == 42))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:15
        if (!((err_r.unwrapOr(99) == 99))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:18
        const ov = ok_r.okValue();
// zbr:test/result_methods_test.zbr:19
        if (!((ov != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:20
        const ev = err_r.errValue();
// zbr:test/result_methods_test.zbr:21
        if (!((ev != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:24
        const mapped = ok_r.map(struct { fn call(x: i64) i64 {
// zbr:test/result_methods_test.zbr:25
            return (x * 2);
         } }.call);
// zbr:test/result_methods_test.zbr:27
        if (!((mapped.isOk() == true))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:28
        if (!((mapped.unwrap() == 84))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:30
        const mapped_err = err_r.map(struct { fn call(x: i64) i64 {
// zbr:test/result_methods_test.zbr:31
            return (x * 2);
         } }.call);
// zbr:test/result_methods_test.zbr:33
        if (!((mapped_err.isErr() == true))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:36
        const chained = ok_r.flatMap(struct { fn call(x: i64) _Result(i64, []const u8) {
// zbr:test/result_methods_test.zbr:37
            if ((x == 0)) {
// zbr:test/result_methods_test.zbr:38
                return .{ .err = "zero" };
            }
// zbr:test/result_methods_test.zbr:39
            return .{ .ok = @divTrunc(100, x) };
         } }.call);
// zbr:test/result_methods_test.zbr:41
        if (!((chained.isOk() == true))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:42
        if (!((chained.unwrap() == 2))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:44
        const zero_r: _Result(i64, []const u8) = .{ .ok = 0 };
// zbr:test/result_methods_test.zbr:45
        const chained_err = zero_r.flatMap(struct { fn call(x: i64) _Result(i64, []const u8) {
// zbr:test/result_methods_test.zbr:46
            if ((x == 0)) {
// zbr:test/result_methods_test.zbr:47
                return .{ .err = "zero" };
            }
// zbr:test/result_methods_test.zbr:48
            return .{ .ok = @divTrunc(100, x) };
         } }.call);
// zbr:test/result_methods_test.zbr:50
        if (!((chained_err.isErr() == true))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/result_methods_test.zbr:52
        std.debug.print("{s}\n", .{"result_methods_test: all assertions passed"});
    }
