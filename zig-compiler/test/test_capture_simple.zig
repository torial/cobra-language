...
// Source: test/test_capture_simple.zbr
...
pub const Main = struct {
    pub fn main() void {
// zbr:test/test_capture_simple.zbr:4
        const x: i64 = 5;
// zbr:test/test_capture_simple.zbr:5
        const get_x = struct {
            x: i64,
            fn call(self: @This()) i64 {
// zbr:test/test_capture_simple.zbr:8
                return self.x;
            }
        }{ .x = x, };
// zbr:test/test_capture_simple.zbr:9
        std.debug.print("{any}\n", .{get_x.call()});
    }
