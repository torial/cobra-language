...
// Source: test/type_check_test.zbr
...
pub const Dog = struct {
    _type_tag: u64 = _ttag_Dog,
    name: []const u8 = undefined,
    breed: []const u8 = undefined,
    pub fn init(n: []const u8, b: []const u8) Dog {
        var self: Dog = undefined;
        self._type_tag = _ttag_Dog;
// zbr:test/type_check_test.zbr:5
        self.name = n;
// zbr:test/type_check_test.zbr:6
        self.breed = b;
        return self;
    }
...
const _ttag_Dog: u64 = 1265483177;
const _reflect_Dog_name: []const u8 = "Dog";
const _reflect_Dog_fields: []const []const u8 = &.{"name", "breed"};
const _reflect_Dog_field_types: []const []const u8 = &.{"str", "str"};

pub const Cat = struct {
    _type_tag: u64 = _ttag_Cat,
    name: []const u8 = undefined,
    pub fn init(n: []const u8) Cat {
        var self: Cat = undefined;
        self._type_tag = _ttag_Cat;
// zbr:test/type_check_test.zbr:11
        self.name = n;
        return self;
    }
...
const _ttag_Cat: u64 = 1761538983;
const _reflect_Cat_name: []const u8 = "Cat";
const _reflect_Cat_fields: []const []const u8 = &.{"name"};
const _reflect_Cat_field_types: []const []const u8 = &.{"str"};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/type_check_test.zbr:16
        const d = Dog.init("Rex", "Labrador");
// zbr:test/type_check_test.zbr:17
        const c = Cat.init("Whiskers");
// zbr:test/type_check_test.zbr:20
        if ((d._type_tag == _ttag_Dog)) {
// zbr:test/type_check_test.zbr:21
            std.debug.print("{s}\n", .{"d is Dog: true"});
        }
// zbr:test/type_check_test.zbr:23
        if ((c._type_tag == _ttag_Cat)) {
// zbr:test/type_check_test.zbr:24
            std.debug.print("{s}\n", .{"c is Cat: true"});
        }
// zbr:test/type_check_test.zbr:27
        if ((!(d._type_tag == _ttag_Cat))) {
// zbr:test/type_check_test.zbr:28
            std.debug.print("{s}\n", .{"d is not Cat: correct"});
        }
// zbr:test/type_check_test.zbr:30
        if ((!(c._type_tag == _ttag_Dog))) {
// zbr:test/type_check_test.zbr:31
            std.debug.print("{s}\n", .{"c is not Dog: correct"});
        }
    }
