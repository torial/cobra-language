...
// Source: test/c_interop_test.zbr
...
const CUtils = @cImport(@cInclude("CUtils.h"));
pub const Program = struct {
    pub fn testArithmetic() void {
// zbr:test/c_interop_test.zbr:6
        const sum = CUtils.c_add(10, 32);
// zbr:test/c_interop_test.zbr:7
        std.debug.print("{any}\n", .{sum});
// zbr:test/c_interop_test.zbr:8
        const product = CUtils.c_mul(6, 7);
// zbr:test/c_interop_test.zbr:9
        std.debug.print("{any}\n", .{product});
// zbr:test/c_interop_test.zbr:10
        const diff = CUtils.c_add(100, (-30));
// zbr:test/c_interop_test.zbr:11
        std.debug.print("{any}\n", .{diff});
    }

    pub fn testBoundaryValues() void {
// zbr:test/c_interop_test.zbr:14
        const zero = CUtils.c_add(0, 0);
// zbr:test/c_interop_test.zbr:15
        std.debug.print("{any}\n", .{zero});
// zbr:test/c_interop_test.zbr:16
        const large = CUtils.c_mul(1000, 1000);
// zbr:test/c_interop_test.zbr:17
        std.debug.print("{any}\n", .{large});
// zbr:test/c_interop_test.zbr:18
        const negative = CUtils.c_add((-50), (-25));
// zbr:test/c_interop_test.zbr:19
        std.debug.print("{any}\n", .{negative});
    }

    pub fn main() void {
// zbr:test/c_interop_test.zbr:22
        std.debug.print("{s}\n", .{"C Interop Tests"});
// zbr:test/c_interop_test.zbr:23
        Program.testArithmetic();
// zbr:test/c_interop_test.zbr:24
        Program.testBoundaryValues();
// zbr:test/c_interop_test.zbr:25
        std.debug.print("{s}\n", .{"C interop tests completed"});
    }
