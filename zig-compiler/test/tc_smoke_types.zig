...
pub const TcTypes = struct {
    ...
    pub fn describe(t: TcType) []const u8 {
// zbr:test\tc_smoke_types.zbr:12
        switch (t) {
            .unknown => {
// zbr:test\tc_smoke_types.zbr:13
                return "unknown";
            },
            .int_ => {
// zbr:test\tc_smoke_types.zbr:14
                return "int";
            },
            .str_ => {
// zbr:test\tc_smoke_types.zbr:15
                return "str";
            },
            .optional => |inner_ptr| {
                const inner = inner_ptr.*;
// zbr:test\tc_smoke_types.zbr:17
                return _str_concat("?", TcTypes.describe(inner), _allocator);
            },
        }
    }
