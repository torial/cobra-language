...
// Source: test/zig_interop_test.zbr
...
pub const Program = struct {
    pub fn testBasicMath() void {
// zbr:test/zig_interop_test.zbr:6
        std.debug.print("{s}\n", .{"Basic math operations:"});
// zbr:test/zig_interop_test.zbr:7
        std.debug.print("{any}\n", .{ZigMath.square(7)});
// zbr:test/zig_interop_test.zbr:8
        std.debug.print("{any}\n", .{ZigMath.clamp(15, 0, 10)});
// zbr:test/zig_interop_test.zbr:9
        std.debug.print("{any}\n", .{ZigMath.abs((-42))});
    }

    pub fn testEdgeCases() void {
// zbr:test/zig_interop_test.zbr:12
        std.debug.print("{s}\n", .{"Edge cases:"});
// zbr:test/zig_interop_test.zbr:13
        std.debug.print("{any}\n", .{ZigMath.square(0)});
// zbr:test/zig_interop_test.zbr:14
        std.debug.print("{any}\n", .{ZigMath.clamp(5, 5, 5)});
// zbr:test/zig_interop_test.zbr:15
        std.debug.print("{any}\n", .{ZigMath.abs(0)});
// zbr:test/zig_interop_test.zbr:16
        std.debug.print("{any}\n", .{ZigMath.abs((-1))});
    }

    pub fn testFloatMath() void {
// zbr:test/zig_interop_test.zbr:19
        std.debug.print("{s}\n", .{"Float operations:"});
// zbr:test/zig_interop_test.zbr:20
        const f1 = 3.14;
// zbr:test/zig_interop_test.zbr:21
        const f2 = 2.71;
// zbr:test/zig_interop_test.zbr:22
        std.debug.print("{d}\n", .{(f1 + f2)});
    }

    pub fn main() void {
// zbr:test/zig_interop_test.zbr:25
        Program.testBasicMath();
// zbr:test/zig_interop_test.zbr:26
        Program.testEdgeCases();
// zbr:test/zig_interop_test.zbr:27
        Program.testFloatMath();
    }
