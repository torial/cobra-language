...
pub fn _initAllocator(a: std.mem.Allocator) void {
    _allocator = a;
    @import("expose_lib.zig")._initAllocator(a);
}
...
const expose_lib = @import("expose_lib.zig");
const Color = expose_lib.Color;
const Palette = expose_lib.Palette;
pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/exposing_test.zbr:6
        const c = Color{ .green = {} };
...
// zbr:test/exposing_test.zbr:16
        var p = Palette.init("warm");
// zbr:test/exposing_test.zbr:17
        std.debug.assert(std.mem.eql(u8, p.describe(), "Palette:warm"));
// zbr:test/exposing_test.zbr:19
        std.debug.print("{s}\n", .{"exposing_test: all OK"});
    }
...
pub fn main() void {
    ...
    defer _arena.deinit();
    @import("expose_lib.zig")._initAllocator(_allocator);
    Main.main();
}
