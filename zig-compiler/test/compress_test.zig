...
pub const CompressTest = struct {
    _type_tag: u64 = _ttag_CompressTest,
    pub fn main() void {
// zbr:test/compress_test.zbr:5
        std.debug.print("{}\n", .{_compress_gzip("hello world").len});
// zbr:test/compress_test.zbr:6
        std.debug.print("{s}\n", .{"gzip (stubbed): OK"});
// zbr:test/compress_test.zbr:9
        const result = _compress_gunzip("not valid gzip");
// zbr:test/compress_test.zbr:10
        std.debug.assert((result == null));
// zbr:test/compress_test.zbr:11
        std.debug.print("{s}\n", .{"gunzip bad input: OK"});
// zbr:test/compress_test.zbr:13
        std.debug.print("{s}\n", .{"All compress tests passed."});
    }

    pub fn init() CompressTest {
        var self: CompressTest = undefined;
        self._type_tag = _ttag_CompressTest;
        return self;
    }

};

const _ttag_CompressTest: u64 = 981549005;
const _reflect_CompressTest_name: []const u8 = "CompressTest";
const _reflect_CompressTest_fields: []const []const u8 = &.{};
const _reflect_CompressTest_field_types: []const []const u8 = &.{};
