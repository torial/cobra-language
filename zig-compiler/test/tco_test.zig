...
pub const Acc = struct {
    _type_tag: u64 = _ttag_Acc,
    pub fn sumTo(_p_n: i64, _p_acc: i64) i64 {
        var n = _p_n;
        var acc = _p_acc;
        while (true) {
// zbr:test/tco_test.zbr:5
            if (_zebra_le(n, 0)) {
// zbr:test/tco_test.zbr:6
                return acc;
            }
// zbr:test/tco_test.zbr:7
            { const _tco0 = (n - 1); const _tco1 = (acc + n); n = _tco0; acc = _tco1; }
            continue;
        }
    }

    pub fn init() Acc {
        var self: Acc = undefined;
        self._type_tag = _ttag_Acc;
        return self;
    }

};

const _ttag_Acc: u64 = 2765422138;
const _reflect_Acc_name: []const u8 = "Acc";
const _reflect_Acc_fields: []const []const u8 = &.{};
const _reflect_Acc_field_types: []const []const u8 = &.{};

pub const Counter = struct {
    _type_tag: u64 = _ttag_Counter,
    count: i64 = 0,
    pub fn countDown(self: *Counter, _p_n: i64) i64 {
        var n = _p_n;
        while (true) {
// zbr:test/tco_test.zbr:13
            if (_zebra_le(n, 0)) {
// zbr:test/tco_test.zbr:14
                return self.count;
            }
// zbr:test/tco_test.zbr:15
            self.count = (self.count + 1);
// zbr:test/tco_test.zbr:16
            { const _tco0 = (n - 1); n = _tco0; }
            continue;
        }
    }
...
pub const Program = struct {
    ...
    pub fn main() void {
// zbr:test/tco_test.zbr:22
        const s = Acc.sumTo(1000000, 0);
// zbr:test/tco_test.zbr:23
        std.debug.print("{}\n", .{s});
// zbr:test/tco_test.zbr:26
        var c = Counter.init();
// zbr:test/tco_test.zbr:27
        const result = c.countDown(500000);
// zbr:test/tco_test.zbr:28
        std.debug.print("{}\n", .{result});
    }
