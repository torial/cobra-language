...
pub const HashTest = struct {
    _type_tag: u64 = _ttag_HashTest,
    pub fn main() void {
// zbr:test/hash_test.zbr:4
        const h0 = _hash_sha256("");
// zbr:test/hash_test.zbr:5
        std.debug.assert(std.mem.eql(u8, h0, "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"));
// zbr:test/hash_test.zbr:6
        std.debug.print("{s}\n", .{"sha256 empty: OK"});
// zbr:test/hash_test.zbr:9
        const h1 = _hash_sha256("hello");
// zbr:test/hash_test.zbr:10
        std.debug.assert(std.mem.eql(u8, h1, "2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824"));
// zbr:test/hash_test.zbr:11
        std.debug.print("{s}\n", .{"sha256 hello: OK"});
// zbr:test/hash_test.zbr:14
        const h2 = _hash_sha512("hello");
// zbr:test/hash_test.zbr:15
        std.debug.assert((h2.len == 128));
// zbr:test/hash_test.zbr:16
        std.debug.print("{s}\n", .{"sha512 length: OK"});
// zbr:test/hash_test.zbr:19
        const h3 = _hash_md5("hello");
// zbr:test/hash_test.zbr:20
        std.debug.assert(std.mem.eql(u8, h3, "5d41402abc4b2a76b9719d911017c592"));
// zbr:test/hash_test.zbr:21
        std.debug.print("{s}\n", .{"md5 hello: OK"});
// zbr:test/hash_test.zbr:24
        const h4 = _hash_blake3("hello");
// zbr:test/hash_test.zbr:25
        std.debug.assert((h4.len == 64));
// zbr:test/hash_test.zbr:26
        std.debug.print("{s}\n", .{"blake3 length: OK"});
// zbr:test/hash_test.zbr:29
        const h5 = _hash_hmac256("secret-key", "hello world");
// zbr:test/hash_test.zbr:30
        std.debug.assert((h5.len == 64));
// zbr:test/hash_test.zbr:31
        std.debug.print("{s}\n", .{"hmac256 length: OK"});
// zbr:test/hash_test.zbr:33
        std.debug.print("{s}\n", .{"All hash tests passed."});
    }

    pub fn init() HashTest {
        var self: HashTest = undefined;
        self._type_tag = _ttag_HashTest;
        return self;
    }

};

const _ttag_HashTest: u64 = 3718265321;
const _reflect_HashTest_name: []const u8 = "HashTest";
const _reflect_HashTest_fields: []const []const u8 = &.{};
const _reflect_HashTest_field_types: []const []const u8 = &.{};
