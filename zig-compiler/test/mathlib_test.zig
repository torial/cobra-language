...
// zbr:test/mathlib_test.zbr:4
        return (a + b);
    }

    pub fn mul(a: i64, b: i64) i64 {
// zbr:test/mathlib_test.zbr:7
        return (a * b);
    }

    pub fn clamp(val: f64, lo: f64, hi: f64) f64 {
// zbr:test/mathlib_test.zbr:10
        if (_zebra_lt(val, lo)) {
// zbr:test/mathlib_test.zbr:11
            return lo;
        }
// zbr:test/mathlib_test.zbr:12
        if (_zebra_gt(val, hi)) {
// zbr:test/mathlib_test.zbr:13
            return hi;
        }
// zbr:test/mathlib_test.zbr:14
        return val;
    }

    pub fn isEven(n: i64) bool {
// zbr:test/mathlib_test.zbr:17
        return ((n - (@divTrunc(n, 2) * 2)) == 0);
    }
