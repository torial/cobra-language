...
pub const TcSymRef = struct {
    name: []const u8 = undefined,
    kind: TcSymbolKind = undefined,
    pub fn init(n: []const u8, k: TcSymbolKind) TcSymRef {
        var self: TcSymRef = undefined;
// zbr:test\tc_types.zbr:36
        self.name = n;
// zbr:test\tc_types.zbr:37
        self.kind = k;
        return self;
    }
...
pub const TcCrossRef = struct {
    module: []const u8 = undefined,
    type_name: []const u8 = undefined,
    pub fn init(mod: []const u8, tname: []const u8) TcCrossRef {
        var self: TcCrossRef = undefined;
// zbr:test\tc_types.zbr:45
        self.module = mod;
// zbr:test\tc_types.zbr:46
...
pub const TcGenericRef = struct {
    name: []const u8 = undefined,
    kind: TcSymbolKind = undefined,
    args: std.ArrayList(TcType) = undefined,
    pub fn init(n: []const u8, k: TcSymbolKind, a: std.ArrayList(TcType)) TcGenericRef {
        var self: TcGenericRef = undefined;
// zbr:test\tc_types.zbr:56
        self.name = n;
// zbr:test\tc_types.zbr:57
        self.kind = k;
// zbr:test\tc_types.zbr:58
        self.args = a;
        return self;
    }
...
pub const TcType = union(enum) {
    ...
    float_n: i64,
    named: TcSymRef,
    generic_named: TcGenericRef,
    optional: *TcType,
    tuple: std.ArrayList(TcType),
    cross_module: TcCrossRef,
    fn_ref: []const u8,
    fn_sig: []const u8,
    string_builder,
    http_request,
...
pub const TcTypes = struct {
    _type_tag: u64 = _ttag_TcTypes,
    pub fn eql(_p_a: TcType, _p_b: TcType) bool {
        var a = _p_a;
        var b = _p_b;
        while (true) {
// zbr:test\tc_types.zbr:124
            switch (a) {
                .int_ => {
// zbr:test\tc_types.zbr:126
                    return std.meta.eql(b, TcType{ .int_ = {} });
                },
                .uint_ => {
// zbr:test\tc_types.zbr:127
                    return std.meta.eql(b, TcType{ .uint_ = {} });
                },
                .float_ => {
// zbr:test\tc_types.zbr:128
                    return std.meta.eql(b, TcType{ .float_ = {} });
                },
                .bool_ => {
// zbr:test\tc_types.zbr:129
                    return std.meta.eql(b, TcType{ .bool_ = {} });
                },
                .char_ => {
// zbr:test\tc_types.zbr:130
                    return std.meta.eql(b, TcType{ .char_ = {} });
                },
                .string_ => {
// zbr:test\tc_types.zbr:131
                    return std.meta.eql(b, TcType{ .string_ = {} });
                },
                .void_ => {
// zbr:test\tc_types.zbr:132
                    return std.meta.eql(b, TcType{ .void_ = {} });
                },
                .int_n => |wa| {
// zbr:test\tc_types.zbr:136
                    switch (b) {
                        .int_n => |wb| {
// zbr:test\tc_types.zbr:138
                            return (wa == wb);
                        },
                        else => {
// zbr:test\tc_types.zbr:140
                            return false;
                        },
                    }
                },
                .uint_n => |wa| {
// zbr:test\tc_types.zbr:142
                    switch (b) {
                        .uint_n => |wb| {
// zbr:test\tc_types.zbr:144
                            return (wa == wb);
                        },
                        else => {
// zbr:test\tc_types.zbr:146
                            return false;
                        },
                    }
                },
                .float_n => |wa| {
// zbr:test\tc_types.zbr:148
                    switch (b) {
                        .float_n => |wb| {
// zbr:test\tc_types.zbr:150
                            return (wa == wb);
                        },
                        else => {
// zbr:test\tc_types.zbr:152
                            return false;
                        },
                    }
                },
                .named => |na| {
// zbr:test\tc_types.zbr:156
                    switch (b) {
                        .named => |nb| {
// zbr:test\tc_types.zbr:158
                            return (std.mem.eql(u8, na.name, nb.name) and (na.kind == nb.kind));
                        },
                        else => {
// zbr:test\tc_types.zbr:160
                            return false;
                        },
                    }
                },
                .generic_named => |ga| {
// zbr:test\tc_types.zbr:164
                    switch (b) {
                        .generic_named => |gb| {
// zbr:test\tc_types.zbr:166
                            if (!std.mem.eql(u8, ga.name, gb.name)) {
// zbr:test\tc_types.zbr:167
                                return false;
                            }
// zbr:test\tc_types.zbr:168
                            if ((@as(i64, @intCast(ga.args.items.len)) != @as(i64, @intCast(gb.args.items.len)))) {
// zbr:test\tc_types.zbr:169
                                return false;
                            }
// zbr:test\tc_types.zbr:170
                            var i: i64 = 0;
// zbr:test\tc_types.zbr:171
                            while (_zebra_lt(i, @as(i64, @intCast(ga.args.items.len)))) {
// zbr:test\tc_types.zbr:172
                                if ((!TcTypes.eql(ga.args.items[@as(usize, @intCast(i))], gb.args.items[@as(usize, @intCast(i))]))) {
// zbr:test\tc_types.zbr:173
                                    return false;
                                }
// zbr:test\tc_types.zbr:174
                                i = (i + 1);
                            }
// zbr:test\tc_types.zbr:175
                            return true;
                        },
                        else => {
// zbr:test\tc_types.zbr:177
                            return false;
                        },
                    }
                },
                .optional => |ia_ptr| {
                    const ia = ia_ptr.*;
// zbr:test\tc_types.zbr:181
                    switch (b) {
                        .optional => |ib_ptr| {
                            const ib = ib_ptr.*;
// zbr:test\tc_types.zbr:183
                            { const _tco0 = ia; const _tco1 = ib; a = _tco0; b = _tco1; }
                            continue;
                        },
                        else => {
// zbr:test\tc_types.zbr:185
                            return false;
                        },
                    }
                },
                .tuple => |ea| {
// zbr:test\tc_types.zbr:189
                    switch (b) {
                        .tuple => |eb| {
// zbr:test\tc_types.zbr:191
                            if ((@as(i64, @intCast(ea.items.len)) != @as(i64, @intCast(eb.items.len)))) {
// zbr:test\tc_types.zbr:192
                                return false;
                            }
// zbr:test\tc_types.zbr:193
                            var i: i64 = 0;
// zbr:test\tc_types.zbr:194
                            while (_zebra_lt(i, @as(i64, @intCast(ea.items.len)))) {
// zbr:test\tc_types.zbr:195
                                if ((!TcTypes.eql(ea.items[@as(usize, @intCast(i))], eb.items[@as(usize, @intCast(i))]))) {
// zbr:test\tc_types.zbr:196
                                    return false;
                                }
// zbr:test\tc_types.zbr:197
                                i = (i + 1);
                            }
// zbr:test\tc_types.zbr:198
                            return true;
                        },
                        else => {
// zbr:test\tc_types.zbr:200
                            return false;
                        },
                    }
                },
                .cross_module => |ca| {
// zbr:test\tc_types.zbr:204
                    switch (b) {
                        .cross_module => |cb| {
// zbr:test\tc_types.zbr:206
                            return (std.mem.eql(u8, ca.module, cb.module) and std.mem.eql(u8, ca.type_name, cb.type_name));
                        },
                        else => {
// zbr:test\tc_types.zbr:208
                            return false;
                        },
                    }
                },
                .fn_ref => |fa| {
// zbr:test\tc_types.zbr:212
                    switch (b) {
                        .fn_ref => |fb| {
// zbr:test\tc_types.zbr:214
                            return std.mem.eql(u8, fa, fb);
                        },
                        else => {
// zbr:test\tc_types.zbr:216
                            return false;
                        },
                    }
                },
                .fn_sig => |fa| {
// zbr:test\tc_types.zbr:218
                    switch (b) {
                        .fn_sig => |fb| {
// zbr:test\tc_types.zbr:220
                            return std.mem.eql(u8, fa, fb);
                        },
                        else => {
// zbr:test\tc_types.zbr:222
                            return false;
                        },
                    }
                },
                .string_builder => {
// zbr:test\tc_types.zbr:225
                    return std.meta.eql(b, TcType{ .string_builder = {} });
                },
                .http_request => {
// zbr:test\tc_types.zbr:226
                    return std.meta.eql(b, TcType{ .http_request = {} });
                },
                .http_response => {
// zbr:test\tc_types.zbr:227
                    return std.meta.eql(b, TcType{ .http_response = {} });
                },
                .tcp_conn => {
// zbr:test\tc_types.zbr:228
                    return std.meta.eql(b, TcType{ .tcp_conn = {} });
                },
                .udp_socket => {
// zbr:test\tc_types.zbr:229
                    return std.meta.eql(b, TcType{ .udp_socket = {} });
                },
                .regex => {
// zbr:test\tc_types.zbr:230
                    return std.meta.eql(b, TcType{ .regex = {} });
                },
                .gui_context => {
// zbr:test\tc_types.zbr:231
                    return std.meta.eql(b, TcType{ .gui_context = {} });
                },
                .shell => {
// zbr:test\tc_types.zbr:232
                    return std.meta.eql(b, TcType{ .shell = {} });
                },
                .file_ => {
// zbr:test\tc_types.zbr:233
                    return std.meta.eql(b, TcType{ .file_ = {} });
                },
                .str_slice => {
// zbr:test\tc_types.zbr:234
                    return std.meta.eql(b, TcType{ .str_slice = {} });
                },
                .sys_run_result => {
// zbr:test\tc_types.zbr:235
                    return std.meta.eql(b, TcType{ .sys_run_result = {} });
                },
                .json_value => {
// zbr:test\tc_types.zbr:236
                    return std.meta.eql(b, TcType{ .json_value = {} });
                },
                .json_array => {
// zbr:test\tc_types.zbr:237
                    return std.meta.eql(b, TcType{ .json_array = {} });
                },
                .date_time => {
// zbr:test\tc_types.zbr:238
                    return std.meta.eql(b, TcType{ .date_time = {} });
                },
                .calendar_view => {
// zbr:test\tc_types.zbr:239
                    return std.meta.eql(b, TcType{ .calendar_view = {} });
                },
                .csv_table => {
// zbr:test\tc_types.zbr:240
                    return std.meta.eql(b, TcType{ .csv_table = {} });
                },
                .csv_writer => {
// zbr:test\tc_types.zbr:241
                    return std.meta.eql(b, TcType{ .csv_writer = {} });
                },
                .csv_row => {
// zbr:test\tc_types.zbr:242
                    return std.meta.eql(b, TcType{ .csv_row = {} });
                },
                .arg_result => {
// zbr:test\tc_types.zbr:243
                    return std.meta.eql(b, TcType{ .arg_result = {} });
                },
                .uri_result => {
// zbr:test\tc_types.zbr:244
                    return std.meta.eql(b, TcType{ .uri_result = {} });
                },
                .timer_handle => {
// zbr:test\tc_types.zbr:245
                    return std.meta.eql(b, TcType{ .timer_handle = {} });
                },
                .unknown_ => {
// zbr:test\tc_types.zbr:246
                    return std.meta.eql(b, TcType{ .unknown_ = {} });
                },
            }
        }
    }

    pub fn isAssignable(_p_a: TcType, _p_b: TcType) bool {
        var a = _p_a;
        var b = _p_b;
        while (true) {
// zbr:test\tc_types.zbr:253
            if ((std.meta.eql(a, TcType{ .unknown_ = {} }) or std.meta.eql(b, TcType{ .unknown_ = {} }))) {
// zbr:test\tc_types.zbr:254
                return true;
            }
// zbr:test\tc_types.zbr:256
            if ((TcTypes.isNumeric(a) and TcTypes.isNumeric(b))) {
// zbr:test\tc_types.zbr:257
                return true;
            }
// zbr:test\tc_types.zbr:260
            if ((std.meta.eql(b, TcType{ .char_ = {} }) and (TcTypes.isNumeric(a) or std.meta.eql(a, TcType{ .char_ = {} })))) {
// zbr:test\tc_types.zbr:261
                return true;
            }
// zbr:test\tc_types.zbr:262
            if ((std.meta.eql(a, TcType{ .char_ = {} }) and TcTypes.isNumeric(b))) {
// zbr:test\tc_types.zbr:263
                return true;
            }
// zbr:test\tc_types.zbr:266
            switch (a) {
                .fn_ref => {
// zbr:test\tc_types.zbr:268
                    switch (b) {
                        .fn_ref => {
// zbr:test\tc_types.zbr:270
                            return true;
                        },
                        .fn_sig => {
// zbr:test\tc_types.zbr:272
                            return true;
                        },
                        else => {
                            // pass
                ...
                .fn_sig => {
// zbr:test\tc_types.zbr:276
                    switch (b) {
                        .fn_sig => {
// zbr:test\tc_types.zbr:278
                            return true;
                        },
                        else => {
                            // pass
...
// zbr:test\tc_types.zbr:286
            switch (a) {
                .optional => |a_inner_ptr| {
                    const a_inner = a_inner_ptr.*;
// zbr:test\tc_types.zbr:288
                    switch (b) {
                        .optional => |b_inner_ptr| {
                            const b_inner = b_inner_ptr.*;
// zbr:test\tc_types.zbr:290
                            if (std.meta.eql(a_inner, TcType{ .void_ = {} })) {
// zbr:test\tc_types.zbr:291
                                return true;
                            }
// zbr:test\tc_types.zbr:292
                            { const _tco0 = a_inner; const _tco1 = b_inner; a = _tco0; b = _tco1; }
                            continue;
                        },
                        else => {
// zbr:test\tc_types.zbr:294
                            return false;
                        },
                    }
                },
...
// zbr:test\tc_types.zbr:299
            switch (b) {
                .optional => |b_inner_ptr| {
                    const b_inner = b_inner_ptr.*;
// zbr:test\tc_types.zbr:301
                    { const _tco0 = a; const _tco1 = b_inner; a = _tco0; b = _tco1; }
                    continue;
                },
                else => {
                    // pass
...
// zbr:test\tc_types.zbr:305
            return TcTypes.eql(a, b);
        }
    }

    pub fn typeName(t: TcType) []const u8 {
// zbr:test\tc_types.zbr:309
        switch (t) {
            .int_ => {
// zbr:test\tc_types.zbr:310
                return "int";
            },
            .uint_ => {
// zbr:test\tc_types.zbr:311
                return "uint";
            },
            .float_ => {
// zbr:test\tc_types.zbr:312
                return "float";
            },
            .bool_ => {
// zbr:test\tc_types.zbr:313
                return "bool";
            },
            .char_ => {
// zbr:test\tc_types.zbr:314
                return "char";
            },
            .string_ => {
// zbr:test\tc_types.zbr:315
                return "String";
            },
            .void_ => {
// zbr:test\tc_types.zbr:316
                return "void";
            },
            .int_n => {
// zbr:test\tc_types.zbr:317
                return "int<N>";
            },
            .uint_n => {
// zbr:test\tc_types.zbr:318
                return "uint<N>";
            },
            .float_n => {
// zbr:test\tc_types.zbr:319
                return "float<N>";
            },
            .named => |n| {
// zbr:test\tc_types.zbr:321
                return n.name;
            },
            .generic_named => |g| {
// zbr:test\tc_types.zbr:323
                return g.name;
            },
            .optional => |inner_ptr| {
                const inner = inner_ptr.*;
// zbr:test\tc_types.zbr:325
                return _str_concat("?", TcTypes.typeName(inner), _allocator);
            },
            .tuple => {
// zbr:test\tc_types.zbr:327
                return "tuple";
            },
            .cross_module => |c| {
// zbr:test\tc_types.zbr:329
                return c.type_name;
            },
            .fn_ref => |f| {
// zbr:test\tc_types.zbr:331
                return f;
            },
            .fn_sig => |s| {
// zbr:test\tc_types.zbr:333
                return s;
            },
            .string_builder => {
// zbr:test\tc_types.zbr:334
                return "StringBuilder";
            },
            .http_request => {
// zbr:test\tc_types.zbr:335
                return "HttpRequest";
            },
            .http_response => {
// zbr:test\tc_types.zbr:336
                return "HttpResponse";
            },
            .tcp_conn => {
// zbr:test\tc_types.zbr:337
                return "TcpConn";
            },
            .udp_socket => {
// zbr:test\tc_types.zbr:338
                return "UdpSocket";
            },
            .regex => {
// zbr:test\tc_types.zbr:339
                return "Regex";
            },
            .gui_context => {
// zbr:test\tc_types.zbr:340
                return "Gui";
            },
            .shell => {
// zbr:test\tc_types.zbr:341
                return "Shell";
            },
            .file_ => {
// zbr:test\tc_types.zbr:342
                return "File";
            },
            .str_slice => {
// zbr:test\tc_types.zbr:343
                return "[]str";
            },
            .sys_run_result => {
// zbr:test\tc_types.zbr:344
                return "SysRunResult";
            },
            .json_value => {
// zbr:test\tc_types.zbr:345
                return "JsonValue";
            },
            .json_array => {
// zbr:test\tc_types.zbr:346
                return "[]JsonValue";
            },
            .date_time => {
// zbr:test\tc_types.zbr:347
                return "DateTime";
            },
            .calendar_view => {
// zbr:test\tc_types.zbr:348
                return "CalendarView";
            },
            .csv_table => {
// zbr:test\tc_types.zbr:349
                return "CsvTable";
            },
            .csv_writer => {
// zbr:test\tc_types.zbr:350
                return "CsvWriter";
            },
            .csv_row => {
// zbr:test\tc_types.zbr:351
                return "CsvRow";
            },
            .arg_result => {
// zbr:test\tc_types.zbr:352
                return "ArgResult";
            },
            .uri_result => {
// zbr:test\tc_types.zbr:353
                return "UriResult";
            },
            .timer_handle => {
// zbr:test\tc_types.zbr:354
                return "TimerHandle";
            },
            .unknown_ => {
// zbr:test\tc_types.zbr:355
                return "<unknown>";
            },
        }
    }

    pub fn isIntFamily(t: TcType) bool {
// zbr:test\tc_types.zbr:358
        switch (t) {
            .int_ => {
// zbr:test\tc_types.zbr:360
                return true;
            },
            .int_n => {
// zbr:test\tc_types.zbr:362
                return true;
            },
            else => {
// zbr:test\tc_types.zbr:364
                return false;
            },
        }
    }

    pub fn isUintFamily(t: TcType) bool {
// zbr:test\tc_types.zbr:367
        switch (t) {
            .uint_ => {
// zbr:test\tc_types.zbr:369
                return true;
            },
            .uint_n => {
// zbr:test\tc_types.zbr:371
                return true;
            },
            else => {
// zbr:test\tc_types.zbr:373
                return false;
            },
        }
    }

    pub fn isFloatFamily(t: TcType) bool {
// zbr:test\tc_types.zbr:376
        switch (t) {
            .float_ => {
// zbr:test\tc_types.zbr:378
                return true;
            },
            .float_n => {
// zbr:test\tc_types.zbr:380
                return true;
            },
            else => {
// zbr:test\tc_types.zbr:382
                return false;
            },
        }
    }

    pub fn isNumeric(t: TcType) bool {
// zbr:test\tc_types.zbr:385
        return ((TcTypes.isIntFamily(t) or TcTypes.isUintFamily(t)) or TcTypes.isFloatFamily(t));
    }

    pub fn init() TcTypes {
        var self: TcTypes = undefined;
        self._type_tag = _ttag_TcTypes;
        return self;
    }

};

const _ttag_TcTypes: u64 = 1776329665;
const _reflect_TcTypes_name: []const u8 = "TcTypes";
const _reflect_TcTypes_fields: []const []const u8 = &.{};
const _reflect_TcTypes_field_types: []const []const u8 = &.{};
