...
// Source: test\expose_dotted\lib.zbr
...
pub const DottedLib = struct {
    _type_tag: u64 = _ttag_DottedLib,
    pub fn greet() []const u8 {
// zbr:test\expose_dotted\lib.zbr:11
        return "hello from dotted lib";
    }

    pub fn add(a: i64, b: i64) i64 {
// zbr:test\expose_dotted\lib.zbr:14
        return (a + b);
    }

    pub fn makePoint() Point {
// zbr:test\expose_dotted\lib.zbr:17
        return Point.init(3, 4);
    }

    pub fn init() *DottedLib {
        const self = _allocator.create(DottedLib) catch @panic("OOM");
        self._type_tag = _ttag_DottedLib;
        return self;
    }

};

const _ttag_DottedLib: u64 = 1785942596;
const _reflect_DottedLib_name: []const u8 = "DottedLib";
const _reflect_DottedLib_fields: []const []const u8 = &.{};
const _reflect_DottedLib_field_types: []const []const u8 = &.{};
...
// zbr:test\expose_dotted\lib.zbr:23
        self.x = px;
// zbr:test\expose_dotted\lib.zbr:24
        self.y = py;
        return self;
    }

    pub fn sum(self: *Point) i64 {
// zbr:test\expose_dotted\lib.zbr:27
