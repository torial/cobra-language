...
// zbr:test/features.zbr:5
        self.count = (self.count + 1);
    }

    pub fn value(self: *Counter) i64 {
// zbr:test/features.zbr:8
        return self.count;
    }
...
pub const Program = struct {
    ...
    pub fn main() void {
// zbr:test/features.zbr:14
        const nums: i64 = 42;
// zbr:test/features.zbr:15
        std.debug.print("{}\n", .{nums});
// zbr:test/features.zbr:18
        var c: Counter = Counter{};
// zbr:test/features.zbr:19
        c.increment();
// zbr:test/features.zbr:20
        c.increment();
// zbr:test/features.zbr:21
        c.increment();
// zbr:test/features.zbr:22
        std.debug.print("{}\n", .{c.value()});
// zbr:test/features.zbr:25
        const double = struct { fn call(x: i64) @TypeOf((x + x)) { return (x + x); } }.call;
// zbr:test/features.zbr:26
        const result = double(5);
// zbr:test/features.zbr:27
        std.debug.print("{any}\n", .{result});
// zbr:test/features.zbr:30
        const c2: Counter = Counter{};
// zbr:test/features.zbr:31
        const c3 = blk: {
            var _tmp = c2;
            _tmp.count = 99;
            break :blk _tmp;
        };
// zbr:test/features.zbr:33
        std.debug.print("{any}\n", .{c3.count});
    }
