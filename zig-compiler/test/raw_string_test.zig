...
// Source: test/raw_string_test.zbr
...
pub const Main = struct {
    pub fn main() void {
// zbr:test/raw_string_test.zbr:5
        const re1 = _regex_compile("\\d+", "");
// zbr:test/raw_string_test.zbr:6
        std.debug.print("{}\n", .{_regex_match(re1, "42")});
// zbr:test/raw_string_test.zbr:7
        std.debug.print("{}\n", .{_regex_match(re1, "abc")});
// zbr:test/raw_string_test.zbr:10
        const re2 = _regex_compile("\\d+", "");
// zbr:test/raw_string_test.zbr:11
        std.debug.print("{}\n", .{(_regex_match(re1, "99") == _regex_match(re2, "99"))});
// zbr:test/raw_string_test.zbr:14
        const email = _regex_compile("[\\w.+-]+@[\\w-]+\\.[a-z]{2,}", "");
// zbr:test/raw_string_test.zbr:15
        std.debug.print("{}\n", .{_regex_match(email, "user@example.com")});
// zbr:test/raw_string_test.zbr:16
        std.debug.print("{}\n", .{_regex_match(email, "notanemail")});
// zbr:test/raw_string_test.zbr:19
        const wb = _regex_compile("\\bword\\b", "");
// zbr:test/raw_string_test.zbr:20
        std.debug.print("{s}\n", .{_regex_find(wb, "a word here")});
// zbr:test/raw_string_test.zbr:21
        std.debug.print("{s}\n", .{_regex_find(wb, "swordfish")});
// zbr:test/raw_string_test.zbr:24
        const re3 = _regex_compile("\\w+", "");
// zbr:test/raw_string_test.zbr:25
        std.debug.print("{s}\n", .{_regex_find(re3, "hello world")});
    }
