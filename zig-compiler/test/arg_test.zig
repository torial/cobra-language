...
pub const ArgTest = struct {
    ...
    pub fn main() void {
// zbr:test/arg_test.zbr:4
        const args = _arg_parse();
// zbr:test/arg_test.zbr:7
        const verbose = args.flag("--verbose", "-v");
// zbr:test/arg_test.zbr:8
        std.debug.assert((!verbose));
// zbr:test/arg_test.zbr:9
        std.debug.print("{s}\n", .{"flag absent: OK"});
// zbr:test/arg_test.zbr:12
        std.debug.assert((!args.contains("--debug")));
// zbr:test/arg_test.zbr:13
        std.debug.print("{s}\n", .{"contains absent: OK"});
// zbr:test/arg_test.zbr:16
        const out = args.option("--output", "a.out");
// zbr:test/arg_test.zbr:17
        std.debug.assert(std.mem.eql(u8, out, "a.out"));
// zbr:test/arg_test.zbr:18
        std.debug.print("{s}\n", .{"option default: OK"});
// zbr:test/arg_test.zbr:21
        const count = args.optionInt("--count", 5);
// zbr:test/arg_test.zbr:22
        std.debug.assert((count == 5));
// zbr:test/arg_test.zbr:23
        std.debug.print("{s}\n", .{"optionInt default: OK"});
// zbr:test/arg_test.zbr:26
        const pos0 = args.positional(0);
// zbr:test/arg_test.zbr:27
        std.debug.assert((pos0 == null));
// zbr:test/arg_test.zbr:28
        std.debug.print("{s}\n", .{"positional absent: OK"});
...
// zbr:test/arg_test.zbr:35
    ...
    pub fn init() ArgTest {
        var self: ArgTest = undefined;
        self._type_tag = _ttag_ArgTest;
        return self;
    }

};

const _ttag_ArgTest: u64 = 4243611859;
const _reflect_ArgTest_name: []const u8 = "ArgTest";
