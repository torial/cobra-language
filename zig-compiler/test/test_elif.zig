...
pub const Main = struct {
    pub fn check(x: []const u8) i64 {
// zbr:test/test_elif.zbr:4
        var result: i64 = 0;
// zbr:test/test_elif.zbr:5
        if ((std.mem.indexOf(u8, x, "a") != null)) {
// zbr:test/test_elif.zbr:6
            result = 1;
        } else if ((std.mem.indexOf(u8, x, "b") != null)) {
// zbr:test/test_elif.zbr:8
            result = 2;
        } else {
// zbr:test/test_elif.zbr:10
            result = 3;
        }
// zbr:test/test_elif.zbr:11
        return result;
    }

    pub fn main() void {
// zbr:test/test_elif.zbr:14
        std.debug.print("{}\n", .{Main.check("apple")});
// zbr:test/test_elif.zbr:15
        std.debug.print("{}\n", .{Main.check("bat")});
// zbr:test/test_elif.zbr:16
        std.debug.print("{}\n", .{Main.check("cat")});
    }
