...
// zbr:test/sig_test.zbr:4
    return ((_zebra_ge(c, 'a') and _zebra_le(c, 'z')) or (_zebra_ge(c, 'A') and _zebra_le(c, 'Z')));
}

pub fn isDigit(c: u21) bool {
// zbr:test/sig_test.zbr:7
    return (_zebra_ge(c, '0') and _zebra_le(c, '9'));
}

pub fn isAlphaNum(c: u21) bool {
// zbr:test/sig_test.zbr:10
    return (isAlpha(c) or isDigit(c));
}

pub fn spanWhile(src: []const u8, pos: i64, pred: CharPred) i64 {
// zbr:test/sig_test.zbr:14
    var i: i64 = pos;
// zbr:test/sig_test.zbr:15
    while ((_zebra_lt(i, src.len) and pred(src[@intCast(i)]))) {
// zbr:test/sig_test.zbr:16
        i = (i + 1);
    }
// zbr:test/sig_test.zbr:17
    return i;
}

pub const SigTest = struct {
    _type_tag: u64 = _ttag_SigTest,
    pub fn run(self: *SigTest) void {
        _ = self;
// zbr:test/sig_test.zbr:22
        const word = "hello123";
// zbr:test/sig_test.zbr:23
        const alpha_end = spanWhile(word, 0, isAlpha);
// zbr:test/sig_test.zbr:24
        std.debug.assert((alpha_end == 5));
// zbr:test/sig_test.zbr:26
        const alnum_end = spanWhile(word, 0, isAlphaNum);
// zbr:test/sig_test.zbr:27
        std.debug.assert((alnum_end == 8));
// zbr:test/sig_test.zbr:30
        var pred: @TypeOf(&isDigit) = &isDigit;
// zbr:test/sig_test.zbr:31
        std.debug.assert(pred('7'));
// zbr:test/sig_test.zbr:32
        std.debug.assert((!pred('z')));
// zbr:test/sig_test.zbr:35
        pred = &isAlpha;
// zbr:test/sig_test.zbr:36
        std.debug.assert(pred('z'));
// zbr:test/sig_test.zbr:37
        std.debug.assert((!pred('7')));
// zbr:test/sig_test.zbr:40
        pred = &isAlpha;
// zbr:test/sig_test.zbr:41
        const end1 = spanWhile("abc123", 0, pred);
// zbr:test/sig_test.zbr:42
        std.debug.assert((end1 == 3));
// zbr:test/sig_test.zbr:44
        pred = &isDigit;
// zbr:test/sig_test.zbr:45
        const end2 = spanWhile("123abc", 0, pred);
// zbr:test/sig_test.zbr:46
        std.debug.assert((end2 == 3));
    }

    pub fn init() SigTest {
        var self: SigTest = undefined;
        self._type_tag = _ttag_SigTest;
        return self;
    }

};

const _ttag_SigTest: u64 = 2111508034;
const _reflect_SigTest_name: []const u8 = "SigTest";
const _reflect_SigTest_fields: []const []const u8 = &.{};
const _reflect_SigTest_field_types: []const []const u8 = &.{};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/sig_test.zbr:50
        var t = SigTest.init();
// zbr:test/sig_test.zbr:51
        t.run();
// zbr:test/sig_test.zbr:52
        std.debug.print("{s}\n", .{"sig_test: all OK"});
    }
