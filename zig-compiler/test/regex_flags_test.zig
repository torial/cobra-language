...
// Source: test/regex_flags_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/regex_flags_test.zbr:5
        const re_i = _regex_compile("hello", "i");
// zbr:test/regex_flags_test.zbr:6
        std.debug.print("{}\n", .{_regex_match(re_i, "Hello")});
// zbr:test/regex_flags_test.zbr:7
        std.debug.print("{}\n", .{_regex_match(re_i, "HELLO")});
// zbr:test/regex_flags_test.zbr:8
        std.debug.print("{}\n", .{_regex_match(re_i, "world")});
// zbr:test/regex_flags_test.zbr:11
        const re_s = _regex_compile("a.b", "s");
// zbr:test/regex_flags_test.zbr:12
        std.debug.print("{}\n", .{_regex_match(re_s, "a\nb")});
// zbr:test/regex_flags_test.zbr:13
        const re_no_s = _regex_compile("a.b", "");
// zbr:test/regex_flags_test.zbr:14
        std.debug.print("{}\n", .{_regex_match(re_no_s, "a\nb")});
// zbr:test/regex_flags_test.zbr:17
        const re_m = _regex_compile("^\\w+", "m");
// zbr:test/regex_flags_test.zbr:18
        std.debug.print("{s}\n", .{_regex_find(re_m, "hello\nworld")});
// zbr:test/regex_flags_test.zbr:19
        const re_m2 = _regex_compile("\\w+$", "m");
// zbr:test/regex_flags_test.zbr:20
        std.debug.print("{s}\n", .{_regex_find(re_m2, "hello\nworld")});
// zbr:test/regex_flags_test.zbr:23
        const re_lazy = _regex_compile("<.*?>", "");
// zbr:test/regex_flags_test.zbr:24
        std.debug.print("{s}\n", .{_regex_find(re_lazy, "<a><b>")});
// zbr:test/regex_flags_test.zbr:25
        const re_greedy = _regex_compile("<.*>", "");
// zbr:test/regex_flags_test.zbr:26
        std.debug.print("{s}\n", .{_regex_find(re_greedy, "<a><b>")});
// zbr:test/regex_flags_test.zbr:29
        const re_lazy2 = _regex_compile("a+?", "");
// zbr:test/regex_flags_test.zbr:30
        std.debug.print("{s}\n", .{_regex_find(re_lazy2, "aaa")});
// zbr:test/regex_flags_test.zbr:31
        const re_greedy2 = _regex_compile("a+", "");
// zbr:test/regex_flags_test.zbr:32
        std.debug.print("{s}\n", .{_regex_find(re_greedy2, "aaa")});
// zbr:test/regex_flags_test.zbr:35
        const re_wb = _regex_compile("\\bcat\\b", "");
// zbr:test/regex_flags_test.zbr:36
        std.debug.print("{}\n", .{_regex_match(re_wb, "cat")});
// zbr:test/regex_flags_test.zbr:37
        std.debug.print("{s}\n", .{_regex_find(re_wb, "catfish")});
// zbr:test/regex_flags_test.zbr:38
        std.debug.print("{s}\n", .{_regex_find(re_wb, "my cat sat")});
// zbr:test/regex_flags_test.zbr:41
        const re_wB = _regex_compile("\\Bcat\\B", "");
// zbr:test/regex_flags_test.zbr:42
        std.debug.print("{s}\n", .{_regex_find(re_wB, "concatenate")});
// zbr:test/regex_flags_test.zbr:43
        std.debug.print("{s}\n", .{_regex_find(re_wB, "my cat sat")});
// zbr:test/regex_flags_test.zbr:46
        const re_big = _regex_compile("a{1,200}", "");
// zbr:test/regex_flags_test.zbr:47
        std.debug.print("{}\n", .{_regex_match(re_big, "a")});
// zbr:test/regex_flags_test.zbr:50
        const re_u = _regex_compile("a{1,200}", "U");
// zbr:test/regex_flags_test.zbr:51
        std.debug.print("{}\n", .{_regex_match(re_u, "a")});
    }
