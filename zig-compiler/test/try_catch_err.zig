...
// zbr:test/try_catch_err.zbr:4
        if (_zebra_lt(x, 0)) {
// zbr:test/try_catch_err.zbr:5
...
// zbr:test/try_catch_err.zbr:6
        return (x * 2);
    }

    pub fn main() void {
// zbr:test/try_catch_err.zbr:9
        var _try_err_2948: ?anyerror = null;
        _try_blk_2948: {
// zbr:test/try_catch_err.zbr:10
            const result: i64 = App.risky((-3)) catch |_tc_263694a03b8| { _try_err_2948 = _tc_263694a03b8; break :_try_blk_2948; };
// zbr:test/try_catch_err.zbr:11
            std.debug.print("{}\n", .{result});
            break :_try_blk_2948;
        }
        if (_try_err_2948 != null) {
// zbr:test/try_catch_err.zbr:13
            std.debug.print("{s}\n", .{"caught an error"});
        }
// zbr:test/try_catch_err.zbr:15
        std.debug.print("{s}\n", .{"after try"});
    }
