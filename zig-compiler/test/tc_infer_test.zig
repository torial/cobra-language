...
pub fn _initAllocator(a: std.mem.Allocator) void {
    ...
    @import("tc_scope.zig")._initAllocator(a);
    @import("tc_infer.zig")._initAllocator(a);
}
...
const TcTypes = tc_types.TcTypes;
const tc_scope = @import("tc_scope.zig");
const TcScope = tc_scope.TcScope;
const TcScopeKind = tc_scope.TcScopeKind;
const TcSymbol = tc_scope.TcSymbol;
const TcSymKind = tc_scope.TcSymKind;
const tc_infer = @import("tc_infer.zig");
const TcInfer = tc_infer.TcInfer;
const TcExpr = tc_infer.TcExpr;
const TcExprMember = tc_infer.TcExprMember;
const TcExprCall = tc_infer.TcExprCall;
const TcExprBinary = tc_infer.TcExprBinary;
const TcExprUnary = tc_infer.TcExprUnary;
const TcExprCast = tc_infer.TcExprCast;
pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/tc_infer_test.zbr:15
        const sc = TcScope.init();
// zbr:test/tc_infer_test.zbr:16
        sc.push(TcScopeKind.module_);
// zbr:test/tc_infer_test.zbr:17
        sc.push(TcScopeKind.method_);
// zbr:test/tc_infer_test.zbr:19
        const sym_x = TcSymbol.init("x", TcSymKind.local, TcType{ .int_ = {} });
// zbr:test/tc_infer_test.zbr:20
        std.debug.assert(sc.define("x", sym_x));
// zbr:test/tc_infer_test.zbr:22
        const resp_sym = TcSymbol.init("resp", TcSymKind.local, TcType{ .http_response = {} });
// zbr:test/tc_infer_test.zbr:23
        std.debug.assert(sc.define("resp", resp_sym));
// zbr:test/tc_infer_test.zbr:25
        const jv_sym = TcSymbol.init("jv", TcSymKind.local, TcType{ .json_value = {} });
// zbr:test/tc_infer_test.zbr:26
        std.debug.assert(sc.define("jv", jv_sym));
// zbr:test/tc_infer_test.zbr:28
        const opt_resp_sym = TcSymbol.init("maybe_resp", TcSymKind.local, TcType{ .optional = _box_1da7b7f0bb8: { const _bp_1da7b7f0bb8 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_1da7b7f0bb8.* = TcType{ .http_response = {} }; break :_box_1da7b7f0bb8 _bp_1da7b7f0bb8; } });
// zbr:test/tc_infer_test.zbr:29
        std.debug.assert(sc.define("maybe_resp", opt_resp_sym));
// zbr:test/tc_infer_test.zbr:32
        const inf = TcInfer.init(sc);
// zbr:test/tc_infer_test.zbr:35
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .int_lit = {} }), TcType{ .int_ = {} }));
// zbr:test/tc_infer_test.zbr:36
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .float_lit = {} }), TcType{ .float_ = {} }));
// zbr:test/tc_infer_test.zbr:37
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .bool_lit = {} }), TcType{ .bool_ = {} }));
// zbr:test/tc_infer_test.zbr:38
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .string_lit = {} }), TcType{ .string_ = {} }));
// zbr:test/tc_infer_test.zbr:39
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .char_lit = {} }), TcType{ .char_ = {} }));
// zbr:test/tc_infer_test.zbr:40
        const nil_t = inf.inferExpr(TcExpr{ .nil_ = {} });
// zbr:test/tc_infer_test.zbr:41
        std.debug.assert(TcTypes.eql(nil_t, TcType{ .optional = _box_1da7b821980: { const _bp_1da7b821980 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_1da7b821980.* = TcType{ .void_ = {} }; break :_box_1da7b821980 _bp_1da7b821980; } }));
// zbr:test/tc_infer_test.zbr:42
        std.debug.print("{s}\n", .{"1. literal inference OK"});
// zbr:test/tc_infer_test.zbr:45
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .ident = "x" }), TcType{ .int_ = {} }));
// zbr:test/tc_infer_test.zbr:46
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .ident = "y" }), TcType{ .unknown_ = {} }));
// zbr:test/tc_infer_test.zbr:47
        std.debug.print("{s}\n", .{"2. identifier lookup OK"});
// zbr:test/tc_infer_test.zbr:50
        const resp_expr = TcExpr{ .ident = "resp" };
// zbr:test/tc_infer_test.zbr:51
        const mem_status = TcExprMember.init(resp_expr, "status");
// zbr:test/tc_infer_test.zbr:52
        const t_status = inf.inferExpr(TcExpr{ .member = _box_1da7b830bb8: { const _bp_1da7b830bb8 = _allocator.create(tc_infer.TcExprMember) catch @panic("OOM"); _bp_1da7b830bb8.* = mem_status; break :_box_1da7b830bb8 _bp_1da7b830bb8; } });
// zbr:test/tc_infer_test.zbr:53
        std.debug.assert(TcTypes.eql(t_status, TcType{ .uint_ = {} }));
// zbr:test/tc_infer_test.zbr:54
        const mem_text = TcExprMember.init(resp_expr, "text");
// zbr:test/tc_infer_test.zbr:55
        const t_text = inf.inferExpr(TcExpr{ .member = _box_1da7b831270: { const _bp_1da7b831270 = _allocator.create(tc_infer.TcExprMember) catch @panic("OOM"); _bp_1da7b831270.* = mem_text; break :_box_1da7b831270 _bp_1da7b831270; } });
// zbr:test/tc_infer_test.zbr:56
        std.debug.assert(TcTypes.eql(t_text, TcType{ .string_ = {} }));
// zbr:test/tc_infer_test.zbr:57
        std.debug.print("{s}\n", .{"3. member inference on http_response OK"});
// zbr:test/tc_infer_test.zbr:60
        const jv_expr = TcExpr{ .ident = "jv" };
// zbr:test/tc_infer_test.zbr:61
        const mem_get = TcExprMember.init(jv_expr, "get");
// zbr:test/tc_infer_test.zbr:62
        const t_get = inf.inferExpr(TcExpr{ .member = _box_1da7b831b08: { const _bp_1da7b831b08 = _allocator.create(tc_infer.TcExprMember) catch @panic("OOM"); _bp_1da7b831b08.* = mem_get; break :_box_1da7b831b08 _bp_1da7b831b08; } });
// zbr:test/tc_infer_test.zbr:63
        std.debug.assert(TcTypes.eql(t_get, TcType{ .json_value = {} }));
// zbr:test/tc_infer_test.zbr:64
        std.debug.print("{s}\n", .{"4. member inference on json_value OK"});
// zbr:test/tc_infer_test.zbr:67
        const http_ident = TcExpr{ .ident = "Http" };
// zbr:test/tc_infer_test.zbr:68
        const http_mem = TcExprMember.init(http_ident, "get");
// zbr:test/tc_infer_test.zbr:69
        var http_args = std.ArrayList(TcExpr){};
// zbr:test/tc_infer_test.zbr:70
        http_args.append(_allocator, TcExpr{ .string_lit = {} }) catch unreachable;
// zbr:test/tc_infer_test.zbr:71
        const http_call = TcExprCall.init(TcExpr{ .member = _box_1da7b832a60: { const _bp_1da7b832a60 = _allocator.create(tc_infer.TcExprMember) catch @panic("OOM"); _bp_1da7b832a60.* = http_mem; break :_box_1da7b832a60 _bp_1da7b832a60; } }, http_args);
// zbr:test/tc_infer_test.zbr:72
        const t_http_get = inf.inferExpr(TcExpr{ .call = _box_1da7b832d68: { const _bp_1da7b832d68 = _allocator.create(tc_infer.TcExprCall) catch @panic("OOM"); _bp_1da7b832d68.* = http_call; break :_box_1da7b832d68 _bp_1da7b832d68; } });
// zbr:test/tc_infer_test.zbr:73
        std.debug.assert(TcTypes.eql(t_http_get, TcType{ .optional = _box_1da7b833148: { const _bp_1da7b833148 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_1da7b833148.* = TcType{ .http_response = {} }; break :_box_1da7b833148 _bp_1da7b833148; } }));
// zbr:test/tc_infer_test.zbr:74
        std.debug.print("{s}\n", .{"5. static call Http.get OK"});
// zbr:test/tc_infer_test.zbr:77
        const tm_ident = TcExpr{ .ident = "Timer" };
// zbr:test/tc_infer_test.zbr:78
        const tm_mem = TcExprMember.init(tm_ident, "start");
// zbr:test/tc_infer_test.zbr:79
        const tm_args = std.ArrayList(TcExpr){};
// zbr:test/tc_infer_test.zbr:80
        const tm_call = TcExprCall.init(TcExpr{ .member = _box_1da7b8337d8: { const _bp_1da7b8337d8 = _allocator.create(tc_infer.TcExprMember) catch @panic("OOM"); _bp_1da7b8337d8.* = tm_mem; break :_box_1da7b8337d8 _bp_1da7b8337d8; } }, tm_args);
// zbr:test/tc_infer_test.zbr:81
        const t_timer = inf.inferExpr(TcExpr{ .call = _box_1da7b833ae0: { const _bp_1da7b833ae0 = _allocator.create(tc_infer.TcExprCall) catch @panic("OOM"); _bp_1da7b833ae0.* = tm_call; break :_box_1da7b833ae0 _bp_1da7b833ae0; } });
// zbr:test/tc_infer_test.zbr:82
        std.debug.assert(TcTypes.eql(t_timer, TcType{ .timer_handle = {} }));
// zbr:test/tc_infer_test.zbr:83
        std.debug.print("{s}\n", .{"6. static call Timer.start OK"});
// zbr:test/tc_infer_test.zbr:86
        const bi_arith = TcExprBinary.init("+", TcExpr{ .int_lit = {} }, TcExpr{ .int_lit = {} });
// zbr:test/tc_infer_test.zbr:87
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .binary = _box_1da7b840418: { const _bp_1da7b840418 = _allocator.create(tc_infer.TcExprBinary) catch @panic("OOM"); _bp_1da7b840418.* = bi_arith; break :_box_1da7b840418 _bp_1da7b840418; } }), TcType{ .int_ = {} }));
// zbr:test/tc_infer_test.zbr:88
        const bi_cmp = TcExprBinary.init("==", TcExpr{ .int_lit = {} }, TcExpr{ .int_lit = {} });
// zbr:test/tc_infer_test.zbr:89
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .binary = _box_1da7b840bc8: { const _bp_1da7b840bc8 = _allocator.create(tc_infer.TcExprBinary) catch @panic("OOM"); _bp_1da7b840bc8.* = bi_cmp; break :_box_1da7b840bc8 _bp_1da7b840bc8; } }), TcType{ .bool_ = {} }));
// zbr:test/tc_infer_test.zbr:90
        const bi_str = TcExprBinary.init("+", TcExpr{ .string_lit = {} }, TcExpr{ .string_lit = {} });
// zbr:test/tc_infer_test.zbr:91
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .binary = _box_1da7b841378: { const _bp_1da7b841378 = _allocator.create(tc_infer.TcExprBinary) catch @panic("OOM"); _bp_1da7b841378.* = bi_str; break :_box_1da7b841378 _bp_1da7b841378; } }), TcType{ .string_ = {} }));
// zbr:test/tc_infer_test.zbr:92
        const bi_lt = TcExprBinary.init("<", TcExpr{ .float_lit = {} }, TcExpr{ .float_lit = {} });
// zbr:test/tc_infer_test.zbr:93
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .binary = _box_1da7b841b28: { const _bp_1da7b841b28 = _allocator.create(tc_infer.TcExprBinary) catch @panic("OOM"); _bp_1da7b841b28.* = bi_lt; break :_box_1da7b841b28 _bp_1da7b841b28; } }), TcType{ .bool_ = {} }));
// zbr:test/tc_infer_test.zbr:94
        std.debug.print("{s}\n", .{"7. binary operator inference OK"});
// zbr:test/tc_infer_test.zbr:97
        const un_neg = TcExprUnary.init("-", TcExpr{ .int_lit = {} });
// zbr:test/tc_infer_test.zbr:98
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .unary = _box_1da7b842250: { const _bp_1da7b842250 = _allocator.create(tc_infer.TcExprUnary) catch @panic("OOM"); _bp_1da7b842250.* = un_neg; break :_box_1da7b842250 _bp_1da7b842250; } }), TcType{ .int_ = {} }));
// zbr:test/tc_infer_test.zbr:99
        const un_not = TcExprUnary.init("not", TcExpr{ .bool_lit = {} });
// zbr:test/tc_infer_test.zbr:100
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .unary = _box_1da7b842928: { const _bp_1da7b842928 = _allocator.create(tc_infer.TcExprUnary) catch @panic("OOM"); _bp_1da7b842928.* = un_not; break :_box_1da7b842928 _bp_1da7b842928; } }), TcType{ .bool_ = {} }));
// zbr:test/tc_infer_test.zbr:101
        std.debug.print("{s}\n", .{"8. unary operator inference OK"});
// zbr:test/tc_infer_test.zbr:104
        const cast_expr = TcExprCast.init(TcType{ .float_ = {} });
// zbr:test/tc_infer_test.zbr:105
        std.debug.assert(TcTypes.eql(inf.inferExpr(TcExpr{ .cast = cast_expr }), TcType{ .float_ = {} }));
// zbr:test/tc_infer_test.zbr:106
        std.debug.print("{s}\n", .{"9. cast inference OK"});
// zbr:test/tc_infer_test.zbr:109
        const opt_chain = TcExpr{ .ident = "maybe_resp" };
// zbr:test/tc_infer_test.zbr:110
        const chain_expr = TcExpr{ .optional_chain = _box_1da7b843bc8: { const _bp_1da7b843bc8 = _allocator.create(tc_infer.TcExpr) catch @panic("OOM"); _bp_1da7b843bc8.* = opt_chain; break :_box_1da7b843bc8 _bp_1da7b843bc8; } };
// zbr:test/tc_infer_test.zbr:111
        std.debug.assert(TcTypes.eql(inf.inferExpr(chain_expr), TcType{ .http_response = {} }));
// zbr:test/tc_infer_test.zbr:112
        std.debug.print("{s}\n", .{"10. optional_chain inference OK"});
// zbr:test/tc_infer_test.zbr:114
        std.debug.print("{s}\n", .{"tc_infer_test: all OK"});
    }
...
pub fn main() void {
    ...
    defer _arena.deinit();
    @import("tc_types.zig")._initAllocator(_allocator);
    @import("tc_scope.zig")._initAllocator(_allocator);
    @import("tc_infer.zig")._initAllocator(_allocator);
    Main.main();
}
