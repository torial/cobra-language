...
// Source: test/arena_scope_test.zbr
...
// zbr:test/arena_scope_test.zbr:7
        self.n = 0;
        return self;
    }

    pub fn inc(self: *Counter) void {
// zbr:test/arena_scope_test.zbr:9
        self.n = (self.n + 1);
    }

    pub fn value(self: *Counter) i64 {
// zbr:test/arena_scope_test.zbr:11
        return self.n;
    }
...
const _reflect_Counter_fields: []const []const u8 = &.{"n"};
const _reflect_Counter_field_types: []const []const u8 = &.{"int"};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/arena_scope_test.zbr:16
        var x: i64 = 0;
// zbr:test/arena_scope_test.zbr:19
        { // arena
            var _arena_scope_1 = std.heap.ArenaAllocator.init(_allocator);
            const _parent_alloc_1 = _allocator;
            _allocator = _arena_scope_1.allocator();
            defer { _allocator = _parent_alloc_1; _arena_scope_1.deinit(); }
// zbr:test/arena_scope_test.zbr:20
            var c = Counter.init();
// zbr:test/arena_scope_test.zbr:21
            c.inc();
// zbr:test/arena_scope_test.zbr:22
            c.inc();
// zbr:test/arena_scope_test.zbr:23
            c.inc();
// zbr:test/arena_scope_test.zbr:24
            x = c.value();
        }
// zbr:test/arena_scope_test.zbr:27
        std.debug.assert((x == 3));
// zbr:test/arena_scope_test.zbr:30
        var y: i64 = 0;
// zbr:test/arena_scope_test.zbr:31
        { // arena
            var _arena_scope_1 = std.heap.ArenaAllocator.init(_allocator);
            const _parent_alloc_1 = _allocator;
            _allocator = _arena_scope_1.allocator();
            defer { _allocator = _parent_alloc_1; _arena_scope_1.deinit(); }
// zbr:test/arena_scope_test.zbr:32
            var a = Counter.init();
// zbr:test/arena_scope_test.zbr:33
            a.inc();
// zbr:test/arena_scope_test.zbr:34
            { // arena
                var _arena_scope_2 = std.heap.ArenaAllocator.init(_allocator);
                const _parent_alloc_2 = _allocator;
                _allocator = _arena_scope_2.allocator();
                defer { _allocator = _parent_alloc_2; _arena_scope_2.deinit(); }
// zbr:test/arena_scope_test.zbr:35
                var b = Counter.init();
// zbr:test/arena_scope_test.zbr:36
                b.inc();
// zbr:test/arena_scope_test.zbr:37
                b.inc();
// zbr:test/arena_scope_test.zbr:38
                y = (a.value() + b.value());
            }
        }
// zbr:test/arena_scope_test.zbr:40
        std.debug.assert((y == 3));
// zbr:test/arena_scope_test.zbr:41
        std.debug.print("{s}\n", .{"arena scope OK"});
    }
