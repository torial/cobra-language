...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/tc_scope_test.zbr:11
        const sc = TcScope.init();
// zbr:test/tc_scope_test.zbr:12
        std.debug.assert((sc.depth() == 0));
// zbr:test/tc_scope_test.zbr:13
        std.debug.print("{s}\n", .{"1. empty scope OK"});
// zbr:test/tc_scope_test.zbr:16
        sc.push(TcScopeKind.module_);
// zbr:test/tc_scope_test.zbr:17
        std.debug.assert((sc.depth() == 1));
// zbr:test/tc_scope_test.zbr:18
        std.debug.assert((sc.currentKind() == TcScopeKind.module_));
// zbr:test/tc_scope_test.zbr:19
        sc.push(TcScopeKind.type_);
// zbr:test/tc_scope_test.zbr:20
        std.debug.assert((sc.depth() == 2));
// zbr:test/tc_scope_test.zbr:21
        std.debug.assert((sc.currentKind() == TcScopeKind.type_));
// zbr:test/tc_scope_test.zbr:22
        sc.push(TcScopeKind.method_);
// zbr:test/tc_scope_test.zbr:23
        std.debug.assert((sc.depth() == 3));
// zbr:test/tc_scope_test.zbr:24
        std.debug.assert((sc.currentKind() == TcScopeKind.method_));
// zbr:test/tc_scope_test.zbr:25
        sc.pop();
// zbr:test/tc_scope_test.zbr:26
        std.debug.assert((sc.depth() == 2));
// zbr:test/tc_scope_test.zbr:27
        std.debug.assert((sc.currentKind() == TcScopeKind.type_));
// zbr:test/tc_scope_test.zbr:28
        sc.pop();
// zbr:test/tc_scope_test.zbr:29
        sc.pop();
// zbr:test/tc_scope_test.zbr:30
        std.debug.assert((sc.depth() == 0));
// zbr:test/tc_scope_test.zbr:31
        std.debug.print("{s}\n", .{"2. push/pop depth OK"});
// zbr:test/tc_scope_test.zbr:34
        sc.push(TcScopeKind.module_);
// zbr:test/tc_scope_test.zbr:35
        const sym_a = TcSymbol.init("MyClass", TcSymKind.class_, TcType{ .unknown_ = {} });
// zbr:test/tc_scope_test.zbr:36
        std.debug.assert(sc.define("MyClass", sym_a));
// zbr:test/tc_scope_test.zbr:37
        std.debug.assert(sc.hasLocal("MyClass"));
// zbr:test/tc_scope_test.zbr:38
        std.debug.assert((!sc.hasLocal("Missing")));
// zbr:test/tc_scope_test.zbr:40
        std.debug.assert((!sc.define("MyClass", sym_a)));
// zbr:test/tc_scope_test.zbr:41
        std.debug.print("{s}\n", .{"3. define/hasLocal OK"});
// zbr:test/tc_scope_test.zbr:44
        const got = sc.getLocal("MyClass");
// zbr:test/tc_scope_test.zbr:45
        std.debug.assert(std.mem.eql(u8, got.name, "MyClass"));
// zbr:test/tc_scope_test.zbr:46
        std.debug.assert((got.kind == TcSymKind.class_));
// zbr:test/tc_scope_test.zbr:47
        std.debug.print("{s}\n", .{"4. getLocal OK"});
// zbr:test/tc_scope_test.zbr:50
        const sym_x = TcSymbol.init("x", TcSymKind.local, TcType{ .int_ = {} });
// zbr:test/tc_scope_test.zbr:51
        sc.push(TcScopeKind.method_);
// zbr:test/tc_scope_test.zbr:52
        std.debug.assert(sc.define("x", sym_x));
// zbr:test/tc_scope_test.zbr:54
        std.debug.assert(sc.hasSymbol("x"));
// zbr:test/tc_scope_test.zbr:55
        std.debug.assert(sc.hasSymbol("MyClass"));
// zbr:test/tc_scope_test.zbr:57
        std.debug.assert((!sc.hasLocal("MyClass")));
// zbr:test/tc_scope_test.zbr:59
        const lx = sc.lookup("x");
// zbr:test/tc_scope_test.zbr:60
        std.debug.assert(std.mem.eql(u8, lx.name, "x"));
// zbr:test/tc_scope_test.zbr:61
        std.debug.assert((lx.kind == TcSymKind.local));
// zbr:test/tc_scope_test.zbr:62
        const lc = sc.lookup("MyClass");
// zbr:test/tc_scope_test.zbr:63
        std.debug.assert(std.mem.eql(u8, lc.name, "MyClass"));
// zbr:test/tc_scope_test.zbr:64
        std.debug.assert((lc.kind == TcSymKind.class_));
// zbr:test/tc_scope_test.zbr:65
        std.debug.print("{s}\n", .{"5. cross-frame lookup OK"});
// zbr:test/tc_scope_test.zbr:68
        sc.push(TcScopeKind.block_);
// zbr:test/tc_scope_test.zbr:69
        const sym_x2 = TcSymbol.init("x", TcSymKind.local, TcType{ .string_ = {} });
// zbr:test/tc_scope_test.zbr:70
        std.debug.assert(sc.define("x", sym_x2));
// zbr:test/tc_scope_test.zbr:71
        const lx2 = sc.lookup("x");
// zbr:test/tc_scope_test.zbr:72
        std.debug.assert(TcTypes.eql(lx2.type_, TcType{ .string_ = {} }));
// zbr:test/tc_scope_test.zbr:73
        sc.pop();
// zbr:test/tc_scope_test.zbr:75
        const lx3 = sc.lookup("x");
// zbr:test/tc_scope_test.zbr:76
        std.debug.assert(TcTypes.eql(lx3.type_, TcType{ .int_ = {} }));
// zbr:test/tc_scope_test.zbr:77
        std.debug.print("{s}\n", .{"6. shadowing OK"});
// zbr:test/tc_scope_test.zbr:80
        sc.pop();
// zbr:test/tc_scope_test.zbr:81
        std.debug.assert((!sc.hasSymbol("x")));
// zbr:test/tc_scope_test.zbr:82
        std.debug.assert(sc.hasSymbol("MyClass"));
// zbr:test/tc_scope_test.zbr:83
        sc.pop();
// zbr:test/tc_scope_test.zbr:84
        std.debug.assert((!sc.hasSymbol("MyClass")));
// zbr:test/tc_scope_test.zbr:85
        std.debug.assert((sc.depth() == 0));
// zbr:test/tc_scope_test.zbr:86
        std.debug.print("{s}\n", .{"7. pop removes symbols OK"});
// zbr:test/tc_scope_test.zbr:89
        sc.push(TcScopeKind.module_);
// zbr:test/tc_scope_test.zbr:90
        const sym_b = TcSymbol.init("int", TcSymKind.class_, TcType{ .int_ = {} });
// zbr:test/tc_scope_test.zbr:91
        std.debug.assert(sc.define("int", sym_b));
// zbr:test/tc_scope_test.zbr:92
        std.debug.assert(sc.hasLocal("int"));
// zbr:test/tc_scope_test.zbr:93
        sc.pop();
// zbr:test/tc_scope_test.zbr:94
        std.debug.print("{s}\n", .{"8. reuse after pop OK"});
// zbr:test/tc_scope_test.zbr:96
        std.debug.print("{s}\n", .{"tc_scope_test: all OK"});
    }
