...
pub const TerminalTest = struct {
    _type_tag: u64 = _ttag_TerminalTest,
    pub fn main() void {
// zbr:test/terminal_test.zbr:4
        std.debug.print("{}\n", .{_term_is_tty()});
// zbr:test/terminal_test.zbr:5
        std.debug.print("{s}\n", .{"isTty: OK"});
// zbr:test/terminal_test.zbr:8
        const w = _term_width();
// zbr:test/terminal_test.zbr:9
        std.debug.assert(_zebra_gt(w, 0));
// zbr:test/terminal_test.zbr:10
        std.debug.print("{s}\n", .{"width: OK"});
// zbr:test/terminal_test.zbr:12
        const h = _term_height();
// zbr:test/terminal_test.zbr:13
        std.debug.assert(_zebra_gt(h, 0));
// zbr:test/terminal_test.zbr:14
        std.debug.print("{s}\n", .{"height: OK"});
// zbr:test/terminal_test.zbr:17
        _term_print("hello", "green", false);
// zbr:test/terminal_test.zbr:18
        _term_print(" world", "red", true);
// zbr:test/terminal_test.zbr:19
        _term_print("bold text", "bold", false);
// zbr:test/terminal_test.zbr:20
        _term_print("", "", true);
// zbr:test/terminal_test.zbr:21
        std.debug.print("{s}\n", .{"Terminal.write: OK"});
// zbr:test/terminal_test.zbr:23
        std.debug.print("{s}\n", .{"All terminal tests passed."});
    }

    pub fn init() TerminalTest {
        var self: TerminalTest = undefined;
        self._type_tag = _ttag_TerminalTest;
        return self;
    }

};

const _ttag_TerminalTest: u64 = 2964645129;
const _reflect_TerminalTest_name: []const u8 = "TerminalTest";
const _reflect_TerminalTest_fields: []const []const u8 = &.{};
const _reflect_TerminalTest_field_types: []const []const u8 = &.{};
