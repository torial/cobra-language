...
// Source: test/selfhost_probe.zbr
...
// zbr:test/selfhost_probe.zbr:19
        self.line = l;
// zbr:test/selfhost_probe.zbr:20
        self.col = c;
        return self;
    }
...
// zbr:test/selfhost_probe.zbr:27
        self.kind = k;
// zbr:test/selfhost_probe.zbr:28
        self.text = t;
// zbr:test/selfhost_probe.zbr:29
...
// zbr:test/selfhost_probe.zbr:38
        self.message = msg;
// zbr:test/selfhost_probe.zbr:39
        self.line = l;
// zbr:test/selfhost_probe.zbr:40
        self.col = c;
        return self;
    }

    pub fn show(self: *Diag) []const u8 {
// zbr:test/selfhost_probe.zbr:42
        return self.message;
    }
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/selfhost_probe.zbr:82
        const t = Token.init(TokenKind{ .ident = {} }, "foo", 1, 0);
// zbr:test/selfhost_probe.zbr:83
        std.debug.assert(std.mem.eql(u8, t.text, "foo"));
// zbr:test/selfhost_probe.zbr:84
        std.debug.assert((t.span.line == 1));
// zbr:test/selfhost_probe.zbr:87
        std.debug.assert(std.mem.eql(u8, kindName(TokenKind{ .plus = {} }), "plus"));
// zbr:test/selfhost_probe.zbr:88
        std.debug.assert(std.mem.eql(u8, kindName(TokenKind{ .eof = {} }), "eof"));
// zbr:test/selfhost_probe.zbr:91
        var d = Diag.init("unexpected token", 3, 7);
// zbr:test/selfhost_probe.zbr:92
        std.debug.assert(std.mem.eql(u8, d.show(), "unexpected token"));
// zbr:test/selfhost_probe.zbr:94
