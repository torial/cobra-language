...
pub const MimeTest = struct {
    _type_tag: u64 = _ttag_MimeTest,
    pub fn main() void {
// zbr:test/mime_test.zbr:4
        std.debug.assert(std.mem.eql(u8, _mime_from_ext(".png"), "image/png"));
// zbr:test/mime_test.zbr:5
        std.debug.print("{s}\n", .{"fromExt png: OK"});
// zbr:test/mime_test.zbr:7
        std.debug.assert(std.mem.eql(u8, _mime_from_ext(".html"), "text/html"));
// zbr:test/mime_test.zbr:8
        std.debug.print("{s}\n", .{"fromExt html: OK"});
// zbr:test/mime_test.zbr:10
        std.debug.assert(std.mem.eql(u8, _mime_from_ext(".json"), "application/json"));
// zbr:test/mime_test.zbr:11
        std.debug.print("{s}\n", .{"fromExt json: OK"});
// zbr:test/mime_test.zbr:13
        std.debug.assert(std.mem.eql(u8, _mime_from_ext(".js"), "text/javascript"));
// zbr:test/mime_test.zbr:14
        std.debug.print("{s}\n", .{"fromExt js: OK"});
// zbr:test/mime_test.zbr:16
        std.debug.assert(std.mem.eql(u8, _mime_from_ext(".mp4"), "video/mp4"));
// zbr:test/mime_test.zbr:17
        std.debug.print("{s}\n", .{"fromExt mp4: OK"});
// zbr:test/mime_test.zbr:20
        std.debug.assert(std.mem.eql(u8, _mime_from_ext(".zbr"), "application/octet-stream"));
// zbr:test/mime_test.zbr:21
        std.debug.print("{s}\n", .{"fromExt unknown: OK"});
// zbr:test/mime_test.zbr:24
        std.debug.assert(std.mem.eql(u8, _mime_to_ext("text/html"), ".html"));
// zbr:test/mime_test.zbr:25
        std.debug.print("{s}\n", .{"toExt html: OK"});
// zbr:test/mime_test.zbr:27
        std.debug.assert(std.mem.eql(u8, _mime_to_ext("image/png"), ".png"));
// zbr:test/mime_test.zbr:28
        std.debug.print("{s}\n", .{"toExt png: OK"});
// zbr:test/mime_test.zbr:30
        std.debug.assert(std.mem.eql(u8, _mime_to_ext("application/json"), ".json"));
// zbr:test/mime_test.zbr:31
        std.debug.print("{s}\n", .{"toExt json: OK"});
// zbr:test/mime_test.zbr:34
        std.debug.assert(std.mem.eql(u8, _mime_to_ext("application/x-unknown"), ""));
// zbr:test/mime_test.zbr:35
        std.debug.print("{s}\n", .{"toExt unknown: OK"});
// zbr:test/mime_test.zbr:37
        std.debug.print("{s}\n", .{"All MIME tests passed."});
    }

    pub fn init() MimeTest {
        var self: MimeTest = undefined;
        self._type_tag = _ttag_MimeTest;
        return self;
    }

};

const _ttag_MimeTest: u64 = 427727613;
const _reflect_MimeTest_name: []const u8 = "MimeTest";
const _reflect_MimeTest_fields: []const []const u8 = &.{};
const _reflect_MimeTest_field_types: []const []const u8 = &.{};
