...
pub const Main = struct {
    pub fn main() void {
// zbr:test/gui_test.zbr:4
        const frame = struct {
            count: i64,
            fn call(self: *@This(), g: GuiContext) void {
// zbr:test/gui_test.zbr:7
                {
                    const _gw0 = (std.fmt.allocPrint(_allocator, "Count: {}", .{self.count}) catch @panic("OOM"));
                    defer _allocator.free(_gw0);
                    g.text(_gw0);
                }
// zbr:test/gui_test.zbr:8
                if (g.button("Increment")) {
// zbr:test/gui_test.zbr:9
                    self.count = (self.count + 1);
                }
// zbr:test/gui_test.zbr:10
                if (g.button("Reset")) {
// zbr:test/gui_test.zbr:11
                    self.count = 0;
                }
// zbr:test/gui_test.zbr:12
                g.separator();
// zbr:test/gui_test.zbr:13
                g.text("Done!");
            }
        }{ .count = 0, };
// zbr:test/gui_test.zbr:14
        _gui_run("Counter", 400, 300, frame);
    }
