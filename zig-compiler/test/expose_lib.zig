...
pub const Palette = struct {
    _type_tag: u64 = _ttag_Palette,
    name: []const u8 = undefined,
    pub fn init(n: []const u8) Palette {
        var self: Palette = undefined;
        self._type_tag = _ttag_Palette;
// zbr:test\expose_lib.zbr:10
        self.name = n;
        return self;
    }

    pub fn describe(self: *Palette) []const u8 {
// zbr:test\expose_lib.zbr:13
        return _str_concat("Palette:", self.name, _allocator);
    }

};

const _ttag_Palette: u64 = 2114461760;
const _reflect_Palette_name: []const u8 = "Palette";
const _reflect_Palette_fields: []const []const u8 = &.{"name"};
const _reflect_Palette_field_types: []const []const u8 = &.{"str"};

pub fn makeRed() Color {
// zbr:test\expose_lib.zbr:16
    return Color{ .red = {} };
}
