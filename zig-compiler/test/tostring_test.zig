...
pub const Main = struct {
    pub fn main() void {
// zbr:test/tostring_test.zbr:4
        const n: i64 = 42;
// zbr:test/tostring_test.zbr:5
        const f: f64 = 3.14;
// zbr:test/tostring_test.zbr:6
        const s1 = (std.fmt.allocPrint(_allocator, "{}", .{n}) catch unreachable);
        defer _allocator.free(s1);
// zbr:test/tostring_test.zbr:7
        const s2 = (std.fmt.allocPrint(_allocator, "{d}", .{f}) catch unreachable);
        defer _allocator.free(s2);
// zbr:test/tostring_test.zbr:8
        std.debug.print("{s}\n", .{s1});
// zbr:test/tostring_test.zbr:9
        std.debug.print("{s}\n", .{s2});
// zbr:test/tostring_test.zbr:10
        const big: i64 = (-100);
// zbr:test/tostring_test.zbr:11
        {
