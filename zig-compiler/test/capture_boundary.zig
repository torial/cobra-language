...
pub const Program = struct {
    pub fn main() void {
// zbr:test/capture_boundary.zbr:4
        const double = struct { fn call(x: i64) @TypeOf((x * 2)) { return (x * 2); } }.call;
// zbr:test/capture_boundary.zbr:5
        const offset: i64 = 10;
// zbr:test/capture_boundary.zbr:6
        const adder = struct {
            offset: i64,
            fn call(self: @This(), x: i64) void {
// zbr:test/capture_boundary.zbr:9
                std.debug.print("{}\n", .{(x + self.offset)});
            }
        }{ .offset = offset, };
// zbr:test/capture_boundary.zbr:10
        std.debug.print("{any}\n", .{double(7)});
// zbr:test/capture_boundary.zbr:11
        adder.call(5);
    }
