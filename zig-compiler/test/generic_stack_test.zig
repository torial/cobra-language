...
// Source: test/generic_stack_test.zbr
...
pub fn Stack(comptime T: type) type {
    return struct {
        _type_tag: u64 = _ttag_Stack,
        items: std.ArrayList(T) = undefined,
        count: i64 = undefined,
        pub fn init() @This() {
            var self: @This() = undefined;
            self._type_tag = _ttag_Stack;
// zbr:test/generic_stack_test.zbr:6
            self.items = std.ArrayList(T){};
// zbr:test/generic_stack_test.zbr:7
            self.count = 0;
            return self;
        }

        pub fn push(self: *@This(), val: T) void {
// zbr:test/generic_stack_test.zbr:10
            self.items.append(_allocator, val) catch unreachable;
// zbr:test/generic_stack_test.zbr:11
            self.count = (self.count + 1);
        }

        pub fn pop(self: *@This()) ?T {
// zbr:test/generic_stack_test.zbr:14
            if ((self.count == 0)) {
// zbr:test/generic_stack_test.zbr:15
                return null;
            }
// zbr:test/generic_stack_test.zbr:16
            self.count = (self.count - 1);
// zbr:test/generic_stack_test.zbr:17
            return self.items.items[@as(usize, @intCast(self.count))];
        }

        pub fn peek(self: *@This()) ?T {
// zbr:test/generic_stack_test.zbr:20
            if ((self.count == 0)) {
// zbr:test/generic_stack_test.zbr:21
                return null;
            }
// zbr:test/generic_stack_test.zbr:22
            return self.items.items[@as(usize, @intCast((self.count - 1)))];
        }

        pub fn isEmpty(self: *@This()) bool {
// zbr:test/generic_stack_test.zbr:25
            return (self.count == 0);
        }
...
const _ttag_Stack: u64 = 135058847;

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/generic_stack_test.zbr:30
        var s = Stack(i64).init();
// zbr:test/generic_stack_test.zbr:31
        s.push(10);
// zbr:test/generic_stack_test.zbr:32
        s.push(20);
// zbr:test/generic_stack_test.zbr:33
        s.push(30);
// zbr:test/generic_stack_test.zbr:34
        std.debug.print("{any}\n", .{s.pop()});
// zbr:test/generic_stack_test.zbr:35
        std.debug.print("{any}\n", .{s.pop()});
// zbr:test/generic_stack_test.zbr:36
        std.debug.print("{}\n", .{s.count});
// zbr:test/generic_stack_test.zbr:37
        std.debug.print("{}\n", .{s.isEmpty()});
// zbr:test/generic_stack_test.zbr:39
        var ss = Stack([]const u8).init();
// zbr:test/generic_stack_test.zbr:40
        ss.push("hello");
// zbr:test/generic_stack_test.zbr:41
        ss.push("world");
// zbr:test/generic_stack_test.zbr:42
        std.debug.print("{s}\n", .{ss.pop() orelse ""});
// zbr:test/generic_stack_test.zbr:43
        std.debug.print("{s}\n", .{ss.peek() orelse ""});
    }
