...
// Source: test/try_postfix_test.zbr
...
pub const Math = struct {
    ...
    pub fn safeDiv(a: i64, b: i64) anyerror!i64 {
// zbr:test/try_postfix_test.zbr:4
        if ((b == 0)) {
// zbr:test/try_postfix_test.zbr:5
            _error_ctx = .{ .message = "division by zero", .details = null };
            return error.ZebraError;
        }
// zbr:test/try_postfix_test.zbr:6
        return @divTrunc(a, b);
    }
...
// zbr:test/try_postfix_test.zbr:12
        const result = try Math.safeDiv(10, 2);
// zbr:test/try_postfix_test.zbr:13
        std.debug.print("{d}\n", .{result});
// zbr:test/try_postfix_test.zbr:15
        const result2 = try Math.safeDiv(10, 0);
// zbr:test/try_postfix_test.zbr:16
        std.debug.print("{d}\n", .{result2});
    }
