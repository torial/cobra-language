...
pub const UriTest = struct {
    _type_tag: u64 = _ttag_UriTest,
    pub fn main() void {
// zbr:test/uri_test.zbr:3
        const u = _uri_parse("https://api.example.com/v1/users?page=2");
// zbr:test/uri_test.zbr:4
        std.debug.assert(std.mem.eql(u8, u.scheme, "https"));
// zbr:test/uri_test.zbr:5
        std.debug.print("{s}\n", .{"scheme: OK"});
// zbr:test/uri_test.zbr:7
        std.debug.assert(std.mem.eql(u8, u.host, "api.example.com"));
// zbr:test/uri_test.zbr:8
        std.debug.print("{s}\n", .{"host: OK"});
// zbr:test/uri_test.zbr:10
        std.debug.assert(std.mem.eql(u8, u.path, "/v1/users"));
// zbr:test/uri_test.zbr:11
        std.debug.print("{s}\n", .{"path: OK"});
// zbr:test/uri_test.zbr:13
        std.debug.assert(std.mem.eql(u8, u.query, "page=2"));
// zbr:test/uri_test.zbr:14
        std.debug.print("{s}\n", .{"query: OK"});
// zbr:test/uri_test.zbr:17
        std.debug.assert((u.port == 0));
// zbr:test/uri_test.zbr:18
        std.debug.print("{s}\n", .{"port absent: OK"});
// zbr:test/uri_test.zbr:21
        const uport = _uri_parse("http://localhost:8080/health");
// zbr:test/uri_test.zbr:22
        std.debug.assert((uport.port == 8080));
// zbr:test/uri_test.zbr:23
        std.debug.print("{s}\n", .{"port present: OK"});
// zbr:test/uri_test.zbr:26
        const ufile = _uri_parse("file:///etc/hosts");
// zbr:test/uri_test.zbr:27
        std.debug.assert(std.mem.eql(u8, ufile.scheme, "file"));
// zbr:test/uri_test.zbr:28
        std.debug.assert(std.mem.eql(u8, ufile.path, "/etc/hosts"));
// zbr:test/uri_test.zbr:29
        std.debug.print("{s}\n", .{"file uri: OK"});
// zbr:test/uri_test.zbr:31
        std.debug.print("{s}\n", .{"All URI tests passed."});
    }

    pub fn init() UriTest {
        var self: UriTest = undefined;
        self._type_tag = _ttag_UriTest;
        return self;
    }

};

const _ttag_UriTest: u64 = 680421021;
const _reflect_UriTest_name: []const u8 = "UriTest";
const _reflect_UriTest_fields: []const []const u8 = &.{};
const _reflect_UriTest_field_types: []const []const u8 = &.{};
