...
pub const Program = struct {
    ...
    pub fn main() void {
// zbr:test/with_test.zbr:8
        var p: Point = Point{};
// zbr:test/with_test.zbr:9
        { // with p
// zbr:test/with_test.zbr:10
            p.x = 10;
// zbr:test/with_test.zbr:11
            p.y = 20;
        }
// zbr:test/with_test.zbr:12
        std.debug.print("{}\n", .{p.x});
// zbr:test/with_test.zbr:13
        std.debug.print("{}\n", .{p.y});
    }
