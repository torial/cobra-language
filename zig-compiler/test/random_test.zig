...
pub const RandomTest = struct {
    ...
    pub fn main() void {
// zbr:test/random_test.zbr:4
        _random_seed(42);
// zbr:test/random_test.zbr:7
        const n = _random_int(1, 100);
// zbr:test/random_test.zbr:8
        std.debug.assert(_zebra_ge(n, 1));
// zbr:test/random_test.zbr:9
        std.debug.assert(_zebra_le(n, 100));
// zbr:test/random_test.zbr:10
        std.debug.print("{s}\n", .{"randInt in range: OK"});
// zbr:test/random_test.zbr:13
        const f = _random_float();
// zbr:test/random_test.zbr:14
        std.debug.assert(_zebra_ge(f, 0.0));
// zbr:test/random_test.zbr:15
        std.debug.assert(_zebra_lt(f, 1.0));
// zbr:test/random_test.zbr:16
        std.debug.print("{s}\n", .{"randFloat in range: OK"});
// zbr:test/random_test.zbr:19
        std.debug.print("{}\n", .{_random_bool()});
// zbr:test/random_test.zbr:20
        std.debug.print("{s}\n", .{"randBool: OK"});
// zbr:test/random_test.zbr:23
        const byt = _random_bytes(16);
// zbr:test/random_test.zbr:24
        std.debug.assert((byt.len == 32));
// zbr:test/random_test.zbr:25
        std.debug.print("{s}\n", .{"bytes length: OK"});
...
// zbr:test/random_test.zbr:30
        fruits.append(_allocator, "banana") catch unreachable;
// zbr:test/random_test.zbr:31
        fruits.append(_allocator, "cherry") catch unreachable;
// zbr:test/random_test.zbr:32
        std.debug.print("{any}\n", .{fruits.items[_rng().uintLessThan(usize, fruits.items.len)]});
// zbr:test/random_test.zbr:33
        std.debug.print("{s}\n", .{"choice: OK"});
...
// zbr:test/random_test.zbr:39
        nums.append(_allocator, 3) catch unreachable;
// zbr:test/random_test.zbr:40
        nums.append(_allocator, 4) catch unreachable;
// zbr:test/random_test.zbr:41
...
// zbr:test/random_test.zbr:46
    ...
    pub fn init() RandomTest {
        var self: RandomTest = undefined;
        self._type_tag = _ttag_RandomTest;
        return self;
    }

};

const _ttag_RandomTest: u64 = 16044802;
const _reflect_RandomTest_name: []const u8 = "RandomTest";
const _reflect_RandomTest_fields: []const []const u8 = &.{};
const _reflect_RandomTest_field_types: []const []const u8 = &.{};
