...
pub const App = struct {
    ...
    pub fn main() void {
// zbr:test/error_prop.zbr:4
        const _try_err_1c38: ?anyerror = null;
        _try_blk_1c38: {
// zbr:test/error_prop.zbr:5
            const x: i64 = 42;
// zbr:test/error_prop.zbr:6
            std.debug.print("{}\n", .{x});
            break :_try_blk_1c38;
        }
        if (_try_err_1c38 != null) {
// zbr:test/error_prop.zbr:8
            std.debug.print("{s}\n", .{"caught error"});
        }
    }
