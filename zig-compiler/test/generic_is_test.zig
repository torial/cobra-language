...
// Source: test/generic_is_test.zbr
...
pub fn Box(comptime T: type) type {
    return struct {
        _type_tag: u64 = _ttag_Box,
        value: T = undefined,
        pub fn init(v: T) @This() {
            var self: @This() = undefined;
            self._type_tag = _ttag_Box;
// zbr:test/generic_is_test.zbr:5
            self.value = v;
            return self;
        }
...
const _ttag_Box: u64 = 3586883282;

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/generic_is_test.zbr:10
        const b = Box(i64).init(42);
// zbr:test/generic_is_test.zbr:11
        std.debug.print("{}\n", .{(b._type_tag == _ttag_Box)});
// zbr:test/generic_is_test.zbr:12
        std.debug.print("{}\n", .{(!(b._type_tag == _ttag_Box))});
// zbr:test/generic_is_test.zbr:14
        const s = Box([]const u8).init("hi");
// zbr:test/generic_is_test.zbr:15
        std.debug.print("{}\n", .{(s._type_tag == _ttag_Box)});
    }
