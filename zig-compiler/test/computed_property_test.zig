...
// Source: test/computed_property_test.zbr
...
// zbr:test/computed_property_test.zbr:10
        return (self.width * self.height);
    }

    pub fn perimeter(self: *const Rectangle) f64 {
// zbr:test/computed_property_test.zbr:13
        return (2.0 * (self.width + self.height));
    }

    pub fn isSquare(self: *const Rectangle) bool {
// zbr:test/computed_property_test.zbr:16
        return (self.width == self.height);
    }
...
// zbr:test/computed_property_test.zbr:22
        std.debug.print("{d}\n", .{r.area()});
// zbr:test/computed_property_test.zbr:23
        std.debug.print("{d}\n", .{r.perimeter()});
// zbr:test/computed_property_test.zbr:24
        std.debug.print("{}\n", .{r.isSquare()});
// zbr:test/computed_property_test.zbr:26
        const sq = Rectangle.init(5.0, 5.0);
// zbr:test/computed_property_test.zbr:27
        std.debug.print("{d}\n", .{sq.area()});
// zbr:test/computed_property_test.zbr:28
        std.debug.print("{}\n", .{sq.isSquare()});
    }
