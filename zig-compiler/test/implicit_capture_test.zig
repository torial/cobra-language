...
// Source: test/implicit_capture_test.zbr
...
pub const Program = struct {
    pub fn main() void {
// zbr:test/implicit_capture_test.zbr:5
        const base: i64 = 10;
// zbr:test/implicit_capture_test.zbr:6
        const adder = struct {
            base: @TypeOf(base),
            fn call(self: @This(), x: i64) i64 {
// zbr:test/implicit_capture_test.zbr:7
                return (x + self.base);
            }
        }{ .base = base, };
// zbr:test/implicit_capture_test.zbr:8
        std.debug.print("{any}\n", .{adder.call(5)});
// zbr:test/implicit_capture_test.zbr:11
        const scale: i64 = 3;
// zbr:test/implicit_capture_test.zbr:12
        const triple = struct {
            scale: @TypeOf(scale),
            fn call(self: @This(), n: i64) @TypeOf((n * scale)) {
                return (n * self.scale);
            }
        }{ .scale = scale, };
// zbr:test/implicit_capture_test.zbr:13
        std.debug.print("{any}\n", .{triple.call(4)});
// zbr:test/implicit_capture_test.zbr:16
        const a: i64 = 100;
// zbr:test/implicit_capture_test.zbr:17
        const b: i64 = 7;
// zbr:test/implicit_capture_test.zbr:18
        const combine = struct {
            a: @TypeOf(a),
            b: @TypeOf(b),
            fn call(self: @This(), x: i64) i64 {
// zbr:test/implicit_capture_test.zbr:19
                return ((x + self.a) - self.b);
            }
        }{ .a = a, .b = b, };
// zbr:test/implicit_capture_test.zbr:20
        std.debug.print("{any}\n", .{combine.call(0)});
// zbr:test/implicit_capture_test.zbr:23
        const offset: i64 = 20;
// zbr:test/implicit_capture_test.zbr:24
        const shifted = struct {
            offset: i64,
            fn call(self: @This(), x: i64) void {
// zbr:test/implicit_capture_test.zbr:27
                std.debug.print("{}\n", .{(x + self.offset)});
            }
        }{ .offset = offset, };
// zbr:test/implicit_capture_test.zbr:28
        shifted.call(5);
    }
