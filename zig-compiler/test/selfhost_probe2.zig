...
// Source: test/selfhost_probe2.zbr
...
// zbr:test/selfhost_probe2.zbr:13
        self.line = l;
// zbr:test/selfhost_probe2.zbr:14
        self.col = c;
        return self;
    }
...
// zbr:test/selfhost_probe2.zbr:21
        self.kind = k;
// zbr:test/selfhost_probe2.zbr:22
        self.text = t;
// zbr:test/selfhost_probe2.zbr:23
...
// zbr:test/selfhost_probe2.zbr:30
        self.message = msg;
// zbr:test/selfhost_probe2.zbr:31
        self.line = l;
// zbr:test/selfhost_probe2.zbr:32
        self.col = c;
        return self;
    }

    pub fn show(self: *Diag) []const u8 {
// zbr:test/selfhost_probe2.zbr:34
        return self.message;
    }
...
// zbr:test/selfhost_probe2.zbr:39
        switch (k) {
            TokenKind.ident => {
// zbr:test/selfhost_probe2.zbr:40
                return "ident";
            },
            TokenKind.number => {
// zbr:test/selfhost_probe2.zbr:41
                return "number";
            },
            TokenKind.plus => {
// zbr:test/selfhost_probe2.zbr:42
                return "plus";
            },
            TokenKind.eof => {
// zbr:test/selfhost_probe2.zbr:43
                return "eof";
            },
        }
    }
...
// zbr:test/selfhost_probe2.zbr:50
        self.tokens = std.ArrayList(Token){};
// zbr:test/selfhost_probe2.zbr:51
        self.pos = 0;
        return self;
    }

    pub fn push(self: *Lexer, k: TokenKind, t: []const u8, l: i64, c: i64) void {
// zbr:test/selfhost_probe2.zbr:54
...
// zbr:test/selfhost_probe2.zbr:59
        return TokenKind{ .eof = {} };
    }

    pub fn advance(self: *Lexer) Token {
// zbr:test/selfhost_probe2.zbr:62
        const t = self.tokens[@intCast(self.pos)];
// zbr:test/selfhost_probe2.zbr:63
        self.pos = (self.pos + 1);
// zbr:test/selfhost_probe2.zbr:64
        return t;
    }
