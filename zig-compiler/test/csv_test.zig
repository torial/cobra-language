...
// zbr:test/csv_test.zbr:6
        const csv = _csv_parse(simple);
// zbr:test/csv_test.zbr:8
        if (!((_csv_row_count(csv) == 4))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:9
        if (!((_csv_col_count(csv) == 3))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:12
        const hdr = _csv_header(csv);
// zbr:test/csv_test.zbr:13
        if (!(std.mem.eql(u8, hdr.items[@as(usize, @intCast(0))], "name"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:14
        if (!(std.mem.eql(u8, hdr.items[@as(usize, @intCast(1))], "score"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:15
        if (!(std.mem.eql(u8, hdr.items[@as(usize, @intCast(2))], "city"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:16
        if (!((@as(i64, @intCast(hdr.items.len)) == 3))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:19
        const r1 = _csv_row(csv, 1);
// zbr:test/csv_test.zbr:20
        if (!(std.mem.eql(u8, r1.items[@as(usize, @intCast(0))], "Alice"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:21
        if (!(std.mem.eql(u8, r1.items[@as(usize, @intCast(1))], "95"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:22
        if (!(std.mem.eql(u8, r1.items[@as(usize, @intCast(2))], "Boston"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:24
        const r3 = _csv_row(csv, 3);
// zbr:test/csv_test.zbr:25
        if (!(std.mem.eql(u8, r3.items[@as(usize, @intCast(0))], "Carla"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:26
        if (!(std.mem.eql(u8, r3.items[@as(usize, @intCast(1))], "100"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:29
        const r2 = _csv_row(csv, 2);
// zbr:test/csv_test.zbr:30
        if (!(std.mem.eql(u8, _csv_get(csv, r2, "name"), "Bob"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:31
        if (!(std.mem.eql(u8, _csv_get(csv, r2, "city"), "Austin"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:32
        if (!(std.mem.eql(u8, _csv_get(csv, r2, "score"), "87"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:33
        if (!(std.mem.eql(u8, _csv_get(csv, r2, "nope"), ""))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:37
        if (!(((_csv_row_count(csv) - 1) == 3))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:40
        var high: i64 = 0;
// zbr:test/csv_test.zbr:41
        {
            const _it_row = _csv_data_rows(csv);
            for (_it_row.items) |row| {
// zbr:test/csv_test.zbr:42
                const s = _csv_get(csv, row, "score");
// zbr:test/csv_test.zbr:43
                if ((std.mem.eql(u8, s, "95") or std.mem.eql(u8, s, "100"))) {
// zbr:test/csv_test.zbr:44
                    high = (high + 1);
                }
            }
        }
// zbr:test/csv_test.zbr:45
        if (!((high == 2))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:48
        if (!((_csv_row_count(csv) == 4))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:53
        const comma_csv = "name,city\n\"Smith, Jr\",Boston";
// zbr:test/csv_test.zbr:54
        const cc = _csv_parse(comma_csv);
// zbr:test/csv_test.zbr:55
        if (!((_csv_row_count(cc) == 2))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:56
        const cr = _csv_row(cc, 1);
// zbr:test/csv_test.zbr:57
        if (!(std.mem.eql(u8, cr.items[@as(usize, @intCast(0))], "Smith, Jr"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:58
        if (!(std.mem.eql(u8, cr.items[@as(usize, @intCast(1))], "Boston"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:63
        const quote_csv = "name,note\nAlice,\"She said \"\"hello\"\"\"";
// zbr:test/csv_test.zbr:64
        const qc = _csv_parse(quote_csv);
// zbr:test/csv_test.zbr:65
        if (!((_csv_row_count(qc) == 2))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:66
        const qr = _csv_row(qc, 1);
// zbr:test/csv_test.zbr:67
        if (!(std.mem.eql(u8, qr.items[@as(usize, @intCast(0))], "Alice"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:68
        if (!(std.mem.eql(u8, qr.items[@as(usize, @intCast(1))], "She said \"hello\""))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:73
        const mixed_csv = "key,value\n\"Jones, \"\"Jr\"\"\",\"New York\"";
// zbr:test/csv_test.zbr:74
        const mc = _csv_parse(mixed_csv);
// zbr:test/csv_test.zbr:75
        const mr = _csv_row(mc, 1);
// zbr:test/csv_test.zbr:76
        if (!(std.mem.eql(u8, mr.items[@as(usize, @intCast(0))], "Jones, \"Jr\""))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:77
        if (!(std.mem.eql(u8, mr.items[@as(usize, @intCast(1))], "New York"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:80
        const file_csv = _csv_parse_file("test/texts/MAR.csv");
// zbr:test/csv_test.zbr:81
        if (!(_zebra_gt(_csv_row_count(file_csv), 1))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:82
        if (!((_csv_col_count(file_csv) == 3))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:84
        const fhdr = _csv_header(file_csv);
// zbr:test/csv_test.zbr:85
        if (!(std.mem.eql(u8, fhdr.items[@as(usize, @intCast(0))], "book"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:86
        if (!(std.mem.eql(u8, fhdr.items[@as(usize, @intCast(1))], "chapter:verse"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:87
        if (!(std.mem.eql(u8, fhdr.items[@as(usize, @intCast(2))], "text"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:89
        const first_data = _csv_row(file_csv, 1);
// zbr:test/csv_test.zbr:90
        if (!(std.mem.eql(u8, first_data.items[@as(usize, @intCast(0))], "MAR"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:91
        if (!(std.mem.eql(u8, _csv_get(file_csv, first_data, "book"), "MAR"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:94
        if (!(_zebra_gt(_csv_row_count(file_csv), 1))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:97
        var writer = _csv_writer_init();
// zbr:test/csv_test.zbr:98
        _csv_write_row(&writer, _csv_header(csv));
// zbr:test/csv_test.zbr:99
        {
            const _it_row = _csv_data_rows(csv);
            for (_it_row.items) |row| {
// zbr:test/csv_test.zbr:100
                _csv_write_row(&writer, row);
            }
        }
// zbr:test/csv_test.zbr:101
        const rebuilt = _csv_build(&writer);
// zbr:test/csv_test.zbr:102
        if (!(_zebra_gt(rebuilt.len, 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:103
        if (!((std.mem.indexOf(u8, rebuilt, "Alice") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:104
        if (!((std.mem.indexOf(u8, rebuilt, "name") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:105
        if (!((std.mem.indexOf(u8, rebuilt, "Boston") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:109
        var writer2 = _csv_writer_init();
// zbr:test/csv_test.zbr:110
        _csv_write_row(&writer2, _csv_header(cc));
// zbr:test/csv_test.zbr:111
        {
            const _it_row = _csv_data_rows(cc);
            for (_it_row.items) |row| {
// zbr:test/csv_test.zbr:112
                _csv_write_row(&writer2, row);
            }
        }
// zbr:test/csv_test.zbr:113
        const rt = _csv_build(&writer2);
// zbr:test/csv_test.zbr:115
        const rt_csv = _csv_parse(rt);
// zbr:test/csv_test.zbr:116
        if (!((_csv_row_count(rt_csv) == 2))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:117
        const rt_row = _csv_row(rt_csv, 1);
// zbr:test/csv_test.zbr:118
        if (!(std.mem.eql(u8, rt_row.items[@as(usize, @intCast(0))], "Smith, Jr"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:121
        const resp = HttpResponse{ .status = 200, .text = "hello" };
// zbr:test/csv_test.zbr:122
        if (!((resp.status == 200))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:123
        if (!(std.mem.eql(u8, resp.text, "hello"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:125
        const resp2 = _http_with_header(resp, "Content-Type", "application/json");
// zbr:test/csv_test.zbr:126
        if (!((resp2.status == 200))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:127
        if (!(std.mem.eql(u8, resp2.text, "hello"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:129
        const resp3 = _http_with_header(resp2, "X-Custom", "value");
// zbr:test/csv_test.zbr:130
        if (!((resp3.status == 200))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/csv_test.zbr:132
