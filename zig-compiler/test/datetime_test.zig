...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/datetime_test.zbr:5
        const epoch = _DateTime{ .epoch_ms = 0 };
// zbr:test/datetime_test.zbr:6
        const dt = _dt_from_gregorian(2024, 3, 15, 0, 0, 0);
// zbr:test/datetime_test.zbr:7
        const dt2 = _dt_from_gregorian(2024, 3, 15, 14, 30, 45);
// zbr:test/datetime_test.zbr:10
        std.debug.print("{}\n", .{_dt_to_gregorian(epoch.epoch_ms).year});
// zbr:test/datetime_test.zbr:11
        std.debug.print("{}\n", .{_dt_to_gregorian(epoch.epoch_ms).month});
// zbr:test/datetime_test.zbr:12
        std.debug.print("{}\n", .{_dt_to_gregorian(epoch.epoch_ms).day});
// zbr:test/datetime_test.zbr:13
        std.debug.print("{}\n", .{_dt_weekday(epoch)});
// zbr:test/datetime_test.zbr:16
        std.debug.print("{}\n", .{_dt_to_gregorian(dt.epoch_ms).year});
// zbr:test/datetime_test.zbr:17
        std.debug.print("{}\n", .{_dt_to_gregorian(dt.epoch_ms).month});
// zbr:test/datetime_test.zbr:18
        std.debug.print("{}\n", .{_dt_to_gregorian(dt.epoch_ms).day});
// zbr:test/datetime_test.zbr:21
        std.debug.print("{}\n", .{_dt_to_gregorian(dt2.epoch_ms).hour});
// zbr:test/datetime_test.zbr:22
        std.debug.print("{}\n", .{_dt_to_gregorian(dt2.epoch_ms).minute});
// zbr:test/datetime_test.zbr:23
        std.debug.print("{}\n", .{_dt_to_gregorian(dt2.epoch_ms).second});
// zbr:test/datetime_test.zbr:26
        std.debug.print("{}\n", .{epoch.epoch_ms});
// zbr:test/datetime_test.zbr:29
        std.debug.print("{s}\n", .{_dt_to_iso8601(epoch)});
// zbr:test/datetime_test.zbr:30
        std.debug.print("{s}\n", .{_dt_to_iso8601(dt2)});
// zbr:test/datetime_test.zbr:33
        {
            const _pt0 = _dt_format(dt2, "yyyy-MM-dd HH:mm:ss");
            defer _allocator.free(_pt0);
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:test/datetime_test.zbr:34
        {
            const _pt0 = _dt_format(dt2, "d MMMM yyyy");
            defer _allocator.free(_pt0);
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:test/datetime_test.zbr:35
        {
            const _pt0 = _dt_format(dt2, "EEE, d MMM yyyy");
            defer _allocator.free(_pt0);
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:test/datetime_test.zbr:38
        const d_plus = _dt_add_days(_dt_from_gregorian(2024, 3, 15, 0, 0, 0), 10);
// zbr:test/datetime_test.zbr:39
        std.debug.print("{}\n", .{_dt_to_gregorian(d_plus.epoch_ms).day});
// zbr:test/datetime_test.zbr:42
        const jan31 = _dt_from_gregorian(2024, 1, 31, 0, 0, 0);
// zbr:test/datetime_test.zbr:43
        const feb_dt = _dt_add_months(jan31, 1);
// zbr:test/datetime_test.zbr:44
        std.debug.print("{}\n", .{_dt_to_gregorian(feb_dt.epoch_ms).month});
// zbr:test/datetime_test.zbr:45
        std.debug.print("{}\n", .{_dt_to_gregorian(feb_dt.epoch_ms).day});
// zbr:test/datetime_test.zbr:47
        const jan31_23 = _dt_from_gregorian(2023, 1, 31, 0, 0, 0);
// zbr:test/datetime_test.zbr:48
        const feb23_dt = _dt_add_months(jan31_23, 1);
// zbr:test/datetime_test.zbr:49
        std.debug.print("{}\n", .{_dt_to_gregorian(feb23_dt.epoch_ms).day});
// zbr:test/datetime_test.zbr:52
        const feb29_24 = _dt_from_gregorian(2024, 2, 29, 0, 0, 0);
// zbr:test/datetime_test.zbr:53
        const next_yr = _dt_add_years(feb29_24, 1);
// zbr:test/datetime_test.zbr:54
        std.debug.print("{}\n", .{_dt_to_gregorian(next_yr.epoch_ms).year});
// zbr:test/datetime_test.zbr:55
        std.debug.print("{}\n", .{_dt_to_gregorian(next_yr.epoch_ms).day});
// zbr:test/datetime_test.zbr:58
        const t = _dt_from_gregorian(2024, 1, 1, 23, 59, 0);
// zbr:test/datetime_test.zbr:59
        const t2 = _dt_add_hours(t, 1);
// zbr:test/datetime_test.zbr:60
        std.debug.print("{}\n", .{_dt_to_gregorian(t2.epoch_ms).day});
// zbr:test/datetime_test.zbr:61
        std.debug.print("{}\n", .{_dt_to_gregorian(t2.epoch_ms).hour});
// zbr:test/datetime_test.zbr:64
        const a = _dt_from_gregorian(2020, 1, 1, 0, 0, 0);
// zbr:test/datetime_test.zbr:65
        const b = _dt_from_gregorian(2021, 1, 1, 0, 0, 0);
// zbr:test/datetime_test.zbr:66
        std.debug.print("{}\n", .{a.epoch_ms < b.epoch_ms});
// zbr:test/datetime_test.zbr:67
        std.debug.print("{}\n", .{b.epoch_ms < a.epoch_ms});
// zbr:test/datetime_test.zbr:68
        std.debug.print("{}\n", .{b.epoch_ms > a.epoch_ms});
// zbr:test/datetime_test.zbr:69
        std.debug.print("{}\n", .{a.epoch_ms == a.epoch_ms});
// zbr:test/datetime_test.zbr:70
        std.debug.print("{}\n", .{a.epoch_ms == b.epoch_ms});
// zbr:test/datetime_test.zbr:73
        std.debug.print("{}\n", .{_dt_days_between(a, b)});
// zbr:test/datetime_test.zbr:74
        std.debug.print("{}\n", .{_dt_days_between(b, a)});
// zbr:test/datetime_test.zbr:77
        const s1 = _dt_from_gregorian(2024, 1, 1, 0, 0, 0);
// zbr:test/datetime_test.zbr:78
        const s2 = _dt_from_gregorian(2024, 1, 1, 0, 0, 30);
// zbr:test/datetime_test.zbr:79
        std.debug.print("{}\n", .{_dt_seconds_between(s1, s2)});
// zbr:test/datetime_test.zbr:82
        const view = _dt_in_calendar(dt, Calendar.Gregorian);
// zbr:test/datetime_test.zbr:83
        std.debug.print("{}\n", .{view.year});
// zbr:test/datetime_test.zbr:84
        std.debug.print("{}\n", .{view.month});
// zbr:test/datetime_test.zbr:85
        std.debug.print("{}\n", .{view.day});
// zbr:test/datetime_test.zbr:86
        std.debug.print("{}\n", .{view.weekday});
// zbr:test/datetime_test.zbr:87
        std.debug.print("{s}\n", .{view.monthName});
// zbr:test/datetime_test.zbr:88
        std.debug.print("{s}\n", .{view.era});
// zbr:test/datetime_test.zbr:91
        const now = _dt_now();
// zbr:test/datetime_test.zbr:92
        std.debug.print("{}\n", .{_zebra_ge(_dt_to_gregorian(now.epoch_ms).year, 2024)});
    }
