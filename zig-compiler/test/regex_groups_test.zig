...
// Source: test/regex_groups_test.zbr
...
pub const Main = struct {
    pub fn main() void {
// zbr:test/regex_groups_test.zbr:5
        const re = _regex_compile("(\\w+)\\s+(\\w+)", "");
// zbr:test/regex_groups_test.zbr:6
        for (_regex_groups(re, "hello world")) |g| {
// zbr:test/regex_groups_test.zbr:7
            std.debug.print("{s}\n", .{g});
        }
// zbr:test/regex_groups_test.zbr:10
        const date_re = _regex_compile("(\\d+)-(\\d+)-(\\d+)", "");
// zbr:test/regex_groups_test.zbr:11
        for (_regex_groups(date_re, "2026-04-06")) |part| {
// zbr:test/regex_groups_test.zbr:12
            std.debug.print("{s}\n", .{part});
        }
// zbr:test/regex_groups_test.zbr:15
        for (_regex_groups(re, "nope")) |x| {
// zbr:test/regex_groups_test.zbr:16
            std.debug.print("{s}\n", .{x});
        }
    }
