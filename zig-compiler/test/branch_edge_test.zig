...
// Source: test/branch_edge_test.zbr
...
pub const Parser = struct {
    ...
    pub fn makeNum(n: i64) Expr {
// zbr:test/branch_edge_test.zbr:9
        return Expr{ .num = n };
    }
...
const _reflect_Parser_fields: []const []const u8 = &.{};
const _reflect_Parser_field_types: []const []const u8 = &.{};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/branch_edge_test.zbr:15
        const e = Expr{ .num = 42 };
// zbr:test/branch_edge_test.zbr:16
        switch (e) {
            .num => |n| {
...
// zbr:test/branch_edge_test.zbr:25
        const e2 = Parser.makeNum(7);
// zbr:test/branch_edge_test.zbr:26
        switch (e2) {
            .num => |n| {
