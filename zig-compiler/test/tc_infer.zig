...
pub const TcExprMember = struct {
    obj: *TcExpr = undefined,
    member: []const u8 = undefined,
    pub fn init(o: TcExpr, m: []const u8) TcExprMember {
        var self: TcExprMember = undefined;
// zbr:test\tc_infer.zbr:29
        { const _rp = _allocator.create(TcExpr) catch @panic("OOM"); _rp.* = o; self.obj = _rp; }
// zbr:test\tc_infer.zbr:30
        self.member = m;
        return self;
    }
...
pub const TcExprCall = struct {
    callee: *TcExpr = undefined,
    args: std.ArrayList(TcExpr) = undefined,
    pub fn init(c: TcExpr, a: std.ArrayList(TcExpr)) TcExprCall {
        var self: TcExprCall = undefined;
// zbr:test\tc_infer.zbr:38
        { const _rp = _allocator.create(TcExpr) catch @panic("OOM"); _rp.* = c; self.callee = _rp; }
// zbr:test\tc_infer.zbr:39
        self.args = a;
        return self;
    }
...
pub const TcExprBinary = struct {
    op: []const u8 = undefined,
    left: *TcExpr = undefined,
    right: *TcExpr = undefined,
    pub fn init(op: []const u8, l: TcExpr, r: TcExpr) TcExprBinary {
        var self: TcExprBinary = undefined;
// zbr:test\tc_infer.zbr:47
        self.op = op;
// zbr:test\tc_infer.zbr:48
        { const _rp = _allocator.create(TcExpr) catch @panic("OOM"); _rp.* = l; self.left = _rp; }
// zbr:test\tc_infer.zbr:49
        { const _rp = _allocator.create(TcExpr) catch @panic("OOM"); _rp.* = r; self.right = _rp; }
        return self;
    }

};

pub const TcExprUnary = struct {
    op: []const u8 = undefined,
    operand: *TcExpr = undefined,
    pub fn init(op: []const u8, o: TcExpr) TcExprUnary {
        var self: TcExprUnary = undefined;
// zbr:test\tc_infer.zbr:56
        self.op = op;
// zbr:test\tc_infer.zbr:57
        { const _rp = _allocator.create(TcExpr) catch @panic("OOM"); _rp.* = o; self.operand = _rp; }
        return self;
    }

};

pub const TcExprCast = struct {
    target: TcType = undefined,
    pub fn init(t: TcType) TcExprCast {
        var self: TcExprCast = undefined;
// zbr:test\tc_infer.zbr:63
        self.target = t;
        return self;
    }
...
pub const TcExpr = union(enum) {
    ...
    unary: *TcExprUnary,
    cast: TcExprCast,
    optional_chain: *TcExpr,
};

pub const TcInfer = struct {
    _type_tag: u64 = _ttag_TcInfer,
    _scope: *TcScope = undefined,
    pub fn init(scope: *TcScope) *TcInfer {
        const self = _allocator.create(TcInfer) catch @panic("OOM");
        self._type_tag = _ttag_TcInfer;
// zbr:test\tc_infer.zbr:104
        self._scope = scope;
        return self;
    }

    pub fn inferExpr(self: *TcInfer, _p_e: TcExpr) TcType {
        var e = _p_e;
        while (true) {
// zbr:test\tc_infer.zbr:109
            switch (e) {
                .int_lit => {
// zbr:test\tc_infer.zbr:111
                    return TcType{ .int_ = {} };
                },
                .float_lit => {
// zbr:test\tc_infer.zbr:112
                    return TcType{ .float_ = {} };
                },
                .bool_lit => {
// zbr:test\tc_infer.zbr:113
                    return TcType{ .bool_ = {} };
                },
                .string_lit => {
// zbr:test\tc_infer.zbr:114
                    return TcType{ .string_ = {} };
                },
                .char_lit => {
// zbr:test\tc_infer.zbr:115
                    return TcType{ .char_ = {} };
                },
                .nil_ => {
// zbr:test\tc_infer.zbr:117
                    return TcType{ .optional = _box_1da7b9a1d08: { const _bp_1da7b9a1d08 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_1da7b9a1d08.* = TcType{ .void_ = {} }; break :_box_1da7b9a1d08 _bp_1da7b9a1d08; } };
                },
                .this_ => {
// zbr:test\tc_infer.zbr:119
                    return TcType{ .unknown_ = {} };
                },
                .ident => |name| {
// zbr:test\tc_infer.zbr:123
                    if (self._scope.hasSymbol(name)) {
// zbr:test\tc_infer.zbr:124
                        return self._scope.lookup(name).type_;
                    }
// zbr:test\tc_infer.zbr:125
                    return TcType{ .unknown_ = {} };
                },
                .member => |m_ptr| {
                    const m = m_ptr.*;
// zbr:test\tc_infer.zbr:129
                    const obj_t = self.inferExpr(m.obj.*);
// zbr:test\tc_infer.zbr:130
                    return self.inferMember(obj_t, m.member);
                },
                .call => |c_ptr| {
                    const c = c_ptr.*;
// zbr:test\tc_infer.zbr:134
                    return self.inferCall(c);
                },
                .binary => |b_ptr| {
                    const b = b_ptr.*;
// zbr:test\tc_infer.zbr:138
                    const lt = self.inferExpr(b.left.*);
// zbr:test\tc_infer.zbr:139
                    const rt = self.inferExpr(b.right.*);
// zbr:test\tc_infer.zbr:140
                    return self.inferBinary(b.op, lt, rt);
                },
                .unary => |u_ptr| {
                    const u = u_ptr.*;
// zbr:test\tc_infer.zbr:144
                    if (std.mem.eql(u8, u.op, "not")) {
// zbr:test\tc_infer.zbr:145
                        return TcType{ .bool_ = {} };
                    }
// zbr:test\tc_infer.zbr:147
                    { const _tco0 = u.operand.*; e = _tco0; }
                    continue;
                },
                .cast => |c| {
// zbr:test\tc_infer.zbr:151
                    return c.target;
                },
                .optional_chain => |inner_ptr| {
                    const inner = inner_ptr.*;
// zbr:test\tc_infer.zbr:155
                    const t = self.inferExpr(inner);
// zbr:test\tc_infer.zbr:156
    ...
    pub fn inferMember(self: *TcInfer, obj_t: TcType, member: []const u8) TcType {
        _ = self;
// zbr:test\tc_infer.zbr:161
        const stdlib_t = TcStdlib.memberType(obj_t, member);
// zbr:test\tc_infer.zbr:162
        if ((!TcTypes.eql(stdlib_t, TcType{ .unknown_ = {} }))) {
// zbr:test\tc_infer.zbr:163
            return stdlib_t;
        }
// zbr:test\tc_infer.zbr:166
        return TcType{ .unknown_ = {} };
    }

    pub fn inferCall(self: *TcInfer, c: TcExprCall) TcType {
// zbr:test\tc_infer.zbr:172
        switch (c.callee.*) {
            .member => |m_ptr| {
                const m = m_ptr.*;
// zbr:test\tc_infer.zbr:174
                switch (m.obj.*) {
                    .ident => |class_name| {
// zbr:test\tc_infer.zbr:176
                        const sc_t = TcStdlib.staticCall(class_name, m.member);
// zbr:test\tc_infer.zbr:177
                        if ((!TcTypes.eql(sc_t, TcType{ .unknown_ = {} }))) {
// zbr:test\tc_infer.zbr:178
                            return sc_t;
                        }
                    },
                    else => {
...
// zbr:test\tc_infer.zbr:184
        switch (c.callee.*) {
            .member => |m_ptr| {
                const m = m_ptr.*;
// zbr:test\tc_infer.zbr:186
                const obj_t = self.inferExpr(m.obj.*);
// zbr:test\tc_infer.zbr:187
                return self.inferMember(obj_t, m.member);
            },
            else => {
                // pass
...
// zbr:test\tc_infer.zbr:192
        return TcType{ .unknown_ = {} };
    }

    pub fn inferBinary(self: *TcInfer, op: []const u8, lt: TcType, rt: TcType) TcType {
        _ = self;
// zbr:test\tc_infer.zbr:197
...
// zbr:test\tc_infer.zbr:198
            return TcType{ .bool_ = {} };
        }
// zbr:test\tc_infer.zbr:200
        if ((std.mem.eql(u8, op, "and") or std.mem.eql(u8, op, "or"))) {
// zbr:test\tc_infer.zbr:201
            return TcType{ .bool_ = {} };
        }
// zbr:test\tc_infer.zbr:203
        if (std.mem.eql(u8, op, "+")) {
// zbr:test\tc_infer.zbr:204
            if ((TcTypes.eql(lt, TcType{ .string_ = {} }) or TcTypes.eql(rt, TcType{ .string_ = {} }))) {
// zbr:test\tc_infer.zbr:205
                return TcType{ .string_ = {} };
            }
        }
// zbr:test\tc_infer.zbr:207
        if ((TcTypes.isNumeric(lt) and TcTypes.isNumeric(rt))) {
// zbr:test\tc_infer.zbr:208
            return lt;
        }
// zbr:test\tc_infer.zbr:210
        if ((TcTypes.isFloatFamily(lt) or TcTypes.isFloatFamily(rt))) {
// zbr:test\tc_infer.zbr:211
            return TcType{ .float_ = {} };
        }
// zbr:test\tc_infer.zbr:213
        if ((TcTypes.eql(lt, TcType{ .unknown_ = {} }) or TcTypes.eql(rt, TcType{ .unknown_ = {} }))) {
// zbr:test\tc_infer.zbr:214
            return TcType{ .unknown_ = {} };
        }
// zbr:test\tc_infer.zbr:215
        return TcType{ .unknown_ = {} };
    }

};

const _ttag_TcInfer: u64 = 377331768;
const _reflect_TcInfer_name: []const u8 = "TcInfer";
const _reflect_TcInfer_fields: []const []const u8 = &.{"_scope"};
const _reflect_TcInfer_field_types: []const []const u8 = &.{"TcScope"};
