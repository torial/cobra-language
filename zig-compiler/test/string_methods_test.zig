...
pub const Main = struct {
    pub fn main() void {
// zbr:test/string_methods_test.zbr:5
        const greeting: []const u8 = "hello";
// zbr:test/string_methods_test.zbr:6
        std.debug.print("{}\n", .{greeting.len});
// zbr:test/string_methods_test.zbr:9
        const padded: []const u8 = "  hi  ";
// zbr:test/string_methods_test.zbr:10
        std.debug.print("{s}\n", .{std.mem.trimLeft(u8, padded, &std.ascii.whitespace)});
// zbr:test/string_methods_test.zbr:11
        std.debug.print("{s}\n", .{std.mem.trimRight(u8, padded, &std.ascii.whitespace)});
// zbr:test/string_methods_test.zbr:14
        const empty: []const u8 = "";
// zbr:test/string_methods_test.zbr:15
        std.debug.print("{}\n", .{(empty.len == 0)});
// zbr:test/string_methods_test.zbr:16
        std.debug.print("{}\n", .{(greeting.len == 0)});
// zbr:test/string_methods_test.zbr:19
        const sentence: []const u8 = "banana";
// zbr:test/string_methods_test.zbr:20
        std.debug.print("{}\n", .{@as(i64, @intCast(std.mem.count(u8, sentence, "an")))});
// zbr:test/string_methods_test.zbr:23
        var words = std.ArrayList([]const u8){};
        defer words.deinit(_allocator);
// zbr:test/string_methods_test.zbr:24
        words.append(_allocator, "one") catch unreachable;
// zbr:test/string_methods_test.zbr:25
        words.append(_allocator, "two") catch unreachable;
// zbr:test/string_methods_test.zbr:26
        words.append(_allocator, "three") catch unreachable;
// zbr:test/string_methods_test.zbr:27
        {
            const _pt0 = (std.mem.join(_allocator, ", ", words.items) catch @panic("OOM"));
            defer _allocator.free(_pt0);
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:test/string_methods_test.zbr:30
        const text: []const u8 = "line1\nline2\nline3";
// zbr:test/string_methods_test.zbr:31
        var _it_line = std.mem.splitScalar(u8, text, '\n');
        while (_it_line.next()) |line| {
// zbr:test/string_methods_test.zbr:32
            std.debug.print("{s}\n", .{line});
        }
// zbr:test/string_methods_test.zbr:35
        {
...
// zbr:test/string_methods_test.zbr:38
        const hi: []const u8 = "hi";
// zbr:test/string_methods_test.zbr:39
        {
