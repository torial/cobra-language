...
// Source: test/regex_anchors_test.zbr
...
pub const Main = struct {
    pub fn main() void {
// zbr:test/regex_anchors_test.zbr:5
        const anchored = _regex_compile("^hello$", "");
// zbr:test/regex_anchors_test.zbr:6
        std.debug.print("{}\n", .{_regex_match(anchored, "hello")});
// zbr:test/regex_anchors_test.zbr:7
        std.debug.print("{}\n", .{_regex_match(anchored, "hello world")});
// zbr:test/regex_anchors_test.zbr:10
        const starts = _regex_compile("^\\d+", "");
// zbr:test/regex_anchors_test.zbr:11
        std.debug.print("{s}\n", .{_regex_find(starts, "42 abc")});
// zbr:test/regex_anchors_test.zbr:12
        std.debug.print("{s}\n", .{_regex_find(starts, "abc 42")});
// zbr:test/regex_anchors_test.zbr:15
        const exact = _regex_compile("\\d{4}", "");
// zbr:test/regex_anchors_test.zbr:16
        std.debug.print("{}\n", .{_regex_match(exact, "2026")});
// zbr:test/regex_anchors_test.zbr:17
        std.debug.print("{}\n", .{_regex_match(exact, "123")});
// zbr:test/regex_anchors_test.zbr:20
        const range_re = _regex_compile("a{2,4}", "");
// zbr:test/regex_anchors_test.zbr:21
        std.debug.print("{}\n", .{_regex_match(range_re, "aa")});
// zbr:test/regex_anchors_test.zbr:22
        std.debug.print("{}\n", .{_regex_match(range_re, "aaaa")});
// zbr:test/regex_anchors_test.zbr:23
        std.debug.print("{}\n", .{_regex_match(range_re, "a")});
// zbr:test/regex_anchors_test.zbr:26
        const nc = _regex_compile("(?:ab)+", "");
// zbr:test/regex_anchors_test.zbr:27
        std.debug.print("{}\n", .{_regex_match(nc, "abab")});
// zbr:test/regex_anchors_test.zbr:28
        std.debug.print("{}\n", .{_regex_match(nc, "ab")});
    }
