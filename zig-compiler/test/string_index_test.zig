...
// Source: test/string_index_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/string_index_test.zbr:4
        const s: []const u8 = "hello";
// zbr:test/string_index_test.zbr:5
        const c = s[@intCast(0)];
// zbr:test/string_index_test.zbr:6
        std.debug.print("{u}\n", .{c});
// zbr:test/string_index_test.zbr:7
        const sub = s[@intCast(1)..@intCast(3)];
// zbr:test/string_index_test.zbr:8
        std.debug.print("{s}\n", .{sub});
// zbr:test/string_index_test.zbr:9
        std.debug.print("{}\n", .{s.len});
    }
