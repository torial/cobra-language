...
// Source: test/generic_infer_test.zbr
...
pub const Container = struct {
    ...
    flags: std.ArrayList(bool) = undefined,
    pub fn init() Container {
        var self: Container = undefined;
        self._type_tag = _ttag_Container;
// zbr:test/generic_infer_test.zbr:5
        self.items = std.ArrayList([]const u8){};
// zbr:test/generic_infer_test.zbr:6
        self.flags = std.ArrayList(bool){};
        return self;
    }

    pub fn add(self: *Container, s: []const u8, flag: bool) void {
// zbr:test/generic_infer_test.zbr:8
        self.items.append(_allocator, s) catch unreachable;
// zbr:test/generic_infer_test.zbr:9
        self.flags.append(_allocator, flag) catch unreachable;
    }

    pub fn first(self: *Container) []const u8 {
// zbr:test/generic_infer_test.zbr:11
        return self.items.items[@as(usize, @intCast(0))];
    }

    pub fn firstFlag(self: *Container) bool {
// zbr:test/generic_infer_test.zbr:13
        return self.flags.items[@as(usize, @intCast(0))];
    }
...
const _reflect_Container_fields: []const []const u8 = &.{"items", "flags"};
const _reflect_Container_field_types: []const []const u8 = &.{"List(str)", "List(bool)"};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/generic_infer_test.zbr:17
        var c = Container.init();
// zbr:test/generic_infer_test.zbr:18
        c.add("hello", true);
// zbr:test/generic_infer_test.zbr:19
        c.add("world", false);
// zbr:test/generic_infer_test.zbr:20
        std.debug.assert(std.mem.eql(u8, c.first(), "hello"));
// zbr:test/generic_infer_test.zbr:21
        std.debug.assert((c.firstFlag() == true));
// zbr:test/generic_infer_test.zbr:22
        std.debug.print("{s}\n", .{"generic_infer_test: all OK"});
    }
