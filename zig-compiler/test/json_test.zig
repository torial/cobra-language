...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/json_test.zbr:5
        const json = "{\"name\": \"Alice\", \"age\": 30, \"score\": 9.5, \"active\": true}";
// zbr:test/json_test.zbr:6
        const data = _json_parse(json);
// zbr:test/json_test.zbr:7
        if (!((data != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:9
        const d = data.?;
// zbr:test/json_test.zbr:10
        if (!(std.mem.eql(u8, _json_get_str(d, "name"), "Alice"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:11
        if (!((_json_get_int(d, "age") == 30))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:12
        if (!(_zebra_gt(_json_get_float(d, "score"), 9.4))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:13
        if (!((_json_get_bool(d, "active") == true))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:16
        if (!(std.mem.eql(u8, _json_get_str(d, "missing"), ""))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:17
        if (!((_json_get_int(d, "missing") == 0))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:18
        if (!((_json_get_bool(d, "missing") == false))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:21
        const nested = "{\"user\": {\"id\": 42, \"tag\": \"admin\"}}";
// zbr:test/json_test.zbr:22
        const nd = _json_parse(nested).?;
// zbr:test/json_test.zbr:23
        const user = _json_get_obj(nd, "user");
// zbr:test/json_test.zbr:24
        if (!((_json_get_int(user, "id") == 42))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:25
        if (!(std.mem.eql(u8, _json_get_str(user, "tag"), "admin"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:28
        const arr_json = "{\"tags\": [\"alpha\", \"beta\", \"gamma\"]}";
// zbr:test/json_test.zbr:29
        const ad = _json_parse(arr_json).?;
// zbr:test/json_test.zbr:30
        const tags = _json_get_list(ad, "tags");
// zbr:test/json_test.zbr:31
        var count: i64 = 0;
// zbr:test/json_test.zbr:32
        for (tags) |tag| {
// zbr:test/json_test.zbr:33
            if (_json_is_null(tag)) {
// zbr:test/json_test.zbr:34
                count = (count + 0);
            } else {
// zbr:test/json_test.zbr:36
                count = (count + 1);
            }
        }
// zbr:test/json_test.zbr:37
        if (!((count == 3))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:40
        const obj = _json_object();
// zbr:test/json_test.zbr:41
        if (!((_json_is_object(obj) == true))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:42
        if (!((_json_is_array(obj) == false))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:43
        if (!((_json_is_null(obj) == false))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:45
        const arr = _json_array();
// zbr:test/json_test.zbr:46
        if (!((_json_is_array(arr) == true))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:49
        var builder = _json_object();
// zbr:test/json_test.zbr:50
        _json_put_str(&builder, "city", "Springfield");
// zbr:test/json_test.zbr:51
        _json_put_int(&builder, "pop", 50000);
// zbr:test/json_test.zbr:52
        _json_put_float(&builder, "lat", 37.5);
// zbr:test/json_test.zbr:53
        _json_put_bool(&builder, "capital", false);
// zbr:test/json_test.zbr:55
        const out = _json_stringify(builder);
// zbr:test/json_test.zbr:56
        if (!((std.mem.indexOf(u8, out, "Springfield") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:57
        if (!((std.mem.indexOf(u8, out, "50000") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:60
        var list = _json_array();
// zbr:test/json_test.zbr:61
        _json_arr_str(&list, "one");
// zbr:test/json_test.zbr:62
        _json_arr_int(&list, 2);
// zbr:test/json_test.zbr:63
        _json_arr_float(&list, 3.0);
// zbr:test/json_test.zbr:64
        _json_arr_bool(&list, true);
// zbr:test/json_test.zbr:66
        const list_out = _json_stringify(list);
// zbr:test/json_test.zbr:67
        if (!((std.mem.indexOf(u8, list_out, "one") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:70
        const rt_json = "{\"x\": 1, \"y\": 2}";
// zbr:test/json_test.zbr:71
        const rt = _json_parse(rt_json).?;
// zbr:test/json_test.zbr:72
        const rt_str = _json_stringify(rt);
// zbr:test/json_test.zbr:73
        if (!((std.mem.indexOf(u8, rt_str, "\"x\"") != null))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/json_test.zbr:75
        std.debug.print("{s}\n", .{"json_test: all assertions passed"});
    }
