...
// Source: test/tc_stdlib_test.zbr
...
pub fn _initAllocator(a: std.mem.Allocator) void {
    ...
    @import("tc_stdlib.zig")._initAllocator(a);
}
...
const tc_stdlib = @import("tc_stdlib.zig");
const TcStdlib = tc_stdlib.TcStdlib;
pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/tc_stdlib_test.zbr:11
        const sb_len = TcStdlib.memberType(TcType{ .string_builder = {} }, "len");
// zbr:test/tc_stdlib_test.zbr:12
        std.debug.assert(TcTypes.eql(sb_len, TcType{ .int_ = {} }));
// zbr:test/tc_stdlib_test.zbr:13
        const sb_ts = TcStdlib.memberType(TcType{ .string_builder = {} }, "toString");
// zbr:test/tc_stdlib_test.zbr:14
        std.debug.assert(TcTypes.eql(sb_ts, TcType{ .string_ = {} }));
// zbr:test/tc_stdlib_test.zbr:15
        const sb_app = TcStdlib.memberType(TcType{ .string_builder = {} }, "append");
// zbr:test/tc_stdlib_test.zbr:16
        std.debug.assert(TcTypes.eql(sb_app, TcType{ .void_ = {} }));
// zbr:test/tc_stdlib_test.zbr:17
        std.debug.print("{s}\n", .{"1. string_builder memberType OK"});
// zbr:test/tc_stdlib_test.zbr:19
        const hr_status = TcStdlib.memberType(TcType{ .http_response = {} }, "status");
// zbr:test/tc_stdlib_test.zbr:20
        std.debug.assert(TcTypes.eql(hr_status, TcType{ .uint_ = {} }));
// zbr:test/tc_stdlib_test.zbr:21
        const hr_text = TcStdlib.memberType(TcType{ .http_response = {} }, "text");
// zbr:test/tc_stdlib_test.zbr:22
        std.debug.assert(TcTypes.eql(hr_text, TcType{ .string_ = {} }));
// zbr:test/tc_stdlib_test.zbr:23
        std.debug.print("{s}\n", .{"2. http_response memberType OK"});
// zbr:test/tc_stdlib_test.zbr:25
        const req_path = TcStdlib.memberType(TcType{ .http_request = {} }, "path");
// zbr:test/tc_stdlib_test.zbr:26
        std.debug.assert(TcTypes.eql(req_path, TcType{ .string_ = {} }));
// zbr:test/tc_stdlib_test.zbr:27
        std.debug.print("{s}\n", .{"3. http_request memberType OK"});
// zbr:test/tc_stdlib_test.zbr:29
        const jv_str = TcStdlib.memberType(TcType{ .json_value = {} }, "asString");
// zbr:test/tc_stdlib_test.zbr:30
        std.debug.assert(TcTypes.eql(jv_str, TcType{ .string_ = {} }));
// zbr:test/tc_stdlib_test.zbr:31
        const jv_int = TcStdlib.memberType(TcType{ .json_value = {} }, "asInt");
// zbr:test/tc_stdlib_test.zbr:32
        std.debug.assert(TcTypes.eql(jv_int, TcType{ .int_ = {} }));
// zbr:test/tc_stdlib_test.zbr:33
        const jv_get = TcStdlib.memberType(TcType{ .json_value = {} }, "get");
// zbr:test/tc_stdlib_test.zbr:34
        std.debug.assert(TcTypes.eql(jv_get, TcType{ .json_value = {} }));
// zbr:test/tc_stdlib_test.zbr:35
        const jv_lst = TcStdlib.memberType(TcType{ .json_value = {} }, "getList");
// zbr:test/tc_stdlib_test.zbr:36
        std.debug.assert(TcTypes.eql(jv_lst, TcType{ .json_array = {} }));
// zbr:test/tc_stdlib_test.zbr:37
        std.debug.print("{s}\n", .{"4. json_value memberType OK"});
// zbr:test/tc_stdlib_test.zbr:39
        const dt_year = TcStdlib.memberType(TcType{ .date_time = {} }, "year");
// zbr:test/tc_stdlib_test.zbr:40
        std.debug.assert(TcTypes.eql(dt_year, TcType{ .int_ = {} }));
// zbr:test/tc_stdlib_test.zbr:41
        const dt_fmt = TcStdlib.memberType(TcType{ .date_time = {} }, "format");
// zbr:test/tc_stdlib_test.zbr:42
        std.debug.assert(TcTypes.eql(dt_fmt, TcType{ .string_ = {} }));
// zbr:test/tc_stdlib_test.zbr:43
        std.debug.print("{s}\n", .{"5. date_time memberType OK"});
// zbr:test/tc_stdlib_test.zbr:45
        const uri_host = TcStdlib.memberType(TcType{ .uri_result = {} }, "host");
// zbr:test/tc_stdlib_test.zbr:46
        std.debug.assert(TcTypes.eql(uri_host, TcType{ .string_ = {} }));
// zbr:test/tc_stdlib_test.zbr:47
        const uri_port = TcStdlib.memberType(TcType{ .uri_result = {} }, "port");
// zbr:test/tc_stdlib_test.zbr:48
        std.debug.assert(TcTypes.eql(uri_port, TcType{ .int_ = {} }));
// zbr:test/tc_stdlib_test.zbr:49
        std.debug.print("{s}\n", .{"6. uri_result memberType OK"});
// zbr:test/tc_stdlib_test.zbr:51
        const tm_el = TcStdlib.memberType(TcType{ .timer_handle = {} }, "elapsed");
// zbr:test/tc_stdlib_test.zbr:52
        std.debug.assert(TcTypes.eql(tm_el, TcType{ .float_ = {} }));
// zbr:test/tc_stdlib_test.zbr:53
        const tm_us = TcStdlib.memberType(TcType{ .timer_handle = {} }, "elapsedMicros");
// zbr:test/tc_stdlib_test.zbr:54
        std.debug.assert(TcTypes.eql(tm_us, TcType{ .int_ = {} }));
// zbr:test/tc_stdlib_test.zbr:55
        std.debug.print("{s}\n", .{"7. timer_handle memberType OK"});
// zbr:test/tc_stdlib_test.zbr:57
        const csv_len = TcStdlib.memberType(TcType{ .csv_table = {} }, "len");
// zbr:test/tc_stdlib_test.zbr:58
        std.debug.assert(TcTypes.eql(csv_len, TcType{ .int_ = {} }));
// zbr:test/tc_stdlib_test.zbr:59
        const csv_row = TcStdlib.memberType(TcType{ .csv_table = {} }, "row");
// zbr:test/tc_stdlib_test.zbr:60
        std.debug.assert(TcTypes.eql(csv_row, TcType{ .csv_row = {} }));
// zbr:test/tc_stdlib_test.zbr:61
        const row_at = TcStdlib.memberType(TcType{ .csv_row = {} }, "at");
// zbr:test/tc_stdlib_test.zbr:62
        std.debug.assert(TcTypes.eql(row_at, TcType{ .string_ = {} }));
// zbr:test/tc_stdlib_test.zbr:63
        std.debug.print("{s}\n", .{"8. csv_table/csv_row memberType OK"});
// zbr:test/tc_stdlib_test.zbr:65
        const arg_flag = TcStdlib.memberType(TcType{ .arg_result = {} }, "flag");
// zbr:test/tc_stdlib_test.zbr:66
        std.debug.assert(TcTypes.eql(arg_flag, TcType{ .bool_ = {} }));
// zbr:test/tc_stdlib_test.zbr:67
        const arg_opt = TcStdlib.memberType(TcType{ .arg_result = {} }, "option");
// zbr:test/tc_stdlib_test.zbr:68
        std.debug.assert(TcTypes.eql(arg_opt, TcType{ .string_ = {} }));
// zbr:test/tc_stdlib_test.zbr:69
        std.debug.print("{s}\n", .{"9. arg_result memberType OK"});
// zbr:test/tc_stdlib_test.zbr:72
        const unk = TcStdlib.memberType(TcType{ .http_response = {} }, "bogus");
// zbr:test/tc_stdlib_test.zbr:73
        std.debug.assert(TcTypes.eql(unk, TcType{ .unknown_ = {} }));
// zbr:test/tc_stdlib_test.zbr:75
        const unk2 = TcStdlib.memberType(TcType{ .int_ = {} }, "anything");
// zbr:test/tc_stdlib_test.zbr:76
        std.debug.assert(TcTypes.eql(unk2, TcType{ .unknown_ = {} }));
// zbr:test/tc_stdlib_test.zbr:77
        std.debug.print("{s}\n", .{"10. unknown fallthrough OK"});
// zbr:test/tc_stdlib_test.zbr:80
        const http_get = TcStdlib.staticCall("Http", "get");
// zbr:test/tc_stdlib_test.zbr:81
        std.debug.assert(TcTypes.eql(http_get, TcType{ .optional = _box_28484920b78: { const _bp_28484920b78 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_28484920b78.* = TcType{ .http_response = {} }; break :_box_28484920b78 _bp_28484920b78; } }));
// zbr:test/tc_stdlib_test.zbr:82
        const http_json = TcStdlib.staticCall("Http", "json");
// zbr:test/tc_stdlib_test.zbr:83
        std.debug.assert(TcTypes.eql(http_json, TcType{ .optional = _box_284849210f0: { const _bp_284849210f0 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_284849210f0.* = TcType{ .json_value = {} }; break :_box_284849210f0 _bp_284849210f0; } }));
// zbr:test/tc_stdlib_test.zbr:84
        std.debug.print("{s}\n", .{"11. Http staticCall OK"});
// zbr:test/tc_stdlib_test.zbr:86
        const csv_parse = TcStdlib.staticCall("Csv", "parse");
// zbr:test/tc_stdlib_test.zbr:87
        std.debug.assert(TcTypes.eql(csv_parse, TcType{ .csv_table = {} }));
// zbr:test/tc_stdlib_test.zbr:88
        const csv_writer = TcStdlib.staticCall("Csv", "writer");
// zbr:test/tc_stdlib_test.zbr:89
        std.debug.assert(TcTypes.eql(csv_writer, TcType{ .csv_writer = {} }));
// zbr:test/tc_stdlib_test.zbr:90
        std.debug.print("{s}\n", .{"12. Csv staticCall OK"});
// zbr:test/tc_stdlib_test.zbr:92
        const json_parse = TcStdlib.staticCall("Json", "parse");
// zbr:test/tc_stdlib_test.zbr:93
        std.debug.assert(TcTypes.eql(json_parse, TcType{ .optional = _box_28484922688: { const _bp_28484922688 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_28484922688.* = TcType{ .json_value = {} }; break :_box_28484922688 _bp_28484922688; } }));
// zbr:test/tc_stdlib_test.zbr:94
        const json_str = TcStdlib.staticCall("Json", "stringify");
// zbr:test/tc_stdlib_test.zbr:95
        std.debug.assert(TcTypes.eql(json_str, TcType{ .string_ = {} }));
// zbr:test/tc_stdlib_test.zbr:96
        std.debug.print("{s}\n", .{"13. Json staticCall OK"});
// zbr:test/tc_stdlib_test.zbr:98
        const rx_compile = TcStdlib.staticCall("Regex", "compile");
// zbr:test/tc_stdlib_test.zbr:99
        std.debug.assert(TcTypes.eql(rx_compile, TcType{ .regex = {} }));
// zbr:test/tc_stdlib_test.zbr:100
        std.debug.print("{s}\n", .{"14. Regex staticCall OK"});
// zbr:test/tc_stdlib_test.zbr:102
        const arg_parse = TcStdlib.staticCall("Arg", "parse");
// zbr:test/tc_stdlib_test.zbr:103
        std.debug.assert(TcTypes.eql(arg_parse, TcType{ .arg_result = {} }));
// zbr:test/tc_stdlib_test.zbr:104
        std.debug.print("{s}\n", .{"15. Arg staticCall OK"});
// zbr:test/tc_stdlib_test.zbr:106
        const uri_parse = TcStdlib.staticCall("Uri", "parse");
// zbr:test/tc_stdlib_test.zbr:107
        std.debug.assert(TcTypes.eql(uri_parse, TcType{ .uri_result = {} }));
// zbr:test/tc_stdlib_test.zbr:108
        std.debug.print("{s}\n", .{"16. Uri staticCall OK"});
// zbr:test/tc_stdlib_test.zbr:110
        const timer_st = TcStdlib.staticCall("Timer", "start");
// zbr:test/tc_stdlib_test.zbr:111
        std.debug.assert(TcTypes.eql(timer_st, TcType{ .timer_handle = {} }));
// zbr:test/tc_stdlib_test.zbr:112
        std.debug.print("{s}\n", .{"17. Timer staticCall OK"});
// zbr:test/tc_stdlib_test.zbr:114
        const rnd_int = TcStdlib.staticCall("Random", "randInt");
// zbr:test/tc_stdlib_test.zbr:115
        std.debug.assert(TcTypes.eql(rnd_int, TcType{ .int_ = {} }));
// zbr:test/tc_stdlib_test.zbr:116
        const rnd_flt = TcStdlib.staticCall("Random", "randFloat");
// zbr:test/tc_stdlib_test.zbr:117
        std.debug.assert(TcTypes.eql(rnd_flt, TcType{ .float_ = {} }));
// zbr:test/tc_stdlib_test.zbr:118
        std.debug.print("{s}\n", .{"18. Random staticCall OK"});
// zbr:test/tc_stdlib_test.zbr:120
        const dt_now = TcStdlib.staticCall("DateTime", "now");
// zbr:test/tc_stdlib_test.zbr:121
        std.debug.assert(TcTypes.eql(dt_now, TcType{ .date_time = {} }));
// zbr:test/tc_stdlib_test.zbr:122
        std.debug.print("{s}\n", .{"19. DateTime staticCall OK"});
// zbr:test/tc_stdlib_test.zbr:124
        const math_sqrt = TcStdlib.staticCall("Math", "sqrt");
// zbr:test/tc_stdlib_test.zbr:125
        std.debug.assert(TcTypes.eql(math_sqrt, TcType{ .float_ = {} }));
// zbr:test/tc_stdlib_test.zbr:126
        const math_isnan = TcStdlib.staticCall("Math", "isNaN");
// zbr:test/tc_stdlib_test.zbr:127
        std.debug.assert(TcTypes.eql(math_isnan, TcType{ .bool_ = {} }));
// zbr:test/tc_stdlib_test.zbr:128
        std.debug.print("{s}\n", .{"20. Math staticCall OK"});
// zbr:test/tc_stdlib_test.zbr:130
        const compress_gz = TcStdlib.staticCall("Compress", "gzip");
// zbr:test/tc_stdlib_test.zbr:131
        std.debug.assert(TcTypes.eql(compress_gz, TcType{ .string_ = {} }));
// zbr:test/tc_stdlib_test.zbr:132
        const compress_ung = TcStdlib.staticCall("Compress", "gunzip");
// zbr:test/tc_stdlib_test.zbr:133
        std.debug.assert(TcTypes.eql(compress_ung, TcType{ .optional = _box_28484925fa8: { const _bp_28484925fa8 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_28484925fa8.* = TcType{ .string_ = {} }; break :_box_28484925fa8 _bp_28484925fa8; } }));
// zbr:test/tc_stdlib_test.zbr:134
        std.debug.print("{s}\n", .{"21. Compress staticCall OK"});
// zbr:test/tc_stdlib_test.zbr:136
        const unk_sc = TcStdlib.staticCall("NotAClass", "method");
// zbr:test/tc_stdlib_test.zbr:137
        std.debug.assert(TcTypes.eql(unk_sc, TcType{ .unknown_ = {} }));
// zbr:test/tc_stdlib_test.zbr:138
        std.debug.print("{s}\n", .{"22. unknown class staticCall OK"});
// zbr:test/tc_stdlib_test.zbr:140
        std.debug.print("{s}\n", .{"tc_stdlib_test: all OK"});
    }
...
pub fn main() void {
    ...
    @import("tc_stdlib.zig")._initAllocator(_allocator);
    Main.main();
}
