...
// Source: test/enum_branch_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/enum_branch_test.zbr:10
        const d: Direction = Direction.north;
// zbr:test/enum_branch_test.zbr:11
        switch (d) {
            Direction.north => {
// zbr:test/enum_branch_test.zbr:13
                std.debug.print("{s}\n", .{"north"});
            },
            Direction.south => {
// zbr:test/enum_branch_test.zbr:15
                std.debug.print("{s}\n", .{"south"});
            },
            Direction.east => {
// zbr:test/enum_branch_test.zbr:17
                std.debug.print("{s}\n", .{"east"});
            },
            Direction.west => {
// zbr:test/enum_branch_test.zbr:19
                std.debug.print("{s}\n", .{"west"});
            },
        }
// zbr:test/enum_branch_test.zbr:21
        const d2: Direction = Direction.east;
// zbr:test/enum_branch_test.zbr:22
        switch (d2) {
            Direction.east, Direction.west => {
// zbr:test/enum_branch_test.zbr:24
                std.debug.print("{s}\n", .{"horizontal"});
            },
            else => {
// zbr:test/enum_branch_test.zbr:26
                std.debug.print("{s}\n", .{"vertical"});
            },
        }
// zbr:test/enum_branch_test.zbr:28
        const d3: Direction = Direction.south;
// zbr:test/enum_branch_test.zbr:29
        switch (d3) {
            Direction.north => {
// zbr:test/enum_branch_test.zbr:31
                std.debug.print("{s}\n", .{"going north"});
            },
            else => {
// zbr:test/enum_branch_test.zbr:33
                std.debug.print("{s}\n", .{"not north"});
            },
        }
    }
