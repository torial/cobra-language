...
// Source: C:/projects/cobra-language/zig-compiler/test/throws_autoprop_test.zbr
...
pub const ErrorPropTest = struct {
    _type_tag: u64 = _ttag_ErrorPropTest,
    pub fn inner(self: *ErrorPropTest) anyerror!void {
        _ = self;
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_autoprop_test.zbr:9
        _error_ctx = .{ .message = "from inner", .details = null };
        return error.ZebraError;
    }

    pub fn outer(self: *ErrorPropTest) anyerror!void {
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_autoprop_test.zbr:13
        try self.inner();
    }

    pub fn run(self: *ErrorPropTest) void {
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_autoprop_test.zbr:17
        var _try_err_36b0: ?anyerror = null;
        _try_blk_36b0: {
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_autoprop_test.zbr:18
            self.outer() catch |_e| { _try_err_36b0 = _e; break :_try_blk_36b0; };
            break :_try_blk_36b0;
        }
        if (_try_err_36b0 != null) {
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_autoprop_test.zbr:20
            std.debug.print("{s}\n", .{"caught: OK"});
        }
    }

    pub fn init() ErrorPropTest {
        var self: ErrorPropTest = undefined;
        self._type_tag = _ttag_ErrorPropTest;
        return self;
    }

};

const _ttag_ErrorPropTest: u64 = 486243400;
const _reflect_ErrorPropTest_name: []const u8 = "ErrorPropTest";
const _reflect_ErrorPropTest_fields: []const []const u8 = &.{};
const _reflect_ErrorPropTest_field_types: []const []const u8 = &.{};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_autoprop_test.zbr:25
        var t = ErrorPropTest.init();
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_autoprop_test.zbr:26
        t.run();
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_autoprop_test.zbr:27
        std.debug.print("{s}\n", .{"throws_autoprop_test: passed"});
    }
