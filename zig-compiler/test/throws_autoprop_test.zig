...
// Source: test/throws_autoprop_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/throws_autoprop_test.zbr:25
        var t = ErrorPropTest.init();
// zbr:test/throws_autoprop_test.zbr:26
        t.run();
// zbr:test/throws_autoprop_test.zbr:27
