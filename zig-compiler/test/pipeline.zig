...
// zbr:test/pipeline.zbr:4
        return (a + b);
    }

    pub fn double(x: i64) i64 {
// zbr:test/pipeline.zbr:7
        return (x + x);
    }

    pub fn main() void {
// zbr:test/pipeline.zbr:11
        const result = Math.double(Math.add(3, 10));
// zbr:test/pipeline.zbr:12
        std.debug.print("{d}\n", .{result});
// zbr:test/pipeline.zbr:15
        const triple = struct { fn call(x: i64) i64 { return ((x + x) + x); } }.call;
// zbr:test/pipeline.zbr:16
        const t = triple(7);
// zbr:test/pipeline.zbr:17
        std.debug.print("{any}\n", .{t});
    }
