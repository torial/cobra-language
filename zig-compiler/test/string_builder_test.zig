...
// Source: test/string_builder_test.zbr
...
pub const Main = struct {
    pub fn main() void {
// zbr:test/string_builder_test.zbr:5
        var sb = std.ArrayList(u8){};
        defer sb.deinit(_allocator);
// zbr:test/string_builder_test.zbr:6
        sb.appendSlice(_allocator, "hello") catch @panic("OOM");
// zbr:test/string_builder_test.zbr:7
        sb.appendSlice(_allocator, ", ") catch @panic("OOM");
// zbr:test/string_builder_test.zbr:8
        sb.appendSlice(_allocator, "world") catch @panic("OOM");
// zbr:test/string_builder_test.zbr:9
        std.debug.print("{s}\n", .{sb.items});
// zbr:test/string_builder_test.zbr:12
        std.debug.print("{}\n", .{sb.items.len});
// zbr:test/string_builder_test.zbr:15
        sb.clearRetainingCapacity();
// zbr:test/string_builder_test.zbr:16
        std.debug.print("{}\n", .{sb.items.len});
// zbr:test/string_builder_test.zbr:19
        var words = std.ArrayList([]const u8){};
        defer words.deinit(_allocator);
// zbr:test/string_builder_test.zbr:20
        words.append(_allocator, "one") catch unreachable;
// zbr:test/string_builder_test.zbr:21
        words.append(_allocator, "two") catch unreachable;
// zbr:test/string_builder_test.zbr:22
        words.append(_allocator, "three") catch unreachable;
// zbr:test/string_builder_test.zbr:23
        var sb2 = std.ArrayList(u8){};
        defer sb2.deinit(_allocator);
// zbr:test/string_builder_test.zbr:24
        var first: bool = true;
// zbr:test/string_builder_test.zbr:25
        for (words.items) |w| {
// zbr:test/string_builder_test.zbr:26
            if ((!first)) {
// zbr:test/string_builder_test.zbr:27
                sb2.appendSlice(_allocator, ", ") catch @panic("OOM");
            }
// zbr:test/string_builder_test.zbr:28
            sb2.appendSlice(_allocator, w) catch @panic("OOM");
// zbr:test/string_builder_test.zbr:29
            first = false;
        }
// zbr:test/string_builder_test.zbr:30
        std.debug.print("{s}\n", .{sb2.items});
// zbr:test/string_builder_test.zbr:33
        var sb3 = std.ArrayList(u8){};
        defer sb3.deinit(_allocator);
// zbr:test/string_builder_test.zbr:34
        sb3.appendSlice(_allocator, "abc") catch @panic("OOM");
// zbr:test/string_builder_test.zbr:35
        sb3.append(_allocator, @as(u8, @intCast(33))) catch @panic("OOM");
// zbr:test/string_builder_test.zbr:36
        std.debug.print("{s}\n", .{sb3.items});
    }
