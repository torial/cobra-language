...
pub const Main = struct {
    pub fn main() void {
// zbr:test/math_test.zbr:5
        std.debug.print("{}\n", .{(_zebra_gt(std.math.pi, 3.14) and _zebra_lt(std.math.pi, 3.15))});
// zbr:test/math_test.zbr:6
        std.debug.print("{}\n", .{(_zebra_gt(std.math.e, 2.71) and _zebra_lt(std.math.e, 2.72))});
// zbr:test/math_test.zbr:7
        std.debug.print("{}\n", .{(_zebra_gt(std.math.tau, 6.28) and _zebra_lt(std.math.tau, 6.29))});
// zbr:test/math_test.zbr:10
        const sin90: f64 = std.math.sin(@as(f64, (std.math.pi / 2.0)));
// zbr:test/math_test.zbr:11
        std.debug.print("{}\n", .{_zebra_gt(sin90, 0.999)});
// zbr:test/math_test.zbr:12
        const cos0: f64 = std.math.cos(@as(f64, 0.0));
// zbr:test/math_test.zbr:13
        std.debug.print("{}\n", .{_zebra_gt(cos0, 0.999)});
// zbr:test/math_test.zbr:14
        const atan2_val: f64 = std.math.atan2(@as(f64, 1.0), @as(f64, 1.0));
// zbr:test/math_test.zbr:15
        std.debug.print("{}\n", .{(_zebra_gt(atan2_val, 0.785) and _zebra_lt(atan2_val, 0.786))});
// zbr:test/math_test.zbr:18
        std.debug.print("{}\n", .{_zebra_gt(std.math.sqrt(@as(f64, 9.0)), 2.999)});
// zbr:test/math_test.zbr:19
        std.debug.print("{}\n", .{_zebra_gt(std.math.pow(f64, @as(f64, 2.0), @as(f64, 10.0)), 1023.9)});
// zbr:test/math_test.zbr:22
        std.debug.print("{}\n", .{_zebra_gt(std.math.log(f64, std.math.e, @as(f64, std.math.e)), 0.999)});
// zbr:test/math_test.zbr:23
        std.debug.print("{}\n", .{_zebra_gt(std.math.log2(@as(f64, 8.0)), 2.999)});
// zbr:test/math_test.zbr:24
        std.debug.print("{}\n", .{_zebra_gt(std.math.log10(@as(f64, 1000.0)), 2.999)});
// zbr:test/math_test.zbr:25
        std.debug.print("{}\n", .{_zebra_gt(std.math.exp(@as(f64, 0.0)), 0.999)});
// zbr:test/math_test.zbr:28
        std.debug.print("{}\n", .{_zebra_gt(std.math.floor(@as(f64, 3.9)), 2.999)});
// zbr:test/math_test.zbr:29
        std.debug.print("{}\n", .{_zebra_gt(std.math.ceil(@as(f64, 3.1)), 3.999)});
// zbr:test/math_test.zbr:30
        std.debug.print("{}\n", .{_zebra_gt(std.math.round(@as(f64, 3.5)), 3.999)});
// zbr:test/math_test.zbr:31
        std.debug.print("{}\n", .{_zebra_gt(std.math.trunc(@as(f64, 3.9)), 2.999)});
// zbr:test/math_test.zbr:34
        std.debug.print("{}\n", .{_zebra_gt(@abs((-5.0)), 4.999)});
// zbr:test/math_test.zbr:35
        std.debug.print("{}\n", .{(@abs((-7)) == 7)});
// zbr:test/math_test.zbr:36
        std.debug.print("{}\n", .{_zebra_gt(@min(3.0, 7.0), 2.999)});
// zbr:test/math_test.zbr:37
        std.debug.print("{}\n", .{_zebra_gt(@max(3.0, 7.0), 6.999)});
// zbr:test/math_test.zbr:38
        std.debug.print("{}\n", .{_zebra_gt(std.math.clamp(15.0, 0.0, 10.0), 9.999)});
// zbr:test/math_test.zbr:41
        std.debug.print("{}\n", .{std.math.isNan(@as(f64, std.math.nan(f64)))});
// zbr:test/math_test.zbr:42
        std.debug.print("{}\n", .{std.math.isInf(@as(f64, std.math.inf(f64)))});
// zbr:test/math_test.zbr:43
        std.debug.print("{}\n", .{(std.math.isNan(@as(f64, 1.0)) == false)});
    }
