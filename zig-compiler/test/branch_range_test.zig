...
// Source: test/branch_range_test.zbr
...
pub const BranchRangeTest = struct {
    _type_tag: u64 = _ttag_BranchRangeTest,
    pub fn classify(self: *BranchRangeTest, c: u21) []const u8 {
        _ = self;
// zbr:test/branch_range_test.zbr:3
        switch (c) {
            'a'...'z' => {
// zbr:test/branch_range_test.zbr:5
                return "lower";
            },
            'A'...'Z' => {
// zbr:test/branch_range_test.zbr:7
                return "upper";
            },
            '0'...'9' => {
// zbr:test/branch_range_test.zbr:9
                return "digit";
            },
            else => {
// zbr:test/branch_range_test.zbr:11
                return "other";
            },
        }
    }

    pub fn run(self: *BranchRangeTest) void {
// zbr:test/branch_range_test.zbr:14
        std.debug.assert(std.mem.eql(u8, self.classify('g'), "lower"));
// zbr:test/branch_range_test.zbr:15
        std.debug.assert(std.mem.eql(u8, self.classify('M'), "upper"));
// zbr:test/branch_range_test.zbr:16
        std.debug.assert(std.mem.eql(u8, self.classify('5'), "digit"));
// zbr:test/branch_range_test.zbr:17
        std.debug.assert(std.mem.eql(u8, self.classify('!'), "other"));
// zbr:test/branch_range_test.zbr:18
        std.debug.assert(std.mem.eql(u8, self.classify('z'), "lower"));
// zbr:test/branch_range_test.zbr:19
        std.debug.assert(std.mem.eql(u8, self.classify('A'), "upper"));
// zbr:test/branch_range_test.zbr:20
        std.debug.assert(std.mem.eql(u8, self.classify('0'), "digit"));
// zbr:test/branch_range_test.zbr:21
        std.debug.assert(std.mem.eql(u8, self.classify('9'), "digit"));
    }

    pub fn init() BranchRangeTest {
        var self: BranchRangeTest = undefined;
        self._type_tag = _ttag_BranchRangeTest;
        return self;
    }

};

const _ttag_BranchRangeTest: u64 = 3708736818;
const _reflect_BranchRangeTest_name: []const u8 = "BranchRangeTest";
const _reflect_BranchRangeTest_fields: []const []const u8 = &.{};
const _reflect_BranchRangeTest_field_types: []const []const u8 = &.{};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/branch_range_test.zbr:25
        var t = BranchRangeTest.init();
// zbr:test/branch_range_test.zbr:26
        t.run();
// zbr:test/branch_range_test.zbr:27
        std.debug.print("{s}\n", .{"branch_range_test: all OK"});
    }
