...
pub const App = struct {
    ...
    pub fn main() void {
// zbr:test/use_test.zbr:6
        const d: i64 = MathUtils.double(7);
// zbr:test/use_test.zbr:7
        const s: i64 = MathUtils.square(4);
// zbr:test/use_test.zbr:8
        std.debug.print("{}\n", .{d});
// zbr:test/use_test.zbr:9
        std.debug.print("{}\n", .{s});
    }
