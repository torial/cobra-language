...
// Source: test/tcp_advanced_test.zbr
...
pub const Main = struct {
    pub fn main() void {
// zbr:test/tcp_advanced_test.zbr:5
        const conn = _tcp_connect("httpbin.org", 80);
// zbr:test/tcp_advanced_test.zbr:6
        if ((conn != null)) {
// zbr:test/tcp_advanced_test.zbr:7
            _tcp_write(conn.?, "GET /get HTTP/1.0\r\nHost: httpbin.org\r\n\r\n");
// zbr:test/tcp_advanced_test.zbr:9
            const status_line: []const u8 = _tcp_read_line(conn.?);
// zbr:test/tcp_advanced_test.zbr:10
            _tcp_close(conn.?);
// zbr:test/tcp_advanced_test.zbr:11
            std.debug.print("{}\n", .{std.mem.startsWith(u8, status_line, "HTTP/1")});
// zbr:test/tcp_advanced_test.zbr:12
            std.debug.print("{}\n", .{_zebra_gt(status_line.len, 0)});
        }
// zbr:test/tcp_advanced_test.zbr:15
        const conn2 = _tcp_connect("httpbin.org", 80);
// zbr:test/tcp_advanced_test.zbr:16
        if ((conn2 != null)) {
// zbr:test/tcp_advanced_test.zbr:17
            _tcp_write(conn2.?, "GET /get HTTP/1.0\r\nHost: httpbin.org\r\n\r\n");
// zbr:test/tcp_advanced_test.zbr:18
            const chunk: []const u8 = _tcp_read_bytes(conn2.?, 12);
// zbr:test/tcp_advanced_test.zbr:19
            _tcp_close(conn2.?);
// zbr:test/tcp_advanced_test.zbr:20
            std.debug.print("{}\n", .{std.mem.startsWith(u8, chunk, "HTTP/")});
// zbr:test/tcp_advanced_test.zbr:21
            std.debug.print("{}\n", .{_zebra_gt(chunk.len, 0)});
        }
    }
