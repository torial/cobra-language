...
// zbr:test/sort_test.zbr:6
        nums.append(_allocator, 5) catch unreachable;
// zbr:test/sort_test.zbr:7
        nums.append(_allocator, 2) catch unreachable;
// zbr:test/sort_test.zbr:8
        nums.append(_allocator, 8) catch unreachable;
// zbr:test/sort_test.zbr:9
        nums.append(_allocator, 1) catch unreachable;
// zbr:test/sort_test.zbr:10
        nums.append(_allocator, 9) catch unreachable;
// zbr:test/sort_test.zbr:11
        _zebra_sort_natural(@TypeOf(nums.items[0]), nums.items);
// zbr:test/sort_test.zbr:12
        for (nums.items) |n| {
// zbr:test/sort_test.zbr:13
            std.debug.print("{}\n", .{n});
        }
// zbr:test/sort_test.zbr:16
        var words = std.ArrayList([]const u8){};
        defer words.deinit(_allocator);
// zbr:test/sort_test.zbr:17
        words.append(_allocator, "banana") catch unreachable;
// zbr:test/sort_test.zbr:18
        words.append(_allocator, "apple") catch unreachable;
// zbr:test/sort_test.zbr:19
        words.append(_allocator, "cherry") catch unreachable;
// zbr:test/sort_test.zbr:20
        _zebra_sort_natural(@TypeOf(words.items[0]), words.items);
// zbr:test/sort_test.zbr:21
        for (words.items) |w| {
// zbr:test/sort_test.zbr:22
            std.debug.print("{s}\n", .{w});
        }
// zbr:test/sort_test.zbr:25
        var desc = std.ArrayList(i64){};
        defer desc.deinit(_allocator);
// zbr:test/sort_test.zbr:26
        desc.append(_allocator, 3) catch unreachable;
// zbr:test/sort_test.zbr:27
        desc.append(_allocator, 1) catch unreachable;
// zbr:test/sort_test.zbr:28
        desc.append(_allocator, 4) catch unreachable;
// zbr:test/sort_test.zbr:29
        desc.append(_allocator, 1) catch unreachable;
// zbr:test/sort_test.zbr:30
        desc.append(_allocator, 5) catch unreachable;
// zbr:test/sort_test.zbr:31
        _zebra_sort_by(@TypeOf(desc.items[0]), struct { fn call(a: anytype, b: anytype) @TypeOf(_zebra_gt(a, b)) { return _zebra_gt(a, b); } }.call, desc.items);
// zbr:test/sort_test.zbr:32
        for (desc.items) |n| {
// zbr:test/sort_test.zbr:33
            std.debug.print("{}\n", .{n});
        }
...
// zbr:test/sort_test.zbr:44
        carol.score = 78;
// zbr:test/sort_test.zbr:45
        var people = std.ArrayList(Person){};
        defer people.deinit(_allocator);
// zbr:test/sort_test.zbr:46
        people.append(_allocator, alice) catch unreachable;
// zbr:test/sort_test.zbr:47
        people.append(_allocator, bob) catch unreachable;
// zbr:test/sort_test.zbr:48
        people.append(_allocator, carol) catch unreachable;
// zbr:test/sort_test.zbr:49
        _zebra_sort_by(@TypeOf(people.items[0]), struct { fn call(a: anytype, b: anytype) @TypeOf(_zebra_gt(a.score, b.score)) { return _zebra_gt(a.score, b.score); } }.call, people.items);
// zbr:test/sort_test.zbr:50
        for (people.items) |p| {
// zbr:test/sort_test.zbr:51
            std.debug.print("{s}\n", .{p.name});
        }
// zbr:test/sort_test.zbr:54
        var stable = std.ArrayList(i64){};
        defer stable.deinit(_allocator);
// zbr:test/sort_test.zbr:55
        stable.append(_allocator, 3) catch unreachable;
// zbr:test/sort_test.zbr:56
        stable.append(_allocator, 1) catch unreachable;
// zbr:test/sort_test.zbr:57
        stable.append(_allocator, 3) catch unreachable;
// zbr:test/sort_test.zbr:58
        stable.append(_allocator, 2) catch unreachable;
// zbr:test/sort_test.zbr:59
        stable.append(_allocator, 1) catch unreachable;
// zbr:test/sort_test.zbr:60
        _zebra_sort_natural(@TypeOf(stable.items[0]), stable.items);
// zbr:test/sort_test.zbr:61
        for (stable.items) |n| {
// zbr:test/sort_test.zbr:62
            std.debug.print("{}\n", .{n});
        }
// zbr:test/sort_test.zbr:65
        var reverse_sort = std.ArrayList([]const u8){};
        defer reverse_sort.deinit(_allocator);
// zbr:test/sort_test.zbr:66
        reverse_sort.append(_allocator, "cat") catch unreachable;
// zbr:test/sort_test.zbr:67
        reverse_sort.append(_allocator, "ant") catch unreachable;
// zbr:test/sort_test.zbr:68
        reverse_sort.append(_allocator, "bat") catch unreachable;
// zbr:test/sort_test.zbr:69
        _zebra_sort_by(@TypeOf(reverse_sort.items[0]), struct { fn call(a: anytype, b: anytype) @TypeOf(_zebra_gt(a, b)) { return _zebra_gt(a, b); } }.call, reverse_sort.items);
// zbr:test/sort_test.zbr:70
        for (reverse_sort.items) |w| {
// zbr:test/sort_test.zbr:71
            std.debug.print("{s}\n", .{w});
        }
// zbr:test/sort_test.zbr:74
        var empty = std.ArrayList(i64){};
        defer empty.deinit(_allocator);
// zbr:test/sort_test.zbr:75
        _zebra_sort_natural(@TypeOf(empty.items[0]), empty.items);
// zbr:test/sort_test.zbr:76
        std.debug.print("{}\n", .{@as(i64, @intCast(empty.items.len))});
// zbr:test/sort_test.zbr:79
        var single = std.ArrayList(i64){};
        defer single.deinit(_allocator);
// zbr:test/sort_test.zbr:80
        single.append(_allocator, 42) catch unreachable;
// zbr:test/sort_test.zbr:81
        _zebra_sort_natural(@TypeOf(single.items[0]), single.items);
// zbr:test/sort_test.zbr:82
        std.debug.print("{}\n", .{single.items[@as(usize, @intCast(0))]});
// zbr:test/sort_test.zbr:85
        var already = std.ArrayList(i64){};
        defer already.deinit(_allocator);
// zbr:test/sort_test.zbr:86
        already.append(_allocator, 1) catch unreachable;
// zbr:test/sort_test.zbr:87
        already.append(_allocator, 2) catch unreachable;
// zbr:test/sort_test.zbr:88
        already.append(_allocator, 3) catch unreachable;
// zbr:test/sort_test.zbr:89
        _zebra_sort_natural(@TypeOf(already.items[0]), already.items);
// zbr:test/sort_test.zbr:90
        for (already.items) |n| {
// zbr:test/sort_test.zbr:91
            std.debug.print("{}\n", .{n});
        }
// zbr:test/sort_test.zbr:94
        var rev_input = std.ArrayList(i64){};
        defer rev_input.deinit(_allocator);
// zbr:test/sort_test.zbr:95
        rev_input.append(_allocator, 3) catch unreachable;
// zbr:test/sort_test.zbr:96
        rev_input.append(_allocator, 2) catch unreachable;
// zbr:test/sort_test.zbr:97
        rev_input.append(_allocator, 1) catch unreachable;
// zbr:test/sort_test.zbr:98
        _zebra_sort_natural(@TypeOf(rev_input.items[0]), rev_input.items);
// zbr:test/sort_test.zbr:99
        for (rev_input.items) |n| {
// zbr:test/sort_test.zbr:100
            std.debug.print("{}\n", .{n});
        }
// zbr:test/sort_test.zbr:103
        var dupes = std.ArrayList(i64){};
        defer dupes.deinit(_allocator);
// zbr:test/sort_test.zbr:104
        dupes.append(_allocator, 1) catch unreachable;
// zbr:test/sort_test.zbr:105
        dupes.append(_allocator, 5) catch unreachable;
// zbr:test/sort_test.zbr:106
        dupes.append(_allocator, 1) catch unreachable;
// zbr:test/sort_test.zbr:107
        dupes.append(_allocator, 5) catch unreachable;
// zbr:test/sort_test.zbr:108
        dupes.append(_allocator, 1) catch unreachable;
// zbr:test/sort_test.zbr:109
        _zebra_sort_natural(@TypeOf(dupes.items[0]), dupes.items);
// zbr:test/sort_test.zbr:110
        std.debug.print("{}\n", .{@as(i64, @intCast(dupes.items.len))});
// zbr:test/sort_test.zbr:113
        var floats = std.ArrayList(f64){};
        defer floats.deinit(_allocator);
// zbr:test/sort_test.zbr:114
        floats.append(_allocator, 3.14) catch unreachable;
// zbr:test/sort_test.zbr:115
        floats.append(_allocator, 2.71) catch unreachable;
// zbr:test/sort_test.zbr:116
        floats.append(_allocator, 1.41) catch unreachable;
// zbr:test/sort_test.zbr:117
        _zebra_sort_natural(@TypeOf(floats.items[0]), floats.items);
// zbr:test/sort_test.zbr:118
        for (floats.items) |f| {
// zbr:test/sort_test.zbr:119
            std.debug.print("{d}\n", .{f});
        }
// zbr:test/sort_test.zbr:122
        var mixed_case = std.ArrayList([]const u8){};
        defer mixed_case.deinit(_allocator);
// zbr:test/sort_test.zbr:123
        mixed_case.append(_allocator, "Apple") catch unreachable;
// zbr:test/sort_test.zbr:124
        mixed_case.append(_allocator, "apple") catch unreachable;
// zbr:test/sort_test.zbr:125
        mixed_case.append(_allocator, "Banana") catch unreachable;
// zbr:test/sort_test.zbr:126
        _zebra_sort_natural(@TypeOf(mixed_case.items[0]), mixed_case.items);
// zbr:test/sort_test.zbr:127
        for (mixed_case.items) |w| {
// zbr:test/sort_test.zbr:128
            std.debug.print("{s}\n", .{w});
        }
// zbr:test/sort_test.zbr:131
...
// zbr:test/sort_test.zbr:142
        p3.score = 85;
// zbr:test/sort_test.zbr:143
        people2.append(_allocator, p3) catch unreachable;
// zbr:test/sort_test.zbr:144
        _zebra_sort_by(@TypeOf(people2.items[0]), struct { fn call(a: anytype, b: anytype) bool {
// zbr:test/sort_test.zbr:145
            if ((a.score != b.score)) {
// zbr:test/sort_test.zbr:146
                return _zebra_gt(a.score, b.score);
            }
// zbr:test/sort_test.zbr:147
            return _zebra_gt(a.name, b.name);
         } }.call, people2.items);
// zbr:test/sort_test.zbr:149
        for (people2.items) |p| {
// zbr:test/sort_test.zbr:150
            {
                const _pt0 = (std.mem.concat(_allocator, u8, &.{ (std.mem.concat(_allocator, u8, &.{ p.name, ": " }) catch unreachable), (std.fmt.allocPrint(_allocator, "{}", .{p.score}) catch unreachable) }) catch unreachable);
