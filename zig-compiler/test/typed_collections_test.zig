...
// Source: test/typed_collections_test.zbr
...
pub const Program = struct {
    _type_id: u32 = _tid_Program,
    pub fn doubleAll(nums: std.ArrayList(i64)) std.ArrayList(i64) {
// zbr:test/typed_collections_test.zbr:5
        var result = std.ArrayList(i64){};
// zbr:test/typed_collections_test.zbr:6
        for (nums.items) |n| {
// zbr:test/typed_collections_test.zbr:7
            result.append(_allocator, (n * 2)) catch unreachable;
        }
// zbr:test/typed_collections_test.zbr:8
        return result;
    }

    pub fn countWords(words: std.ArrayList([]const u8)) i64 {
// zbr:test/typed_collections_test.zbr:12
        return @as(i64, @intCast(words.items.len));
    }

    pub fn main() void {
// zbr:test/typed_collections_test.zbr:16
        var nums = std.ArrayList(i64){};
        defer nums.deinit(_allocator);
// zbr:test/typed_collections_test.zbr:17
        nums.append(_allocator, 10) catch unreachable;
// zbr:test/typed_collections_test.zbr:18
        nums.append(_allocator, 20) catch unreachable;
// zbr:test/typed_collections_test.zbr:19
        nums.append(_allocator, 30) catch unreachable;
// zbr:test/typed_collections_test.zbr:20
        std.debug.print("{any}\n", .{nums.items.len});
// zbr:test/typed_collections_test.zbr:21
        std.debug.print("{}\n", .{nums.items[@as(usize, @intCast(0))]});
// zbr:test/typed_collections_test.zbr:24
        var doubled: std.ArrayList(i64) = Program.doubleAll(nums);
        defer doubled.deinit(_allocator);
// zbr:test/typed_collections_test.zbr:25
        for (doubled.items) |n| {
// zbr:test/typed_collections_test.zbr:26
            std.debug.print("{}\n", .{n});
        }
// zbr:test/typed_collections_test.zbr:29
        var words = std.ArrayList([]const u8){};
        defer words.deinit(_allocator);
// zbr:test/typed_collections_test.zbr:30
        words.append(_allocator, "alpha") catch unreachable;
// zbr:test/typed_collections_test.zbr:31
        words.append(_allocator, "beta") catch unreachable;
// zbr:test/typed_collections_test.zbr:32
        words.append(_allocator, "gamma") catch unreachable;
// zbr:test/typed_collections_test.zbr:33
        std.debug.print("{}\n", .{Program.countWords(words)});
// zbr:test/typed_collections_test.zbr:36
        var scores = std.StringHashMap(i64).init(_allocator);
        defer scores.deinit();
// zbr:test/typed_collections_test.zbr:37
        scores.put((_allocator.dupe(u8, "alice") catch @panic("OOM")), 95) catch unreachable;
// zbr:test/typed_collections_test.zbr:38
        scores.put((_allocator.dupe(u8, "bob") catch @panic("OOM")), 87) catch unreachable;
// zbr:test/typed_collections_test.zbr:39
        std.debug.print("{}\n", .{scores.contains("alice")});
// zbr:test/typed_collections_test.zbr:40
        std.debug.print("{}\n", .{(scores.get("alice") orelse undefined)});
// zbr:test/typed_collections_test.zbr:41
        std.debug.print("{any}\n", .{scores.count()});
// zbr:test/typed_collections_test.zbr:44
        var codes = std.AutoHashMap(i64, []const u8).init(_allocator);
        defer codes.deinit();
// zbr:test/typed_collections_test.zbr:45
        codes.put(200, "OK") catch unreachable;
// zbr:test/typed_collections_test.zbr:46
        codes.put(404, "Not Found") catch unreachable;
// zbr:test/typed_collections_test.zbr:47
        std.debug.print("{}\n", .{codes.contains(200)});
// zbr:test/typed_collections_test.zbr:48
        std.debug.print("{s}\n", .{(codes.get(200) orelse undefined)});
    }

};

const _tid_Program: u32 = 3290774379;
