...
// Source: test\crossmod_types_lib.zbr
...
// zbr:test\crossmod_types_lib.zbr:7
        self.x = px;
// zbr:test\crossmod_types_lib.zbr:8
        self.y = py;
        return self;
    }

    pub fn distFromOrigin(self: *Point) f64 {
// zbr:test\crossmod_types_lib.zbr:11
        const dx = (self.x * self.x);
// zbr:test\crossmod_types_lib.zbr:12
        const dy = (self.y * self.y);
// zbr:test\crossmod_types_lib.zbr:13
        return std.math.sqrt(@as(f64, (dx + dy)));
    }

    pub fn show(self: *Point) []const u8 {
// zbr:test\crossmod_types_lib.zbr:16
