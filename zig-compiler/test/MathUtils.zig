...
pub const MathUtils = struct {
    _type_tag: u64 = _ttag_MathUtils,
    pub fn double(x: i64) i64 {
// zbr:test/MathUtils.zbr:4
        return (x * 2);
    }

    pub fn square(x: i64) i64 {
// zbr:test/MathUtils.zbr:7
        return (x * x);
    }

    pub fn cube(x: i64) i64 {
// zbr:test/MathUtils.zbr:10
        return ((x * x) * x);
    }

    pub fn max(a: i64, b: i64) i64 {
// zbr:test/MathUtils.zbr:13
        if (_zebra_gt(a, b)) {
// zbr:test/MathUtils.zbr:14
            return a;
        }
// zbr:test/MathUtils.zbr:15
        return b;
    }

    pub fn init() MathUtils {
        var self: MathUtils = undefined;
        self._type_tag = _ttag_MathUtils;
        return self;
    }

};

const _ttag_MathUtils: u64 = 1329086920;
const _reflect_MathUtils_name: []const u8 = "MathUtils";
const _reflect_MathUtils_fields: []const []const u8 = &.{};
const _reflect_MathUtils_field_types: []const []const u8 = &.{};
