...
// Source: test/typechecker_test.zbr
...
pub fn _initAllocator(a: std.mem.Allocator) void {
    ...
    @import("tc_check.zig")._initAllocator(a);
...
const tc_check = @import("tc_check.zig");
const TcStmt = tc_check.TcStmt;
const TcStmtReturn = tc_check.TcStmtReturn;
const TcStmtVarDecl = tc_check.TcStmtVarDecl;
const TcStmtIf = tc_check.TcStmtIf;
const TcStmtAssert = tc_check.TcStmtAssert;
const typechecker = @import("typechecker.zig");
const TypeChecker = typechecker.TypeChecker;
pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/typechecker_test.zbr:14
        const tc = TypeChecker.init();
// zbr:test/typechecker_test.zbr:15
        std.debug.assert((tc.currentDepth() == 1));
// zbr:test/typechecker_test.zbr:16
        std.debug.assert(tc.ok());
// zbr:test/typechecker_test.zbr:17
        tc.enterScope(TcScopeKind.type_);
// zbr:test/typechecker_test.zbr:18
        std.debug.assert((tc.currentDepth() == 2));
// zbr:test/typechecker_test.zbr:19
        tc.leaveScope();
// zbr:test/typechecker_test.zbr:20
        std.debug.assert((tc.currentDepth() == 1));
// zbr:test/typechecker_test.zbr:21
        std.debug.print("{s}\n", .{"1. lifecycle OK"});
// zbr:test/typechecker_test.zbr:24
        std.debug.assert(tc.defineSymbol("PI", TcSymKind.var_, TcType{ .float_ = {} }));
// zbr:test/typechecker_test.zbr:25
        std.debug.assert(tc.hasSymbol("PI"));
// zbr:test/typechecker_test.zbr:26
        std.debug.assert(TcTypes.eql(tc.symbolType("PI"), TcType{ .float_ = {} }));
// zbr:test/typechecker_test.zbr:27
        std.debug.assert((!tc.hasSymbol("undefined_name")));
// zbr:test/typechecker_test.zbr:28
        std.debug.assert(TcTypes.eql(tc.symbolType("undefined_name"), TcType{ .unknown_ = {} }));
// zbr:test/typechecker_test.zbr:30
        std.debug.assert((!tc.defineSymbol("PI", TcSymKind.var_, TcType{ .int_ = {} })));
// zbr:test/typechecker_test.zbr:31
        std.debug.print("{s}\n", .{"2. symbol define/lookup OK"});
// zbr:test/typechecker_test.zbr:34
        const t_text = tc.memberType(TcType{ .http_response = {} }, "text");
// zbr:test/typechecker_test.zbr:35
        std.debug.assert(TcTypes.eql(t_text, TcType{ .string_ = {} }));
// zbr:test/typechecker_test.zbr:36
        const t_csv = tc.staticCallType("Csv", "parse");
// zbr:test/typechecker_test.zbr:37
        std.debug.assert(TcTypes.eql(t_csv, TcType{ .csv_table = {} }));
// zbr:test/typechecker_test.zbr:38
        std.debug.print("{s}\n", .{"3. memberType/staticCallType OK"});
// zbr:test/typechecker_test.zbr:41
        var stmts_ok = std.ArrayList(TcStmt){};
// zbr:test/typechecker_test.zbr:42
        stmts_ok.append(_allocator, TcStmt{ .return_ = TcStmtReturn.init(TcExpr{ .int_lit = {} }) }) catch unreachable;
// zbr:test/typechecker_test.zbr:43
        tc.checkMethod(TcType{ .int_ = {} }, stmts_ok);
// zbr:test/typechecker_test.zbr:44
        if (!(tc.ok())) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/typechecker_test.zbr:45
        std.debug.print("{s}\n", .{"4. checkMethod valid int return OK"});
// zbr:test/typechecker_test.zbr:48
        var stmts_bad = std.ArrayList(TcStmt){};
// zbr:test/typechecker_test.zbr:49
        stmts_bad.append(_allocator, TcStmt{ .return_ = TcStmtReturn.init(TcExpr{ .string_lit = {} }) }) catch unreachable;
// zbr:test/typechecker_test.zbr:50
        tc.checkMethod(TcType{ .int_ = {} }, stmts_bad);
// zbr:test/typechecker_test.zbr:51
        if (!((!tc.ok()))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/typechecker_test.zbr:52
        std.debug.assert((@as(i64, @intCast(tc.errors.items.len)) == 1));
// zbr:test/typechecker_test.zbr:53
        std.debug.print("{s}\n", .{"5. checkMethod type mismatch reported OK"});
// zbr:test/typechecker_test.zbr:55
        tc.clearErrors();
// zbr:test/typechecker_test.zbr:56
        std.debug.assert(tc.ok());
// zbr:test/typechecker_test.zbr:57
        std.debug.print("{s}\n", .{"6. clearErrors OK"});
// zbr:test/typechecker_test.zbr:60
        var stmts_void = std.ArrayList(TcStmt){};
// zbr:test/typechecker_test.zbr:61
        stmts_void.append(_allocator, TcStmt{ .return_void = {} }) catch unreachable;
// zbr:test/typechecker_test.zbr:62
        tc.checkMethod(TcType{ .void_ = {} }, stmts_void);
// zbr:test/typechecker_test.zbr:63
        std.debug.assert(tc.ok());
// zbr:test/typechecker_test.zbr:64
        std.debug.print("{s}\n", .{"7. void method return OK"});
// zbr:test/typechecker_test.zbr:67
        var stmts_if = std.ArrayList(TcStmt){};
// zbr:test/typechecker_test.zbr:68
        stmts_if.append(_allocator, TcStmt{ .if_ = TcStmtIf.init(TcExpr{ .int_lit = {} }) }) catch unreachable;
// zbr:test/typechecker_test.zbr:69
        tc.checkMethod(TcType{ .void_ = {} }, stmts_if);
// zbr:test/typechecker_test.zbr:70
        std.debug.assert((!tc.ok()));
// zbr:test/typechecker_test.zbr:71
        std.debug.assert((@as(i64, @intCast(tc.errors.items.len)) == 1));
// zbr:test/typechecker_test.zbr:72
        tc.clearErrors();
// zbr:test/typechecker_test.zbr:73
        std.debug.print("{s}\n", .{"8. if non-bool condition reported OK"});
// zbr:test/typechecker_test.zbr:76
        var stmts_assert = std.ArrayList(TcStmt){};
// zbr:test/typechecker_test.zbr:77
        const bi_cmp = TcExprBinary.init("==", TcExpr{ .float_lit = {} }, TcExpr{ .float_lit = {} });
// zbr:test/typechecker_test.zbr:78
        stmts_assert.append(_allocator, TcStmt{ .assert_ = TcStmtAssert.init(TcExpr{ .binary = _box_2c4c3891e60: { const _bp_2c4c3891e60 = _allocator.create(tc_infer.TcExprBinary) catch @panic("OOM"); _bp_2c4c3891e60.* = bi_cmp; break :_box_2c4c3891e60 _bp_2c4c3891e60; } }) }) catch unreachable;
// zbr:test/typechecker_test.zbr:79
        tc.checkMethod(TcType{ .void_ = {} }, stmts_assert);
// zbr:test/typechecker_test.zbr:80
        std.debug.assert(tc.ok());
// zbr:test/typechecker_test.zbr:81
        std.debug.print("{s}\n", .{"9. assert with bool cond OK"});
// zbr:test/typechecker_test.zbr:84
        var stmts_multi = std.ArrayList(TcStmt){};
// zbr:test/typechecker_test.zbr:85
        stmts_multi.append(_allocator, TcStmt{ .var_decl = TcStmtVarDecl.init("a", TcType{ .int_ = {} }, TcExpr{ .string_lit = {} }) }) catch unreachable;
// zbr:test/typechecker_test.zbr:86
        stmts_multi.append(_allocator, TcStmt{ .var_decl = TcStmtVarDecl.init("b", TcType{ .bool_ = {} }, TcExpr{ .float_lit = {} }) }) catch unreachable;
// zbr:test/typechecker_test.zbr:87
        stmts_multi.append(_allocator, TcStmt{ .pass_ = {} }) catch unreachable;
// zbr:test/typechecker_test.zbr:88
        tc.checkMethod(TcType{ .void_ = {} }, stmts_multi);
// zbr:test/typechecker_test.zbr:89
        std.debug.assert((@as(i64, @intCast(tc.errors.items.len)) == 2));
// zbr:test/typechecker_test.zbr:90
        tc.clearErrors();
// zbr:test/typechecker_test.zbr:91
        std.debug.print("{s}\n", .{"10. multiple errors in checkMethod OK"});
// zbr:test/typechecker_test.zbr:94
        std.debug.assert(std.mem.eql(u8, tc.typeName(TcType{ .string_ = {} }), "String"));
// zbr:test/typechecker_test.zbr:95
        std.debug.assert(std.mem.eql(u8, tc.typeName(TcType{ .optional = _box_2c4c3893a28: { const _bp_2c4c3893a28 = _allocator.create(tc_types.TcType) catch @panic("OOM"); _bp_2c4c3893a28.* = TcType{ .int_ = {} }; break :_box_2c4c3893a28 _bp_2c4c3893a28; } }), "?int"));
// zbr:test/typechecker_test.zbr:96
        std.debug.assert(tc.isNumeric(TcType{ .int_ = {} }));
// zbr:test/typechecker_test.zbr:97
        std.debug.assert((!tc.isNumeric(TcType{ .bool_ = {} })));
// zbr:test/typechecker_test.zbr:98
        std.debug.assert(tc.isAssignable(TcType{ .int_ = {} }, TcType{ .float_ = {} }));
// zbr:test/typechecker_test.zbr:99
        std.debug.assert((!tc.isAssignable(TcType{ .bool_ = {} }, TcType{ .string_ = {} })));
// zbr:test/typechecker_test.zbr:100
        std.debug.print("{s}\n", .{"11. type query helpers OK"});
// zbr:test/typechecker_test.zbr:103
        tc.enterScope(TcScopeKind.type_);
// zbr:test/typechecker_test.zbr:104
        std.debug.assert(tc.defineSymbol("count", TcSymKind.var_, TcType{ .int_ = {} }));
// zbr:test/typechecker_test.zbr:106
        var stmts_inner = std.ArrayList(TcStmt){};
// zbr:test/typechecker_test.zbr:107
        stmts_inner.append(_allocator, TcStmt{ .return_ = TcStmtReturn.init(TcExpr{ .int_lit = {} }) }) catch unreachable;
// zbr:test/typechecker_test.zbr:108
        tc.checkMethod(TcType{ .int_ = {} }, stmts_inner);
// zbr:test/typechecker_test.zbr:109
        std.debug.assert(tc.ok());
// zbr:test/typechecker_test.zbr:110
        tc.leaveScope();
// zbr:test/typechecker_test.zbr:111
        std.debug.print("{s}\n", .{"12. nested scope checkMethod OK"});
// zbr:test/typechecker_test.zbr:113
        std.debug.print("{s}\n", .{"typechecker_test: all OK"});
    }
...
pub fn main() void {
    ...
    @import("tc_check.zig")._initAllocator(_allocator);
