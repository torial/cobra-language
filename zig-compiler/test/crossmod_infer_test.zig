...
// Source: test/crossmod_infer_test.zbr
...
pub const App = struct {
    ...
    pub fn testTypeInference() void {
// zbr:test/crossmod_infer_test.zbr:9
        const d = MathUtils.double(7);
// zbr:test/crossmod_infer_test.zbr:10
        const s = MathUtils.square(4);
// zbr:test/crossmod_infer_test.zbr:11
        std.debug.print("{}\n", .{d});
// zbr:test/crossmod_infer_test.zbr:12
        std.debug.print("{}\n", .{s});
    }

    pub fn testInferenceWithOperations() void {
// zbr:test/crossmod_infer_test.zbr:15
        const x = MathUtils.double(3);
// zbr:test/crossmod_infer_test.zbr:16
        const y = MathUtils.cube(2);
// zbr:test/crossmod_infer_test.zbr:17
        const z = (x + y);
// zbr:test/crossmod_infer_test.zbr:18
        std.debug.print("{}\n", .{z});
    }

    pub fn testChainedInference() void {
// zbr:test/crossmod_infer_test.zbr:21
        const result = MathUtils.square(MathUtils.double(5));
// zbr:test/crossmod_infer_test.zbr:22
        std.debug.print("{}\n", .{result});
    }

    pub fn main() void {
// zbr:test/crossmod_infer_test.zbr:25
        App.testTypeInference();
// zbr:test/crossmod_infer_test.zbr:26
        App.testInferenceWithOperations();
// zbr:test/crossmod_infer_test.zbr:27
        App.testChainedInference();
    }
...
pub fn main() void {
    ...
    defer _arena.deinit();
    @import("MathUtils.zig")._initAllocator(_allocator);
    App.main();
}
