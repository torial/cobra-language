...
// Source: test/struct_destruct_test.zbr
...
const _reflect_Point_fields: []const []const u8 = &.{"x", "y", "z"};
const _reflect_Point_field_types: []const []const u8 = &.{"int", "int", "int"};
...
const _reflect_Person_fields: []const []const u8 = &.{"name", "age"};
const _reflect_Person_field_types: []const []const u8 = &.{"str", "int"};

pub const Program = struct {
    pub fn main() void {
// zbr:test/struct_destruct_test.zbr:14
        var p = Point{};
// zbr:test/struct_destruct_test.zbr:15
        p.x = 10;
// zbr:test/struct_destruct_test.zbr:16
        p.y = 20;
// zbr:test/struct_destruct_test.zbr:17
        const _dt_2c0 = p;
        const x = _dt_2c0.x;
        const y = _dt_2c0.y;
// zbr:test/struct_destruct_test.zbr:18
        std.debug.print("{}\n", .{x});
// zbr:test/struct_destruct_test.zbr:19
        std.debug.print("{}\n", .{y});
// zbr:test/struct_destruct_test.zbr:22
        var alice = Person{};
// zbr:test/struct_destruct_test.zbr:23
        alice.name = "Alice";
// zbr:test/struct_destruct_test.zbr:24
        alice.age = 30;
// zbr:test/struct_destruct_test.zbr:25
        const _dt_780 = alice;
        const name = _dt_780.name;
        const age = _dt_780.age;
// zbr:test/struct_destruct_test.zbr:26
        std.debug.print("{s}\n", .{name});
// zbr:test/struct_destruct_test.zbr:27
        std.debug.print("{}\n", .{age});
// zbr:test/struct_destruct_test.zbr:30
        var p2 = Point{};
// zbr:test/struct_destruct_test.zbr:31
        p2.z = 99;
// zbr:test/struct_destruct_test.zbr:32
        const _dt_5270 = p2;
        const z = _dt_5270.z;
// zbr:test/struct_destruct_test.zbr:33
        std.debug.print("{}\n", .{z});
    }
