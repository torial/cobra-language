...
// Source: test/nil_tracking_test.zbr
...
pub const Main = struct {
    pub fn main() void {
// zbr:test/nil_tracking_test.zbr:5
        const name: ?[]const u8 = "Alice";
// zbr:test/nil_tracking_test.zbr:6
        if ((name != null)) {
// zbr:test/nil_tracking_test.zbr:7
            std.debug.print("{s}\n", .{name.?});
        }
// zbr:test/nil_tracking_test.zbr:10
        const empty: ?[]const u8 = null;
// zbr:test/nil_tracking_test.zbr:11
        if ((empty != null)) {
// zbr:test/nil_tracking_test.zbr:12
            std.debug.print("{s}\n", .{empty.?});
        } else {
// zbr:test/nil_tracking_test.zbr:14
            std.debug.print("{s}\n", .{"got nil"});
        }
// zbr:test/nil_tracking_test.zbr:17
        const val: ?[]const u8 = "hello";
// zbr:test/nil_tracking_test.zbr:18
        if ((val == null)) {
// zbr:test/nil_tracking_test.zbr:19
            std.debug.print("{s}\n", .{"nil"});
        } else {
// zbr:test/nil_tracking_test.zbr:21
            std.debug.print("{s}\n", .{val.?});
        }
// zbr:test/nil_tracking_test.zbr:24
        const n: ?i64 = 42;
// zbr:test/nil_tracking_test.zbr:25
        if ((n != null)) {
// zbr:test/nil_tracking_test.zbr:26
            std.debug.print("{}\n", .{n.?});
        }
    }
