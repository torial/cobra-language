...
pub const LogTest = struct {
    _type_tag: u64 = _ttag_LogTest,
    pub fn main() void {
// zbr:test/log_test.zbr:4
        _log_timestamp(false);
// zbr:test/log_test.zbr:6
        _log_info("starting test");
// zbr:test/log_test.zbr:7
        _log_warn("this is a warning");
// zbr:test/log_test.zbr:8
        _log_err("this is an error");
// zbr:test/log_test.zbr:11
        _log_debug("this should NOT appear");
// zbr:test/log_test.zbr:14
        _log_set_level(0);
// zbr:test/log_test.zbr:15
        _log_debug("debug now visible");
// zbr:test/log_test.zbr:18
        _log_set_level(3);
// zbr:test/log_test.zbr:19
        _log_info("this info should NOT appear");
// zbr:test/log_test.zbr:20
        _log_warn("this warn should NOT appear");
// zbr:test/log_test.zbr:21
        _log_err("only error visible");
// zbr:test/log_test.zbr:24
        _log_set_output_stderr(false);
// zbr:test/log_test.zbr:25
        _log_set_level(1);
// zbr:test/log_test.zbr:26
        _log_info("writing to stdout now");
// zbr:test/log_test.zbr:27
        _log_set_output_stderr(true);
// zbr:test/log_test.zbr:29
        std.debug.print("{s}\n", .{"All log tests passed."});
    }

    pub fn init() LogTest {
        var self: LogTest = undefined;
        self._type_tag = _ttag_LogTest;
        return self;
    }

};

const _ttag_LogTest: u64 = 1514647273;
const _reflect_LogTest_name: []const u8 = "LogTest";
const _reflect_LogTest_fields: []const []const u8 = &.{};
const _reflect_LogTest_field_types: []const []const u8 = &.{};
