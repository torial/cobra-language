...
// Source: test/escape_field_test.zbr
...
// zbr:test/escape_field_test.zbr:12
        var c = Container.init();
// zbr:test/escape_field_test.zbr:13
        var items = std.ArrayList([]const u8){};
// zbr:test/escape_field_test.zbr:14
        items.append(_allocator, "alpha") catch unreachable;
// zbr:test/escape_field_test.zbr:15
        items.append(_allocator, "beta") catch unreachable;
// zbr:test/escape_field_test.zbr:16
        c.items = items;
// zbr:test/escape_field_test.zbr:17
        c.label = label;
// zbr:test/escape_field_test.zbr:18
        return c;
    }
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/escape_field_test.zbr:23
        const c = Builder.build("test");
// zbr:test/escape_field_test.zbr:24
