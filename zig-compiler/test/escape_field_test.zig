...
// Source: C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr
...
pub const Container = struct {
    _type_tag: u64 = _ttag_Container,
    items: std.ArrayList([]const u8) = undefined,
    label: []const u8 = undefined,
    pub fn init() Container {
        var self: Container = undefined;
        self._type_tag = _ttag_Container;
        return self;
    }

};

const _ttag_Container: u64 = 2990360344;
const _reflect_Container_name: []const u8 = "Container";
const _reflect_Container_fields: []const []const u8 = &.{"items", "label"};
const _reflect_Container_field_types: []const []const u8 = &.{"List(str)", "str"};

pub const Builder = struct {
    _type_tag: u64 = _ttag_Builder,
    pub fn build(label: []const u8) Container {
// zbr:C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr:12
        var c = Container.init();
// zbr:C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr:13
        var items = std.ArrayList([]const u8){};
// zbr:C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr:14
        items.append(_allocator, "alpha") catch unreachable;
// zbr:C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr:15
        items.append(_allocator, "beta") catch unreachable;
// zbr:C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr:16
        c.items = items;
// zbr:C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr:17
        c.label = label;
// zbr:C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr:18
        return c;
    }

    pub fn init() Builder {
        var self: Builder = undefined;
        self._type_tag = _ttag_Builder;
        return self;
    }

};

const _ttag_Builder: u64 = 1792399840;
const _reflect_Builder_name: []const u8 = "Builder";
const _reflect_Builder_fields: []const []const u8 = &.{};
const _reflect_Builder_field_types: []const []const u8 = &.{};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr:23
        const c = Builder.build("test");
// zbr:C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr:24
        if (!((@as(i64, @intCast(c.items.items.len)) == 2))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr:25
        std.debug.print("{s}\n", .{c.items.items[@as(usize, @intCast(0))]});
// zbr:C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr:26
        std.debug.print("{s}\n", .{c.label});
// zbr:C:/projects/cobra-language/zig-compiler/test/escape_field_test.zbr:27
        std.debug.print("{s}\n", .{"escape_field_test: all assertions passed"});
    }
