...
// Source: C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:5
        const word: []const u8 = "abc";
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:6
        var chars_list = std.ArrayList([]const u8){};
        defer chars_list.deinit(_allocator);
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:7
        var _cp_it_2748 = std.unicode.Utf8View.initUnchecked(word).iterator();
        while (_cp_it_2748.nextCodepoint()) |c| {
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:8
            chars_list.append(_allocator, (blk: { var _cpbuf: [4]u8 = undefined; const _cplen = std.unicode.utf8Encode(c, &_cpbuf) catch 1; const _cpout = _allocator.dupe(u8, _cpbuf[0.._cplen]) catch @panic("OOM"); break :blk @as([]const u8, _cpout); })) catch unreachable;
        }
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:9
        for (chars_list.items) |s| {
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:10
            std.debug.print("{s}\n", .{s});
        }
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:13
        const greek: []const u8 = "λόγος";
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:14
        var gchars = std.ArrayList([]const u8){};
        defer gchars.deinit(_allocator);
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:15
        var _cp_it_570 = std.unicode.Utf8View.initUnchecked(greek).iterator();
        while (_cp_it_570.nextCodepoint()) |c| {
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:16
            gchars.append(_allocator, (blk: { var _cpbuf: [4]u8 = undefined; const _cplen = std.unicode.utf8Encode(c, &_cpbuf) catch 1; const _cpout = _allocator.dupe(u8, _cpbuf[0.._cplen]) catch @panic("OOM"); break :blk @as([]const u8, _cpout); })) catch unreachable;
        }
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:17
        std.debug.print("{}\n", .{@as(i64, @intCast(gchars.items.len))});
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:20
        var i: i64 = 0;
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:21
        while (_zebra_lt(i, @as(i64, @intCast(chars_list.items.len)))) {
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:22
            std.debug.print("{s}\n", .{chars_list.items[@as(usize, @intCast(i))]});
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:23
            i = (i + 1);
        }
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:26
        const n = @as(i64, @intCast(std.unicode.utf8CountCodepoints(word) catch 0));
// zbr:C:/projects/cobra-language/zig-compiler/test/char_tostring_test.zbr:27
        std.debug.print("{}\n", .{(n - 2)});
    }
