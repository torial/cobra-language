...
// Source: test/char_tostring_test.zbr
...
// zbr:test/char_tostring_test.zbr:17
        std.debug.print("{}\n", .{@as(i64, @intCast(gchars.items.len))});
// zbr:test/char_tostring_test.zbr:20
        var i: i64 = 0;
// zbr:test/char_tostring_test.zbr:21
        while (_zebra_lt(i, @as(i64, @intCast(chars_list.items.len)))) {
// zbr:test/char_tostring_test.zbr:22
            std.debug.print("{s}\n", .{chars_list.items[@as(usize, @intCast(i))]});
// zbr:test/char_tostring_test.zbr:23
            i = (i + 1);
        }
// zbr:test/char_tostring_test.zbr:26
        const n = @as(i64, @intCast(std.unicode.utf8CountCodepoints(word) catch 0));
// zbr:test/char_tostring_test.zbr:27
        std.debug.print("{}\n", .{(n - 2)});
    }
