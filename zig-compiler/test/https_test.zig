...
pub const Main = struct {
    pub fn main() void {
// zbr:test/https_test.zbr:5
        const r = _http_get("https://httpbin.org/get");
// zbr:test/https_test.zbr:6
        if ((r != null)) {
// zbr:test/https_test.zbr:7
            std.debug.print("{}\n", .{r.?.status});
// zbr:test/https_test.zbr:8
            std.debug.print("{}\n", .{_zebra_gt(r.?.text.len, 0)});
        }
// zbr:test/https_test.zbr:9
        if ((r == null)) {
// zbr:test/https_test.zbr:10
            std.debug.print("{s}\n", .{"HTTPS failed"});
        }
    }
