...
// Source: test/generic_pair_test.zbr
...
// zbr:test/generic_pair_test.zbr:6
            self.first = a;
// zbr:test/generic_pair_test.zbr:7
            self.second = b;
            return self;
        }

        pub fn swap(self: *@This()) Pair(B, A) {
// zbr:test/generic_pair_test.zbr:10
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/generic_pair_test.zbr:15
        const p = Pair([]const u8, i64).init("hello", 42);
// zbr:test/generic_pair_test.zbr:16
        std.debug.print("{}\n", .{p.second});
// zbr:test/generic_pair_test.zbr:18
        const q = Pair(i64, bool).init(100, true);
// zbr:test/generic_pair_test.zbr:19
        std.debug.print("{}\n", .{q.first});
// zbr:test/generic_pair_test.zbr:20
        std.debug.print("{}\n", .{q.second});
// zbr:test/generic_pair_test.zbr:22
        var r = Pair(i64, []const u8).init(1, "one");
// zbr:test/generic_pair_test.zbr:23
        std.debug.print("{}\n", .{r.first});
// zbr:test/generic_pair_test.zbr:26
        const s = r.swap();
// zbr:test/generic_pair_test.zbr:27
        std.debug.print("{any}\n", .{s.second});
    }
