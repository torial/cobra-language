...
const TcSymRef = tc_types.TcSymRef;
const TcSymbolKind = tc_types.TcSymbolKind;
const TcGenericRef = tc_types.TcGenericRef;
const TcCrossRef = tc_types.TcCrossRef;
pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/tc_types_test.zbr:10
        std.debug.assert(TcTypes.eql(TcType{ .int_ = {} }, TcType{ .int_ = {} }));
// zbr:test/tc_types_test.zbr:11
        std.debug.assert((!TcTypes.eql(TcType{ .int_ = {} }, TcType{ .string_ = {} })));
// zbr:test/tc_types_test.zbr:12
        std.debug.assert(TcTypes.eql(TcType{ .string_ = {} }, TcType{ .string_ = {} }));
// zbr:test/tc_types_test.zbr:13
        std.debug.assert((!TcTypes.eql(TcType{ .int_ = {} }, TcType{ .string_ = {} })));
// zbr:test/tc_types_test.zbr:14
        std.debug.assert(TcTypes.eql(TcType{ .unknown_ = {} }, TcType{ .unknown_ = {} }));
// zbr:test/tc_types_test.zbr:15
        std.debug.assert((!TcTypes.eql(TcType{ .int_ = {} }, TcType{ .unknown_ = {} })));
// zbr:test/tc_types_test.zbr:16
        std.debug.assert(TcTypes.eql(TcType{ .bool_ = {} }, TcType{ .bool_ = {} }));
// zbr:test/tc_types_test.zbr:17
        std.debug.assert(TcTypes.eql(TcType{ .void_ = {} }, TcType{ .void_ = {} }));
// zbr:test/tc_types_test.zbr:18
        std.debug.print("{s}\n", .{"1. unit primitive eql OK"});
// zbr:test/tc_types_test.zbr:21
        std.debug.assert(TcTypes.eql(TcType{ .int_n = 32 }, TcType{ .int_n = 32 }));
// zbr:test/tc_types_test.zbr:22
        std.debug.assert((!TcTypes.eql(TcType{ .int_n = 32 }, TcType{ .int_n = 64 })));
// zbr:test/tc_types_test.zbr:23
        std.debug.assert((!TcTypes.eql(TcType{ .int_n = 32 }, TcType{ .uint_n = 32 })));
// zbr:test/tc_types_test.zbr:24
        std.debug.assert(TcTypes.eql(TcType{ .float_n = 64 }, TcType{ .float_n = 64 }));
// zbr:test/tc_types_test.zbr:25
        std.debug.print("{s}\n", .{"2. sized numeric eql OK"});
// zbr:test/tc_types_test.zbr:28
        const sym_int = TcSymRef.init("MyInt", TcSymbolKind.class_);
// zbr:test/tc_types_test.zbr:29
        const sym_int2 = TcSymRef.init("MyInt", TcSymbolKind.class_);
// zbr:test/tc_types_test.zbr:30
        const sym_str = TcSymRef.init("MyStr", TcSymbolKind.class_);
// zbr:test/tc_types_test.zbr:31
        const sym_uni = TcSymRef.init("MyUnion", TcSymbolKind.union_);
// zbr:test/tc_types_test.zbr:32
        std.debug.assert(TcTypes.eql(TcType{ .named = sym_int }, TcType{ .named = sym_int2 }));
// zbr:test/tc_types_test.zbr:33
        std.debug.assert((!TcTypes.eql(TcType{ .named = sym_int }, TcType{ .named = sym_str })));
// zbr:test/tc_types_test.zbr:34
        std.debug.assert((!TcTypes.eql(TcType{ .named = sym_int }, TcType{ .named = sym_uni })));
...
// zbr:test/tc_types_test.zbr:42
        std.debug.assert((!TcTypes.eql(opt_int, opt_str)));
...
// zbr:test/tc_types_test.zbr:48
        std.debug.print("{s}\n", .{"4. optional eql OK"});
// zbr:test/tc_types_test.zbr:51
        var ta = std.ArrayList(TcType){};
// zbr:test/tc_types_test.zbr:52
        ta.append(_allocator, TcType{ .int_ = {} }) catch unreachable;
// zbr:test/tc_types_test.zbr:53
        ta.append(_allocator, TcType{ .string_ = {} }) catch unreachable;
// zbr:test/tc_types_test.zbr:54
        var tb = std.ArrayList(TcType){};
// zbr:test/tc_types_test.zbr:55
        tb.append(_allocator, TcType{ .int_ = {} }) catch unreachable;
// zbr:test/tc_types_test.zbr:56
        tb.append(_allocator, TcType{ .string_ = {} }) catch unreachable;
// zbr:test/tc_types_test.zbr:57
        var tc = std.ArrayList(TcType){};
// zbr:test/tc_types_test.zbr:58
        tc.append(_allocator, TcType{ .int_ = {} }) catch unreachable;
// zbr:test/tc_types_test.zbr:59
        tc.append(_allocator, TcType{ .int_ = {} }) catch unreachable;
// zbr:test/tc_types_test.zbr:60
        std.debug.assert(TcTypes.eql(TcType{ .tuple = ta }, TcType{ .tuple = tb }));
// zbr:test/tc_types_test.zbr:61
        std.debug.assert((!TcTypes.eql(TcType{ .tuple = ta }, TcType{ .tuple = tc })));
// zbr:test/tc_types_test.zbr:62
        std.debug.print("{s}\n", .{"5. tuple eql OK"});
// zbr:test/tc_types_test.zbr:65
        const ca = TcCrossRef.init("Ast", "Expr");
// zbr:test/tc_types_test.zbr:66
        const cb = TcCrossRef.init("Ast", "Expr");
// zbr:test/tc_types_test.zbr:67
        const cc = TcCrossRef.init("Ast", "Stmt");
// zbr:test/tc_types_test.zbr:68
        std.debug.assert(TcTypes.eql(TcType{ .cross_module = ca }, TcType{ .cross_module = cb }));
// zbr:test/tc_types_test.zbr:69
        std.debug.assert((!TcTypes.eql(TcType{ .cross_module = ca }, TcType{ .cross_module = cc })));
// zbr:test/tc_types_test.zbr:70
        std.debug.print("{s}\n", .{"6. cross_module eql OK"});
// zbr:test/tc_types_test.zbr:73
        std.debug.assert(TcTypes.isIntFamily(TcType{ .int_ = {} }));
// zbr:test/tc_types_test.zbr:74
        std.debug.assert(TcTypes.isIntFamily(TcType{ .int_n = 32 }));
// zbr:test/tc_types_test.zbr:75
        std.debug.assert((!TcTypes.isIntFamily(TcType{ .uint_ = {} })));
// zbr:test/tc_types_test.zbr:76
        std.debug.assert(TcTypes.isUintFamily(TcType{ .uint_ = {} }));
// zbr:test/tc_types_test.zbr:77
        std.debug.assert(TcTypes.isUintFamily(TcType{ .uint_n = 8 }));
// zbr:test/tc_types_test.zbr:78
        std.debug.assert((!TcTypes.isUintFamily(TcType{ .int_ = {} })));
// zbr:test/tc_types_test.zbr:79
        std.debug.assert(TcTypes.isFloatFamily(TcType{ .float_ = {} }));
// zbr:test/tc_types_test.zbr:80
        std.debug.assert(TcTypes.isFloatFamily(TcType{ .float_n = 32 }));
// zbr:test/tc_types_test.zbr:81
        std.debug.assert((!TcTypes.isFloatFamily(TcType{ .int_ = {} })));
// zbr:test/tc_types_test.zbr:82
        std.debug.assert(TcTypes.isNumeric(TcType{ .int_ = {} }));
// zbr:test/tc_types_test.zbr:83
        std.debug.assert(TcTypes.isNumeric(TcType{ .uint_n = 64 }));
// zbr:test/tc_types_test.zbr:84
        std.debug.assert(TcTypes.isNumeric(TcType{ .float_ = {} }));
// zbr:test/tc_types_test.zbr:85
        std.debug.assert((!TcTypes.isNumeric(TcType{ .bool_ = {} })));
// zbr:test/tc_types_test.zbr:86
        std.debug.assert((!TcTypes.isNumeric(TcType{ .string_ = {} })));
// zbr:test/tc_types_test.zbr:87
        std.debug.print("{s}\n", .{"7. numeric predicates OK"});
// zbr:test/tc_types_test.zbr:90
        std.debug.assert(TcTypes.isAssignable(TcType{ .int_ = {} }, TcType{ .unknown_ = {} }));
// zbr:test/tc_types_test.zbr:91
        std.debug.assert(TcTypes.isAssignable(TcType{ .unknown_ = {} }, TcType{ .int_ = {} }));
// zbr:test/tc_types_test.zbr:92
        std.debug.assert(TcTypes.isAssignable(TcType{ .int_ = {} }, TcType{ .float_ = {} }));
// zbr:test/tc_types_test.zbr:93
        std.debug.assert(TcTypes.isAssignable(TcType{ .int_n = 32 }, TcType{ .int_n = 64 }));
// zbr:test/tc_types_test.zbr:94
        std.debug.assert(TcTypes.isAssignable(TcType{ .bool_ = {} }, TcType{ .bool_ = {} }));
...
// zbr:test/tc_types_test.zbr:105
        std.debug.assert(TcTypes.isAssignable(TcType{ .fn_ref = "foo" }, TcType{ .fn_ref = "bar" }));
// zbr:test/tc_types_test.zbr:106
        std.debug.assert(TcTypes.isAssignable(TcType{ .fn_sig = "A" }, TcType{ .fn_sig = "B" }));
// zbr:test/tc_types_test.zbr:107
        std.debug.print("{s}\n", .{"8. isAssignable OK"});
// zbr:test/tc_types_test.zbr:110
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .int_ = {} }), "int"));
// zbr:test/tc_types_test.zbr:111
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .string_ = {} }), "String"));
// zbr:test/tc_types_test.zbr:112
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .void_ = {} }), "void"));
...
// zbr:test/tc_types_test.zbr:117
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .named = sym_point }), "Point"));
// zbr:test/tc_types_test.zbr:118
        const cross = TcCrossRef.init("Ast", "DeclMethod");
// zbr:test/tc_types_test.zbr:119
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .cross_module = cross }), "DeclMethod"));
// zbr:test/tc_types_test.zbr:120
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .fn_ref = "myFn" }), "myFn"));
// zbr:test/tc_types_test.zbr:121
        std.debug.assert(std.mem.eql(u8, TcTypes.typeName(TcType{ .regex = {} }), "Regex"));
// zbr:test/tc_types_test.zbr:122
        std.debug.print("{s}\n", .{"9. typeName OK"});
// zbr:test/tc_types_test.zbr:125
        var ga_args = std.ArrayList(TcType){};
// zbr:test/tc_types_test.zbr:126
        ga_args.append(_allocator, TcType{ .int_ = {} }) catch unreachable;
// zbr:test/tc_types_test.zbr:127
        var gb_args = std.ArrayList(TcType){};
// zbr:test/tc_types_test.zbr:128
        gb_args.append(_allocator, TcType{ .int_ = {} }) catch unreachable;
// zbr:test/tc_types_test.zbr:129
        var gc_args = std.ArrayList(TcType){};
// zbr:test/tc_types_test.zbr:130
        gc_args.append(_allocator, TcType{ .string_ = {} }) catch unreachable;
// zbr:test/tc_types_test.zbr:131
        const ga = TcGenericRef.init("Stack", TcSymbolKind.class_, ga_args);
// zbr:test/tc_types_test.zbr:132
        const gb = TcGenericRef.init("Stack", TcSymbolKind.class_, gb_args);
// zbr:test/tc_types_test.zbr:133
        const gc = TcGenericRef.init("Stack", TcSymbolKind.class_, gc_args);
// zbr:test/tc_types_test.zbr:134
        const gd = TcGenericRef.init("Queue", TcSymbolKind.class_, ga_args);
// zbr:test/tc_types_test.zbr:135
        std.debug.assert(TcTypes.eql(TcType{ .generic_named = ga }, TcType{ .generic_named = gb }));
// zbr:test/tc_types_test.zbr:136
        std.debug.assert((!TcTypes.eql(TcType{ .generic_named = ga }, TcType{ .generic_named = gc })));
// zbr:test/tc_types_test.zbr:137
        std.debug.assert((!TcTypes.eql(TcType{ .generic_named = ga }, TcType{ .generic_named = gd })));
// zbr:test/tc_types_test.zbr:138
        std.debug.print("{s}\n", .{"10. generic_named eql OK"});
// zbr:test/tc_types_test.zbr:140
