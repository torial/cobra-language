...
pub const Main = struct {
    pub fn main() void {
// zbr:test/http_test.zbr:5
        const response = _http_get("http://httpbin.org/get");
// zbr:test/http_test.zbr:6
        if ((response != null)) {
// zbr:test/http_test.zbr:7
            std.debug.print("{}\n", .{response.?.status});
// zbr:test/http_test.zbr:8
            std.debug.print("{}\n", .{response.?.text.len});
        }
// zbr:test/http_test.zbr:11
        const r2 = _http_post("http://httpbin.org/post", "hello=world");
// zbr:test/http_test.zbr:12
        if ((r2 != null)) {
// zbr:test/http_test.zbr:13
            std.debug.print("{}\n", .{r2.?.status});
        }
    }
