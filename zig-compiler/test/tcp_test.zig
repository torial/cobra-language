...
pub const Main = struct {
    pub fn main() void {
// zbr:test/tcp_test.zbr:5
        const conn = _tcp_connect("httpbin.org", 80);
// zbr:test/tcp_test.zbr:6
        if ((conn != null)) {
// zbr:test/tcp_test.zbr:7
            _tcp_write(conn.?, "GET /get HTTP/1.0\r\nHost: httpbin.org\r\n\r\n");
// zbr:test/tcp_test.zbr:8
            const data: []const u8 = _tcp_read(conn.?);
// zbr:test/tcp_test.zbr:9
            _tcp_close(conn.?);
// zbr:test/tcp_test.zbr:10
            std.debug.print("{}\n", .{data.len});
// zbr:test/tcp_test.zbr:11
            std.debug.print("{}\n", .{std.mem.startsWith(u8, data, "HTTP/1")});
        }
    }
