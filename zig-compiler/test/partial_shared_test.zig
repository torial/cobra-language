...
// Source: test/partial_shared_test.zbr
...
pub const PartialSharedTest = struct {
    _type_tag: u64 = _ttag_PartialSharedTest,
    pub fn greet(name: []const u8) []const u8 {
// zbr:test/partial_shared_test.zbr:6
        return _str_concat("Hello, ", name, _allocator);
    }

    pub fn describe() []const u8 {
// zbr:test/partial_shared_test.zbr:7
        return "PartialSharedTest v1";
    }

    pub fn init() PartialSharedTest {
        var self: PartialSharedTest = undefined;
        self._type_tag = _ttag_PartialSharedTest;
        return self;
    }

};

const _ttag_PartialSharedTest: u64 = 461804187;
const _reflect_PartialSharedTest_name: []const u8 = "PartialSharedTest";
const _reflect_PartialSharedTest_fields: []const []const u8 = &.{};
const _reflect_PartialSharedTest_field_types: []const []const u8 = &.{};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/partial_shared_test.zbr:11
        const msg = PartialSharedTest.greet("world");
// zbr:test/partial_shared_test.zbr:12
        std.debug.print("{s}\n", .{msg});
// zbr:test/partial_shared_test.zbr:13
        const desc = PartialSharedTest.describe();
// zbr:test/partial_shared_test.zbr:14
        std.debug.print("{s}\n", .{desc});
// zbr:test/partial_shared_test.zbr:15
        std.debug.print("{s}\n", .{"partial_shared_test: done"});
    }
