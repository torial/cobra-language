...
// Source: test/expressiveness_test.zbr
...
pub const Greeter = struct {
    _type_tag: u64 = _ttag_Greeter,
    pub fn greet(self: *Greeter, name: []const u8, greeting: []const u8) void {
        _ = self;
// zbr:test/expressiveness_test.zbr:3
        std.debug.print("{s}\n", .{_str_concat(_str_concat(_str_concat(greeting, ", ", _allocator), name, _allocator), "!", _allocator)});
    }

    pub fn check(self: *Greeter, value: i64, lo: i64, hi: i64) bool {
        _ = self;
// zbr:test/expressiveness_test.zbr:6
        return (_zebra_ge(value, lo) and _zebra_le(value, hi));
    }

    pub fn init() Greeter {
        var self: Greeter = undefined;
        self._type_tag = _ttag_Greeter;
        return self;
    }

};

const _ttag_Greeter: u64 = 3972884157;
...
// zbr:test/expressiveness_test.zbr:11
        var g: Greeter = Greeter.init();
// zbr:test/expressiveness_test.zbr:14
        g.greet("Alice", "Hello");
// zbr:test/expressiveness_test.zbr:15
        g.greet("Bob", "Hey");
// zbr:test/expressiveness_test.zbr:16
        g.greet("Carol", "Hi");
// zbr:test/expressiveness_test.zbr:19
        const ok = g.check(5, 1, 10);
// zbr:test/expressiveness_test.zbr:20
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "{}", .{ok}) catch unreachable);
            defer _allocator.free(_pt0);
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:test/expressiveness_test.zbr:23
        const s = "hello world";
// zbr:test/expressiveness_test.zbr:24
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "{}", .{_zebra_in("world", s)}) catch unreachable);
            defer _allocator.free(_pt0);
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:test/expressiveness_test.zbr:25
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "{}", .{_zebra_in("xyz", s)}) catch unreachable);
            defer _allocator.free(_pt0);
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:test/expressiveness_test.zbr:26
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "{}", .{(!_zebra_in("xyz", s))}) catch unreachable);
            defer _allocator.free(_pt0);
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:test/expressiveness_test.zbr:29
        const sep = _str_repeat("=", 20, _allocator);
// zbr:test/expressiveness_test.zbr:30
        std.debug.print("{s}\n", .{sep});
// zbr:test/expressiveness_test.zbr:31
...
// zbr:test/expressiveness_test.zbr:37
        nums.append(_allocator, 30) catch unreachable;
// zbr:test/expressiveness_test.zbr:38
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "{}", .{_zebra_in(20, nums)}) catch unreachable);
            defer _allocator.free(_pt0);
            std.debug.print("{s}\n", .{_pt0});
        }
// zbr:test/expressiveness_test.zbr:39
        {
            const _pt0 = (std.fmt.allocPrint(_allocator, "{}", .{_zebra_in(99, nums)}) catch unreachable);
            defer _allocator.free(_pt0);
            std.debug.print("{s}\n", .{_pt0});
        }
    }
