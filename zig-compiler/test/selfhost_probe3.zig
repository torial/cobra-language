...
// Source: test/selfhost_probe3.zbr
...
pub const Span = struct {
    _type_tag: u64 = _ttag_Span,
    line: i64 = undefined,
    col: i64 = undefined,
    pub fn init(l: i64, c: i64) Span {
        var self: Span = undefined;
        self._type_tag = _ttag_Span;
// zbr:test/selfhost_probe3.zbr:13
        self.line = l;
// zbr:test/selfhost_probe3.zbr:14
        self.col = c;
        return self;
    }
...
const _ttag_Span: u64 = 2879928289;
const _reflect_Span_name: []const u8 = "Span";
const _reflect_Span_fields: []const []const u8 = &.{"line", "col"};
const _reflect_Span_field_types: []const []const u8 = &.{"int", "int"};
...
pub const Token = struct {
    ...
    span: Span = undefined,
    pub fn init(k: TokenKind, t: []const u8, l: i64, c: i64) Token {
        var self: Token = undefined;
        self._type_tag = _ttag_Token;
// zbr:test/selfhost_probe3.zbr:21
        self.kind = k;
// zbr:test/selfhost_probe3.zbr:22
        self.text = t;
// zbr:test/selfhost_probe3.zbr:23
        self.span = Span.init(l, c);
        return self;
    }
...
const _reflect_Token_fields: []const []const u8 = &.{"kind", "text", "span"};
const _reflect_Token_field_types: []const []const u8 = &.{"TokenKind", "str", "Span"};

pub const Diag = struct {
    _type_tag: u64 = _ttag_Diag,
    message: []const u8 = undefined,
    line: i64 = undefined,
    col: i64 = undefined,
    pub fn init(msg: []const u8, l: i64, c: i64) Diag {
        var self: Diag = undefined;
        self._type_tag = _ttag_Diag;
// zbr:test/selfhost_probe3.zbr:30
        self.message = msg;
// zbr:test/selfhost_probe3.zbr:31
        self.line = l;
// zbr:test/selfhost_probe3.zbr:32
        self.col = c;
        return self;
    }

    pub fn show(self: *Diag) []const u8 {
// zbr:test/selfhost_probe3.zbr:34
        return self.message;
    }

};

const _ttag_Diag: u64 = 3533170478;
const _reflect_Diag_name: []const u8 = "Diag";
const _reflect_Diag_fields: []const []const u8 = &.{"message", "line", "col"};
const _reflect_Diag_field_types: []const []const u8 = &.{"str", "int", "int"};

pub const Helper = struct {
    _type_tag: u64 = _ttag_Helper,
    pub fn kindName(k: TokenKind) []const u8 {
// zbr:test/selfhost_probe3.zbr:39
        switch (k) {
            .ident => {
// zbr:test/selfhost_probe3.zbr:40
                return "ident";
            },
            .number => {
// zbr:test/selfhost_probe3.zbr:41
                return "number";
            },
            .plus => {
// zbr:test/selfhost_probe3.zbr:42
                return "plus";
            },
            .eof => {
// zbr:test/selfhost_probe3.zbr:43
                return "eof";
            },
        }
    }
    ...
    pub fn init() Helper {
        var self: Helper = undefined;
        self._type_tag = _ttag_Helper;
        return self;
    }

};

const _ttag_Helper: u64 = 1784786765;
const _reflect_Helper_name: []const u8 = "Helper";
const _reflect_Helper_fields: []const []const u8 = &.{};
const _reflect_Helper_field_types: []const []const u8 = &.{};
...
// zbr:test/selfhost_probe3.zbr:50
        self.tokens = std.ArrayList(Token){};
// zbr:test/selfhost_probe3.zbr:51
        self.pos = 0;
        return self;
    }

    pub fn push(self: *Lexer, k: TokenKind, t: []const u8, l: i64, c: i64) void {
// zbr:test/selfhost_probe3.zbr:54
        self.tokens.append(Token.init(k, t, l, c));
    }

    pub fn peek(self: *Lexer) TokenKind {
// zbr:test/selfhost_probe3.zbr:57
        if (_zebra_lt(self.pos, self.tokens.items.len)) {
// zbr:test/selfhost_probe3.zbr:58
            return self.tokens[@intCast(self.pos)].kind;
        }
// zbr:test/selfhost_probe3.zbr:59
        return TokenKind{ .eof = {} };
    }

    pub fn advance(self: *Lexer) Token {
// zbr:test/selfhost_probe3.zbr:62
        const t = self.tokens[@intCast(self.pos)];
// zbr:test/selfhost_probe3.zbr:63
        self.pos = (self.pos + 1);
// zbr:test/selfhost_probe3.zbr:64
        return t;
    }
...
const _reflect_Lexer_fields: []const []const u8 = &.{"tokens", "pos"};
const _reflect_Lexer_field_types: []const []const u8 = &.{"List(Token)", "int"};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/selfhost_probe3.zbr:69
        const t = Token.init(TokenKind{ .ident = {} }, "foo", 1, 0);
// zbr:test/selfhost_probe3.zbr:70
        std.debug.assert(std.mem.eql(u8, t.text, "foo"));
// zbr:test/selfhost_probe3.zbr:71
        std.debug.assert((t.span.line == 1));
// zbr:test/selfhost_probe3.zbr:73
        std.debug.assert(std.mem.eql(u8, Helper.kindName(TokenKind{ .plus = {} }), "plus"));
// zbr:test/selfhost_probe3.zbr:74
        std.debug.assert(std.mem.eql(u8, Helper.kindName(TokenKind{ .eof = {} }), "eof"));
// zbr:test/selfhost_probe3.zbr:76
        var d = Diag.init("unexpected token", 3, 7);
// zbr:test/selfhost_probe3.zbr:77
        std.debug.assert(std.mem.eql(u8, d.show(), "unexpected token"));
// zbr:test/selfhost_probe3.zbr:79
        std.debug.print("{s}\n", .{"self-hosting probe OK"});
    }
