...
// Source: test/transitive_test.zbr
...
pub fn _initAllocator(a: std.mem.Allocator) void {
    ...
    @import("StringHelper.zig")._initAllocator(a);
}
...
const StringHelper = @import("StringHelper.zig").StringHelper;
pub const App = struct {
    _type_tag: u64 = _ttag_App,
    pub fn main() void {
// zbr:test/transitive_test.zbr:7
        const n: i64 = MathUtils.double(3);
// zbr:test/transitive_test.zbr:8
        std.debug.print("{}\n", .{n});
// zbr:test/transitive_test.zbr:9
        const g: []const u8 = StringHelper.greet("hello");
// zbr:test/transitive_test.zbr:10
        std.debug.print("{s}\n", .{g});
    }
...
pub fn main() void {
    ...
    @import("StringHelper.zig")._initAllocator(_allocator);
    App.main();
}
