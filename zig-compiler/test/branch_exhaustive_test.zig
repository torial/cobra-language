...
// Source: test/branch_exhaustive_test.zbr
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/branch_exhaustive_test.zbr:10
        const s = Shape{ .circle = 3.14 };
// zbr:test/branch_exhaustive_test.zbr:11
        switch (s) {
            .circle => |r| {
...
// zbr:test/branch_exhaustive_test.zbr:20
        switch (s) {
            .circle => |r| {
...
// zbr:test/branch_exhaustive_test.zbr:27
        const s2 = Shape{ .rect = 42 };
// zbr:test/branch_exhaustive_test.zbr:28
        switch (s2) {
            .rect => |n| {
