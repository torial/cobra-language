...
pub const StringHelper = struct {
    _type_tag: u64 = _ttag_StringHelper,
    pub fn greet(name: []const u8) []const u8 {
// zbr:test/StringHelper.zbr:4
        return (std.mem.concat(_allocator, u8, &.{ name, "!" }) catch unreachable);
    }

    pub fn init() StringHelper {
        var self: StringHelper = undefined;
        self._type_tag = _ttag_StringHelper;
        return self;
    }

};

const _ttag_StringHelper: u64 = 1331083336;
const _reflect_StringHelper_name: []const u8 = "StringHelper";
const _reflect_StringHelper_fields: []const []const u8 = &.{};
const _reflect_StringHelper_field_types: []const []const u8 = &.{};
