...
// Source: test/branch_guard_test.zbr
...
// zbr:test/branch_guard_test.zbr:9
        const _bv_1b427830038 = s;
        var _bd_1b427830038 = false;
        if (!_bd_1b427830038 and _bv_1b427830038 == .circle) {
            const r = _bv_1b427830038.circle;
            if (_zebra_gt(r, 5.0)) {
            _bd_1b427830038 = true;
// zbr:test/branch_guard_test.zbr:11
                return "big circle";
            }
        }
        if (!_bd_1b427830038 and _bv_1b427830038 == .circle) {
            ...
            _ = r;
            _bd_1b427830038 = true;
// zbr:test/branch_guard_test.zbr:13
                return "small circle";
        }
        if (!_bd_1b427830038 and _bv_1b427830038 == .square) {
            const side = _bv_1b427830038.square;
            if (_zebra_gt(side, 10.0)) {
            _bd_1b427830038 = true;
// zbr:test/branch_guard_test.zbr:15
                return "big square";
            }
        }
        if (!_bd_1b427830038 and _bv_1b427830038 == .square) {
            ...
            _ = side;
            _bd_1b427830038 = true;
// zbr:test/branch_guard_test.zbr:17
                return "small square";
        }
        if (!_bd_1b427830038 and _bv_1b427830038 == .point) {
            _bd_1b427830038 = true;
// zbr:test/branch_guard_test.zbr:19
                return "point";
        }
        if (!_bd_1b427830038) unreachable;
        unreachable;
    }

    pub fn main() void {
// zbr:test/branch_guard_test.zbr:23
        const x = 7;
// zbr:test/branch_guard_test.zbr:24
        const _bv_1b4278305d8 = x;
        var _bd_1b4278305d8 = false;
        if (!_bd_1b4278305d8 and (_bv_1b4278305d8 == 7)) {
            if (_zebra_gt(x, 5)) {
            _bd_1b4278305d8 = true;
// zbr:test/branch_guard_test.zbr:26
                std.debug.print("{s}\n", .{"seven big"});
            }
        }
        if (!_bd_1b4278305d8 and (_bv_1b4278305d8 == 7)) {
            _bd_1b4278305d8 = true;
// zbr:test/branch_guard_test.zbr:28
                std.debug.print("{s}\n", .{"seven small"});
        }
        if (!_bd_1b4278305d8) {
// zbr:test/branch_guard_test.zbr:30
            std.debug.print("{s}\n", .{"other"});
        }
// zbr:test/branch_guard_test.zbr:33
        const y = 7;
// zbr:test/branch_guard_test.zbr:34
        const _bv_1b427830958 = y;
        var _bd_1b427830958 = false;
        if (!_bd_1b427830958 and (_bv_1b427830958 == 7)) {
            if (_zebra_gt(y, 100)) {
            _bd_1b427830958 = true;
// zbr:test/branch_guard_test.zbr:36
                std.debug.print("{s}\n", .{"seven huge"});
            }
        }
        if (!_bd_1b427830958 and (_bv_1b427830958 == 7)) {
            _bd_1b427830958 = true;
// zbr:test/branch_guard_test.zbr:38
                std.debug.print("{s}\n", .{"seven ok"});
        }
        if (!_bd_1b427830958) unreachable;
// zbr:test/branch_guard_test.zbr:41
        std.debug.print("{s}\n", .{Main.checkShape(Shape{ .circle = 8.0 })});
// zbr:test/branch_guard_test.zbr:42
        std.debug.print("{s}\n", .{Main.checkShape(Shape{ .circle = 3.0 })});
// zbr:test/branch_guard_test.zbr:43
        std.debug.print("{s}\n", .{Main.checkShape(Shape{ .square = 12.0 })});
// zbr:test/branch_guard_test.zbr:44
        std.debug.print("{s}\n", .{Main.checkShape(Shape{ .square = 4.0 })});
// zbr:test/branch_guard_test.zbr:45
        std.debug.print("{s}\n", .{Main.checkShape(Shape{ .point = {} })});
    }
