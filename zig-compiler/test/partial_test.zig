...
// zbr:test/partial_test.zbr:4
        return _str_concat("Hello, ", name, _allocator);
    }

    pub fn score(a: i64, b: i64) i64 {
// zbr:test/partial_test.zbr:5
        return (a - b);
    }
...
// zbr:test/partial_test.zbr:5
    ...
    pub fn init() PartialTest {
        var self: PartialTest = undefined;
        self._type_tag = _ttag_PartialTest;
        return self;
    }

};

const _ttag_PartialTest: u64 = 948776506;
const _reflect_PartialTest_name: []const u8 = "PartialTest";
const _reflect_PartialTest_fields: []const []const u8 = &.{};
const _reflect_PartialTest_field_types: []const []const u8 = &.{};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/partial_test.zbr:10
        const g = PartialTest.greet("Alice");
// zbr:test/partial_test.zbr:11
        if (!(std.mem.eql(u8, g, "Hello, Alice"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/partial_test.zbr:13
        const d = PartialTest.describe("Bob", 42);
// zbr:test/partial_test.zbr:14
        if (!(std.mem.eql(u8, d, "Bob: 42"))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/partial_test.zbr:16
        const s = PartialTest.score(10, 3);
// zbr:test/partial_test.zbr:17
        if (!((s == 7))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/partial_test.zbr:19
        std.debug.print("{s}\n", .{"partial_test: all assertions passed"});
    }
