...
// Source: test/selfhost_probe6.zbr
...
pub fn preamble() []const u8 {
// zbr:test/selfhost_probe6.zbr:15
    return "const std = @import(\"std\");\nconst Allocator = std.mem.Allocator;\npub fn main() void {}\n";
}

pub fn test_multiline() void {
// zbr:test/selfhost_probe6.zbr:22
    const s = preamble();
// zbr:test/selfhost_probe6.zbr:23
    std.debug.assert((std.mem.indexOf(u8, s, "const std") != null));
// zbr:test/selfhost_probe6.zbr:24
    std.debug.assert((std.mem.indexOf(u8, s, "pub fn main") != null));
// zbr:test/selfhost_probe6.zbr:25
    std.debug.print("{s}\n", .{"1. multiline \"\"\": OK"});
}

pub const GenCtx = struct {
    owner: []const u8 = undefined,
    indent_: i64 = undefined,
    throws_: bool = undefined,
    pub fn init(owner: []const u8, indent_: i64, throws_: bool) GenCtx {
        var self: GenCtx = undefined;
// zbr:test/selfhost_probe6.zbr:35
        self.owner = owner;
// zbr:test/selfhost_probe6.zbr:36
        self.indent_ = indent_;
// zbr:test/selfhost_probe6.zbr:37
        self.throws_ = throws_;
        return self;
    }

    pub fn withOwner(self: *GenCtx, new_owner: []const u8) GenCtx {
// zbr:test/selfhost_probe6.zbr:40
        const copy = blk: {
            var _tmp = self.*;
            _tmp.owner = new_owner;
            break :blk _tmp;
        };
// zbr:test/selfhost_probe6.zbr:42
        return copy;
    }

    pub fn withIndent(self: *GenCtx, delta: i64) GenCtx {
// zbr:test/selfhost_probe6.zbr:45
        const copy = blk: {
            var _tmp = self.*;
            _tmp.indent_ = (self.indent_ + delta);
            break :blk _tmp;
        };
// zbr:test/selfhost_probe6.zbr:47
        return copy;
    }

    pub fn withThrows(self: *GenCtx, t: bool) GenCtx {
// zbr:test/selfhost_probe6.zbr:50
        const copy = blk: {
            var _tmp = self.*;
            _tmp.throws_ = t;
            break :blk _tmp;
        };
// zbr:test/selfhost_probe6.zbr:52
        return copy;
    }

};

pub fn test_struct_except() void {
// zbr:test/selfhost_probe6.zbr:55
    var g = GenCtx.init("module", 0, false);
// zbr:test/selfhost_probe6.zbr:56
    var g2 = g.withOwner("MyClass");
// zbr:test/selfhost_probe6.zbr:57
    var g3 = g2.withIndent(1);
// zbr:test/selfhost_probe6.zbr:58
    const g4 = g3.withThrows(true);
// zbr:test/selfhost_probe6.zbr:59
    std.debug.assert(std.mem.eql(u8, g.owner, "module"));
// zbr:test/selfhost_probe6.zbr:60
    std.debug.assert(std.mem.eql(u8, g2.owner, "MyClass"));
// zbr:test/selfhost_probe6.zbr:61
    std.debug.assert((g3.indent_ == 1));
// zbr:test/selfhost_probe6.zbr:62
    std.debug.assert((g4.throws_ == true));
// zbr:test/selfhost_probe6.zbr:63
    std.debug.assert(std.mem.eql(u8, g3.owner, "MyClass"));
// zbr:test/selfhost_probe6.zbr:64
    std.debug.print("{s}\n", .{"2. struct except copy: OK"});
}

pub fn test_string_builder() void {
// zbr:test/selfhost_probe6.zbr:69
    var b = std.ArrayList(u8){};
    defer b.deinit(_allocator);
// zbr:test/selfhost_probe6.zbr:70
    b.appendSlice(_allocator, "pub fn ") catch @panic("OOM");
// zbr:test/selfhost_probe6.zbr:71
    b.appendSlice(_allocator, "init(") catch @panic("OOM");
// zbr:test/selfhost_probe6.zbr:72
    b.appendSlice(_allocator, ") void {") catch @panic("OOM");
// zbr:test/selfhost_probe6.zbr:73
    b.appendSlice(_allocator, "\n}") catch @panic("OOM");
// zbr:test/selfhost_probe6.zbr:74
    const result = (_allocator.dupe(u8, b.items) catch @panic("OOM"));
// zbr:test/selfhost_probe6.zbr:75
    std.debug.assert((std.mem.indexOf(u8, result, "pub fn init") != null));
// zbr:test/selfhost_probe6.zbr:76
    std.debug.assert((std.mem.indexOf(u8, result, "void") != null));
// zbr:test/selfhost_probe6.zbr:77
    std.debug.print("{s}\n", .{"3. StringBuilder: OK"});
}

pub const CgNode = union(enum) {
    int_lit: []const u8,
    float_lit: []const u8,
    bool_lit: bool,
    str_lit: []const u8,
...
pub fn emitNode(node: CgNode) []const u8 {
// zbr:test/selfhost_probe6.zbr:100
    switch (node) {
        .int_lit => |t| {
// zbr:test/selfhost_probe6.zbr:102
            return t;
        },
        .float_lit => |t| {
// zbr:test/selfhost_probe6.zbr:104
            return t;
        },
        .bool_lit => |v| {
// zbr:test/selfhost_probe6.zbr:106
            if (v) {
// zbr:test/selfhost_probe6.zbr:107
                return "true";
            }
// zbr:test/selfhost_probe6.zbr:108
            return "false";
        },
        .str_lit => |t| {
// zbr:test/selfhost_probe6.zbr:110
            return _str_concat(_str_concat("\"", t, _allocator), "\"", _allocator);
        },
        .nil_lit => {
// zbr:test/selfhost_probe6.zbr:112
            return "null";
        },
        .ident_ => |n| {
// zbr:test/selfhost_probe6.zbr:114
            return n;
        },
        .member_ => |n| {
// zbr:test/selfhost_probe6.zbr:116
            return _str_concat("self.", n, _allocator);
        },
        .call_ => |n| {
// zbr:test/selfhost_probe6.zbr:118
            return _str_concat(n, "()", _allocator);
        },
        .binary_ => |op| {
// zbr:test/selfhost_probe6.zbr:120
            return _str_concat(_str_concat("(", op, _allocator), ")", _allocator);
        },
        .unary_ => |op| {
// zbr:test/selfhost_probe6.zbr:122
            return op;
        },
        .cast_ => |t| {
// zbr:test/selfhost_probe6.zbr:124
            return _str_concat(_str_concat("@as(", t, _allocator), ", x)", _allocator);
        },
        .if_expr => |c| {
// zbr:test/selfhost_probe6.zbr:126
            return _str_concat(_str_concat("if (", c, _allocator), ") ...", _allocator);
        },
        .lambda_ => {
// zbr:test/selfhost_probe6.zbr:128
            return "fn() void { ... }";
        },
        .list_lit => |n| {
// zbr:test/selfhost_probe6.zbr:130
            return (std.fmt.allocPrint(_allocator, "list[{}]", .{n}) catch @panic("OOM"));
        },
        .dict_lit => |n| {
// zbr:test/selfhost_probe6.zbr:132
            return (std.fmt.allocPrint(_allocator, "dict[{}]", .{n}) catch @panic("OOM"));
        },
        .zig_lit => |t| {
// zbr:test/selfhost_probe6.zbr:134
            return t;
        },
    }
}

pub fn test_many_variants() void {
// zbr:test/selfhost_probe6.zbr:137
    std.debug.assert(std.mem.eql(u8, emitNode(CgNode{ .int_lit = "42" }), "42"));
// zbr:test/selfhost_probe6.zbr:138
    std.debug.assert(std.mem.eql(u8, emitNode(CgNode{ .bool_lit = true }), "true"));
// zbr:test/selfhost_probe6.zbr:139
    std.debug.assert(std.mem.eql(u8, emitNode(CgNode{ .bool_lit = false }), "false"));
// zbr:test/selfhost_probe6.zbr:140
    std.debug.assert(std.mem.eql(u8, emitNode(CgNode{ .str_lit = "hi" }), "\"hi\""));
// zbr:test/selfhost_probe6.zbr:141
    std.debug.assert(std.mem.eql(u8, emitNode(CgNode{ .nil_lit = {} }), "null"));
// zbr:test/selfhost_probe6.zbr:142
    std.debug.assert(std.mem.eql(u8, emitNode(CgNode{ .member_ = "x" }), "self.x"));
// zbr:test/selfhost_probe6.zbr:143
    std.debug.assert(std.mem.eql(u8, emitNode(CgNode{ .call_ = "foo" }), "foo()"));
// zbr:test/selfhost_probe6.zbr:144
    std.debug.assert(std.mem.eql(u8, emitNode(CgNode{ .cast_ = "i64" }), "@as(i64, x)"));
// zbr:test/selfhost_probe6.zbr:145
    std.debug.assert(std.mem.eql(u8, emitNode(CgNode{ .list_lit = 3 }), "list[3]"));
// zbr:test/selfhost_probe6.zbr:146
    std.debug.assert(std.mem.eql(u8, emitNode(CgNode{ .zig_lit = "@panic(\"x\")" }), "@panic(\"x\")"));
// zbr:test/selfhost_probe6.zbr:147
    std.debug.print("{s}\n", .{"4. branch many variants: OK"});
}

pub fn dispatchMethod(obj_type: []const u8, method: []const u8) []const u8 {
// zbr:test/selfhost_probe6.zbr:152
    if (std.mem.eql(u8, obj_type, "List")) {
// zbr:test/selfhost_probe6.zbr:153
        if (std.mem.eql(u8, method, "add")) {
// zbr:test/selfhost_probe6.zbr:154
            return "list.append";
        }
// zbr:test/selfhost_probe6.zbr:155
        if (std.mem.eql(u8, method, "count")) {
// zbr:test/selfhost_probe6.zbr:156
            return "@as(i64, @intCast(list.items.len))";
        }
// zbr:test/selfhost_probe6.zbr:157
        if (std.mem.eql(u8, method, "at")) {
// zbr:test/selfhost_probe6.zbr:158
            return "list.items";
        }
// zbr:test/selfhost_probe6.zbr:159
        if (std.mem.eql(u8, method, "remove")) {
// zbr:test/selfhost_probe6.zbr:160
            return "list.orderedRemove";
        }
// zbr:test/selfhost_probe6.zbr:161
        return _str_concat("list.", method, _allocator);
    }
// zbr:test/selfhost_probe6.zbr:162
    if (std.mem.eql(u8, obj_type, "HashMap")) {
// zbr:test/selfhost_probe6.zbr:163
        if (std.mem.eql(u8, method, "set")) {
// zbr:test/selfhost_probe6.zbr:164
            return "map.put";
        }
// zbr:test/selfhost_probe6.zbr:165
        if (std.mem.eql(u8, method, "get")) {
// zbr:test/selfhost_probe6.zbr:166
            return "map.get";
        }
// zbr:test/selfhost_probe6.zbr:167
        if (std.mem.eql(u8, method, "has")) {
// zbr:test/selfhost_probe6.zbr:168
            return "map.contains";
        }
// zbr:test/selfhost_probe6.zbr:169
        if (std.mem.eql(u8, method, "remove")) {
// zbr:test/selfhost_probe6.zbr:170
            return "map.remove";
        }
// zbr:test/selfhost_probe6.zbr:171
        return _str_concat("map.", method, _allocator);
    }
// zbr:test/selfhost_probe6.zbr:172
    if (std.mem.eql(u8, obj_type, "str")) {
// zbr:test/selfhost_probe6.zbr:173
        if (std.mem.eql(u8, method, "contains")) {
// zbr:test/selfhost_probe6.zbr:174
            return "std.mem.indexOf";
        }
// zbr:test/selfhost_probe6.zbr:175
        if (std.mem.eql(u8, method, "startsWith")) {
// zbr:test/selfhost_probe6.zbr:176
            return "std.mem.startsWith";
        }
// zbr:test/selfhost_probe6.zbr:177
        if (std.mem.eql(u8, method, "endsWith")) {
// zbr:test/selfhost_probe6.zbr:178
            return "std.mem.endsWith";
        }
// zbr:test/selfhost_probe6.zbr:179
        return _str_concat("str.", method, _allocator);
    }
// zbr:test/selfhost_probe6.zbr:180
    return _str_concat(_str_concat(obj_type, ".", _allocator), method, _allocator);
}

pub fn test_dispatch_chain() void {
// zbr:test/selfhost_probe6.zbr:183
    std.debug.assert(std.mem.eql(u8, dispatchMethod("List", "add"), "list.append"));
// zbr:test/selfhost_probe6.zbr:184
    std.debug.assert((std.mem.indexOf(u8, dispatchMethod("List", "count"), "intCast") != null));
// zbr:test/selfhost_probe6.zbr:185
    std.debug.assert(std.mem.eql(u8, dispatchMethod("HashMap", "has"), "map.contains"));
// zbr:test/selfhost_probe6.zbr:186
    std.debug.assert((std.mem.indexOf(u8, dispatchMethod("str", "startsWith"), "startsWith") != null));
// zbr:test/selfhost_probe6.zbr:187
    std.debug.assert(std.mem.eql(u8, dispatchMethod("Other", "foo"), "Other.foo"));
// zbr:test/selfhost_probe6.zbr:188
    std.debug.print("{s}\n", .{"5. dispatch chain: OK"});
}

pub const EmitCtx = struct {
    buf_: []const u8 = undefined,
    depth_: i64 = undefined,
    pub fn init() EmitCtx {
        var self: EmitCtx = undefined;
// zbr:test/selfhost_probe6.zbr:197
        self.buf_ = "";
// zbr:test/selfhost_probe6.zbr:198
        self.depth_ = 0;
        return self;
    }

    pub fn write_(self: *EmitCtx, s: []const u8) EmitCtx {
// zbr:test/selfhost_probe6.zbr:201
        const copy = blk: {
            var _tmp = self.*;
            _tmp.buf_ = _str_concat(self.buf_, s, _allocator);
            break :blk _tmp;
        };
// zbr:test/selfhost_probe6.zbr:203
        return copy;
    }

    pub fn indented(self: *EmitCtx) EmitCtx {
// zbr:test/selfhost_probe6.zbr:206
        const copy = blk: {
            var _tmp = self.*;
            _tmp.depth_ = (self.depth_ + 1);
            break :blk _tmp;
        };
// zbr:test/selfhost_probe6.zbr:208
        return copy;
    }

    pub fn dedented(self: *EmitCtx) EmitCtx {
// zbr:test/selfhost_probe6.zbr:211
        const copy = blk: {
            var _tmp = self.*;
            _tmp.depth_ = (self.depth_ - 1);
            break :blk _tmp;
        };
// zbr:test/selfhost_probe6.zbr:213
        return copy;
    }

    pub fn writeLine(self: *EmitCtx, s: []const u8) EmitCtx {
// zbr:test/selfhost_probe6.zbr:216
        const pad = (blk: { var _rep = std.ArrayList([]const u8){}; defer _rep.deinit(_allocator); var _ri: i64 = 0; while (_ri < self.depth_) : (_ri += 1) _rep.append(_allocator, "    ") catch unreachable; break :blk std.mem.concat(_allocator, u8, _rep.items) catch unreachable; });
        defer _allocator.free(pad);
// zbr:test/selfhost_probe6.zbr:217
        const copy = blk: {
            var _tmp = self.*;
            _tmp.buf_ = _str_concat(_str_concat(_str_concat(self.buf_, pad, _allocator), s, _allocator), "\n", _allocator);
            break :blk _tmp;
        };
// zbr:test/selfhost_probe6.zbr:219
        return copy;
    }

};

pub fn test_struct_return() void {
// zbr:test/selfhost_probe6.zbr:222
    var ctx = EmitCtx.init();
// zbr:test/selfhost_probe6.zbr:223
    ctx = ctx.indented();
// zbr:test/selfhost_probe6.zbr:224
    ctx = ctx.writeLine("pub fn foo() void {");
// zbr:test/selfhost_probe6.zbr:225
    ctx = ctx.indented();
// zbr:test/selfhost_probe6.zbr:226
    ctx = ctx.writeLine("return;");
// zbr:test/selfhost_probe6.zbr:227
    ctx = ctx.dedented();
// zbr:test/selfhost_probe6.zbr:228
    ctx = ctx.writeLine("}");
// zbr:test/selfhost_probe6.zbr:229
    std.debug.assert((std.mem.indexOf(u8, ctx.buf_, "pub fn foo") != null));
// zbr:test/selfhost_probe6.zbr:230
    std.debug.assert((std.mem.indexOf(u8, ctx.buf_, "return;") != null));
// zbr:test/selfhost_probe6.zbr:231
    std.debug.assert((std.mem.indexOf(u8, ctx.buf_, "        ") != null));
// zbr:test/selfhost_probe6.zbr:232
    std.debug.print("{s}\n", .{"6. struct method chain: OK"});
}

pub const SubCtx = struct {
    indent_: i64 = undefined,
    owner: []const u8 = undefined,
    out_: []const u8 = undefined,
    pub fn init(indent_: i64, owner: []const u8) SubCtx {
        var self: SubCtx = undefined;
// zbr:test/selfhost_probe6.zbr:242
        self.indent_ = indent_;
// zbr:test/selfhost_probe6.zbr:243
        self.owner = owner;
// zbr:test/selfhost_probe6.zbr:244
        self.out_ = "";
        return self;
    }

    pub fn sub(self: *SubCtx, extra: i64) SubCtx {
// zbr:test/selfhost_probe6.zbr:247
        const copy = blk: {
            var _tmp = self.*;
            _tmp.indent_ = (self.indent_ + extra);
            _tmp.out_ = "";
            break :blk _tmp;
        };
// zbr:test/selfhost_probe6.zbr:250
        return copy;
    }

    pub fn emit_(self: *SubCtx, s: []const u8) SubCtx {
// zbr:test/selfhost_probe6.zbr:253
        const copy = blk: {
            var _tmp = self.*;
            _tmp.out_ = _str_concat(self.out_, s, _allocator);
            break :blk _tmp;
        };
// zbr:test/selfhost_probe6.zbr:255
        return copy;
    }

};

pub fn test_nested_ctx() void {
// zbr:test/selfhost_probe6.zbr:258
    var g = SubCtx.init(0, "MyClass");
// zbr:test/selfhost_probe6.zbr:259
    var bg = g.sub(1);
// zbr:test/selfhost_probe6.zbr:260
    var bg2 = bg.emit_("var x: i64 = 0;");
// zbr:test/selfhost_probe6.zbr:261
    const bg3 = bg2.emit_(" var y = x + 1;");
// zbr:test/selfhost_probe6.zbr:262
    std.debug.assert((g.indent_ == 0));
// zbr:test/selfhost_probe6.zbr:263
    std.debug.assert(std.mem.eql(u8, g.out_, ""));
// zbr:test/selfhost_probe6.zbr:264
    std.debug.assert((bg.indent_ == 1));
// zbr:test/selfhost_probe6.zbr:265
    std.debug.assert((std.mem.indexOf(u8, bg3.out_, "x + 1") != null));
// zbr:test/selfhost_probe6.zbr:266
    std.debug.print("{s}\n", .{"7. nested struct ctx: OK"});
}

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:test/selfhost_probe6.zbr:273
        test_multiline();
// zbr:test/selfhost_probe6.zbr:274
        test_struct_except();
// zbr:test/selfhost_probe6.zbr:275
        test_string_builder();
// zbr:test/selfhost_probe6.zbr:276
        test_many_variants();
// zbr:test/selfhost_probe6.zbr:277
        test_dispatch_chain();
// zbr:test/selfhost_probe6.zbr:278
        test_struct_return();
// zbr:test/selfhost_probe6.zbr:279
        test_nested_ctx();
// zbr:test/selfhost_probe6.zbr:280
        std.debug.print("{s}\n", .{"selfhost_probe6: all OK"});
    }
