...
pub const Main = struct {
    pub fn main() void {
// zbr:test/unicode_test.zbr:5
        const s: []const u8 = "hello";
// zbr:test/unicode_test.zbr:6
        std.debug.print("{}\n", .{std.unicode.utf8ValidateSlice(s)});
// zbr:test/unicode_test.zbr:10
        std.debug.print("{}\n", .{@as(i64, @intCast(std.unicode.utf8CountCodepoints(s) catch 0))});
// zbr:test/unicode_test.zbr:14
        const word: []const u8 = "abc";
// zbr:test/unicode_test.zbr:15
        var _cp_it_310 = std.unicode.Utf8View.initUnchecked(word).iterator();
        while (_cp_it_310.nextCodepoint()) |c| {
// zbr:test/unicode_test.zbr:16
            std.debug.print("{u}\n", .{c});
        }
// zbr:test/unicode_test.zbr:19
        const ca: u21 = 'A';
// zbr:test/unicode_test.zbr:20
        const cz: u21 = 'z';
// zbr:test/unicode_test.zbr:21
        const c0: u21 = '0';
// zbr:test/unicode_test.zbr:22
        const sp: u21 = ' ';
// zbr:test/unicode_test.zbr:24
        std.debug.print("{any}\n", .{std.ascii.isAlphabetic(@as(u8, @truncate(ca)))});
// zbr:test/unicode_test.zbr:25
        std.debug.print("{any}\n", .{std.ascii.isAlphabetic(@as(u8, @truncate(c0)))});
// zbr:test/unicode_test.zbr:26
        std.debug.print("{any}\n", .{std.ascii.isDigit(@as(u8, @truncate(c0)))});
// zbr:test/unicode_test.zbr:27
        std.debug.print("{any}\n", .{std.ascii.isDigit(@as(u8, @truncate(ca)))});
// zbr:test/unicode_test.zbr:28
        std.debug.print("{any}\n", .{std.ascii.isWhitespace(@as(u8, @truncate(sp)))});
// zbr:test/unicode_test.zbr:29
        std.debug.print("{any}\n", .{std.ascii.isUpper(@as(u8, @truncate(ca)))});
// zbr:test/unicode_test.zbr:30
        std.debug.print("{any}\n", .{std.ascii.isLower(@as(u8, @truncate(cz)))});
// zbr:test/unicode_test.zbr:33
        std.debug.print("{any}\n", .{@as(u21, std.ascii.toLower(@as(u8, @truncate(ca))))});
// zbr:test/unicode_test.zbr:34
        std.debug.print("{any}\n", .{@as(u21, std.ascii.toUpper(@as(u8, @truncate(cz))))});
    }
