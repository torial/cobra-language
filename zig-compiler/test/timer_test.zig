...
pub const TimerTest = struct {
    _type_tag: u64 = _ttag_TimerTest,
    pub fn main() void {
// zbr:test/timer_test.zbr:3
        var t = _timer_start();
// zbr:test/timer_test.zbr:6
        const ms = t.elapsed();
// zbr:test/timer_test.zbr:7
        std.debug.assert(_zebra_ge(ms, 0.0));
// zbr:test/timer_test.zbr:8
        std.debug.print("{s}\n", .{"elapsed: OK"});
// zbr:test/timer_test.zbr:11
        const us = t.elapsedMicros();
// zbr:test/timer_test.zbr:12
        std.debug.assert(_zebra_ge(us, 0));
// zbr:test/timer_test.zbr:13
        std.debug.print("{s}\n", .{"elapsedMicros: OK"});
// zbr:test/timer_test.zbr:16
        t.reset();
// zbr:test/timer_test.zbr:17
        const ms2 = t.elapsed();
// zbr:test/timer_test.zbr:18
        std.debug.assert(_zebra_ge(ms2, 0.0));
// zbr:test/timer_test.zbr:19
        std.debug.print("{s}\n", .{"reset: OK"});
// zbr:test/timer_test.zbr:22
        var t1 = _timer_start();
// zbr:test/timer_test.zbr:23
        var t2 = _timer_start();
// zbr:test/timer_test.zbr:24
        const e1 = t1.elapsed();
// zbr:test/timer_test.zbr:25
        const e2 = t2.elapsed();
// zbr:test/timer_test.zbr:26
        std.debug.assert(_zebra_ge(e1, 0.0));
// zbr:test/timer_test.zbr:27
        std.debug.assert(_zebra_ge(e2, 0.0));
// zbr:test/timer_test.zbr:28
        std.debug.print("{s}\n", .{"independent timers: OK"});
// zbr:test/timer_test.zbr:30
        std.debug.print("{s}\n", .{"All timer tests passed."});
    }

    pub fn init() TimerTest {
        var self: TimerTest = undefined;
        self._type_tag = _ttag_TimerTest;
        return self;
    }

};

const _ttag_TimerTest: u64 = 3712572738;
const _reflect_TimerTest_name: []const u8 = "TimerTest";
const _reflect_TimerTest_fields: []const []const u8 = &.{};
const _reflect_TimerTest_field_types: []const []const u8 = &.{};
