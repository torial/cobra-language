...
// Source: test/string_branch_test.zbr
...
pub const Main = struct {
    _type_id: u32 = _tid_Main,
    pub fn classify(cmd: []const u8) []const u8 {
// zbr:test/string_branch_test.zbr:4
        {
            const _bs_1c351d901c8 = cmd;
            if (std.mem.eql(u8, _bs_1c351d901c8, "start") or std.mem.eql(u8, _bs_1c351d901c8, "begin")) {
// zbr:test/string_branch_test.zbr:6
                return "start command";
            } else if (std.mem.eql(u8, _bs_1c351d901c8, "stop") or std.mem.eql(u8, _bs_1c351d901c8, "end") or std.mem.eql(u8, _bs_1c351d901c8, "quit")) {
// zbr:test/string_branch_test.zbr:8
                return "stop command";
            } else if (std.mem.eql(u8, _bs_1c351d901c8, "help")) {
// zbr:test/string_branch_test.zbr:10
                return "help command";
            } else {
// zbr:test/string_branch_test.zbr:12
    ...
    pub fn main() void {
// zbr:test/string_branch_test.zbr:15
        std.debug.print("{s}\n", .{Main.classify("start")});
// zbr:test/string_branch_test.zbr:16
        std.debug.print("{s}\n", .{Main.classify("begin")});
// zbr:test/string_branch_test.zbr:17
        std.debug.print("{s}\n", .{Main.classify("stop")});
// zbr:test/string_branch_test.zbr:18
        std.debug.print("{s}\n", .{Main.classify("quit")});
// zbr:test/string_branch_test.zbr:19
        std.debug.print("{s}\n", .{Main.classify("help")});
// zbr:test/string_branch_test.zbr:20
        std.debug.print("{s}\n", .{Main.classify("foo")});
// zbr:test/string_branch_test.zbr:23
        const lang = "Zebra";
// zbr:test/string_branch_test.zbr:24
        {
            const _bs_1c351d854f0 = lang;
            if (std.mem.eql(u8, _bs_1c351d854f0, "Zebra")) {
// zbr:test/string_branch_test.zbr:26
                std.debug.print("{s}\n", .{"Zebra is the best"});
            } else if (std.mem.eql(u8, _bs_1c351d854f0, "Python")) {
// zbr:test/string_branch_test.zbr:28
                std.debug.print("{s}\n", .{"Python is fine"});
            } else {
// zbr:test/string_branch_test.zbr:30
                std.debug.print("{s}\n", .{"unknown language"});
            }
        }
    }
    ...
    pub fn init() Main {
        ...
        self._type_id = _tid_Main;
        return self;
    }

};

const _tid_Main: u32 = 1366325544;
