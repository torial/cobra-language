...
// zbr:test/string_branch_test.zbr:4
        {
            const _bs_18398fb01b8 = cmd;
            if (std.mem.eql(u8, _bs_18398fb01b8, "start") or std.mem.eql(u8, _bs_18398fb01b8, "begin")) {
// zbr:test/string_branch_test.zbr:6
                return "start command";
            } else if (std.mem.eql(u8, _bs_18398fb01b8, "stop") or std.mem.eql(u8, _bs_18398fb01b8, "end") or std.mem.eql(u8, _bs_18398fb01b8, "quit")) {
// zbr:test/string_branch_test.zbr:8
                return "stop command";
            } else if (std.mem.eql(u8, _bs_18398fb01b8, "help")) {
...
// zbr:test/string_branch_test.zbr:24
        {
            const _bs_18398dc5548 = lang;
            if (std.mem.eql(u8, _bs_18398dc5548, "Zebra")) {
// zbr:test/string_branch_test.zbr:26
                std.debug.print("{s}\n", .{"Zebra is the best"});
            } else if (std.mem.eql(u8, _bs_18398dc5548, "Python")) {
