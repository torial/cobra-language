...
// Source: test/branch_inline_return_test.zbr
...
pub const Calc = struct {
    ...
    scale: i64 = undefined,
    pub fn init(s: i64) Calc {
        var self: Calc = undefined;
        self._type_tag = _ttag_Calc;
// zbr:test/branch_inline_return_test.zbr:49
        self.scale = s;
        return self;
    }

    pub fn scaled(self: *Calc, n: i64) i64 {
// zbr:test/branch_inline_return_test.zbr:52
        return (n * self.scale);
    }

    pub fn describe(self: *Calc, o: Op) []const u8 {
        _ = self;
...
const _ttag_Calc: u64 = 1025367796;
const _reflect_Calc_name: []const u8 = "Calc";
const _reflect_Calc_fields: []const []const u8 = &.{"scale"};
const _reflect_Calc_field_types: []const []const u8 = &.{"int"};
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/branch_inline_return_test.zbr:77
        std.debug.assert(std.mem.eql(u8, opName(Op{ .add = {} }), "add"));
// zbr:test/branch_inline_return_test.zbr:78
        std.debug.assert(std.mem.eql(u8, opName(Op{ .neg = {} }), "neg"));
// zbr:test/branch_inline_return_test.zbr:79
        std.debug.assert(std.mem.eql(u8, opSymbol(Op{ .mul = {} }), "*"));
// zbr:test/branch_inline_return_test.zbr:82
        std.debug.assert((opPriority(Op{ .add = {} }) == 1));
// zbr:test/branch_inline_return_test.zbr:83
        std.debug.assert((opPriority(Op{ .mul = {} }) == 2));
// zbr:test/branch_inline_return_test.zbr:84
        std.debug.assert((opPriority(Op{ .neg = {} }) == 3));
// zbr:test/branch_inline_return_test.zbr:87
        std.debug.assert((isAdditive(Op{ .add = {} }) == true));
// zbr:test/branch_inline_return_test.zbr:88
        std.debug.assert((isAdditive(Op{ .mul = {} }) == false));
// zbr:test/branch_inline_return_test.zbr:91
        var c = Calc.init(10);
// zbr:test/branch_inline_return_test.zbr:92
        std.debug.assert(std.mem.eql(u8, c.describe(Op{ .add = {} }), "add"));
// zbr:test/branch_inline_return_test.zbr:93
        std.debug.assert((c.scaled(5) == 50));
// zbr:test/branch_inline_return_test.zbr:96
        std.debug.assert((opCode(Op{ .add = {} }) == 10));
// zbr:test/branch_inline_return_test.zbr:97
        std.debug.assert((opCode(Op{ .sub = {} }) == 20));
// zbr:test/branch_inline_return_test.zbr:98
        std.debug.assert((opCode(Op{ .mul = {} }) == 30));
// zbr:test/branch_inline_return_test.zbr:99
        std.debug.assert((opCode(Op{ .neg = {} }) == 40));
// zbr:test/branch_inline_return_test.zbr:102
        const x = Op{ .mul = {} };
...
// zbr:test/branch_inline_return_test.zbr:109
