...
// Source: test/list_direct_iter.zbr
...
pub const Program = struct {
    ...
    pub fn main() void {
// zbr:test/list_direct_iter.zbr:4
        var nums = std.ArrayList(i64){};
        defer nums.deinit(_allocator);
// zbr:test/list_direct_iter.zbr:5
        nums.append(_allocator, 1) catch unreachable;
// zbr:test/list_direct_iter.zbr:6
        nums.append(_allocator, 2) catch unreachable;
// zbr:test/list_direct_iter.zbr:7
        nums.append(_allocator, 3) catch unreachable;
// zbr:test/list_direct_iter.zbr:8
        for (nums.items) |x| {
// zbr:test/list_direct_iter.zbr:9
            std.debug.print("{}\n", .{x});
        }
    }
