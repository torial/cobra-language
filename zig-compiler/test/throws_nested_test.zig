...
// Source: C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr
...
pub const Helper = struct {
    ...
    pub fn compute(self: *Helper) anyerror!void {
        _ = self;
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr:15
        _error_ctx = .{ .message = "from compute", .details = null };
...
pub const Engine = struct {
    _type_tag: u64 = _ttag_Engine,
    helper: Helper = undefined,
    pub fn init() Engine {
        var self: Engine = undefined;
        self._type_tag = _ttag_Engine;
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr:21
        self.helper = Helper.init();
        return self;
    }

    pub fn doWork(self: *Engine) anyerror!void {
        _ = self;
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr:25
        _error_ctx = .{ .message = "from doWork", .details = null };
        return error.ZebraError;
    }

    pub fn run(self: *Engine) anyerror!void {
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr:29
        try self.doWork();
    }

    pub fn runWithHelper(self: *Engine) anyerror!void {
        _ = self;
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr:35
        const h = Helper.init();
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr:36
        try h.compute();
    }

};

const _ttag_Engine: u64 = 3680572763;
const _reflect_Engine_name: []const u8 = "Engine";
const _reflect_Engine_fields: []const []const u8 = &.{"helper"};
const _reflect_Engine_field_types: []const []const u8 = &.{"Helper"};

pub const Main = struct {
    _type_tag: u64 = _ttag_Main,
    pub fn main() void {
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr:41
        var e = Engine.init();
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr:44
        var _try_err_5020: ?anyerror = null;
        _try_blk_5020: {
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr:45
            e.run() catch |_tc_22bba7a3fa0| { _try_err_5020 = _tc_22bba7a3fa0; break :_try_blk_5020; };
            break :_try_blk_5020;
        }
        if (_try_err_5020 != null) {
            // pass
        }
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr:50
        var _try_err_5248: ?anyerror = null;
        _try_blk_5248: {
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr:51
            e.helper.compute() catch |_tc_22bba7b51f8| { _try_err_5248 = _tc_22bba7b51f8; break :_try_blk_5248; };
            break :_try_blk_5248;
        }
        if (_try_err_5248 != null) {
            // pass
        }
// zbr:C:/projects/cobra-language/zig-compiler/test/throws_nested_test.zbr:55
        std.debug.print("{s}\n", .{"throws_nested_test: passed"});
    }
