...
// Source: test/throws_nested_test.zbr
...
pub const Helper = struct {
    ...
    pub fn compute(self: *Helper) anyerror!void {
        _ = self;
// zbr:test/throws_nested_test.zbr:15
...
// zbr:test/throws_nested_test.zbr:21
    ...
    pub fn doWork(self: *Engine) anyerror!void {
        _ = self;
// zbr:test/throws_nested_test.zbr:25
        _error_ctx = .{ .message = "from doWork", .details = null };
        return error.ZebraError;
    }

    pub fn run(self: *Engine) anyerror!void {
// zbr:test/throws_nested_test.zbr:29
        try self.doWork();
    }

    pub fn runWithHelper(self: *Engine) anyerror!void {
        _ = self;
// zbr:test/throws_nested_test.zbr:35
        const h = Helper.init();
// zbr:test/throws_nested_test.zbr:36
        try h.compute();
    }
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/throws_nested_test.zbr:41
        var e = Engine.init();
// zbr:test/throws_nested_test.zbr:44
        var _try_err_5020: ?anyerror = null;
        _try_blk_5020: {
// zbr:test/throws_nested_test.zbr:45
            e.run() catch |_tc_2375cfa3fa0| { _try_err_5020 = _tc_2375cfa3fa0; break :_try_blk_5020; };
            break :_try_blk_5020;
        }
        if (_try_err_5020 != null) {
            // pass
        }
// zbr:test/throws_nested_test.zbr:50
        var _try_err_5248: ?anyerror = null;
        _try_blk_5248: {
// zbr:test/throws_nested_test.zbr:51
            e.helper.compute() catch |_tc_2375cfb51f8| { _try_err_5248 = _tc_2375cfb51f8; break :_try_blk_5248; };
            break :_try_blk_5248;
        }
        if (_try_err_5248 != null) {
            // pass
        }
// zbr:test/throws_nested_test.zbr:55
