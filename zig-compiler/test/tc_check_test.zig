...
const TcCheck = tc_check.TcCheck;
...
pub const Main = struct {
    ...
    pub fn main() void {
// zbr:test/tc_check_test.zbr:13
        const sc = TcScope.init();
// zbr:test/tc_check_test.zbr:14
        sc.push(TcScopeKind.module_);
// zbr:test/tc_check_test.zbr:15
        sc.push(TcScopeKind.method_);
// zbr:test/tc_check_test.zbr:16
        const sym_n = TcSymbol.init("n", TcSymKind.local, TcType{ .int_ = {} });
// zbr:test/tc_check_test.zbr:17
        std.debug.assert(sc.define("n", sym_n));
// zbr:test/tc_check_test.zbr:18
        const inf = TcInfer.init(sc);
// zbr:test/tc_check_test.zbr:21
        const chk1 = TcCheck.init(inf, TcType{ .int_ = {} });
// zbr:test/tc_check_test.zbr:22
        const ret_ok = TcStmtReturn.init(TcExpr{ .int_lit = {} });
// zbr:test/tc_check_test.zbr:23
        chk1.checkStmt(TcStmt{ .return_ = ret_ok });
// zbr:test/tc_check_test.zbr:24
        if (!(chk1.ok())) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/tc_check_test.zbr:25
        std.debug.print("{s}\n", .{"1. valid return OK"});
// zbr:test/tc_check_test.zbr:28
        const chk2 = TcCheck.init(inf, TcType{ .int_ = {} });
// zbr:test/tc_check_test.zbr:29
        const ret_bad = TcStmtReturn.init(TcExpr{ .string_lit = {} });
// zbr:test/tc_check_test.zbr:30
        chk2.checkStmt(TcStmt{ .return_ = ret_bad });
// zbr:test/tc_check_test.zbr:31
        if (!((!chk2.ok()))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/tc_check_test.zbr:32
        std.debug.assert((@as(i64, @intCast(chk2.errors.items.len)) == 1));
// zbr:test/tc_check_test.zbr:33
        std.debug.print("{s}\n", .{"2. return type mismatch reported OK"});
// zbr:test/tc_check_test.zbr:36
        const chk3 = TcCheck.init(inf, TcType{ .void_ = {} });
// zbr:test/tc_check_test.zbr:37
        chk3.checkStmt(TcStmt{ .return_void = {} });
// zbr:test/tc_check_test.zbr:38
        std.debug.assert(chk3.ok());
// zbr:test/tc_check_test.zbr:39
        std.debug.print("{s}\n", .{"3. void return in void method OK"});
// zbr:test/tc_check_test.zbr:42
        const chk4 = TcCheck.init(inf, TcType{ .int_ = {} });
// zbr:test/tc_check_test.zbr:43
        chk4.checkStmt(TcStmt{ .return_void = {} });
// zbr:test/tc_check_test.zbr:44
        std.debug.assert((!chk4.ok()));
// zbr:test/tc_check_test.zbr:45
        std.debug.print("{s}\n", .{"4. void return in int method reported OK"});
// zbr:test/tc_check_test.zbr:48
        const chk5 = TcCheck.init(inf, TcType{ .void_ = {} });
// zbr:test/tc_check_test.zbr:49
        const vd_ok = TcStmtVarDecl.init("x", TcType{ .int_ = {} }, TcExpr{ .int_lit = {} });
// zbr:test/tc_check_test.zbr:50
        chk5.checkStmt(TcStmt{ .var_decl = vd_ok });
// zbr:test/tc_check_test.zbr:51
        std.debug.assert(chk5.ok());
// zbr:test/tc_check_test.zbr:52
        std.debug.print("{s}\n", .{"5. valid var_decl OK"});
// zbr:test/tc_check_test.zbr:55
        const chk6 = TcCheck.init(inf, TcType{ .void_ = {} });
// zbr:test/tc_check_test.zbr:56
        const vd_bad = TcStmtVarDecl.init("x", TcType{ .int_ = {} }, TcExpr{ .string_lit = {} });
// zbr:test/tc_check_test.zbr:57
        chk6.checkStmt(TcStmt{ .var_decl = vd_bad });
// zbr:test/tc_check_test.zbr:58
        std.debug.assert((!chk6.ok()));
// zbr:test/tc_check_test.zbr:59
        std.debug.assert((@as(i64, @intCast(chk6.errors.items.len)) == 1));
// zbr:test/tc_check_test.zbr:60
        std.debug.print("{s}\n", .{"6. var_decl mismatch reported OK"});
// zbr:test/tc_check_test.zbr:63
        const chk7 = TcCheck.init(inf, TcType{ .void_ = {} });
// zbr:test/tc_check_test.zbr:64
        const bi_cmp = TcExprBinary.init("==", TcExpr{ .int_lit = {} }, TcExpr{ .int_lit = {} });
// zbr:test/tc_check_test.zbr:65
        const if_ok = TcStmtIf.init(TcExpr{ .binary = _box_25309760be8: { const _bp_25309760be8 = _allocator.create(tc_infer.TcExprBinary) catch @panic("OOM"); _bp_25309760be8.* = bi_cmp; break :_box_25309760be8 _bp_25309760be8; } });
// zbr:test/tc_check_test.zbr:66
        chk7.checkStmt(TcStmt{ .if_ = if_ok });
// zbr:test/tc_check_test.zbr:67
        std.debug.assert(chk7.ok());
// zbr:test/tc_check_test.zbr:68
        std.debug.print("{s}\n", .{"7. if with bool cond OK"});
// zbr:test/tc_check_test.zbr:71
        const chk8 = TcCheck.init(inf, TcType{ .void_ = {} });
// zbr:test/tc_check_test.zbr:72
        const if_bad = TcStmtIf.init(TcExpr{ .int_lit = {} });
// zbr:test/tc_check_test.zbr:73
        chk8.checkStmt(TcStmt{ .if_ = if_bad });
// zbr:test/tc_check_test.zbr:74
        std.debug.assert((!chk8.ok()));
// zbr:test/tc_check_test.zbr:75
        std.debug.print("{s}\n", .{"8. if with int cond reported OK"});
// zbr:test/tc_check_test.zbr:78
        const chk9 = TcCheck.init(inf, TcType{ .void_ = {} });
// zbr:test/tc_check_test.zbr:79
        const assert_ok = TcStmtAssert.init(TcExpr{ .bool_lit = {} });
// zbr:test/tc_check_test.zbr:80
        chk9.checkStmt(TcStmt{ .assert_ = assert_ok });
// zbr:test/tc_check_test.zbr:81
        std.debug.assert(chk9.ok());
// zbr:test/tc_check_test.zbr:82
        std.debug.print("{s}\n", .{"9. assert with bool cond OK"});
// zbr:test/tc_check_test.zbr:85
        const chk10 = TcCheck.init(inf, TcType{ .void_ = {} });
// zbr:test/tc_check_test.zbr:86
        const assert_bad = TcStmtAssert.init(TcExpr{ .string_lit = {} });
// zbr:test/tc_check_test.zbr:87
        chk10.checkStmt(TcStmt{ .assert_ = assert_bad });
// zbr:test/tc_check_test.zbr:88
        std.debug.assert((!chk10.ok()));
// zbr:test/tc_check_test.zbr:89
        std.debug.print("{s}\n", .{"10. assert with string cond reported OK"});
// zbr:test/tc_check_test.zbr:92
        const chk11 = TcCheck.init(inf, TcType{ .void_ = {} });
// zbr:test/tc_check_test.zbr:93
        chk11.checkStmt(TcStmt{ .pass_ = {} });
// zbr:test/tc_check_test.zbr:94
        std.debug.assert(chk11.ok());
// zbr:test/tc_check_test.zbr:95
        std.debug.print("{s}\n", .{"11. pass_ OK"});
// zbr:test/tc_check_test.zbr:98
        const chk12 = TcCheck.init(inf, TcType{ .int_ = {} });
// zbr:test/tc_check_test.zbr:99
        var stmts = std.ArrayList(TcStmt){};
// zbr:test/tc_check_test.zbr:100
        stmts.append(_allocator, TcStmt{ .var_decl = TcStmtVarDecl.init("a", TcType{ .int_ = {} }, TcExpr{ .string_lit = {} }) }) catch unreachable;
// zbr:test/tc_check_test.zbr:101
        stmts.append(_allocator, TcStmt{ .var_decl = TcStmtVarDecl.init("b", TcType{ .string_ = {} }, TcExpr{ .int_lit = {} }) }) catch unreachable;
// zbr:test/tc_check_test.zbr:102
        stmts.append(_allocator, TcStmt{ .pass_ = {} }) catch unreachable;
// zbr:test/tc_check_test.zbr:103
        chk12.checkStmts(stmts);
// zbr:test/tc_check_test.zbr:104
        if (!((@as(i64, @intCast(chk12.errors.items.len)) == 2))) {
            std.debug.print("assertion failed\n", .{});
            unreachable;
        }
// zbr:test/tc_check_test.zbr:105
        std.debug.print("{s}\n", .{"12. checkStmts accumulates errors OK"});
// zbr:test/tc_check_test.zbr:107
        std.debug.print("{s}\n", .{"tc_check_test: all OK"});
    }
