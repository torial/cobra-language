...
pub const App = struct {
    pub fn findPositive(x: i64) ?i64 {
// zbr:test/nilable_test.zbr:4
        if (_zebra_gt(x, 0)) {
// zbr:test/nilable_test.zbr:5
            return x;
        }
// zbr:test/nilable_test.zbr:6
        return null;
    }

    pub fn orDefault(val: ?i64, fallback: i64) i64 {
// zbr:test/nilable_test.zbr:9
        return val orelse fallback;
    }

    pub fn main() void {
// zbr:test/nilable_test.zbr:12
        const a: ?i64 = App.findPositive(5);
// zbr:test/nilable_test.zbr:13
        const b: ?i64 = App.findPositive((-1));
// zbr:test/nilable_test.zbr:15
        if ((a == null)) {
// zbr:test/nilable_test.zbr:16
            std.debug.print("{s}\n", .{"a is nil"});
        } else {
// zbr:test/nilable_test.zbr:18
            std.debug.print("{}\n", .{a.?});
        }
// zbr:test/nilable_test.zbr:20
        if ((b == null)) {
// zbr:test/nilable_test.zbr:21
            std.debug.print("{s}\n", .{"b is nil"});
        }
// zbr:test/nilable_test.zbr:23
        const c: i64 = App.orDefault(a, 99);
// zbr:test/nilable_test.zbr:24
        const d: i64 = App.orDefault(b, 99);
// zbr:test/nilable_test.zbr:25
        std.debug.print("{}\n", .{c});
// zbr:test/nilable_test.zbr:26
        std.debug.print("{}\n", .{d});
    }
